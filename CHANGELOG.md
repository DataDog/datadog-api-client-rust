...
### Changed
* 200 col lim explicit in api docs [#1928](https://github.com/DataDog/datadog-api-client-rust/pull/1928)
* Add GET/PATCH /api/v2/ci/github/accounts to CI Visibility spec [#1916](https://github.com/DataDog/datadog-api-client-rust/pull/1916)
* Mark supported_values as nullable and remove unused detection_frequency in Governance Console API [#1912](https://github.com/DataDog/datadog-api-client-rust/pull/1912)

### Added
* Add llm-observability alert monitor type [#1927](https://github.com/DataDog/datadog-api-client-rust/pull/1927)
* Add allowed_resources to Deployment Gates FDD rule options [#1926](https://github.com/DataDog/datadog-api-client-rust/pull/1926)
* Document meta.idempotency_key in CreateDegradation and UpdateDegradation [#1920](https://github.com/DataDog/datadog-api-client-rust/pull/1920)
*  Add spec for maintenance update edit endpoint [#1909](https://github.com/DataDog/datadog-api-client-rust/pull/1909)
* Document PATCH /api/v2/dora/deployments [#1905](https://github.com/DataDog/datadog-api-client-rust/pull/1905)

### Removed
* Update Status Pages UpdateStatusPage documentation to reflect enabled attribute deprecation [#1924](https://github.com/DataDog/datadog-api-client-rust/pull/1924)
* Make RUM rate limit config API private pending rename [#1918](https://github.com/DataDog/datadog-api-client-rust/pull/1918)

### Fixed
* Remove redundant otel fields from Fleet Automation v2 agent detail endpoint [#1915](https://github.com/DataDog/datadog-api-client-rust/pull/1915)
...
### Changed
* Add wasm32-unknown-unknown and wasm32-wasip2 build support [#1434](https://github.com/DataDog/datadog-api-client-rust/pull/1434)
* Add sample_attribute to log exclusion filter [#1399](https://github.com/DataDog/datadog-api-client-rust/pull/1399)
* Add tags and description fields to the logs nested pipeline type LogsPipelineProcessor [#1388](https://github.com/DataDog/datadog-api-client-rust/pull/1388)
* Update documentation for api/v2/metrics endpoint [#1379](https://github.com/DataDog/datadog-api-client-rust/pull/1379)
* Observability Pipelines - Updating descriptions and making the tags field optional not required [#1283](https://github.com/DataDog/datadog-api-client-rust/pull/1283)
* Fix Restriction Policies API documentation - add missing resource types [#1246](https://github.com/DataDog/datadog-api-client-rust/pull/1246)

### Added
* Add wasm32-unknown-unknown and wasm32-wasip2 build support [#1434](https://github.com/DataDog/datadog-api-client-rust/pull/1434)
* Add Synthetics test file upload and download endpoints [#1432](https://github.com/DataDog/datadog-api-client-rust/pull/1432)
* document v2 stable mcnulty-web-py3 endpoints [#1430](https://github.com/DataDog/datadog-api-client-rust/pull/1430)
* document synthetics API to retrieve fast test result [#1426](https://github.com/DataDog/datadog-api-client-rust/pull/1426)
* Add description field to widget definition schemas [#1408](https://github.com/DataDog/datadog-api-client-rust/pull/1408)
* Add Widgets API v2 OpenAPI spec [#1406](https://github.com/DataDog/datadog-api-client-rust/pull/1406)
* Add bulk triage endpoints for security monitoring signals [#1405](https://github.com/DataDog/datadog-api-client-rust/pull/1405)
* Add cost_aggregation parameter to GetEstimatedCostByOrg [#1400](https://github.com/DataDog/datadog-api-client-rust/pull/1400)
* Add new endpoints for Test Optimization settings for service [#1395](https://github.com/DataDog/datadog-api-client-rust/pull/1395)
* dashboards - Add DashboardTab schema and tabs property to Dashboard spec [#1393](https://github.com/DataDog/datadog-api-client-rust/pull/1393)
* Add WildcardWidgetDefinition to Dashboard spec [#1390](https://github.com/DataDog/datadog-api-client-rust/pull/1390)
* Add feature flags public api endpoints to api spec [#1386](https://github.com/DataDog/datadog-api-client-rust/pull/1386)
* Use openapi-transformer split mechanism for full spec generation [#1385](https://github.com/DataDog/datadog-api-client-rust/pull/1385)
* Add v2 deployment gates evaluation endpoints [#1384](https://github.com/DataDog/datadog-api-client-rust/pull/1384)
* Make datadog agent source address configurable in Observability Pipelines [#1380](https://github.com/DataDog/datadog-api-client-rust/pull/1380)
* Add OpenAPI documentation for keep_unmatched field in ocsf mapper processor  [#1376](https://github.com/DataDog/datadog-api-client-rust/pull/1376)
* Add Batch Rows Query Endpoint to Reference Tables API spec [#1373](https://github.com/DataDog/datadog-api-client-rust/pull/1373)
* Add apm_metrics query support to dashboard OpenAPI spec [#1370](https://github.com/DataDog/datadog-api-client-rust/pull/1370)
* Add Observability Pipelines Amazon S3 Generic destination [#1366](https://github.com/DataDog/datadog-api-client-rust/pull/1366)
* [OPA-4681] Update Public API for Splunk HEC destination indexed_fields [#1362](https://github.com/DataDog/datadog-api-client-rust/pull/1362)
* RUM - simplify cross-product sampling descriptions on rum-retention-filters API docs [#1324](https://github.com/DataDog/datadog-api-client-rust/pull/1324)
* Add `name_aliases` field to `PermissionAttributes` for `ListPermissions` endpoint [#1323](https://github.com/DataDog/datadog-api-client-rust/pull/1323)
* Add audit track to list of available org connections [#1320](https://github.com/DataDog/datadog-api-client-rust/pull/1320)
* Add partial hierarchy selection to team sync endpoints [#1315](https://github.com/DataDog/datadog-api-client-rust/pull/1315)
* Billing_plan field deprecation - correction start date [#1311](https://github.com/DataDog/datadog-api-client-rust/pull/1311)
* Add support for composite queries on monitor variables [#1309](https://github.com/DataDog/datadog-api-client-rust/pull/1309)
* Add ci_code_coverage_committers to usage API [#1307](https://github.com/DataDog/datadog-api-client-rust/pull/1307)
* Expose usage-attribution-types publicly and update attribution descriptions [#1306](https://github.com/DataDog/datadog-api-client-rust/pull/1306)
* Adds OpenTelemetry source support for metrics pipelines [#1305](https://github.com/DataDog/datadog-api-client-rust/pull/1305)
* Add Edge Devices Monitoring fields to usage summary API [#1298](https://github.com/DataDog/datadog-api-client-rust/pull/1298)
* Add new param to api/v2/metrics [#1297](https://github.com/DataDog/datadog-api-client-rust/pull/1297)
* Add Network Path fields to usage summary API [#1296](https://github.com/DataDog/datadog-api-client-rust/pull/1296)
* Add FormulaAndFunctionEventQueryGroupByFields schema to support flat group_by form [#1294](https://github.com/DataDog/datadog-api-client-rust/pull/1294)
* billing_plan field deprecation in billable-summary endpoint [#1289](https://github.com/DataDog/datadog-api-client-rust/pull/1289)
* Add OpenAPI spec for LLM Observability Experiments API [#1287](https://github.com/DataDog/datadog-api-client-rust/pull/1287)
* Add OCI support to Cloud Security Management Enterprise usage fields [#1282](https://github.com/DataDog/datadog-api-client-rust/pull/1282)
* Add bad events support in metric SLOs [#1280](https://github.com/DataDog/datadog-api-client-rust/pull/1280)
* Add missing persona_mapping endpoints [#1276](https://github.com/DataDog/datadog-api-client-rust/pull/1276)
* Adding Observability Pipelines Secret Management feature support [#1274](https://github.com/DataDog/datadog-api-client-rust/pull/1274)
* Workflow Automation - Add Form Trigger [#1273](https://github.com/DataDog/datadog-api-client-rust/pull/1273)
* Add Maintenances and minor updates to Status Pages API [#1271](https://github.com/DataDog/datadog-api-client-rust/pull/1271)
* Add OpenAPI spec for Change Management endpoints [#1265](https://github.com/DataDog/datadog-api-client-rust/pull/1265)
* Introduce api/v2/integration API endpoint [#1263](https://github.com/DataDog/datadog-api-client-rust/pull/1263)
* Add sort parameter to detection rules list endpoint [#1259](https://github.com/DataDog/datadog-api-client-rust/pull/1259)
* dashboards - Add DashboardTab schema and tabs property to Dashboard spec [#1257](https://github.com/DataDog/datadog-api-client-rust/pull/1257)
* Add public documentation on NDM interface tags endpoint [#1256](https://github.com/DataDog/datadog-api-client-rust/pull/1256)
* Add documentation for POST api/v2/incidents/import [#1252](https://github.com/DataDog/datadog-api-client-rust/pull/1252)
* Post an event v2 API - add a new enum value to links.category field and add pattern validation on changed_resource.name field [#1251](https://github.com/DataDog/datadog-api-client-rust/pull/1251)
* Add receives_permissions_from field to Roles API [#1245](https://github.com/DataDog/datadog-api-client-rust/pull/1245)
* Add new endpoints for Code Coverage summary information [#1244](https://github.com/DataDog/datadog-api-client-rust/pull/1244)
* Adding custom mapper support to Observability Pipelines OCSF Mapper [#1241](https://github.com/DataDog/datadog-api-client-rust/pull/1241)
* Add seats API v2 endpoints with error responses and required fields [#1240](https://github.com/DataDog/datadog-api-client-rust/pull/1240)
* Timeseries Request Style supports value labels field [#1230](https://github.com/DataDog/datadog-api-client-rust/pull/1230)
* Added support for Google Chat Organization Handles Public API [#1220](https://github.com/DataDog/datadog-api-client-rust/pull/1220)
* Add Network Path test endpoints to v2 spec [#1216](https://github.com/DataDog/datadog-api-client-rust/pull/1216)
* Add OpenAPI documentation for cloud-auth-config service [#1186](https://github.com/DataDog/datadog-api-client-rust/pull/1186)
* Add suppression sort by create date [#1171](https://github.com/DataDog/datadog-api-client-rust/pull/1171)
* Add specs for new ccm_config endpoints [#1152](https://github.com/DataDog/datadog-api-client-rust/pull/1152)
* Add Sankey widget definition to Dashboards api specs [#1130](https://github.com/DataDog/datadog-api-client-rust/pull/1130)

### Fixed
* Fix consistency issues in security monitoring signal triage routes [#1422](https://github.com/DataDog/datadog-api-client-rust/pull/1422)
* Add pageStart extension to case management pagination [#1412](https://github.com/DataDog/datadog-api-client-rust/pull/1412)
* Fix consistency issues in security monitoring signal triage routes [#1404](https://github.com/DataDog/datadog-api-client-rust/pull/1404)
* fix(MonitorThresholds): treat empty string as null for f64 threshold fields [#1292](https://github.com/DataDog/datadog-api-client-rust/pull/1292)
* Fix WidgetNewFixedSpan - timestamps are milliseconds not seconds [#1267](https://github.com/DataDog/datadog-api-client-rust/pull/1267)
* Increase validation limit on integration type [#1260](https://github.com/DataDog/datadog-api-client-rust/pull/1260)
...
### Deprecated
* Deprecate ListVulnerabilities endpoint [#1402](https://github.com/DataDog/datadog-api-client-rust/pull/1402)
* Deprecate appsecspans datasource in SecurityMonitoringStandardDataSource [#1374](https://github.com/DataDog/datadog-api-client-rust/pull/1374)
* Mark legacy non-FnF query fields and WidgetEvent as deprecated in dashboard spec + update Distribuition docs [#1291](https://github.com/DataDog/datadog-api-client-rust/pull/1291)
