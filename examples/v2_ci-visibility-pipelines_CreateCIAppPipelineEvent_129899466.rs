...
use datadog_api_client::datadogV2::model::CIAppPipelineEventFinishedJob;
                ...
                CIAppCreatePipelineEventRequestData::new()
                    .attributes(CIAppCreatePipelineEventRequestAttributes::new(
                        CIAppCreatePipelineEventRequestAttributesResource::CIAppPipelineEventJob(
                            Box::new(CIAppPipelineEventJob::CIAppPipelineEventFinishedJob(
                                Box::new(CIAppPipelineEventFinishedJob::new(
