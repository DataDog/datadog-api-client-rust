// Update targeting rules for a flag in an environment with a scheduled start
// returns "OK" response
...
async fn main() {
    ...
    let body = OverwriteAllocationsRequest::new(vec![AllocationDataRequest::new(
        UpsertAllocationRequest::new(
            "scheduled-start-allocation-example-feature-flag".to_string(),
        ...
        .exposure_schedule(ExposureScheduleRequest::new(
            RolloutOptionsRequest::new(RolloutStrategy::UNIFORM_INTERVALS)
                .scheduled_start("absolute:2021-11-12T11:11:11+00:00".to_string())
