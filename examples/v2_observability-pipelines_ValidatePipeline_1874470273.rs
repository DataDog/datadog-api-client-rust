// Validate an observability pipeline with Splunk HEC destination endpoint_target
// returns "OK" response
...
use datadog_api_client::datadogV2::model::ObservabilityPipelineSplunkHecDestinationEndpointTarget;
        ...
        ObservabilityPipelineSpec::new(
            ObservabilityPipelineSpecData::new(
                ObservabilityPipelineDataAttributes::new(
                    ...
                    "Pipeline with Splunk HEC endpoint_target".to_string(),
                ),
                "pipelines".to_string(),
            ),
        );
