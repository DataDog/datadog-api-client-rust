...
use datadog_api_client::datadogV2::model::RecommendationsFilterRequestData;
use datadog_api_client::datadogV2::model::RecommendationsFilterRequestDataAttributes;
use datadog_api_client::datadogV2::model::RecommendationsFilterRequestDataType;
use datadog_api_client::datadogV2::model::RecommendationsFilterRequestScope;
use datadog_api_client::datadogV2::model::RecommendationsFilterRequestSortItems;

#[tokio::main]
async fn main() {
    let body = RecommendationsFilterRequest::new(
        RecommendationsFilterRequestData::new(
