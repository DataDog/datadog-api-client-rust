...
async fn main() {
    let body =
        ServiceDefinitionsCreateRequest::ServiceDefinitionV2(
            Box::new(
                ServiceDefinitionV2::new(
                    ...
                    .contacts(
                        vec![
                            ServiceDefinitionV2Contact::ServiceDefinitionV2Email(
                                Box::new(
