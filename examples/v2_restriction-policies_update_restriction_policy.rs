...
async fn main() {
    ...
    let body =
        RestrictionPolicyUpdateRequest::new(
            RestrictionPolicy::new(
                RestrictionPolicyAttributes::new(
                    vec![
                        RestrictionPolicyBinding::new(
    ...
    let resp = api.update_restriction_policy("dashboard:test-update".to_string(), body).await;
