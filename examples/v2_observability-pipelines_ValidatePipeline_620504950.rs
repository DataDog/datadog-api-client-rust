// Validate an observability pipeline with ClickHouse destination arrow_stream
// format returns "OK" response
        ...
        ObservabilityPipelineSpec::new(
            ObservabilityPipelineSpecData::new(
                ObservabilityPipelineDataAttributes::new(
                    ...
                    "Pipeline with ClickHouse Destination Arrow Stream".to_string(),
                ),
                "pipelines".to_string(),
            ),
        );
