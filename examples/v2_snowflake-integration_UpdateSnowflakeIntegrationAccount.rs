...
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountAuthenticationUpdate;
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountPrivateKeyAuthType;
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountPrivateKeyAuthUpdate;
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountSettingsUpdate;
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountUpdateAttributes;
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountUpdateData;
use datadog_api_client::datadogV2::model::SnowflakeIntegrationAccountUpdateRequest;
...
async fn main() {
    let body =
        SnowflakeIntegrationAccountUpdateRequest::new(
            SnowflakeIntegrationAccountUpdateData::new(
                SnowflakeIntegrationAccountUpdateAttributes::new()
                    .authentication(
                        SnowflakeIntegrationAccountAuthenticationUpdate
                        ::SnowflakeIntegrationAccountPrivateKeyAuthUpdate(
                            Box::new(
                                SnowflakeIntegrationAccountPrivateKeyAuthUpdate::new(
...
-----END PRIVATE KEY-----"#.to_string(),
                                    ...
                                    .private_key_name("my-rsa-key".to_string())
                                    .private_key_passphrase(Some("your-private-key-passphrase".to_string())),
                            ),
                        ),
                    )
                    .dataflows(
                    ...
                    .name("prod-snowflake".to_string())
                    .settings(
                        SnowflakeIntegrationAccountSettingsUpdate::new()
                            .snowflake_account_identifier("myorg-myaccount".to_string())
                            .username("datadog_user".to_string()),
                    ),
