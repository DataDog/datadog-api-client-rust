...
use datadog_api_client::datadogV2::api_feature_flags::ListFeatureFlagsOptionalParams;
...
async fn main() {
    ...
    let resp = api
        .list_feature_flags(ListFeatureFlagsOptionalParams::default().page_limit(10))
        .await;
