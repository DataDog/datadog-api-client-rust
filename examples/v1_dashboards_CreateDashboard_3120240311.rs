...
use datadog_api_client::datadogV1::model::WidgetTimeHideIncompleteData;
...
async fn main() {
    let body =
        Dashboard::new(
            ...
            "Example-Dashboard with hide incomplete cost data".to_string(),
            vec![
                Widget::new(
                    WidgetDefinition::TimeseriesWidgetDefinition(
                        Box::new(
                            TimeseriesWidgetDefinition::new(
                                ...
                                .show_legend(true)
                                .time(
                                    WidgetTime::WidgetTimeHideIncompleteData(
                                        Box::new(WidgetTimeHideIncompleteData::new(true)),
                                    ),
                                )
                                .title("".to_string()),
                        ),
