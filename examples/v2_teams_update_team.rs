...
async fn main() {
    ...
    let body =
        TeamUpdateRequest::new(
            TeamUpdate::new(
                TeamUpdateAttributes::new(dd_team_data_attributes_handle, "Example Team updated".to_string())
    ...
    let resp = api.update_team(dd_team_data_id, body).await;
