...
use datadog_api_client::datadogV1::api::api_usage_metering::GetUsageCWSOptionalParams;
...
async fn main() {
    ...
    let resp = api
        .get_usage_cws(
            ...
            GetUsageCWSOptionalParams::default().end_hr("2021-11-08T11:11:11+00:00".to_string()),
        )
        .await;
