...
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionCellScope;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionCellScopeType;
...
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListColumn;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListColumnField;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListQuery;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListRequest;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListRequestAttributes;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListRequestData;
use datadog_api_client::datadogV2::model::ProductAnalyticsRetentionListRequestType;
...
async fn main() {
    let body =
        ProductAnalyticsRetentionListRequest::new(
            ProductAnalyticsRetentionListRequestData::new(
                ProductAnalyticsRetentionListRequestAttributes::new(
                    1756425600000,
                    ProductAnalyticsRetentionListQuery::new(
                        ProductAnalyticsRetentionCellScope::new(
                        ...
                        .columns(
                            vec![
                                ...
                                ::new().field(
                                    ProductAnalyticsRetentionListColumnField::new().path("@usr.email".to_string()),
                                )
                            ],
                        )
                        .limit(100),
    ...
    configuration.set_unstable_operation_enabled("v2.QueryProductAnalyticsRetentionList", true);
    let api = ProductAnalyticsAPI::with_config(configuration);
    let resp = api.query_product_analytics_retention_list(body).await;
