...
use datadog_api_client::datadogV2::model::UpdateAppsDatastoreRequestDataType;
...
async fn main() {
    ...
    let body = UpdateAppsDatastoreRequest::new().data(
        UpdateAppsDatastoreRequestData::new(UpdateAppsDatastoreRequestDataType::DATASTORES)
            .attributes(
