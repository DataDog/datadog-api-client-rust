    ...
    let body =
        ...
        ::new().data(
            ScheduleCreateRequestData::new()
                    ...
                    ScheduleCreateRequestDataAttributes::new(
                        vec![
                            ScheduleCreateRequestDataAttributesLayersItems::new(
                                DateTime::parse_from_rfc3339("2025-02-03T05:00:00+00:00")
                                ...
                                "Layer 1".to_string(),
                                DateTime::parse_from_rfc3339("2025-02-01T00:00:00+00:00")
                                    .expect("Failed to parse datetime")
                                    .with_timezone(&Utc),
                            )
                                .end_date(
                                    DateTime::parse_from_rfc3339("2025-12-31T00:00:00+00:00")
                                        .expect("Failed to parse datetime")
                                        .with_timezone(&Utc),
                                )
                                .restrictions(
                ...
                .type_(ScheduleCreateRequestDataType::SCHEDULES),
        );
