...
use datadog_api_client::datadogV2::model::CreateAppsDatastoreRequestDataType;

#[tokio::main]
async fn main() {
    let body = CreateAppsDatastoreRequest::new().data(
        CreateAppsDatastoreRequestData::new(CreateAppsDatastoreRequestDataType::DATASTORES)
            .attributes(CreateAppsDatastoreRequestDataAttributes::new(
