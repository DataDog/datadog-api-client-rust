...
async fn main() {
    let body =
        LLMObsCustomEvalConfigUpdateRequest::new(
                ...
                LLMObsCustomEvalConfigUpdateAttributes::new(
                    ...
                    .llm_judge_config(
                        LLMObsCustomEvalConfigLLMJudgeConfig::new(
                            ...
                            .context_query(Some("@input.context".to_string()))
                            ...
                            .prompt_template(
                                vec![
                                    LLMObsCustomEvalConfigPromptMessage::new("user".to_string())
                                        .content("Rate the quality of the following response:".to_string())
                                        .contents(
                                            vec![
                                                LLMObsCustomEvalConfigPromptContent::new(
                                                    "text".to_string(),
