...
use datadog_api_client::datadogV2::model::CIAppPipelineEventInProgressJob;
use datadog_api_client::datadogV2::model::CIAppPipelineEventJob;
use datadog_api_client::datadogV2::model::CIAppPipelineEventJobInProgressStatus;
                ...
                CIAppCreatePipelineEventRequestData::new()
                    .attributes(CIAppCreatePipelineEventRequestAttributes::new(
                        CIAppCreatePipelineEventRequestAttributesResource::CIAppPipelineEventJob(
                            Box::new(CIAppPipelineEventJob::CIAppPipelineEventInProgressJob(
                                Box::new(CIAppPipelineEventInProgressJob::new(
