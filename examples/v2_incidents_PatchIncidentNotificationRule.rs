// Partially update an incident notification rule returns "OK" response
use datadog_api_client::datadog;
use datadog_api_client::datadogV2::api_incidents::IncidentsAPI;
use datadog_api_client::datadogV2::api_incidents::PatchIncidentNotificationRuleOptionalParams;
...
async fn main() {
    ...
    configuration.set_unstable_operation_enabled("v2.PatchIncidentNotificationRule", true);
    let api = IncidentsAPI::with_config(configuration);
    let resp = api
        .patch_incident_notification_rule(
            Uuid::parse_str("00000000-0000-0000-0000-000000000001").expect("invalid UUID"),
            body,
            PatchIncidentNotificationRuleOptionalParams::default(),
        )
        .await;
