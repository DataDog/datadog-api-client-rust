...
use datadog_api_client::datadogV1::api::api_usage_metering::GetUsageCIAppOptionalParams;
...
async fn main() {
    ...
    let resp = api
        .get_usage_ci_app(
            ...
            GetUsageCIAppOptionalParams::default().end_hr("2021-11-08T11:11:11+00:00".to_string()),
        )
        .await;
