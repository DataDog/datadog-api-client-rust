...
async fn main() {
    ...
    // Step 3: iterate response_fields over top-level UsageSummaryResponse additional_properties
    ...
    // Step 4: iterate date_fields and date_org_fields over each UsageSummaryDate (and its orgs)
