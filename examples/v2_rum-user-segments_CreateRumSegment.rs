...
use datadog_api_client::datadogV2::model::RumSegmentCreateAttributes;
use datadog_api_client::datadogV2::model::RumSegmentCreateData;
use datadog_api_client::datadogV2::model::RumSegmentCreateRequest;
...
#[tokio::main]
async fn main() {
    let body = RumSegmentCreateRequest::new(RumSegmentCreateData::new(
        RumSegmentCreateAttributes::new(
            RumSegmentDataQuery::new()
                ...
                .to(1710493155000)]),
            "My Segment".to_string(),
        )
        .description("Users who visited the homepage.".to_string())
