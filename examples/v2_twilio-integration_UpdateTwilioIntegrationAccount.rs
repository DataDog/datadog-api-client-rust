...
use datadog_api_client::datadogV2::model::TwilioIntegrationAccountBasicAuthUpdate;
...
async fn main() {
    let body =
        TwilioIntegrationAccountUpdateRequest::new(
            TwilioIntegrationAccountUpdateData::new(
                TwilioIntegrationAccountUpdateAttributes::new()
                    .authentication(
                        TwilioIntegrationAccountAuthenticationUpdate::TwilioIntegrationAccountBasicAuthUpdate(
                            Box::new(
                                TwilioIntegrationAccountBasicAuthUpdate::new(
                    ...
                    .dataflows(
                        TwilioIntegrationDataflowsRequest::new()
                            ...
                            .twilio_messages_logs(TwilioMessagesLogsIntegrationDataflowRequest::new().enabled(true)),
                    )
