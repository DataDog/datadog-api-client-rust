...
use datadog_api_client::datadogV2::model::MonitorConfigPolicyDowntimePolicyCreateRequest;
...
async fn main() {
    let body = MonitorConfigPolicyCreateRequest::new(MonitorConfigPolicyCreateData::new(
        MonitorConfigPolicyAttributeCreateRequest::new(
            MonitorConfigPolicyPolicyCreateRequest::MonitorConfigPolicyDowntimePolicyCreateRequest(
                Box::new(MonitorConfigPolicyDowntimePolicyCreateRequest::new(3600000)),
            ),
            MonitorConfigPolicyType::DOWNTIME,
        ),
