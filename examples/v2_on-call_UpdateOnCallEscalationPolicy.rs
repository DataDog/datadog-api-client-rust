...
use datadog_api_client::datadogV2::model::EscalationPolicyUpdateRequestDataAttributesStepsItemsAssignment;
use datadog_api_client::datadogV2::model::EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItems;
use datadog_api_client::datadogV2::model::EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItemsType;
...
async fn main() {
    ...
    let body =
        EscalationPolicyUpdateRequest::new(
            EscalationPolicyUpdateRequestData::new(
                EscalationPolicyUpdateRequestDataAttributes::new(
                    "Example-On-Call-updated".to_string(),
                    vec![
                        EscalationPolicyUpdateRequestDataAttributesStepsItems::new(
                            vec![
                                EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItems::new()
