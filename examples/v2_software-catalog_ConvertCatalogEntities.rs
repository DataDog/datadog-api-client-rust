...
use datadog_api_client::datadogV2::model::EntitySchemaVersion;
...
async fn main() {
    ...
    configuration.set_unstable_operation_enabled("v2.ConvertCatalogEntities", true);
    let api = SoftwareCatalogAPI::with_config(configuration);
    let resp = api
        .convert_catalog_entities(EntitySchemaVersion::V3, body)
        .await;
