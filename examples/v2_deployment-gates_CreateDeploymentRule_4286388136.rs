...
use datadog_api_client::datadogV2::model::DeploymentRuleOptionsMonitor;
...
async fn main() {
    ...
    let body = CreateDeploymentRuleParams::new().data(CreateDeploymentRuleParamsData::new(
        CreateDeploymentRuleParamsDataAttributes::new(
            "Query monitor deployment rule".to_string(),
            DeploymentRulesOptions::DeploymentRuleOptionsMonitor(Box::new(
                DeploymentRuleOptionsMonitor::new(
