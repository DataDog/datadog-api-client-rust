...
use datadog_api_client::datadogV2::model::RoutingRuleEscalationPolicyAction;
use datadog_api_client::datadogV2::model::RoutingRuleEscalationPolicyActionSupportHours;
use datadog_api_client::datadogV2::model::RoutingRuleEscalationPolicyActionType;
        ...
        TeamRoutingRulesRequestData::new(TeamRoutingRulesRequestDataType::TEAM_ROUTING_RULES)
            .attributes(TeamRoutingRulesRequestDataAttributes::new().rules(vec![
                    TeamRoutingRulesRequestRule::new()
                        .actions(vec![RoutingRuleAction::RoutingRuleEscalationPolicyAction(
                            Box::new(
                                RoutingRuleEscalationPolicyAction::new(
                        ...
                        .query("tags.service:time_restrictions".to_string())
                        .time_restriction(TimeRestrictions::new(
                            vec![
                                TimeRestriction::new()
                    ...
                    TeamRoutingRulesRequestRule::new()
                        .actions(vec![RoutingRuleAction::RoutingRuleEscalationPolicyAction(
                            Box::new(
                                ...
                                .support_hours(
                                    RoutingRuleEscalationPolicyActionSupportHours::new(
                                        "Europe/Paris".to_string(),
                                    )
                                    .restrictions(vec![
                                        TimeRestriction::new()
                        ...
                        .query("tags.service:support_hours_and_acknowledgment_timeout".to_string()),
                    TeamRoutingRulesRequestRule::new()
                        .policy_id(escalation_policy_data_id.clone())
                        .query("tags.service:legacy_policy_definition".to_string())
                        .urgency(Urgency::LOW),
                    TeamRoutingRulesRequestRule::new()
                        .actions(vec![RoutingRuleAction::RoutingRuleEscalationPolicyAction(
                            Box::new(
