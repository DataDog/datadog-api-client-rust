...
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyScalarCompute;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyScalarQuery;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyScalarRequest;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyScalarRequestAttributes;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyScalarRequestData;
...
async fn main() {
    let body =
        ProductAnalyticsJourneyScalarRequest::new(
            ProductAnalyticsJourneyScalarRequestData::new(
                ProductAnalyticsJourneyScalarRequestAttributes::new(
                    1756425600000,
                    ProductAnalyticsJourneyScalarQuery::new(
                        ProductAnalyticsJourneyScalarCompute::new(
                            "count".to_string(),
                        ).target(
