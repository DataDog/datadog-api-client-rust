...
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyFunnelCompute;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyFunnelQuery;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyFunnelRequest;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyFunnelRequestAttributes;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyFunnelRequestData;
...
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyRequestType;
...
async fn main() {
    let body =
        ProductAnalyticsJourneyFunnelRequest::new(
            ProductAnalyticsJourneyFunnelRequestData::new(
                ProductAnalyticsJourneyFunnelRequestAttributes::new(
                    1756425600000,
                    ProductAnalyticsJourneyFunnelQuery::new(
                        ...
                        .compute(ProductAnalyticsJourneyFunnelCompute::new())
                        .group_by(
                            vec![
    ...
    configuration.set_unstable_operation_enabled("v2.QueryProductAnalyticsJourneyFunnel", true);
    let api = ProductAnalyticsAPI::with_config(configuration);
    let resp = api.query_product_analytics_journey_funnel(body).await;
