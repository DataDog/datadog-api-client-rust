...
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyComputedColumn;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyComputedColumnName;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyConversionType;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyListQuery;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyListRequest;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyListRequestAttributes;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyListRequestData;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyListRequestType;
use datadog_api_client::datadogV2::model::ProductAnalyticsJourneyListSort;
...
async fn main() {
    let body =
        ProductAnalyticsJourneyListRequest::new(
            ProductAnalyticsJourneyListRequestData::new(
                ProductAnalyticsJourneyListRequestAttributes::new(
                    1756425600000,
                    ProductAnalyticsJourneyListQuery::new(
                        ...
                        .computed_columns(
                            vec![
                                ProductAnalyticsJourneyComputedColumn::new(
                        ...
                        .sort(ProductAnalyticsJourneyListSort::new().order(QuerySortOrder::DESC))
                        .target(
                            ProductAnalyticsJourneyTarget::ProductAnalyticsJourneyNodeTarget(
                                Box::new(
                                    ProductAnalyticsJourneyNodeTarget::new(
    ...
    configuration.set_unstable_operation_enabled("v2.QueryProductAnalyticsJourneyList", true);
    let api = ProductAnalyticsAPI::with_config(configuration);
    let resp = api.query_product_analytics_journey_list(body).await;
