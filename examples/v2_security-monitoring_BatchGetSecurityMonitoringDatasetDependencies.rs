...
use datadog_api_client::datadogV2::model::SecurityMonitoringDatasetDependenciesRequestAttributes;
use datadog_api_client::datadogV2::model::SecurityMonitoringDatasetDependenciesRequestData;

#[tokio::main]
async fn main() {
    let body = SecurityMonitoringDatasetDependenciesRequest::new(
        SecurityMonitoringDatasetDependenciesRequestData::new(
            SecurityMonitoringDatasetDependenciesRequestAttributes::new(vec![
