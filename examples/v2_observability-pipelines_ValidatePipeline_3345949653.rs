// Validate an observability pipeline with parse grok processor source rules
// returns "OK" response
...
use datadog_api_client::datadogV2::model::ObservabilityPipelineParseGrokProcessorRule;
        ...
        ObservabilityPipelineSpec::new(
            ObservabilityPipelineSpecData::new(
                ObservabilityPipelineDataAttributes::new(
                                            ...
                                            ObservabilityPipelineParseGrokProcessor::new(
                                                ...
                                                vec![
                                                    ...
                                                    ::ObservabilityPipelineParseGrokProcessorRule(
                                                        Box::new(
                                                            ObservabilityPipelineParseGrokProcessorRule::new(
                                                                vec![
                    ...
                    "Pipeline with Parse Grok Source Rules".to_string(),
                ),
                "pipelines".to_string(),
            ),
        );
