...
async fn main() {
    ...
    configuration
        .set_unstable_operation_enabled("v2.DeleteSecurityFindingsAutomationInboxRule", true);
    let api = SecurityMonitoringAPI::with_config(configuration);
    let resp = api
        .delete_security_findings_automation_inbox_rule(valid_inbox_rule_data_id.clone())
        .await;
