...
pub struct CycloneDXMetadata {
    ...
    pub component: crate::datadogV2::model::CycloneDXMetadataComponent,
    /// Information about the scanner tool that produced this BOM.
    #[serde(rename = "tools")]
    pub tools: crate::datadogV2::model::CycloneDXMetadataTools,
    #[serde(flatten)]
...
impl CycloneDXMetadata {
    pub fn new(
        component: crate::datadogV2::model::CycloneDXMetadataComponent,
        tools: crate::datadogV2::model::CycloneDXMetadataTools,
    ) -> CycloneDXMetadata {
        CycloneDXMetadata {
            component,
            tools,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for CycloneDXMetadataVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut component: Option<crate::datadogV2::model::CycloneDXMetadataComponent> =
                    None;
                let mut tools: Option<crate::datadogV2::model::CycloneDXMetadataTools> = None;
