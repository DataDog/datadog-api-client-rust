...
pub struct IncidentGoogleChatConfigurationRelationships {
...
impl IncidentGoogleChatConfigurationRelationships {
    pub fn new() -> IncidentGoogleChatConfigurationRelationships {
...
impl Default for IncidentGoogleChatConfigurationRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentGoogleChatConfigurationRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentGoogleChatConfigurationRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentGoogleChatConfigurationRelationshipsVisitor {
            type Value = IncidentGoogleChatConfigurationRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentGoogleChatConfigurationRelationships {
                    created_by_user,
                    incident_type,
                    last_modified_by_user,
        ...
        deserializer.deserialize_any(IncidentGoogleChatConfigurationRelationshipsVisitor)
    }
}
