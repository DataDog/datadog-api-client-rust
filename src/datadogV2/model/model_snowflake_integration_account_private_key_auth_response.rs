...
pub struct SnowflakeIntegrationAccountPrivateKeyAuthResponse {
...
impl SnowflakeIntegrationAccountPrivateKeyAuthResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for SnowflakeIntegrationAccountPrivateKeyAuthResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SnowflakeIntegrationAccountPrivateKeyAuthResponseVisitor;
        impl<'a> Visitor<'a> for SnowflakeIntegrationAccountPrivateKeyAuthResponseVisitor {
            type Value = SnowflakeIntegrationAccountPrivateKeyAuthResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SnowflakeIntegrationAccountPrivateKeyAuthResponse {
                    auth_type,
                    private_key_name,
        ...
        deserializer.deserialize_any(SnowflakeIntegrationAccountPrivateKeyAuthResponseVisitor)
    }
}
