...
pub struct MuteRuleAttributesResponse {
...
impl MuteRuleAttributesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for MuteRuleAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MuteRuleAttributesResponseVisitor;
        impl<'a> Visitor<'a> for MuteRuleAttributesResponseVisitor {
            type Value = MuteRuleAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = MuteRuleAttributesResponse {
                    action,
                    created_at,
                    created_by,
                    enabled,
        ...
        deserializer.deserialize_any(MuteRuleAttributesResponseVisitor)
    }
}
