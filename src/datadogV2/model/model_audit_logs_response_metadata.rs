...
impl AuditLogsResponseMetadata {
    ...
    pub fn page(mut self, value: crate::datadogV2::model::AuditLogsResponsePage) -> Self {
    ...
    pub fn status(mut self, value: crate::datadogV2::model::AuditLogsResponseStatus) -> Self {
...
impl<'de> Deserialize<'de> for AuditLogsResponseMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AuditLogsResponseMetadataVisitor;
        impl<'a> Visitor<'a> for AuditLogsResponseMetadataVisitor {
            type Value = AuditLogsResponseMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut page: Option<crate::datadogV2::model::AuditLogsResponsePage> = None;
                    ...
                    match k.as_str() {
                        ...
                        "status" => {
                            ...
                            if let Some(ref _status) = status {
                                match _status {
                                    crate::datadogV2::model::AuditLogsResponseStatus::UnparsedObject(_status) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = AuditLogsResponseMetadata {
                    elapsed,
                    page,
                    request_id,
                    status,
        ...
        deserializer.deserialize_any(AuditLogsResponseMetadataVisitor)
    }
}
