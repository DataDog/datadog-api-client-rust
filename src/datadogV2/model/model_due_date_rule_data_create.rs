...
pub struct DueDateRuleDataCreate {
...
impl<'de> Deserialize<'de> for DueDateRuleDataCreate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DueDateRuleDataCreateVisitor;
        impl<'a> Visitor<'a> for DueDateRuleDataCreateVisitor {
            type Value = DueDateRuleDataCreate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DueDateRuleDataCreate {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(DueDateRuleDataCreateVisitor)
    }
}
