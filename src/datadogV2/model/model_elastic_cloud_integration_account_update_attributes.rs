...
pub struct ElasticCloudIntegrationAccountUpdateAttributes {
    ...
    pub authentication:
        Option<crate::datadogV2::model::ElasticCloudIntegrationAccountAuthenticationUpdate>,
    ...
    pub settings: Option<crate::datadogV2::model::ElasticCloudIntegrationAccountSettingsUpdate>,
    #[serde(flatten)]
...
impl ElasticCloudIntegrationAccountUpdateAttributes {
    ...
    pub fn authentication(
        mut self,
        value: crate::datadogV2::model::ElasticCloudIntegrationAccountAuthenticationUpdate,
    ) -> Self {
    ...
    pub fn settings(
        mut self,
        value: crate::datadogV2::model::ElasticCloudIntegrationAccountSettingsUpdate,
    ) -> Self {
        ...
        impl<'a> Visitor<'a> for ElasticCloudIntegrationAccountUpdateAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut authentication: Option<
                    crate::datadogV2::model::ElasticCloudIntegrationAccountAuthenticationUpdate,
                > = None;
                ...
                let mut settings: Option<
                    crate::datadogV2::model::ElasticCloudIntegrationAccountSettingsUpdate,
                > = None;
                        ...
                        "authentication" => {
                            ...
                            if let Some(ref _authentication) = authentication {
                                match _authentication {
                                    crate::datadogV2::model::ElasticCloudIntegrationAccountAuthenticationUpdate::UnparsedObject(_authentication) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
