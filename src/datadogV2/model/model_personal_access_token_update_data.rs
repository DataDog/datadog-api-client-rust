...
impl PersonalAccessTokenUpdateData {
    pub fn new(
        attributes: crate::datadogV2::model::PersonalAccessTokenUpdateAttributes,
        id: uuid::Uuid,
...
impl<'de> Deserialize<'de> for PersonalAccessTokenUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PersonalAccessTokenUpdateDataVisitor;
        impl<'a> Visitor<'a> for PersonalAccessTokenUpdateDataVisitor {
            type Value = PersonalAccessTokenUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::PersonalAccessTokenUpdateAttributes,
                > = None;
                ...
                let content = PersonalAccessTokenUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(PersonalAccessTokenUpdateDataVisitor)
    }
}
