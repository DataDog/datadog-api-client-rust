...
pub struct DueDateRuleAttributesResponse {
...
impl DueDateRuleAttributesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for DueDateRuleAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DueDateRuleAttributesResponseVisitor;
        impl<'a> Visitor<'a> for DueDateRuleAttributesResponseVisitor {
            type Value = DueDateRuleAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DueDateRuleAttributesResponse {
                    action,
                    created_at,
                    created_by,
                    enabled,
        ...
        deserializer.deserialize_any(DueDateRuleAttributesResponseVisitor)
    }
}
