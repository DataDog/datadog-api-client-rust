...
pub struct RumHardcodedCrossProductSamplingEditability {
...
impl RumHardcodedCrossProductSamplingEditability {
    pub fn new() -> RumHardcodedCrossProductSamplingEditability {
...
impl Default for RumHardcodedCrossProductSamplingEditability {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for RumHardcodedCrossProductSamplingEditability {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RumHardcodedCrossProductSamplingEditabilityVisitor;
        impl<'a> Visitor<'a> for RumHardcodedCrossProductSamplingEditabilityVisitor {
            type Value = RumHardcodedCrossProductSamplingEditability;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RumHardcodedCrossProductSamplingEditability {
                    session_replay_sample_rate,
                    trace_sample_rate,
        ...
        deserializer.deserialize_any(RumHardcodedCrossProductSamplingEditabilityVisitor)
    }
}
