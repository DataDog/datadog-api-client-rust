...
pub struct TeamReference {
    ...
    pub attributes: Option<crate::datadogV2::model::TeamReferenceAttributes>,
...
impl TeamReference {
    ...
    pub fn attributes(mut self, value: crate::datadogV2::model::TeamReferenceAttributes) -> Self {
...
impl<'de> Deserialize<'de> for TeamReference {
    ...
    where
        D: Deserializer<'de>,
    {
        struct TeamReferenceVisitor;
        impl<'a> Visitor<'a> for TeamReferenceVisitor {
            type Value = TeamReference;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::TeamReferenceType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(TeamReferenceVisitor)
    }
}
