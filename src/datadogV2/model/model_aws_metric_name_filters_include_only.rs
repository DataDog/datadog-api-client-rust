...
pub struct AWSMetricNameFiltersIncludeOnly {
...
impl AWSMetricNameFiltersIncludeOnly {
    pub fn new(include_only: Vec<String>, namespace: String) -> AWSMetricNameFiltersIncludeOnly {
...
impl<'de> Deserialize<'de> for AWSMetricNameFiltersIncludeOnly {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSMetricNameFiltersIncludeOnlyVisitor;
        impl<'a> Visitor<'a> for AWSMetricNameFiltersIncludeOnlyVisitor {
            type Value = AWSMetricNameFiltersIncludeOnly;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AWSMetricNameFiltersIncludeOnly {
                    include_only,
                    namespace,
        ...
        deserializer.deserialize_any(AWSMetricNameFiltersIncludeOnlyVisitor)
    }
}
