...
/// An individual APM resource stats query.
#[non_exhaustive]
#[skip_serializing_none]
#[derive(Clone, Debug, PartialEq, Serialize)]
pub struct ApmResourceStatsQuery {
    /// A data source for APM resource statistics queries.
    #[serde(rename = "data_source")]
    pub data_source: crate::datadogV2::model::ApmResourceStatsDataSource,
    ...
    #[serde(rename = "stat")]
    pub stat: crate::datadogV2::model::ApmResourceStatName,
    #[serde(flatten)]
...
impl<'de> Deserialize<'de> for ApmResourceStatsQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ApmResourceStatsQueryVisitor;
        impl<'a> Visitor<'a> for ApmResourceStatsQueryVisitor {
            type Value = ApmResourceStatsQuery;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data_source: Option<crate::datadogV2::model::ApmResourceStatsDataSource> =
                    None;
                ...
                let mut stat: Option<crate::datadogV2::model::ApmResourceStatName> = None;
                    ...
                    match k.as_str() {
                        "data_source" => {
                            ...
                            if let Some(ref _data_source) = data_source {
                                match _data_source {
                                    crate::datadogV2::model::ApmResourceStatsDataSource::UnparsedObject(_data_source) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                        ...
                        "stat" => {
                            ...
                            if let Some(ref _stat) = stat {
                                match _stat {
                                    crate::datadogV2::model::ApmResourceStatName::UnparsedObject(_stat) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = ApmResourceStatsQuery {
                    data_source,
                    env,
                    group_by,
                    name,
        ...
        deserializer.deserialize_any(ApmResourceStatsQueryVisitor)
    }
}
