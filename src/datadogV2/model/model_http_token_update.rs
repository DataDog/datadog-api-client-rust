...
impl<'de> Deserialize<'de> for HTTPTokenUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct HTTPTokenUpdateVisitor;
        impl<'a> Visitor<'a> for HTTPTokenUpdateVisitor {
            type Value = HTTPTokenUpdate;
        ...
        deserializer.deserialize_any(HTTPTokenUpdateVisitor)
    }
}
