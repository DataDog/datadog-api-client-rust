...
impl SecurityTriggerWrapper {
    pub fn new(
        security_trigger: crate::datadogV2::model::SecurityTrigger,
...
impl<'de> Deserialize<'de> for SecurityTriggerWrapper {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityTriggerWrapperVisitor;
        impl<'a> Visitor<'a> for SecurityTriggerWrapperVisitor {
            type Value = SecurityTriggerWrapper;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut security_trigger: Option<crate::datadogV2::model::SecurityTrigger> = None;
                ...
                let security_trigger =
                    security_trigger.ok_or_else(|| M::Error::missing_field("security_trigger"))?;

                let content = SecurityTriggerWrapper {
                    security_trigger,
                    start_step_names,
        ...
        deserializer.deserialize_any(SecurityTriggerWrapperVisitor)
    }
}
