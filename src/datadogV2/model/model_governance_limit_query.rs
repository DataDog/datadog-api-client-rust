...
pub struct GovernanceLimitQuery {
...
impl GovernanceLimitQuery {
    pub fn new(query: String, reducer: String, source: String) -> GovernanceLimitQuery {
...
impl<'de> Deserialize<'de> for GovernanceLimitQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GovernanceLimitQueryVisitor;
        impl<'a> Visitor<'a> for GovernanceLimitQueryVisitor {
            type Value = GovernanceLimitQuery;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = GovernanceLimitQuery {
                    query,
                    reducer,
                    source,
        ...
        deserializer.deserialize_any(GovernanceLimitQueryVisitor)
    }
}
