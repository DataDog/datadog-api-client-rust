...
impl<'de> Deserialize<'de> for OpsgenieServiceCreateRequest {
    ...
    where
        D: Deserializer<'de>,
    {
        struct OpsgenieServiceCreateRequestVisitor;
        impl<'a> Visitor<'a> for OpsgenieServiceCreateRequestVisitor {
            type Value = OpsgenieServiceCreateRequest;
        ...
        deserializer.deserialize_any(OpsgenieServiceCreateRequestVisitor)
    }
}
