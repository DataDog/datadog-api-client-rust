...
pub struct ListWorkflowsResponseMetaPage {
...
impl ListWorkflowsResponseMetaPage {
    pub fn new() -> ListWorkflowsResponseMetaPage {
...
impl Default for ListWorkflowsResponseMetaPage {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ListWorkflowsResponseMetaPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListWorkflowsResponseMetaPageVisitor;
        impl<'a> Visitor<'a> for ListWorkflowsResponseMetaPageVisitor {
            type Value = ListWorkflowsResponseMetaPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListWorkflowsResponseMetaPage {
                    total_count,
                    total_filtered_count,
        ...
        deserializer.deserialize_any(ListWorkflowsResponseMetaPageVisitor)
    }
}
