...
pub struct ObservabilityPipelineSentinelOneDestination {
...
impl ObservabilityPipelineSentinelOneDestination {
    pub fn new(
        id: String,
        inputs: Vec<String>,
        region: crate::datadogV2::model::ObservabilityPipelineSentinelOneDestinationRegion,
        type_: crate::datadogV2::model::ObservabilityPipelineSentinelOneDestinationType,
...
impl<'de> Deserialize<'de> for ObservabilityPipelineSentinelOneDestination {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineSentinelOneDestinationVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineSentinelOneDestinationVisitor {
            type Value = ObservabilityPipelineSentinelOneDestination;
                ...
                M: MapAccess<'a>,
            {
                    ...
                    match k.as_str() {
                        ...
                        "region" => {
                            ...
                            if let Some(ref _region) = region {
                                match _region {
                                    crate::datadogV2::model::ObservabilityPipelineSentinelOneDestinationRegion::UnparsedObject(_region) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ObservabilityPipelineSentinelOneDestinationType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = ObservabilityPipelineSentinelOneDestination {
                    buffer,
                    id,
                    inputs,
                    region,
        ...
        deserializer.deserialize_any(ObservabilityPipelineSentinelOneDestinationVisitor)
    }
}
