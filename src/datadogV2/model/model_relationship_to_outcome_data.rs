...
impl<'de> Deserialize<'de> for RelationshipToOutcomeData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RelationshipToOutcomeDataVisitor;
        impl<'a> Visitor<'a> for RelationshipToOutcomeDataVisitor {
            type Value = RelationshipToOutcomeData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RelationshipToOutcomeData {
                    id,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(RelationshipToOutcomeDataVisitor)
    }
}
