...
impl Serialize for MonitorConfigPolicyResourceType {
...
impl<'de> Deserialize<'de> for MonitorConfigPolicyResourceType {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match s.as_str() {
            "monitor-config-policy" => Self::MONITOR_CONFIG_POLICY,
