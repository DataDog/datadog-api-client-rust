...
pub struct CreateRulesetRequestDataAttributesRulesItemsMapping {
...
impl CreateRulesetRequestDataAttributesRulesItemsMapping {
    pub fn new(
...
impl<'de> Deserialize<'de> for CreateRulesetRequestDataAttributesRulesItemsMapping {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateRulesetRequestDataAttributesRulesItemsMappingVisitor;
        impl<'a> Visitor<'a> for CreateRulesetRequestDataAttributesRulesItemsMappingVisitor {
            type Value = CreateRulesetRequestDataAttributesRulesItemsMapping;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateRulesetRequestDataAttributesRulesItemsMapping {
                    destination_key,
                    if_not_exists,
                    source_keys,
