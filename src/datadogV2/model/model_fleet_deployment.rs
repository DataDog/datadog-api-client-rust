...
pub struct FleetDeployment {
    ...
    pub attributes: crate::datadogV2::model::FleetDeploymentAttributes,
...
impl<'de> Deserialize<'de> for FleetDeployment {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetDeploymentVisitor;
        impl<'a> Visitor<'a> for FleetDeploymentVisitor {
            type Value = FleetDeployment;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::FleetDeploymentAttributes> =
                    None;
        ...
        deserializer.deserialize_any(FleetDeploymentVisitor)
    }
}
