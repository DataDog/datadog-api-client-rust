...
pub struct UpdateRuleResponseData {
    /// Details of a rule.
...
impl UpdateRuleResponseData {
    pub fn new() -> UpdateRuleResponseData {
...
impl Default for UpdateRuleResponseData {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for UpdateRuleResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateRuleResponseDataVisitor;
        impl<'a> Visitor<'a> for UpdateRuleResponseDataVisitor {
            type Value = UpdateRuleResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UpdateRuleResponseData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(UpdateRuleResponseDataVisitor)
    }
}
