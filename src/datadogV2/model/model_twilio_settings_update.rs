...
pub struct TwilioSettingsUpdate {
...
impl TwilioSettingsUpdate {
    pub fn new() -> TwilioSettingsUpdate {
...
impl Default for TwilioSettingsUpdate {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for TwilioSettingsUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TwilioSettingsUpdateVisitor;
        impl<'a> Visitor<'a> for TwilioSettingsUpdateVisitor {
            type Value = TwilioSettingsUpdate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = TwilioSettingsUpdate {
                    account_sid,
                    censor_logs,
        ...
        deserializer.deserialize_any(TwilioSettingsUpdateVisitor)
    }
}
