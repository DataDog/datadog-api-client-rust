...
pub struct IncidentImpactCreatedTrigger {
...
impl IncidentImpactCreatedTrigger {
    pub fn new() -> IncidentImpactCreatedTrigger {
...
impl Default for IncidentImpactCreatedTrigger {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentImpactCreatedTrigger {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentImpactCreatedTriggerVisitor;
        impl<'a> Visitor<'a> for IncidentImpactCreatedTriggerVisitor {
            type Value = IncidentImpactCreatedTrigger;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentImpactCreatedTrigger {
                    execution_limit,
                    incident_type,
                    tag_condition,
        ...
        deserializer.deserialize_any(IncidentImpactCreatedTriggerVisitor)
    }
}
