...
impl<'de> Deserialize<'de> for IncidentTeamRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTeamRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentTeamRelationshipsVisitor {
            type Value = IncidentTeamRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentTeamRelationships {
                    created_by,
                    last_modified_by,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(IncidentTeamRelationshipsVisitor)
    }
}
