...
pub struct CreateDataDeletionResponseBody {
...
impl CreateDataDeletionResponseBody {
    pub fn new() -> CreateDataDeletionResponseBody {
...
impl Default for CreateDataDeletionResponseBody {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CreateDataDeletionResponseBody {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateDataDeletionResponseBodyVisitor;
        impl<'a> Visitor<'a> for CreateDataDeletionResponseBodyVisitor {
            type Value = CreateDataDeletionResponseBody;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateDataDeletionResponseBody {
                    data,
                    meta,
        ...
        deserializer.deserialize_any(CreateDataDeletionResponseBodyVisitor)
    }
}
