...
pub struct ElasticCloudIntegration {
...
impl<'de> Deserialize<'de> for ElasticCloudIntegration {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudIntegrationVisitor;
        impl<'a> Visitor<'a> for ElasticCloudIntegrationVisitor {
            type Value = ElasticCloudIntegration;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudIntegration {
                    interface,
                    type_,
        ...
        deserializer.deserialize_any(ElasticCloudIntegrationVisitor)
    }
}
