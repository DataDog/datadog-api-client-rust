...
pub struct LLMObsPromptVersionListDataAttributes {
...
impl LLMObsPromptVersionListDataAttributes {
    pub fn new(
        prompt_id: String,
        prompt_uuid: String,
        version: i64,
...
impl<'de> Deserialize<'de> for LLMObsPromptVersionListDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsPromptVersionListDataAttributesVisitor;
        impl<'a> Visitor<'a> for LLMObsPromptVersionListDataAttributesVisitor {
            type Value = LLMObsPromptVersionListDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                #[allow(deprecated)]
                let content = LLMObsPromptVersionListDataAttributes {
                    author,
                    created_at,
                    datasets,
                    description,
        ...
        deserializer.deserialize_any(LLMObsPromptVersionListDataAttributesVisitor)
    }
}
