...
impl ListFeatureFlagsResponse {
    ...
    pub fn meta(mut self, value: crate::datadogV2::model::FeatureFlagsPaginationMeta) -> Self {
...
impl<'de> Deserialize<'de> for ListFeatureFlagsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListFeatureFlagsResponseVisitor;
        impl<'a> Visitor<'a> for ListFeatureFlagsResponseVisitor {
            type Value = ListFeatureFlagsResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListFeatureFlagsResponse {
                    data,
                    meta,
        ...
        deserializer.deserialize_any(ListFeatureFlagsResponseVisitor)
    }
}
