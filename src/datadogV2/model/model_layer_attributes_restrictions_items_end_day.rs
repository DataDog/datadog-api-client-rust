...
pub enum LayerAttributesRestrictionsItemsEndDay {
    MONDAY,
    TUESDAY,
    WEDNESDAY,
    THURSDAY,
...
impl ToString for LayerAttributesRestrictionsItemsEndDay {
...
impl Serialize for LayerAttributesRestrictionsItemsEndDay {
...
impl<'de> Deserialize<'de> for LayerAttributesRestrictionsItemsEndDay {
