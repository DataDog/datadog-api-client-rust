...
impl Default for CustomRuleRevisionRequest {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CustomRuleRevisionRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CustomRuleRevisionRequestVisitor;
        impl<'a> Visitor<'a> for CustomRuleRevisionRequestVisitor {
            type Value = CustomRuleRevisionRequest;
        ...
        deserializer.deserialize_any(CustomRuleRevisionRequestVisitor)
    }
}
