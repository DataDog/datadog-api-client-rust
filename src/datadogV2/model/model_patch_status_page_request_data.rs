...
impl<'de> Deserialize<'de> for PatchStatusPageRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PatchStatusPageRequestDataVisitor;
        impl<'a> Visitor<'a> for PatchStatusPageRequestDataVisitor {
            type Value = PatchStatusPageRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::PatchStatusPageRequestDataAttributes,
                > = None;
        ...
        deserializer.deserialize_any(PatchStatusPageRequestDataVisitor)
    }
}
