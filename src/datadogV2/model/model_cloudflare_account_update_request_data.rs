...
pub struct CloudflareAccountUpdateRequestData {
    ...
    pub attributes: Option<crate::datadogV2::model::CloudflareAccountUpdateRequestAttributes>,
...
impl<'de> Deserialize<'de> for CloudflareAccountUpdateRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CloudflareAccountUpdateRequestDataVisitor;
        impl<'a> Visitor<'a> for CloudflareAccountUpdateRequestDataVisitor {
            type Value = CloudflareAccountUpdateRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CloudflareAccountUpdateRequestAttributes,
                > = None;
                ...
                let content = CloudflareAccountUpdateRequestData {
                    attributes,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(CloudflareAccountUpdateRequestDataVisitor)
    }
}
