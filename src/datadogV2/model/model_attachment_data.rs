...
impl AttachmentData {
    pub fn new(
        attributes: crate::datadogV2::model::AttachmentDataAttributes,
        id: String,
        relationships: crate::datadogV2::model::AttachmentDataRelationships,
...
impl<'de> Deserialize<'de> for AttachmentData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AttachmentDataVisitor;
        impl<'a> Visitor<'a> for AttachmentDataVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::AttachmentDataAttributes> =
                    None;
                let mut id: Option<String> = None;
                let mut relationships: Option<
                    crate::datadogV2::model::AttachmentDataRelationships,
                > = None;
        ...
        deserializer.deserialize_any(AttachmentDataVisitor)
    }
}
