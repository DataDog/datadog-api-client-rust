...
pub struct OrgGroupPolicyCreateRelationships {
...
impl OrgGroupPolicyCreateRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for OrgGroupPolicyCreateRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPolicyCreateRelationshipsVisitor;
        impl<'a> Visitor<'a> for OrgGroupPolicyCreateRelationshipsVisitor {
            type Value = OrgGroupPolicyCreateRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OrgGroupPolicyCreateRelationships {
                    org_group,
        ...
        deserializer.deserialize_any(OrgGroupPolicyCreateRelationshipsVisitor)
    }
}
