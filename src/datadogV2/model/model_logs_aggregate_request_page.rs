...
impl<'de> Deserialize<'de> for LogsAggregateRequestPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsAggregateRequestPageVisitor;
        impl<'a> Visitor<'a> for LogsAggregateRequestPageVisitor {
            type Value = LogsAggregateRequestPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LogsAggregateRequestPage { cursor, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(LogsAggregateRequestPageVisitor)
    }
}
