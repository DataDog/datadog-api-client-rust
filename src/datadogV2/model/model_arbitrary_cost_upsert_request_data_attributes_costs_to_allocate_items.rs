...
pub struct ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems {
    /// The `items` `condition`.
...
impl ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems {
    pub fn new(
        condition: String,
        tag: String,
...
impl<'de> Deserialize<'de> for ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItemsVisitor;
        impl<'a> Visitor<'a> for ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItemsVisitor {
            type Value = ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems {
                    condition,
                    tag,
                    value,
                    values,
        ...
        deserializer
            .deserialize_any(ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItemsVisitor)
    }
}
