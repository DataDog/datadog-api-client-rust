...
impl PostmortemTemplateDataResponse {
    pub fn new(
        attributes: crate::datadogV2::model::PostmortemTemplateAttributesResponse,
        id: String,
...
impl<'de> Deserialize<'de> for PostmortemTemplateDataResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PostmortemTemplateDataResponseVisitor;
        impl<'a> Visitor<'a> for PostmortemTemplateDataResponseVisitor {
            type Value = PostmortemTemplateDataResponse;
        ...
        deserializer.deserialize_any(PostmortemTemplateDataResponseVisitor)
    }
}
