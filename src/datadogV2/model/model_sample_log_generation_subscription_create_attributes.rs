...
pub struct SampleLogGenerationSubscriptionCreateAttributes {
...
impl SampleLogGenerationSubscriptionCreateAttributes {
    pub fn new(content_pack_id: String) -> SampleLogGenerationSubscriptionCreateAttributes {
...
impl<'de> Deserialize<'de> for SampleLogGenerationSubscriptionCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SampleLogGenerationSubscriptionCreateAttributesVisitor;
        impl<'a> Visitor<'a> for SampleLogGenerationSubscriptionCreateAttributesVisitor {
            type Value = SampleLogGenerationSubscriptionCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SampleLogGenerationSubscriptionCreateAttributes {
                    content_pack_id,
                    duration,
        ...
        deserializer.deserialize_any(SampleLogGenerationSubscriptionCreateAttributesVisitor)
    }
}
