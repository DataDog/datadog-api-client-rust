...
impl<'de> Deserialize<'de> for LogsMetricResponseGroupBy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsMetricResponseGroupByVisitor;
        impl<'a> Visitor<'a> for LogsMetricResponseGroupByVisitor {
            type Value = LogsMetricResponseGroupBy;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LogsMetricResponseGroupBy {
                    path,
                    tag_name,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(LogsMetricResponseGroupByVisitor)
    }
}
