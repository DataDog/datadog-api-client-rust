...
pub struct ModelLabProjectsResponse {
    /// The list of projects.
    #[serde(rename = "data")]
    pub data: Vec<crate::datadogV2::model::ModelLabProjectData>,
...
impl ModelLabProjectsResponse {
    pub fn new(
        data: Vec<crate::datadogV2::model::ModelLabProjectData>,
...
impl<'de> Deserialize<'de> for ModelLabProjectsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ModelLabProjectsResponseVisitor;
        impl<'a> Visitor<'a> for ModelLabProjectsResponseVisitor {
            type Value = ModelLabProjectsResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::ModelLabProjectData>> = None;
                ...
                let content = ModelLabProjectsResponse {
                    data,
                    links,
                    meta,
        ...
        deserializer.deserialize_any(ModelLabProjectsResponseVisitor)
    }
}
