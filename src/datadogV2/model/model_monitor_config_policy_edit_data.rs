...
impl<'de> Deserialize<'de> for MonitorConfigPolicyEditData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonitorConfigPolicyEditDataVisitor;
        impl<'a> Visitor<'a> for MonitorConfigPolicyEditDataVisitor {
            type Value = MonitorConfigPolicyEditData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::MonitorConfigPolicyAttributeEditRequest,
                > = None;
                ...
                let content = MonitorConfigPolicyEditData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(MonitorConfigPolicyEditDataVisitor)
    }
}
