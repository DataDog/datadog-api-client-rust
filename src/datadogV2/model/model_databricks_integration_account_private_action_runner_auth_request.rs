...
pub struct DatabricksIntegrationAccountPrivateActionRunnerAuthRequest {
...
impl DatabricksIntegrationAccountPrivateActionRunnerAuthRequest {
    pub fn new(
...
impl<'de> Deserialize<'de> for DatabricksIntegrationAccountPrivateActionRunnerAuthRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DatabricksIntegrationAccountPrivateActionRunnerAuthRequestVisitor;
        impl<'a> Visitor<'a> for DatabricksIntegrationAccountPrivateActionRunnerAuthRequestVisitor {
            type Value = DatabricksIntegrationAccountPrivateActionRunnerAuthRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DatabricksIntegrationAccountPrivateActionRunnerAuthRequest {
                    auth_type,
                    connection_id,
                    secret_path,
                    user_uuid,
        ...
        deserializer
            .deserialize_any(DatabricksIntegrationAccountPrivateActionRunnerAuthRequestVisitor)
    }
}
