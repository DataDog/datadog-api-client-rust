...
impl<'de> Deserialize<'de> for CaseLinkCreate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CaseLinkCreateVisitor;
        impl<'a> Visitor<'a> for CaseLinkCreateVisitor {
            type Value = CaseLinkCreate;
        ...
        deserializer.deserialize_any(CaseLinkCreateVisitor)
    }
}
