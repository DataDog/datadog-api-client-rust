...
impl<'de> Deserialize<'de> for DashboardListAddItemsRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DashboardListAddItemsRequestVisitor;
        impl<'a> Visitor<'a> for DashboardListAddItemsRequestVisitor {
            type Value = DashboardListAddItemsRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DashboardListAddItemsRequest {
                    dashboards,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(DashboardListAddItemsRequestVisitor)
    }
}
