...
impl SecureEmbedGetResponseAttributes {
    pub fn new() -> SecureEmbedGetResponseAttributes {
    ...
    pub fn credential_suffix(mut self, value: String) -> Self {
        self.credential_suffix = Some(value);
        self
    }
...
impl Default for SecureEmbedGetResponseAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SecureEmbedGetResponseAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecureEmbedGetResponseAttributesVisitor;
        impl<'a> Visitor<'a> for SecureEmbedGetResponseAttributesVisitor {
            type Value = SecureEmbedGetResponseAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut credential_suffix: Option<String> = None;
                ...
                let content = SecureEmbedGetResponseAttributes {
                    created_at,
                    credential_suffix,
                    dashboard_id,
                    global_time,
        ...
        deserializer.deserialize_any(SecureEmbedGetResponseAttributesVisitor)
    }
}
