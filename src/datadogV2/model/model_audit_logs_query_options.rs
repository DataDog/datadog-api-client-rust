...
impl<'de> Deserialize<'de> for AuditLogsQueryOptions {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AuditLogsQueryOptionsVisitor;
        impl<'a> Visitor<'a> for AuditLogsQueryOptionsVisitor {
            type Value = AuditLogsQueryOptions;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AuditLogsQueryOptions {
                    time_offset,
                    timezone,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(AuditLogsQueryOptionsVisitor)
    }
}
