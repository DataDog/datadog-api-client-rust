...
pub struct PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail {
...
impl PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail {
    pub fn new() -> PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail {
...
impl Default for PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<'de> Deserialize<'de>
    for PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
{
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetailVisitor;
        impl<'a> Visitor<'a>
            for PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetailVisitor
        {
            type Value = PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail;
        ...
        deserializer.deserialize_any(
            PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetailVisitor,
        )
    }
}
