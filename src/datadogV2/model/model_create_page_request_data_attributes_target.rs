...
impl CreatePageRequestDataAttributesTarget {
    pub fn new() -> CreatePageRequestDataAttributesTarget {
...
impl Default for CreatePageRequestDataAttributesTarget {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CreatePageRequestDataAttributesTarget {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreatePageRequestDataAttributesTargetVisitor;
        impl<'a> Visitor<'a> for CreatePageRequestDataAttributesTargetVisitor {
            type Value = CreatePageRequestDataAttributesTarget;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreatePageRequestDataAttributesTarget {
                    identifier,
                    type_,
        ...
        deserializer.deserialize_any(CreatePageRequestDataAttributesTargetVisitor)
    }
}
