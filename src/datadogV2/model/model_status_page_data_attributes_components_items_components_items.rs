...
pub struct StatusPageDataAttributesComponentsItemsComponentsItems {
    #[serde(rename = "id")]
...
impl StatusPageDataAttributesComponentsItemsComponentsItems {
    pub fn new() -> StatusPageDataAttributesComponentsItemsComponentsItems {
...
impl Default for StatusPageDataAttributesComponentsItemsComponentsItems {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for StatusPageDataAttributesComponentsItemsComponentsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct StatusPageDataAttributesComponentsItemsComponentsItemsVisitor;
        impl<'a> Visitor<'a> for StatusPageDataAttributesComponentsItemsComponentsItemsVisitor {
            type Value = StatusPageDataAttributesComponentsItemsComponentsItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = StatusPageDataAttributesComponentsItemsComponentsItems {
                    id,
                    name,
                    position,
                    status,
        ...
        deserializer.deserialize_any(StatusPageDataAttributesComponentsItemsComponentsItemsVisitor)
    }
}
