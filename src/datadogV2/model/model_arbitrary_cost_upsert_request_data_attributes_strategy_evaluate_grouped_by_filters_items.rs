...
pub struct ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItems {
    /// The `items` `condition`.
...
impl ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItems {
    pub fn new(
        condition: String,
        tag: String,
    ...
    for ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItems
{
    ...
    where
        D: Deserializer<'de>,
    {
        struct ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItemsVisitor;
        impl<'a> Visitor<'a>
            for ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItemsVisitor
        {
            type Value =
                ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItems;
        ...
        deserializer.deserialize_any(
            ArbitraryCostUpsertRequestDataAttributesStrategyEvaluateGroupedByFiltersItemsVisitor,
        )
    }
}
