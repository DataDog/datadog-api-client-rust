...
pub struct SnowflakeIntegrationAccountUpdateData {
    ...
    pub attributes: crate::datadogV2::model::SnowflakeIntegrationAccountUpdateAttributes,
...
impl SnowflakeIntegrationAccountUpdateData {
    pub fn new(
        attributes: crate::datadogV2::model::SnowflakeIntegrationAccountUpdateAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for SnowflakeIntegrationAccountUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SnowflakeIntegrationAccountUpdateDataVisitor;
        impl<'a> Visitor<'a> for SnowflakeIntegrationAccountUpdateDataVisitor {
            type Value = SnowflakeIntegrationAccountUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SnowflakeIntegrationAccountUpdateAttributes,
                > = None;
                ...
                let content = SnowflakeIntegrationAccountUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(SnowflakeIntegrationAccountUpdateDataVisitor)
    }
}
