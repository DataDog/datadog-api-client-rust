...
impl<'de> Deserialize<'de> for ListRulesResponseDataItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListRulesResponseDataItemVisitor;
        impl<'a> Visitor<'a> for ListRulesResponseDataItemVisitor {
            type Value = ListRulesResponseDataItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListRulesResponseDataItem {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(ListRulesResponseDataItemVisitor)
    }
}
