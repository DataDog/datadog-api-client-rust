...
pub struct ObservabilityPipelineCustomProcessor {
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::ObservabilityPipelineCustomProcessorType,
    #[serde(flatten)]
...
impl ObservabilityPipelineCustomProcessor {
    pub fn new(
        enabled: bool,
        id: String,
        include: String,
...
impl<'de> Deserialize<'de> for ObservabilityPipelineCustomProcessor {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineCustomProcessorVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineCustomProcessorVisitor {
            type Value = ObservabilityPipelineCustomProcessor;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut remaps: Option<
                    Vec<crate::datadogV2::model::ObservabilityPipelineCustomProcessorRemap>,
                > = None;
                let mut type_: Option<
                    crate::datadogV2::model::ObservabilityPipelineCustomProcessorType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ObservabilityPipelineCustomProcessorType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ObservabilityPipelineCustomProcessorVisitor)
    }
}
