...
pub struct CIAppPipelineEventFinishedJob {
...
impl CIAppPipelineEventFinishedJob {
    pub fn new(
...
impl<'de> Deserialize<'de> for CIAppPipelineEventFinishedJob {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppPipelineEventFinishedJobVisitor;
        impl<'a> Visitor<'a> for CIAppPipelineEventFinishedJobVisitor {
            type Value = CIAppPipelineEventFinishedJob;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CIAppPipelineEventFinishedJob {
                    dependencies,
                    end,
                    error,
                    git,
        ...
        deserializer.deserialize_any(CIAppPipelineEventFinishedJobVisitor)
    }
}
