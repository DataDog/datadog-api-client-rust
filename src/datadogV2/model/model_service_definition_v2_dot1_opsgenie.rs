...
impl<'de> Deserialize<'de> for ServiceDefinitionV2Dot1Opsgenie {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ServiceDefinitionV2Dot1OpsgenieVisitor;
        impl<'a> Visitor<'a> for ServiceDefinitionV2Dot1OpsgenieVisitor {
            type Value = ServiceDefinitionV2Dot1Opsgenie;
                ...
                M: MapAccess<'a>,
            {
                let mut region: Option<
                    crate::datadogV2::model::ServiceDefinitionV2Dot1OpsgenieRegion,
                > = None;
                    ...
                    match k.as_str() {
                        "region" => {
                            ...
                            if let Some(ref _region) = region {
                                match _region {
                                    crate::datadogV2::model::ServiceDefinitionV2Dot1OpsgenieRegion::UnparsedObject(_region) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = ServiceDefinitionV2Dot1Opsgenie {
                    region,
                    service_url,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(ServiceDefinitionV2Dot1OpsgenieVisitor)
    }
}
