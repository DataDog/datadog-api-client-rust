...
impl<'de> Deserialize<'de> for GetMultipleRulesetsResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GetMultipleRulesetsResponseDataVisitor;
        impl<'a> Visitor<'a> for GetMultipleRulesetsResponseDataVisitor {
            type Value = GetMultipleRulesetsResponseData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::GetMultipleRulesetsResponseDataAttributes,
                > = None;
                let mut id: Option<String> = None;
                let mut type_: Option<
                    crate::datadogV2::model::GetMultipleRulesetsResponseDataType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::GetMultipleRulesetsResponseDataType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(GetMultipleRulesetsResponseDataVisitor)
    }
}
