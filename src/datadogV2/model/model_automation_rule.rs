...
pub struct AutomationRule {
    ...
    pub attributes: crate::datadogV2::model::AutomationRuleAttributes,
...
impl AutomationRule {
    pub fn new(
        attributes: crate::datadogV2::model::AutomationRuleAttributes,
        id: String,
    ...
    pub fn relationships(
        mut self,
        value: crate::datadogV2::model::AutomationRuleRelationships,
    ) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AutomationRuleVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::AutomationRuleAttributes> =
                    None;
                let mut id: Option<String> = None;
                let mut relationships: Option<
                    crate::datadogV2::model::AutomationRuleRelationships,
                > = None;
