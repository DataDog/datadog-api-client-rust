...
pub struct ElasticCloudMonitoringAccountAttributes {
...
impl ElasticCloudMonitoringAccountAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for ElasticCloudMonitoringAccountAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudMonitoringAccountAttributesVisitor;
        impl<'a> Visitor<'a> for ElasticCloudMonitoringAccountAttributesVisitor {
            type Value = ElasticCloudMonitoringAccountAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudMonitoringAccountAttributes {
                    authentication,
                    dataflows,
                    name,
                    permissions,
        ...
        deserializer.deserialize_any(ElasticCloudMonitoringAccountAttributesVisitor)
    }
}
