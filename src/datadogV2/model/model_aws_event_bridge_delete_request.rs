...
pub struct AWSEventBridgeDeleteRequest {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::AWSEventBridgeDeleteRequestData,
    #[serde(flatten)]
...
impl AWSEventBridgeDeleteRequest {
    pub fn new(
        data: crate::datadogV2::model::AWSEventBridgeDeleteRequestData,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSEventBridgeDeleteRequestVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::AWSEventBridgeDeleteRequestData> =
                    None;
