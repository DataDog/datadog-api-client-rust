...
impl<'de> Deserialize<'de> for TeamRelationshipsLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TeamRelationshipsLinksVisitor;
        impl<'a> Visitor<'a> for TeamRelationshipsLinksVisitor {
            type Value = TeamRelationshipsLinks;
        ...
        deserializer.deserialize_any(TeamRelationshipsLinksVisitor)
    }
}
