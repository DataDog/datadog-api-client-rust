...
pub struct RUMOperationsListResponseMetaPage {
...
impl RUMOperationsListResponseMetaPage {
    pub fn new() -> RUMOperationsListResponseMetaPage {
...
impl Default for RUMOperationsListResponseMetaPage {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for RUMOperationsListResponseMetaPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMOperationsListResponseMetaPageVisitor;
        impl<'a> Visitor<'a> for RUMOperationsListResponseMetaPageVisitor {
            type Value = RUMOperationsListResponseMetaPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RUMOperationsListResponseMetaPage {
                    first_offset,
                    last_offset,
                    limit,
                    next_offset,
        ...
        deserializer.deserialize_any(RUMOperationsListResponseMetaPageVisitor)
    }
}
