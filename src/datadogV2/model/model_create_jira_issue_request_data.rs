...
pub struct CreateJiraIssueRequestData {
...
impl CreateJiraIssueRequestData {
    ...
    pub fn relationships(
        mut self,
        value: crate::datadogV2::model::CreateJiraIssueRequestDataRelationships,
    ) -> Self {
...
impl<'de> Deserialize<'de> for CreateJiraIssueRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateJiraIssueRequestDataVisitor;
        impl<'a> Visitor<'a> for CreateJiraIssueRequestDataVisitor {
            type Value = CreateJiraIssueRequestData;
        ...
        deserializer.deserialize_any(CreateJiraIssueRequestDataVisitor)
    }
}
