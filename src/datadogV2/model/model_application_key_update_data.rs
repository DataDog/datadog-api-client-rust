...
impl<'de> Deserialize<'de> for ApplicationKeyUpdateData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ApplicationKeyUpdateDataVisitor;
        impl<'a> Visitor<'a> for ApplicationKeyUpdateDataVisitor {
            type Value = ApplicationKeyUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::ApplicationKeyUpdateAttributes,
                > = None;
                ...
                let content = ApplicationKeyUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(ApplicationKeyUpdateDataVisitor)
    }
}
