...
pub struct ElasticCloudSettings {
...
impl ElasticCloudSettings {
    pub fn new(url: String) -> ElasticCloudSettings {
...
impl<'de> Deserialize<'de> for ElasticCloudSettings {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudSettingsVisitor;
        impl<'a> Visitor<'a> for ElasticCloudSettingsVisitor {
            type Value = ElasticCloudSettings;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudSettings {
                    cat_allocation_stats_enabled,
                    detailed_index_stats_enabled,
                    index_stats_enabled,
                    pending_task_stats_enabled,
        ...
        deserializer.deserialize_any(ElasticCloudSettingsVisitor)
    }
}
