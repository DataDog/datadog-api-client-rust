...
impl<'de> Deserialize<'de> for SensitiveDataScannerGroupUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerGroupUpdateVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerGroupUpdateVisitor {
            type Value = SensitiveDataScannerGroupUpdate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerGroupUpdate {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(SensitiveDataScannerGroupUpdateVisitor)
    }
}
