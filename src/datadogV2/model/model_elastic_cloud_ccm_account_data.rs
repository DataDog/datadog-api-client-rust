...
pub struct ElasticCloudCcmAccountData {
...
impl ElasticCloudCcmAccountData {
    pub fn new(
...
impl<'de> Deserialize<'de> for ElasticCloudCcmAccountData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudCcmAccountDataVisitor;
        impl<'a> Visitor<'a> for ElasticCloudCcmAccountDataVisitor {
            type Value = ElasticCloudCcmAccountData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudCcmAccountData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(ElasticCloudCcmAccountDataVisitor)
    }
}
