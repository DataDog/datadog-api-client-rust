...
impl<'de> Deserialize<'de> for AssetVersion {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AssetVersionVisitor;
        impl<'a> Visitor<'a> for AssetVersionVisitor {
            type Value = AssetVersion;
        ...
        deserializer.deserialize_any(AssetVersionVisitor)
    }
}
