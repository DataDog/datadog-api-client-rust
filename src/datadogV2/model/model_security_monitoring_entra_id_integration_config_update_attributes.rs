...
pub struct SecurityMonitoringEntraIdIntegrationConfigUpdateAttributes {
...
impl SecurityMonitoringEntraIdIntegrationConfigUpdateAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for SecurityMonitoringEntraIdIntegrationConfigUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringEntraIdIntegrationConfigUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringEntraIdIntegrationConfigUpdateAttributesVisitor {
            type Value = SecurityMonitoringEntraIdIntegrationConfigUpdateAttributes;
        ...
        deserializer
            .deserialize_any(SecurityMonitoringEntraIdIntegrationConfigUpdateAttributesVisitor)
    }
}
