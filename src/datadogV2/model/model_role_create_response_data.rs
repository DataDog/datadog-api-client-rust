...
impl<'de> Deserialize<'de> for RoleCreateResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RoleCreateResponseDataVisitor;
        impl<'a> Visitor<'a> for RoleCreateResponseDataVisitor {
            type Value = RoleCreateResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RoleCreateResponseData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(RoleCreateResponseDataVisitor)
    }
}
