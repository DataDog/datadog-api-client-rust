...
pub struct AWSNamespacesResponse {
    /// List of AWS CloudWatch namespaces that can send metrics to Datadog
    #[serde(rename = "data")]
    pub data: Option<Vec<crate::datadogV2::model::AWSNamespacesResponseData>>,
    #[serde(flatten)]
...
impl AWSNamespacesResponse {
    pub fn new() -> AWSNamespacesResponse {
    ...
    pub fn data(mut self, value: Vec<crate::datadogV2::model::AWSNamespacesResponseData>) -> Self {
...
impl Default for AWSNamespacesResponse {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSNamespacesResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::AWSNamespacesResponseData>> =
                    None;
