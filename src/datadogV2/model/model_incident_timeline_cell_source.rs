...
pub enum IncidentTimelineCellSource {
    SLACK,
    MICROSOFT_TEAMS,
    DATADOG,
    API,
...
impl ToString for IncidentTimelineCellSource {
...
impl Serialize for IncidentTimelineCellSource {
...
impl<'de> Deserialize<'de> for IncidentTimelineCellSource {
