...
pub struct ScheduleUpdateRequestData {
    ...
    pub attributes: Option<crate::datadogV2::model::ScheduleUpdateRequestDataAttributes>,
    ...
    #[serde(rename = "type")]
    pub type_: Option<crate::datadogV2::model::ScheduleUpdateRequestDataType>,
    #[serde(flatten)]
...
impl ScheduleUpdateRequestData {
    pub fn new() -> ScheduleUpdateRequestData {
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::ScheduleUpdateRequestDataAttributes,
    ) -> Self {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::ScheduleUpdateRequestDataType) -> Self {
...
impl Default for ScheduleUpdateRequestData {
    fn default() -> Self {
        Self::new()
    }
}
