...
pub struct ObservabilityPipelineSyslogNgDestination {
...
impl ObservabilityPipelineSyslogNgDestination {
    pub fn new(
        id: String,
        inputs: Vec<String>,
        type_: crate::datadogV2::model::ObservabilityPipelineSyslogNgDestinationType,
...
impl<'de> Deserialize<'de> for ObservabilityPipelineSyslogNgDestination {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineSyslogNgDestinationVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineSyslogNgDestinationVisitor {
            type Value = ObservabilityPipelineSyslogNgDestination;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ObservabilityPipelineSyslogNgDestinationType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ObservabilityPipelineSyslogNgDestinationVisitor)
    }
}
