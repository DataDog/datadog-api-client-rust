...
pub struct RetentionFilterAll {
    ...
    pub attributes: crate::datadogV2::model::RetentionFilterAllAttributes,
...
impl<'de> Deserialize<'de> for RetentionFilterAll {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RetentionFilterAllVisitor;
        impl<'a> Visitor<'a> for RetentionFilterAllVisitor {
            type Value = RetentionFilterAll;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::RetentionFilterAllAttributes> =
                    None;
                ...
                let content = RetentionFilterAll {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(RetentionFilterAllVisitor)
    }
}
