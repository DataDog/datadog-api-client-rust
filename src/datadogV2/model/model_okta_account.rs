...
impl<'de> Deserialize<'de> for OktaAccount {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OktaAccountVisitor;
        impl<'a> Visitor<'a> for OktaAccountVisitor {
            type Value = OktaAccount;
        ...
        deserializer.deserialize_any(OktaAccountVisitor)
    }
}
