...
pub struct ProductAnalyticsJourneyScalarQuery {
    /// Defines the metric computed over the journey for a scalar query.
    #[serde(rename = "compute")]
    pub compute: crate::datadogV2::model::ProductAnalyticsJourneyScalarCompute,
...
impl ProductAnalyticsJourneyScalarQuery {
    pub fn new(
        compute: crate::datadogV2::model::ProductAnalyticsJourneyScalarCompute,
...
impl<'de> Deserialize<'de> for ProductAnalyticsJourneyScalarQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsJourneyScalarQueryVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsJourneyScalarQueryVisitor {
            type Value = ProductAnalyticsJourneyScalarQuery;
                ...
                M: MapAccess<'a>,
            {
                let mut compute: Option<
                    crate::datadogV2::model::ProductAnalyticsJourneyScalarCompute,
                > = None;
                ...
                let content = ProductAnalyticsJourneyScalarQuery {
                    compute,
                    group_by,
                    query_id,
                    search,
        ...
        deserializer.deserialize_any(ProductAnalyticsJourneyScalarQueryVisitor)
    }
}
