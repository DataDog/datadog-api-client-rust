...
pub struct AwsScanOptionsUpdateData {
...
impl<'de> Deserialize<'de> for AwsScanOptionsUpdateData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AwsScanOptionsUpdateDataVisitor;
        impl<'a> Visitor<'a> for AwsScanOptionsUpdateDataVisitor {
            type Value = AwsScanOptionsUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::AwsScanOptionsUpdateAttributes,
                > = None;
        ...
        deserializer.deserialize_any(AwsScanOptionsUpdateDataVisitor)
    }
}
