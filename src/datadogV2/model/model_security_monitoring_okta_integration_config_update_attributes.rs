...
pub struct SecurityMonitoringOktaIntegrationConfigUpdateAttributes {
    ...
    pub secrets: Option<crate::datadogV2::model::SecurityMonitoringIntegrationConfigOktaSecrets>,
...
impl SecurityMonitoringOktaIntegrationConfigUpdateAttributes {
    pub fn new(
    ...
    pub fn secrets(
        mut self,
        value: crate::datadogV2::model::SecurityMonitoringIntegrationConfigOktaSecrets,
    ) -> Self {
...
impl<'de> Deserialize<'de> for SecurityMonitoringOktaIntegrationConfigUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringOktaIntegrationConfigUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringOktaIntegrationConfigUpdateAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringOktaIntegrationConfigUpdateAttributes {
                    domain,
                    enabled,
                    integration_type,
                    name,
        ...
        deserializer.deserialize_any(SecurityMonitoringOktaIntegrationConfigUpdateAttributesVisitor)
    }
}
