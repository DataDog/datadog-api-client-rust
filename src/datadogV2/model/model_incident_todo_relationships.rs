...
impl<'de> Deserialize<'de> for IncidentTodoRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTodoRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentTodoRelationshipsVisitor {
            type Value = IncidentTodoRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentTodoRelationships {
                    created_by_user,
                    last_modified_by_user,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(IncidentTodoRelationshipsVisitor)
    }
}
