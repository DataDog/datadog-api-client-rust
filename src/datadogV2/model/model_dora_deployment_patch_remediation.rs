...
pub struct DORADeploymentPatchRemediation {
    /// The ID of the remediation deployment. Required when the type field is provided.
    #[serde(rename = "id")]
...
impl<'de> Deserialize<'de> for DORADeploymentPatchRemediation {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DORADeploymentPatchRemediationVisitor;
        impl<'a> Visitor<'a> for DORADeploymentPatchRemediationVisitor {
            type Value = DORADeploymentPatchRemediation;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::DORADeploymentPatchRemediationType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(DORADeploymentPatchRemediationVisitor)
    }
}
