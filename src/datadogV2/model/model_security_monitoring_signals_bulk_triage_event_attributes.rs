...
pub struct SecurityMonitoringSignalsBulkTriageEventAttributes {
...
impl SecurityMonitoringSignalsBulkTriageEventAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for SecurityMonitoringSignalsBulkTriageEventAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringSignalsBulkTriageEventAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringSignalsBulkTriageEventAttributesVisitor {
            type Value = SecurityMonitoringSignalsBulkTriageEventAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringSignalsBulkTriageEventAttributes {
                    archive_comment,
                    archive_comment_timestamp,
                    archive_comment_user,
                    archive_reason,
        ...
        deserializer.deserialize_any(SecurityMonitoringSignalsBulkTriageEventAttributesVisitor)
    }
}
