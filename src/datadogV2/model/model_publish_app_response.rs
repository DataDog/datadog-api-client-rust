...
impl<'de> Deserialize<'de> for PublishAppResponse {
    ...
    where
        D: Deserializer<'de>,
    {
        struct PublishAppResponseVisitor;
        impl<'a> Visitor<'a> for PublishAppResponseVisitor {
            type Value = PublishAppResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = PublishAppResponse {
                    data,
        ...
        deserializer.deserialize_any(PublishAppResponseVisitor)
    }
}
