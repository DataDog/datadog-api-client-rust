...
pub struct Maintenance {
    #[serde(rename = "data")]
    pub data: Option<crate::datadogV2::model::MaintenanceData>,
...
impl Maintenance {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::MaintenanceData) -> Self {
...
impl<'de> Deserialize<'de> for Maintenance {
    ...
    where
        D: Deserializer<'de>,
    {
        struct MaintenanceVisitor;
        impl<'a> Visitor<'a> for MaintenanceVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::MaintenanceData> = None;
        ...
        deserializer.deserialize_any(MaintenanceVisitor)
    }
}
