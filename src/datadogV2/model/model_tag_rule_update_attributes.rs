...
pub struct TagRuleUpdateAttributes {
    ...
    pub policy_type: Option<crate::datadogV2::model::TagRuleType>,
...
impl TagRuleUpdateAttributes {
    ...
    pub fn policy_type(mut self, value: crate::datadogV2::model::TagRuleType) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TagRuleUpdateAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut policy_type: Option<crate::datadogV2::model::TagRuleType> = None;
