...
impl<'de> Deserialize<'de> for SpansMetricUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansMetricUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for SpansMetricUpdateAttributesVisitor {
            type Value = SpansMetricUpdateAttributes;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut compute: Option<crate::datadogV2::model::SpansMetricUpdateCompute> = None;
                ...
                let content = SpansMetricUpdateAttributes {
                    compute,
                    filter,
                    group_by,
                    _unparsed,
        ...
        deserializer.deserialize_any(SpansMetricUpdateAttributesVisitor)
    }
}
