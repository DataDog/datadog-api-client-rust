...
pub struct ConnectionDataAttributesResponse {
    ...
    pub external_secrets_manager: Option<std::collections::BTreeMap<String, serde_json::Value>>,
...
impl ConnectionDataAttributesResponse {
    pub fn new(
        ...
        external_secrets_manager: Option<std::collections::BTreeMap<String, serde_json::Value>>,
