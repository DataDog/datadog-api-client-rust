...
pub struct ServiceAccountAccessTokenCreateData {
...
impl<'de> Deserialize<'de> for ServiceAccountAccessTokenCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ServiceAccountAccessTokenCreateDataVisitor;
        impl<'a> Visitor<'a> for ServiceAccountAccessTokenCreateDataVisitor {
            type Value = ServiceAccountAccessTokenCreateData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ServiceAccountAccessTokenCreateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(ServiceAccountAccessTokenCreateDataVisitor)
    }
}
