...
pub struct AWSAccount {
    ...
    pub attributes: crate::datadogV2::model::AWSAccountAttributes,
    /// AWS Account ID
    #[serde(rename = "id")]
    pub id: String,
    /// AWS Account type
...
impl AWSAccount {
    pub fn new(
        attributes: crate::datadogV2::model::AWSAccountAttributes,
        id: String,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSAccountVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::AWSAccountAttributes> = None;
