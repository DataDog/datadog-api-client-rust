...
pub struct CIAppPipelineEventInProgressJob {
    ...
    #[serde(rename = "status")]
    pub status: crate::datadogV2::model::CIAppPipelineEventJobInProgressStatus,
...
impl CIAppPipelineEventInProgressJob {
    pub fn new(
        id: String,
        ...
        status: crate::datadogV2::model::CIAppPipelineEventJobInProgressStatus,
        url: String,
...
impl<'de> Deserialize<'de> for CIAppPipelineEventInProgressJob {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppPipelineEventInProgressJobVisitor;
        impl<'a> Visitor<'a> for CIAppPipelineEventInProgressJobVisitor {
            type Value = CIAppPipelineEventInProgressJob;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut status: Option<
                    crate::datadogV2::model::CIAppPipelineEventJobInProgressStatus,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "status" => {
                            ...
                            if let Some(ref _status) = status {
                                match _status {
                                    crate::datadogV2::model::CIAppPipelineEventJobInProgressStatus::UnparsedObject(_status) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = CIAppPipelineEventInProgressJob {
                    dependencies,
                    error,
                    git,
                    id,
        ...
        deserializer.deserialize_any(CIAppPipelineEventInProgressJobVisitor)
    }
}
