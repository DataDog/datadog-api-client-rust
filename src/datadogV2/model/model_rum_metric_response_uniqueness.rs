...
pub struct RumMetricResponseUniqueness {
    ...
    #[serde(rename = "when")]
    pub when: crate::datadogV2::model::RumMetricResponseUniquenessWhen,
    #[serde(flatten)]
...
impl RumMetricResponseUniqueness {
    pub fn new(
        when: crate::datadogV2::model::RumMetricResponseUniquenessWhen,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for RumMetricResponseUniquenessVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut when: Option<crate::datadogV2::model::RumMetricResponseUniquenessWhen> =
                    None;
                    ...
                    match k.as_str() {
                        "when" => {
                            ...
                            if let Some(ref _when) = when {
                                match _when {
                                    crate::datadogV2::model::RumMetricResponseUniquenessWhen::UnparsedObject(_when) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
