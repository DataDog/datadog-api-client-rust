...
pub struct AWSAccountAttributes {
...
impl AWSAccountAttributes {
    pub fn new(aws_account_id: String) -> AWSAccountAttributes {
...
impl<'de> Deserialize<'de> for AWSAccountAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSAccountAttributesVisitor;
        impl<'a> Visitor<'a> for AWSAccountAttributesVisitor {
            type Value = AWSAccountAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AWSAccountAttributes {
                    account_tags,
                    auth_config,
                    aws_account_id,
                    aws_regions,
        ...
        deserializer.deserialize_any(AWSAccountAttributesVisitor)
    }
}
