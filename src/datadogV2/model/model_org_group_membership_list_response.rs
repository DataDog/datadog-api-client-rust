...
impl OrgGroupMembershipListResponse {
    pub fn new(
        data: Vec<crate::datadogV2::model::OrgGroupMembershipData>,
...
impl<'de> Deserialize<'de> for OrgGroupMembershipListResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupMembershipListResponseVisitor;
        impl<'a> Visitor<'a> for OrgGroupMembershipListResponseVisitor {
            type Value = OrgGroupMembershipListResponse;
        ...
        deserializer.deserialize_any(OrgGroupMembershipListResponseVisitor)
    }
}
