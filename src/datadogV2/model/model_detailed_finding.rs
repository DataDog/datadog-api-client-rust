...
impl DetailedFinding {
    ...
    pub fn attributes(mut self, value: crate::datadogV2::model::DetailedFindingAttributes) -> Self {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::DetailedFindingType) -> Self {
