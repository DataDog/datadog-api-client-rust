...
#[serde(untagged)]
pub enum IncidentUserDefinedRoleIncludedItem {
...
impl<'de> Deserialize<'de> for IncidentUserDefinedRoleIncludedItem {
        ...
        D: Deserializer<'de>,
    {
        ...
        {
            if !_v._unparsed {
                return Ok(IncidentUserDefinedRoleIncludedItem::IncidentUserData(_v));
            }
        }
        if let Ok(_v) = serde_json::from_value::<Box<crate::datadogV2::model::IncidentTypeObject>>(
            ...
            if !_v._unparsed {
                return Ok(IncidentUserDefinedRoleIncludedItem::IncidentTypeObject(_v));
            }
        }

        return Ok(IncidentUserDefinedRoleIncludedItem::UnparsedObject(
