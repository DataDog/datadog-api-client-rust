...
pub struct TeamCreate {
    ...
    pub attributes: crate::datadogV2::model::TeamCreateAttributes,
    /// Relationships formed with the team on creation
    #[serde(rename = "relationships")]
    pub relationships: Option<crate::datadogV2::model::TeamCreateRelationships>,
    /// Team type
    #[serde(rename = "type")]
...
impl TeamCreate {
    pub fn new(
        attributes: crate::datadogV2::model::TeamCreateAttributes,
...
impl<'de> Deserialize<'de> for TeamCreate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct TeamCreateVisitor;
        impl<'a> Visitor<'a> for TeamCreateVisitor {
            type Value = TeamCreate;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::TeamCreateAttributes> = None;
        ...
        deserializer.deserialize_any(TeamCreateVisitor)
    }
}
