...
pub struct NotionIntegration {
    ...
    pub credentials: crate::datadogV2::model::NotionCredentials,
...
impl NotionIntegration {
    pub fn new(
        ...
        type_: crate::datadogV2::model::NotionIntegrationType,
    ) -> NotionIntegration {
        NotionIntegration {
            credentials,
            type_,
...
impl<'de> Deserialize<'de> for NotionIntegration {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct NotionIntegrationVisitor;
        impl<'a> Visitor<'a> for NotionIntegrationVisitor {
            type Value = NotionIntegration;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut credentials: Option<crate::datadogV2::model::NotionCredentials> = None;
                    ...
                    match k.as_str() {
                        "credentials" => {
                            ...
                            if let Some(ref _credentials) = credentials {
                                match _credentials {
                                    crate::datadogV2::model::NotionCredentials::UnparsedObject(
                                        _credentials,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(NotionIntegrationVisitor)
    }
}
