...
pub struct CreateLinearIssueRequestDataRelationships {
...
impl CreateLinearIssueRequestDataRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for CreateLinearIssueRequestDataRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateLinearIssueRequestDataRelationshipsVisitor;
        impl<'a> Visitor<'a> for CreateLinearIssueRequestDataRelationshipsVisitor {
            type Value = CreateLinearIssueRequestDataRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateLinearIssueRequestDataRelationships {
                    findings,
                    project,
        ...
        deserializer.deserialize_any(CreateLinearIssueRequestDataRelationshipsVisitor)
    }
}
