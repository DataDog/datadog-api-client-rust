...
pub struct TwilioIntegrationAccountBasicAuthResponse {
...
impl TwilioIntegrationAccountBasicAuthResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for TwilioIntegrationAccountBasicAuthResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TwilioIntegrationAccountBasicAuthResponseVisitor;
        impl<'a> Visitor<'a> for TwilioIntegrationAccountBasicAuthResponseVisitor {
            type Value = TwilioIntegrationAccountBasicAuthResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = TwilioIntegrationAccountBasicAuthResponse {
                    auth_type,
                    username,
        ...
        deserializer.deserialize_any(TwilioIntegrationAccountBasicAuthResponseVisitor)
    }
}
