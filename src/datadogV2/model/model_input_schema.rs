...
pub struct InputSchema {
    ...
    #[serde(rename = "data")]
    pub data: Option<crate::datadogV2::model::InputSchemaData>,
    #[serde(flatten)]
...
impl InputSchema {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::InputSchemaData) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for InputSchemaVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::InputSchemaData> = None;
