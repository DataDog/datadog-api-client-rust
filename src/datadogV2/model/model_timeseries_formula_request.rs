...
impl<'de> Deserialize<'de> for TimeseriesFormulaRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TimeseriesFormulaRequestVisitor;
        impl<'a> Visitor<'a> for TimeseriesFormulaRequestVisitor {
            type Value = TimeseriesFormulaRequest;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::TimeseriesFormulaRequestAttributes,
                > = None;
                let mut type_: Option<crate::datadogV2::model::TimeseriesFormulaRequestType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::TimeseriesFormulaRequestType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = TimeseriesFormulaRequest {
                    attributes,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(TimeseriesFormulaRequestVisitor)
    }
}
