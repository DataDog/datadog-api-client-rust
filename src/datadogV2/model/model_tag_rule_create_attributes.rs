...
pub struct TagRuleCreateAttributes {
    ...
    pub policy_type: crate::datadogV2::model::TagRuleCreateType,
...
impl TagRuleCreateAttributes {
    pub fn new(
        policy_name: String,
        policy_type: crate::datadogV2::model::TagRuleCreateType,
        scope: String,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TagRuleCreateAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut policy_type: Option<crate::datadogV2::model::TagRuleCreateType> = None;
