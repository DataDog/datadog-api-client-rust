...
pub struct EntityV3RepositoryDatadog {
...
impl EntityV3RepositoryDatadog {
    pub fn new() -> EntityV3RepositoryDatadog {
...
impl Default for EntityV3RepositoryDatadog {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for EntityV3RepositoryDatadog {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EntityV3RepositoryDatadogVisitor;
        impl<'a> Visitor<'a> for EntityV3RepositoryDatadogVisitor {
            type Value = EntityV3RepositoryDatadog;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = EntityV3RepositoryDatadog {
                    code_locations,
                    events,
                    logs,
                    performance_data,
        ...
        deserializer.deserialize_any(EntityV3RepositoryDatadogVisitor)
    }
}
