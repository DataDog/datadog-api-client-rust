...
pub struct DatabricksIntegrationAccountBearerTokenAuthRequest {
...
impl DatabricksIntegrationAccountBearerTokenAuthRequest {
    pub fn new(
...
impl<'de> Deserialize<'de> for DatabricksIntegrationAccountBearerTokenAuthRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DatabricksIntegrationAccountBearerTokenAuthRequestVisitor;
        impl<'a> Visitor<'a> for DatabricksIntegrationAccountBearerTokenAuthRequestVisitor {
            type Value = DatabricksIntegrationAccountBearerTokenAuthRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DatabricksIntegrationAccountBearerTokenAuthRequest {
                    auth_type,
                    token,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(DatabricksIntegrationAccountBearerTokenAuthRequestVisitor)
    }
}
