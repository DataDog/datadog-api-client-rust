...
pub struct ElasticCloudMonitoringAccountData {
...
impl ElasticCloudMonitoringAccountData {
    pub fn new(
...
impl<'de> Deserialize<'de> for ElasticCloudMonitoringAccountData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudMonitoringAccountDataVisitor;
        impl<'a> Visitor<'a> for ElasticCloudMonitoringAccountDataVisitor {
            type Value = ElasticCloudMonitoringAccountData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudMonitoringAccountData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(ElasticCloudMonitoringAccountDataVisitor)
    }
}
