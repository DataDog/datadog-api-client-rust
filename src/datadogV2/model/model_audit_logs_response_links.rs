...
impl<'de> Deserialize<'de> for AuditLogsResponseLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AuditLogsResponseLinksVisitor;
        impl<'a> Visitor<'a> for AuditLogsResponseLinksVisitor {
            type Value = AuditLogsResponseLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AuditLogsResponseLinks { next, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(AuditLogsResponseLinksVisitor)
    }
}
