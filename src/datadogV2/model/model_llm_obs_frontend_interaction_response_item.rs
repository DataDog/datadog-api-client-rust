...
pub struct LLMObsFrontendInteractionResponseItem {
...
impl LLMObsFrontendInteractionResponseItem {
    pub fn new(
...
impl<'de> Deserialize<'de> for LLMObsFrontendInteractionResponseItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsFrontendInteractionResponseItemVisitor;
        impl<'a> Visitor<'a> for LLMObsFrontendInteractionResponseItemVisitor {
            type Value = LLMObsFrontendInteractionResponseItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LLMObsFrontendInteractionResponseItem {
                    already_existed,
                    content_id,
                    frontend,
                    id,
        ...
        deserializer.deserialize_any(LLMObsFrontendInteractionResponseItemVisitor)
    }
}
