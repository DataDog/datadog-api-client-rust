...
pub struct OrgGroupPaginationLinks {
...
impl OrgGroupPaginationLinks {
    pub fn new() -> OrgGroupPaginationLinks {
...
impl Default for OrgGroupPaginationLinks {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for OrgGroupPaginationLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPaginationLinksVisitor;
        impl<'a> Visitor<'a> for OrgGroupPaginationLinksVisitor {
            type Value = OrgGroupPaginationLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OrgGroupPaginationLinks {
                    first,
                    last,
                    next,
                    prev,
        ...
        deserializer.deserialize_any(OrgGroupPaginationLinksVisitor)
    }
}
