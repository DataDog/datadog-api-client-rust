...
impl<'de> Deserialize<'de> for OpsgenieServiceUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OpsgenieServiceUpdateDataVisitor;
        impl<'a> Visitor<'a> for OpsgenieServiceUpdateDataVisitor {
            type Value = OpsgenieServiceUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::OpsgenieServiceUpdateAttributes,
                > = None;
                ...
                let content = OpsgenieServiceUpdateData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(OpsgenieServiceUpdateDataVisitor)
    }
}
