...
pub struct IncidentImpactFieldDataAttributesRequest {
...
impl IncidentImpactFieldDataAttributesRequest {
    pub fn new(
        display_name: String,
...
impl<'de> Deserialize<'de> for IncidentImpactFieldDataAttributesRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentImpactFieldDataAttributesRequestVisitor;
        impl<'a> Visitor<'a> for IncidentImpactFieldDataAttributesRequestVisitor {
            type Value = IncidentImpactFieldDataAttributesRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentImpactFieldDataAttributesRequest {
                    display_name,
                    field_choices,
                    field_type,
                    name,
        ...
        deserializer.deserialize_any(IncidentImpactFieldDataAttributesRequestVisitor)
    }
}
