...
impl<'de> Deserialize<'de> for FastlyAccountCreateRequestData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct FastlyAccountCreateRequestDataVisitor;
        impl<'a> Visitor<'a> for FastlyAccountCreateRequestDataVisitor {
            type Value = FastlyAccountCreateRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::FastlyAccountCreateRequestAttributes,
                > = None;
                ...
                let content = FastlyAccountCreateRequestData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(FastlyAccountCreateRequestDataVisitor)
    }
}
