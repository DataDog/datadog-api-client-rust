...
impl<'de> Deserialize<'de> for MonitorDowntimeMatchResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonitorDowntimeMatchResponseVisitor;
        impl<'a> Visitor<'a> for MonitorDowntimeMatchResponseVisitor {
            type Value = MonitorDowntimeMatchResponse;
            ...
            {
                let mut data: Option<
                    Vec<crate::datadogV2::model::MonitorDowntimeMatchResponseData>,
                > = None;
                let mut meta: Option<crate::datadogV2::model::DowntimeMeta> = None;
                ...
                let content = MonitorDowntimeMatchResponse {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(MonitorDowntimeMatchResponseVisitor)
    }
}
