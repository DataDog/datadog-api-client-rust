...
impl GlobalOrgsLinks {
    pub fn new() -> GlobalOrgsLinks {
        GlobalOrgsLinks {
            next: None,
            prev: None,
            self_: None,
...
impl Default for GlobalOrgsLinks {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for GlobalOrgsLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GlobalOrgsLinksVisitor;
        impl<'a> Visitor<'a> for GlobalOrgsLinksVisitor {
            type Value = GlobalOrgsLinks;
        ...
        deserializer.deserialize_any(GlobalOrgsLinksVisitor)
    }
}
