...
pub struct LLMObsAnnotationItemResponse {
    ...
    pub label_values: Vec<crate::datadogV2::model::LLMObsAnnotationLabelValueResponse>,
...
impl LLMObsAnnotationItemResponse {
    pub fn new(
        created_at: chrono::DateTime<chrono::Utc>,
        created_by: String,
        id: String,
        interaction_id: String,
        label_values: Vec<crate::datadogV2::model::LLMObsAnnotationLabelValueResponse>,
...
impl<'de> Deserialize<'de> for LLMObsAnnotationItemResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsAnnotationItemResponseVisitor;
        impl<'a> Visitor<'a> for LLMObsAnnotationItemResponseVisitor {
            type Value = LLMObsAnnotationItemResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut label_values: Option<
                    Vec<crate::datadogV2::model::LLMObsAnnotationLabelValueResponse>,
                > = None;
                ...
                let content = LLMObsAnnotationItemResponse {
                    created_at,
                    created_by,
                    id,
                    interaction_id,
        ...
        deserializer.deserialize_any(LLMObsAnnotationItemResponseVisitor)
    }
}
