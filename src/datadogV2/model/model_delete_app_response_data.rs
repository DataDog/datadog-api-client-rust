...
impl<'de> Deserialize<'de> for DeleteAppResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DeleteAppResponseDataVisitor;
        impl<'a> Visitor<'a> for DeleteAppResponseDataVisitor {
            type Value = DeleteAppResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DeleteAppResponseData {
                    id,
                    type_,
        ...
        deserializer.deserialize_any(DeleteAppResponseDataVisitor)
    }
}
