...
impl TwilioSettings {
    pub fn new(account_sid: String) -> TwilioSettings {
        TwilioSettings {
            account_sid,
            censor_logs: None,
...
impl<'de> Deserialize<'de> for TwilioSettings {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TwilioSettingsVisitor;
        impl<'a> Visitor<'a> for TwilioSettingsVisitor {
            type Value = TwilioSettings;
        ...
        deserializer.deserialize_any(TwilioSettingsVisitor)
    }
}
