...
impl<'de> Deserialize<'de> for CreateStatusPageRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateStatusPageRequestDataVisitor;
        impl<'a> Visitor<'a> for CreateStatusPageRequestDataVisitor {
            type Value = CreateStatusPageRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CreateStatusPageRequestDataAttributes,
                > = None;
        ...
        deserializer.deserialize_any(CreateStatusPageRequestDataVisitor)
    }
}
