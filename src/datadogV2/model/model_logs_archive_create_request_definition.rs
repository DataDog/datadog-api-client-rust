...
impl<'de> Deserialize<'de> for LogsArchiveCreateRequestDefinition {
    ...
    where
        D: Deserializer<'de>,
    {
        struct LogsArchiveCreateRequestDefinitionVisitor;
        impl<'a> Visitor<'a> for LogsArchiveCreateRequestDefinitionVisitor {
            type Value = LogsArchiveCreateRequestDefinition;
        ...
        deserializer.deserialize_any(LogsArchiveCreateRequestDefinitionVisitor)
    }
}
