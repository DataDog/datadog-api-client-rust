...
impl<'de> Deserialize<'de> for PickActionResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PickActionResponseVisitor;
        impl<'a> Visitor<'a> for PickActionResponseVisitor {
            type Value = PickActionResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = PickActionResponse {
                    matches,
                    request_id,
                    total_matches,
        ...
        deserializer.deserialize_any(PickActionResponseVisitor)
    }
}
