...
pub struct TagPolicyUpdateRequest {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::TagPolicyDataUpdateRequest,
    #[serde(flatten)]
...
impl TagPolicyUpdateRequest {
    pub fn new(
        data: crate::datadogV2::model::TagPolicyDataUpdateRequest,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TagPolicyUpdateRequestVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::TagPolicyDataUpdateRequest> = None;
