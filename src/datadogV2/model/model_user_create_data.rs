...
impl<'de> Deserialize<'de> for UserCreateData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct UserCreateDataVisitor;
        impl<'a> Visitor<'a> for UserCreateDataVisitor {
            type Value = UserCreateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::UserCreateAttributes> = None;
        ...
        deserializer.deserialize_any(UserCreateDataVisitor)
    }
}
