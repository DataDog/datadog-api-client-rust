...
pub struct ParseJSONProcessor {
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::PipelineParseJSONProcessorType,
    #[serde(flatten)]
...
impl ParseJSONProcessor {
    pub fn new(
        ...
        include: String,
        inputs: Vec<String>,
        type_: crate::datadogV2::model::PipelineParseJSONProcessorType,
    ) -> ParseJSONProcessor {
        ParseJSONProcessor {
            field,
            id,
...
impl<'de> Deserialize<'de> for ParseJSONProcessor {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ParseJSONProcessorVisitor;
        impl<'a> Visitor<'a> for ParseJSONProcessorVisitor {
            type Value = ParseJSONProcessor;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV2::model::PipelineParseJSONProcessorType> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::PipelineParseJSONProcessorType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = ParseJSONProcessor {
                    field,
                    id,
                    include,
                    inputs,
        ...
        deserializer.deserialize_any(ParseJSONProcessorVisitor)
    }
}
