...
pub struct CaseViewRelationships {
...
impl CaseViewRelationships {
    pub fn new() -> CaseViewRelationships {
...
impl Default for CaseViewRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CaseViewRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CaseViewRelationshipsVisitor;
        impl<'a> Visitor<'a> for CaseViewRelationshipsVisitor {
            type Value = CaseViewRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CaseViewRelationships {
                    created_by,
                    modified_by,
                    project,
        ...
        deserializer.deserialize_any(CaseViewRelationshipsVisitor)
    }
}
