...
impl TenancyConfigData {
    pub fn new(type_: crate::datadogV2::model::UpdateTenancyConfigDataType) -> TenancyConfigData {
        TenancyConfigData {
            attributes: None,
            id: None,
            type_,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TenancyConfigDataVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::TenancyConfigDataAttributes> =
                    None;
                let mut id: Option<String> = None;
                let mut type_: Option<crate::datadogV2::model::UpdateTenancyConfigDataType> = None;
