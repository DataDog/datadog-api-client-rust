...
pub struct WorkflowListItem {
    ...
    pub attributes: crate::datadogV2::model::WorkflowListItemAttributes,
...
impl WorkflowListItem {
    pub fn new(
        attributes: crate::datadogV2::model::WorkflowListItemAttributes,
...
impl<'de> Deserialize<'de> for WorkflowListItem {
    ...
    where
        D: Deserializer<'de>,
    {
        struct WorkflowListItemVisitor;
        impl<'a> Visitor<'a> for WorkflowListItemVisitor {
            type Value = WorkflowListItem;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::WorkflowListItemAttributes> =
                    None;
        ...
        deserializer.deserialize_any(WorkflowListItemVisitor)
    }
}
