...
pub struct RumRateLimitConfigUpdateAttributes {
...
impl RumRateLimitConfigUpdateAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for RumRateLimitConfigUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RumRateLimitConfigUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for RumRateLimitConfigUpdateAttributesVisitor {
            type Value = RumRateLimitConfigUpdateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RumRateLimitConfigUpdateAttributes {
                    adaptive,
                    custom,
                    mode,
        ...
        deserializer.deserialize_any(RumRateLimitConfigUpdateAttributesVisitor)
    }
}
