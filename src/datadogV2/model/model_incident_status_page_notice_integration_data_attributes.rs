...
pub struct IncidentStatusPageNoticeIntegrationDataAttributes {
...
impl IncidentStatusPageNoticeIntegrationDataAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for IncidentStatusPageNoticeIntegrationDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentStatusPageNoticeIntegrationDataAttributesVisitor;
        impl<'a> Visitor<'a> for IncidentStatusPageNoticeIntegrationDataAttributesVisitor {
            type Value = IncidentStatusPageNoticeIntegrationDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentStatusPageNoticeIntegrationDataAttributes {
                    created,
                    integration_type,
                    modified,
                    status,
        ...
        deserializer.deserialize_any(IncidentStatusPageNoticeIntegrationDataAttributesVisitor)
    }
}
