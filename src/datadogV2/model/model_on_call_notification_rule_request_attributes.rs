...
pub struct OnCallNotificationRuleRequestAttributes {
...
impl OnCallNotificationRuleRequestAttributes {
    pub fn new() -> OnCallNotificationRuleRequestAttributes {
...
impl Default for OnCallNotificationRuleRequestAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for OnCallNotificationRuleRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OnCallNotificationRuleRequestAttributesVisitor;
        impl<'a> Visitor<'a> for OnCallNotificationRuleRequestAttributesVisitor {
            type Value = OnCallNotificationRuleRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OnCallNotificationRuleRequestAttributes {
                    category,
                    channel_settings,
                    delay_minutes,
        ...
        deserializer.deserialize_any(OnCallNotificationRuleRequestAttributesVisitor)
    }
}
