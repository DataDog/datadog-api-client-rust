...
impl<'de> Deserialize<'de> for IncidentTeamCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTeamCreateDataVisitor;
        impl<'a> Visitor<'a> for IncidentTeamCreateDataVisitor {
            type Value = IncidentTeamCreateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::IncidentTeamCreateAttributes> =
                    None;
                ...
                let content = IncidentTeamCreateData {
                    attributes,
                    relationships,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(IncidentTeamCreateDataVisitor)
    }
}
