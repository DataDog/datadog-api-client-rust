...
impl TwilioInterface {
    pub fn new(
        authentication: crate::datadogV2::model::TwilioAuthentication,
        type_: crate::datadogV2::model::TwilioInterfaceType,
    ) -> TwilioInterface {
        TwilioInterface {
            authentication,
            dataflows: None,
...
impl<'de> Deserialize<'de> for TwilioInterface {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TwilioInterfaceVisitor;
        impl<'a> Visitor<'a> for TwilioInterfaceVisitor {
            type Value = TwilioInterface;
        ...
        deserializer.deserialize_any(TwilioInterfaceVisitor)
    }
}
