...
impl<'de> Deserialize<'de> for ContainerImagesResponseLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ContainerImagesResponseLinksVisitor;
        impl<'a> Visitor<'a> for ContainerImagesResponseLinksVisitor {
            type Value = ContainerImagesResponseLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ContainerImagesResponseLinks {
                    first,
                    last,
                    next,
                    prev,
        ...
        deserializer.deserialize_any(ContainerImagesResponseLinksVisitor)
    }
}
