...
impl<'de> Deserialize<'de> for GCPSTSServiceAccountUpdateRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GCPSTSServiceAccountUpdateRequestDataVisitor;
        impl<'a> Visitor<'a> for GCPSTSServiceAccountUpdateRequestDataVisitor {
            type Value = GCPSTSServiceAccountUpdateRequestData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = GCPSTSServiceAccountUpdateRequestData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(GCPSTSServiceAccountUpdateRequestDataVisitor)
    }
}
