...
pub struct ScheduleOnCallResponderDataAttributes {
...
impl ScheduleOnCallResponderDataAttributes {
    pub fn new() -> ScheduleOnCallResponderDataAttributes {
...
impl Default for ScheduleOnCallResponderDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ScheduleOnCallResponderDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ScheduleOnCallResponderDataAttributesVisitor;
        impl<'a> Visitor<'a> for ScheduleOnCallResponderDataAttributesVisitor {
            type Value = ScheduleOnCallResponderDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ScheduleOnCallResponderDataAttributes {
                    position,
        ...
        deserializer.deserialize_any(ScheduleOnCallResponderDataAttributesVisitor)
    }
}
