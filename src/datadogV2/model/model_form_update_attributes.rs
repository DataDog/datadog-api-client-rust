...
pub struct FormUpdateAttributes {
    ...
    pub datastore_config: Option<crate::datadogV2::model::FormDatastoreConfigAttributes>,
...
impl FormUpdateAttributes {
    ...
    pub fn datastore_config(
        mut self,
        value: crate::datadogV2::model::FormDatastoreConfigAttributes,
    ) -> Self {
        self.datastore_config = Some(value);
        self
    }
