...
pub struct SchedulesResponseMetaPage {
    /// First page number.
...
impl SchedulesResponseMetaPage {
    pub fn new() -> SchedulesResponseMetaPage {
...
impl Default for SchedulesResponseMetaPage {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SchedulesResponseMetaPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SchedulesResponseMetaPageVisitor;
        impl<'a> Visitor<'a> for SchedulesResponseMetaPageVisitor {
            type Value = SchedulesResponseMetaPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SchedulesResponseMetaPage {
                    first_number,
                    last_number,
                    next_number,
                    number,
        ...
        deserializer.deserialize_any(SchedulesResponseMetaPageVisitor)
    }
}
