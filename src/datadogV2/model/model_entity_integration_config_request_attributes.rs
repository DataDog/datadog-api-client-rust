...
pub struct EntityIntegrationConfigRequestAttributes {
...
impl EntityIntegrationConfigRequestAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for EntityIntegrationConfigRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EntityIntegrationConfigRequestAttributesVisitor;
        impl<'a> Visitor<'a> for EntityIntegrationConfigRequestAttributesVisitor {
            type Value = EntityIntegrationConfigRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = EntityIntegrationConfigRequestAttributes {
                    config,
        ...
        deserializer.deserialize_any(EntityIntegrationConfigRequestAttributesVisitor)
    }
}
