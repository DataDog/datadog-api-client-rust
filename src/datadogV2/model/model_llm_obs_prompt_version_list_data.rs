...
pub struct LLMObsPromptVersionListData {
    /// Attributes of a prompt version returned in a list, excluding its template.
    #[serde(rename = "attributes")]
    pub attributes: crate::datadogV2::model::LLMObsPromptVersionListDataAttributes,
...
impl LLMObsPromptVersionListData {
    pub fn new(
...
impl<'de> Deserialize<'de> for LLMObsPromptVersionListData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsPromptVersionListDataVisitor;
        impl<'a> Visitor<'a> for LLMObsPromptVersionListDataVisitor {
            type Value = LLMObsPromptVersionListData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::LLMObsPromptVersionListDataAttributes,
                > = None;
                ...
                let content = LLMObsPromptVersionListData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsPromptVersionListDataVisitor)
    }
}
