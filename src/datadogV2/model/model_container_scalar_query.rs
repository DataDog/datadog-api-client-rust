...
/// An individual scalar container query.
#[non_exhaustive]
#[skip_serializing_none]
#[derive(Clone, Debug, PartialEq, Serialize)]
pub struct ContainerScalarQuery {
...
impl<'de> Deserialize<'de> for ContainerScalarQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ContainerScalarQueryVisitor;
        impl<'a> Visitor<'a> for ContainerScalarQueryVisitor {
            type Value = ContainerScalarQuery;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ContainerScalarQuery {
                    aggregator,
                    data_source,
                    is_normalized_cpu,
                    limit,
        ...
        deserializer.deserialize_any(ContainerScalarQueryVisitor)
    }
}
