...
pub struct FeatureFlagEnvironmentListItem {
...
impl FeatureFlagEnvironmentListItem {
    pub fn new(
...
impl<'de> Deserialize<'de> for FeatureFlagEnvironmentListItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FeatureFlagEnvironmentListItemVisitor;
        impl<'a> Visitor<'a> for FeatureFlagEnvironmentListItemVisitor {
            type Value = FeatureFlagEnvironmentListItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FeatureFlagEnvironmentListItem {
                    default_allocation_key,
                    default_variant_id,
                    environment_id,
                    environment_name,
        ...
        deserializer.deserialize_any(FeatureFlagEnvironmentListItemVisitor)
    }
}
