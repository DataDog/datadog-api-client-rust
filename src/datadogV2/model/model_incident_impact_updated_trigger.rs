...
pub struct IncidentImpactUpdatedTrigger {
...
impl IncidentImpactUpdatedTrigger {
    pub fn new() -> IncidentImpactUpdatedTrigger {
...
impl Default for IncidentImpactUpdatedTrigger {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentImpactUpdatedTrigger {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentImpactUpdatedTriggerVisitor;
        impl<'a> Visitor<'a> for IncidentImpactUpdatedTriggerVisitor {
            type Value = IncidentImpactUpdatedTrigger;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentImpactUpdatedTrigger {
                    execution_limit,
                    incident_type,
                    tag_condition,
        ...
        deserializer.deserialize_any(IncidentImpactUpdatedTriggerVisitor)
    }
}
