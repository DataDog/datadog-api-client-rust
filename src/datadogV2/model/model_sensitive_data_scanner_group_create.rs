...
impl<'de> Deserialize<'de> for SensitiveDataScannerGroupCreate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerGroupCreateVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerGroupCreateVisitor {
            type Value = SensitiveDataScannerGroupCreate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerGroupCreate {
                    attributes,
                    relationships,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(SensitiveDataScannerGroupCreateVisitor)
    }
}
