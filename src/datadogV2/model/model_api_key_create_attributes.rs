...
impl<'de> Deserialize<'de> for APIKeyCreateAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct APIKeyCreateAttributesVisitor;
        impl<'a> Visitor<'a> for APIKeyCreateAttributesVisitor {
            type Value = APIKeyCreateAttributes;
        ...
        deserializer.deserialize_any(APIKeyCreateAttributesVisitor)
    }
}
