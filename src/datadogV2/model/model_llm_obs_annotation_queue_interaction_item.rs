...
impl LLMObsAnnotationQueueInteractionItem {
    pub fn new(
        content_id: String,
...
impl<'de> Deserialize<'de> for LLMObsAnnotationQueueInteractionItem {
    ...
    where
        D: Deserializer<'de>,
    {
        struct LLMObsAnnotationQueueInteractionItemVisitor;
        impl<'a> Visitor<'a> for LLMObsAnnotationQueueInteractionItemVisitor {
            type Value = LLMObsAnnotationQueueInteractionItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LLMObsAnnotationQueueInteractionItem {
                    content_id,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsAnnotationQueueInteractionItemVisitor)
    }
}
