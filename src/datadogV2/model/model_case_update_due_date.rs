...
impl CaseUpdateDueDate {
    pub fn new(
        attributes: crate::datadogV2::model::CaseUpdateDueDateAttributes,
...
impl<'de> Deserialize<'de> for CaseUpdateDueDate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CaseUpdateDueDateVisitor;
        impl<'a> Visitor<'a> for CaseUpdateDueDateVisitor {
            type Value = CaseUpdateDueDate;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::CaseUpdateDueDateAttributes> =
                    None;
        ...
        deserializer.deserialize_any(CaseUpdateDueDateVisitor)
    }
}
