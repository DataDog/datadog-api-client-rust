...
pub struct IncidentImpactFieldRelationships {
...
impl IncidentImpactFieldRelationships {
    pub fn new() -> IncidentImpactFieldRelationships {
...
impl Default for IncidentImpactFieldRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentImpactFieldRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentImpactFieldRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentImpactFieldRelationshipsVisitor {
            type Value = IncidentImpactFieldRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentImpactFieldRelationships {
                    created_by_user,
                    incident_type,
                    last_modified_by_user,
        ...
        deserializer.deserialize_any(IncidentImpactFieldRelationshipsVisitor)
    }
}
