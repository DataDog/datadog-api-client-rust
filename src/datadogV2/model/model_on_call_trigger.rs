...
impl Default for OnCallTrigger {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for OnCallTrigger {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OnCallTriggerVisitor;
        impl<'a> Visitor<'a> for OnCallTriggerVisitor {
            type Value = OnCallTrigger;
        ...
        deserializer.deserialize_any(OnCallTriggerVisitor)
    }
}
