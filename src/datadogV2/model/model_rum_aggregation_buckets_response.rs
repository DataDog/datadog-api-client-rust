...
impl<'de> Deserialize<'de> for RUMAggregationBucketsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMAggregationBucketsResponseVisitor;
        impl<'a> Visitor<'a> for RUMAggregationBucketsResponseVisitor {
            type Value = RUMAggregationBucketsResponse;
        ...
        deserializer.deserialize_any(RUMAggregationBucketsResponseVisitor)
    }
}
