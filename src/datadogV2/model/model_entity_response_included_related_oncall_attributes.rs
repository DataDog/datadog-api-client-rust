...
impl EntityResponseIncludedRelatedOncallAttributes {
    ...
    pub fn escalations(
        mut self,
        value: Vec<crate::datadogV2::model::EntityResponseIncludedRelatedOncallEscalationItem>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for EntityResponseIncludedRelatedOncallAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EntityResponseIncludedRelatedOncallAttributesVisitor;
        impl<'a> Visitor<'a> for EntityResponseIncludedRelatedOncallAttributesVisitor {
            type Value = EntityResponseIncludedRelatedOncallAttributes;
                ...
                M: MapAccess<'a>,
            {
                let mut escalations: Option<
                    Vec<crate::datadogV2::model::EntityResponseIncludedRelatedOncallEscalationItem>,
                > = None;
        ...
        deserializer.deserialize_any(EntityResponseIncludedRelatedOncallAttributesVisitor)
    }
}
