...
pub struct LLMObsTraceInteractionItem {
...
impl LLMObsTraceInteractionItem {
    pub fn new(
        content_id: String,
...
impl<'de> Deserialize<'de> for LLMObsTraceInteractionItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsTraceInteractionItemVisitor;
        impl<'a> Visitor<'a> for LLMObsTraceInteractionItemVisitor {
            type Value = LLMObsTraceInteractionItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LLMObsTraceInteractionItem {
                    content_id,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsTraceInteractionItemVisitor)
    }
}
