...
impl<'de> Deserialize<'de> for CloudWorkloadSecurityAgentRuleData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CloudWorkloadSecurityAgentRuleDataVisitor;
        impl<'a> Visitor<'a> for CloudWorkloadSecurityAgentRuleDataVisitor {
            type Value = CloudWorkloadSecurityAgentRuleData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CloudWorkloadSecurityAgentRuleAttributes,
                > = None;
                ...
                let content = CloudWorkloadSecurityAgentRuleData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(CloudWorkloadSecurityAgentRuleDataVisitor)
    }
}
