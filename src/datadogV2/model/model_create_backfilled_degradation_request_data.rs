...
pub struct CreateBackfilledDegradationRequestData {
...
impl CreateBackfilledDegradationRequestData {
    pub fn new(
...
impl<'de> Deserialize<'de> for CreateBackfilledDegradationRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateBackfilledDegradationRequestDataVisitor;
        impl<'a> Visitor<'a> for CreateBackfilledDegradationRequestDataVisitor {
            type Value = CreateBackfilledDegradationRequestData;
        ...
        deserializer.deserialize_any(CreateBackfilledDegradationRequestDataVisitor)
    }
}
