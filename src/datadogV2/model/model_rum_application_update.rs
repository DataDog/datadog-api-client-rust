...
impl<'de> Deserialize<'de> for RUMApplicationUpdate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct RUMApplicationUpdateVisitor;
        impl<'a> Visitor<'a> for RUMApplicationUpdateVisitor {
            type Value = RUMApplicationUpdate;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::RUMApplicationUpdateAttributes,
                > = None;
                let mut id: Option<String> = None;
                let mut type_: Option<crate::datadogV2::model::RUMApplicationUpdateType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::RUMApplicationUpdateType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = RUMApplicationUpdate {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(RUMApplicationUpdateVisitor)
    }
}
