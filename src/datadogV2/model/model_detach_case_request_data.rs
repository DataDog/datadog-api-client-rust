...
impl<'de> Deserialize<'de> for DetachCaseRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DetachCaseRequestDataVisitor;
        impl<'a> Visitor<'a> for DetachCaseRequestDataVisitor {
            type Value = DetachCaseRequestData;
        ...
        deserializer.deserialize_any(DetachCaseRequestDataVisitor)
    }
}
