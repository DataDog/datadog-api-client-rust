...
impl<'de> Deserialize<'de> for MuteRuleUpdateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MuteRuleUpdateRequestVisitor;
        impl<'a> Visitor<'a> for MuteRuleUpdateRequestVisitor {
            type Value = MuteRuleUpdateRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = MuteRuleUpdateRequest {
                    data,
        ...
        deserializer.deserialize_any(MuteRuleUpdateRequestVisitor)
    }
}
