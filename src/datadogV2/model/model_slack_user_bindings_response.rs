...
pub struct SlackUserBindingsResponse {
    ...
    #[serde(rename = "data")]
    pub data: Vec<crate::datadogV2::model::SlackUserBindingData>,
    #[serde(flatten)]
...
impl SlackUserBindingsResponse {
    pub fn new(
        data: Vec<crate::datadogV2::model::SlackUserBindingData>,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for SlackUserBindingsResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::SlackUserBindingData>> = None;
