...
impl OrgGroupPolicyUpdateData {
    pub fn new(
        attributes: crate::datadogV2::model::OrgGroupPolicyUpdateAttributes,
        id: uuid::Uuid,
...
impl<'de> Deserialize<'de> for OrgGroupPolicyUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPolicyUpdateDataVisitor;
        impl<'a> Visitor<'a> for OrgGroupPolicyUpdateDataVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::OrgGroupPolicyUpdateAttributes,
                > = None;
                ...
                let content = OrgGroupPolicyUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(OrgGroupPolicyUpdateDataVisitor)
    }
}
