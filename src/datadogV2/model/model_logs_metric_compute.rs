...
impl<'de> Deserialize<'de> for LogsMetricCompute {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsMetricComputeVisitor;
        impl<'a> Visitor<'a> for LogsMetricComputeVisitor {
            type Value = LogsMetricCompute;
                ...
                M: MapAccess<'a>,
            {
                let mut aggregation_type: Option<
                    crate::datadogV2::model::LogsMetricComputeAggregationType,
                > = None;
                        ...
                        "aggregation_type" => {
                            ...
                            if let Some(ref _aggregation_type) = aggregation_type {
                                match _aggregation_type {
                                    crate::datadogV2::model::LogsMetricComputeAggregationType::UnparsedObject(_aggregation_type) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(LogsMetricComputeVisitor)
    }
}
