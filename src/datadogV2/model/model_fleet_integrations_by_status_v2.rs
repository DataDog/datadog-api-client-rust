...
pub struct FleetIntegrationsByStatusV2 {
    ...
    pub warning_integrations: Option<Vec<crate::datadogV2::model::FleetIntegrationDetailsV2>>,
    /// Integrations that are working correctly.
    #[serde(rename = "working_integrations")]
    pub working_integrations: Option<Vec<crate::datadogV2::model::FleetIntegrationDetailsV2>>,
    #[serde(flatten)]
...
impl FleetIntegrationsByStatusV2 {
    ...
    pub fn configuration_files(
        mut self,
        value: Vec<crate::datadogV2::model::FleetConfigurationFileV2>,
    ) -> Self {
...
impl Default for FleetIntegrationsByStatusV2 {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FleetIntegrationsByStatusV2 {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetIntegrationsByStatusV2Visitor;
        impl<'a> Visitor<'a> for FleetIntegrationsByStatusV2Visitor {
            type Value = FleetIntegrationsByStatusV2;
        ...
        deserializer.deserialize_any(FleetIntegrationsByStatusV2Visitor)
    }
}
