...
impl Serialize for IncidentSearchResultsType {
...
impl<'de> Deserialize<'de> for IncidentSearchResultsType {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match s.as_str() {
            "incidents_search_results" => Self::INCIDENTS_SEARCH_RESULTS,
