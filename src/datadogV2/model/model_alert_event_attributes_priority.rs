...
pub enum AlertEventAttributesPriority {
    PRIORITY_ONE,
    PRIORITY_TWO,
    PRIORITY_THREE,
    PRIORITY_FOUR,
...
impl ToString for AlertEventAttributesPriority {
...
impl Serialize for AlertEventAttributesPriority {
...
impl<'de> Deserialize<'de> for AlertEventAttributesPriority {
