...
impl<'de> Deserialize<'de> for ConfluentAccountResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ConfluentAccountResponseDataVisitor;
        impl<'a> Visitor<'a> for ConfluentAccountResponseDataVisitor {
            type Value = ConfluentAccountResponseData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::ConfluentAccountResponseAttributes,
                > = None;
                ...
                let content = ConfluentAccountResponseData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(ConfluentAccountResponseDataVisitor)
    }
}
