...
impl<'de> Deserialize<'de> for SpansGroupByHistogram {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansGroupByHistogramVisitor;
        impl<'a> Visitor<'a> for SpansGroupByHistogramVisitor {
            type Value = SpansGroupByHistogram;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SpansGroupByHistogram {
                    interval,
                    max,
                    min,
                    _unparsed,
        ...
        deserializer.deserialize_any(SpansGroupByHistogramVisitor)
    }
}
