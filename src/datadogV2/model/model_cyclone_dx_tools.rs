...
impl CycloneDXTools {
    pub fn new(components: Vec<crate::datadogV2::model::CycloneDXToolComponent>) -> CycloneDXTools {
        CycloneDXTools {
            components,
...
impl<'de> Deserialize<'de> for CycloneDXTools {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CycloneDXToolsVisitor;
        impl<'a> Visitor<'a> for CycloneDXToolsVisitor {
            type Value = CycloneDXTools;
        ...
        deserializer.deserialize_any(CycloneDXToolsVisitor)
    }
}
