...
pub struct AWSEventBridgeListResponse {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::AWSEventBridgeListResponseData,
    #[serde(flatten)]
...
impl AWSEventBridgeListResponse {
    pub fn new(
        data: crate::datadogV2::model::AWSEventBridgeListResponseData,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSEventBridgeListResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::AWSEventBridgeListResponseData> =
                    None;
