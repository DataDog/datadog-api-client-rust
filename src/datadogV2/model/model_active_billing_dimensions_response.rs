...
impl<'de> Deserialize<'de> for ActiveBillingDimensionsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ActiveBillingDimensionsResponseVisitor;
        impl<'a> Visitor<'a> for ActiveBillingDimensionsResponseVisitor {
            type Value = ActiveBillingDimensionsResponse;
        ...
        deserializer.deserialize_any(ActiveBillingDimensionsResponseVisitor)
    }
}
