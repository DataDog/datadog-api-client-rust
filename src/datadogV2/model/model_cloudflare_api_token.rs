...
impl CloudflareAPIToken {
    pub fn new(
        api_token: String,
        type_: crate::datadogV2::model::CloudflareAPITokenType,
    ) -> CloudflareAPIToken {
        CloudflareAPIToken {
            api_token,
            type_,
...
impl<'de> Deserialize<'de> for CloudflareAPIToken {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CloudflareAPITokenVisitor;
        impl<'a> Visitor<'a> for CloudflareAPITokenVisitor {
            type Value = CloudflareAPIToken;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CloudflareAPIToken {
                    api_token,
                    type_,
        ...
        deserializer.deserialize_any(CloudflareAPITokenVisitor)
    }
}
