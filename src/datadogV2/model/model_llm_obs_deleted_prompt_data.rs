...
impl<'de> Deserialize<'de> for LLMObsDeletedPromptData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsDeletedPromptDataVisitor;
        impl<'a> Visitor<'a> for LLMObsDeletedPromptDataVisitor {
            type Value = LLMObsDeletedPromptData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::LLMObsDeletedPromptDataAttributes,
                > = None;
                ...
                let content = LLMObsDeletedPromptData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsDeletedPromptDataVisitor)
    }
}
