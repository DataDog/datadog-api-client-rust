...
impl<'de> Deserialize<'de> for SpansAggregateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansAggregateRequestVisitor;
        impl<'a> Visitor<'a> for SpansAggregateRequestVisitor {
            type Value = SpansAggregateRequest;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SpansAggregateData> = None;
                ...
                let content = SpansAggregateRequest { data, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(SpansAggregateRequestVisitor)
    }
}
