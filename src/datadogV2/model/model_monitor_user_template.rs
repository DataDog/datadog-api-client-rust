...
pub struct MonitorUserTemplate {
    ...
    pub versions: Option<Vec<crate::datadogV2::model::SimpleMonitorUserTemplate>>,
    #[serde(flatten)]
...
impl MonitorUserTemplate {
    ...
    pub fn versions(
        mut self,
        value: Vec<crate::datadogV2::model::SimpleMonitorUserTemplate>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for MonitorUserTemplate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct MonitorUserTemplateVisitor;
        impl<'a> Visitor<'a> for MonitorUserTemplateVisitor {
            type Value = MonitorUserTemplate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut versions: Option<Vec<crate::datadogV2::model::SimpleMonitorUserTemplate>> =
                    None;
                ...
                let content = MonitorUserTemplate {
                    created,
                    description,
                    modified,
                    monitor_definition,
        ...
        deserializer.deserialize_any(MonitorUserTemplateVisitor)
    }
}
