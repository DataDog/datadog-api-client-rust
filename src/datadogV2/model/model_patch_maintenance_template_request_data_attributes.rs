...
pub struct PatchMaintenanceTemplateRequestDataAttributes {
...
impl PatchMaintenanceTemplateRequestDataAttributes {
    pub fn new() -> PatchMaintenanceTemplateRequestDataAttributes {
...
impl Default for PatchMaintenanceTemplateRequestDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for PatchMaintenanceTemplateRequestDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PatchMaintenanceTemplateRequestDataAttributesVisitor;
        impl<'a> Visitor<'a> for PatchMaintenanceTemplateRequestDataAttributesVisitor {
            type Value = PatchMaintenanceTemplateRequestDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = PatchMaintenanceTemplateRequestDataAttributes {
                    completed_description,
                    component_ids,
                    in_progress_description,
                    maintenance_title,
        ...
        deserializer.deserialize_any(PatchMaintenanceTemplateRequestDataAttributesVisitor)
    }
}
