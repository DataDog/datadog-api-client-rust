...
pub struct SyntheticsGlobalVariable {
    ...
    pub attributes: Option<crate::datadogV2::model::SyntheticsGlobalVariableAttributes>,
    ...
    pub parse_test_options:
        Option<crate::datadogV2::model::SyntheticsGlobalVariableParseTestOptions>,
    ...
    #[serde(rename = "value")]
    pub value: crate::datadogV2::model::SyntheticsGlobalVariableValue,
    #[serde(flatten)]
...
impl SyntheticsGlobalVariable {
    pub fn new(
        ...
        name: String,
        tags: Vec<String>,
        value: crate::datadogV2::model::SyntheticsGlobalVariableValue,
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::SyntheticsGlobalVariableAttributes,
    ) -> Self {
    ...
    pub fn parse_test_options(
        mut self,
        value: crate::datadogV2::model::SyntheticsGlobalVariableParseTestOptions,
    ) -> Self {
        ...
        impl<'a> Visitor<'a> for SyntheticsGlobalVariableVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SyntheticsGlobalVariableAttributes,
                > = None;
                ...
                let mut parse_test_options: Option<
                    crate::datadogV2::model::SyntheticsGlobalVariableParseTestOptions,
                > = None;
                let mut parse_test_public_id: Option<String> = None;
                let mut tags: Option<Vec<String>> = None;
                let mut value: Option<crate::datadogV2::model::SyntheticsGlobalVariableValue> =
                    None;
