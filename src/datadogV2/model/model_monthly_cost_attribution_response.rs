...
impl<'de> Deserialize<'de> for MonthlyCostAttributionResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonthlyCostAttributionResponseVisitor;
        impl<'a> Visitor<'a> for MonthlyCostAttributionResponseVisitor {
            type Value = MonthlyCostAttributionResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::MonthlyCostAttributionBody>> =
                    None;
                let mut meta: Option<crate::datadogV2::model::MonthlyCostAttributionMeta> = None;
                ...
                let content = MonthlyCostAttributionResponse {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(MonthlyCostAttributionResponseVisitor)
    }
}
