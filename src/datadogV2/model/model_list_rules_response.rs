...
impl<'de> Deserialize<'de> for ListRulesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListRulesResponseVisitor;
        impl<'a> Visitor<'a> for ListRulesResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::ListRulesResponseDataItem>> =
                    None;
                let mut links: Option<crate::datadogV2::model::ListRulesResponseLinks> = None;
        ...
        deserializer.deserialize_any(ListRulesResponseVisitor)
    }
}
