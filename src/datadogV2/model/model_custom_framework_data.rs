...
pub struct CustomFrameworkData {
    /// Framework Data Attributes.
    #[serde(rename = "attributes")]
    pub attributes: crate::datadogV2::model::CustomFrameworkDataAttributes,
...
impl CustomFrameworkData {
    pub fn new(
        attributes: crate::datadogV2::model::CustomFrameworkDataAttributes,
...
impl<'de> Deserialize<'de> for CustomFrameworkData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CustomFrameworkDataVisitor;
        impl<'a> Visitor<'a> for CustomFrameworkDataVisitor {
            type Value = CustomFrameworkData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::CustomFrameworkDataAttributes> =
                    None;
                ...
                let content = CustomFrameworkData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(CustomFrameworkDataVisitor)
    }
}
