...
impl<'de> Deserialize<'de> for IncidentServicesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentServicesResponseVisitor;
        impl<'a> Visitor<'a> for IncidentServicesResponseVisitor {
            type Value = IncidentServicesResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::IncidentServiceResponseData>> =
                    None;
                ...
                let content = IncidentServicesResponse {
                    data,
                    included,
                    meta,
                    _unparsed,
        ...
        deserializer.deserialize_any(IncidentServicesResponseVisitor)
    }
}
