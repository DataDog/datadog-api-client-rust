...
pub struct CreateMuteRuleParametersDataAttributes {
...
impl CreateMuteRuleParametersDataAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for CreateMuteRuleParametersDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateMuteRuleParametersDataAttributesVisitor;
        impl<'a> Visitor<'a> for CreateMuteRuleParametersDataAttributesVisitor {
            type Value = CreateMuteRuleParametersDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateMuteRuleParametersDataAttributes {
                    action,
                    enabled,
                    name,
                    rule,
        ...
        deserializer.deserialize_any(CreateMuteRuleParametersDataAttributesVisitor)
    }
}
