...
impl<'de> Deserialize<'de> for ObservabilityPipelineDiskBufferOptions {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineDiskBufferOptionsVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineDiskBufferOptionsVisitor {
            type Value = ObservabilityPipelineDiskBufferOptions;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<
                    crate::datadogV2::model::ObservabilityPipelineBufferOptionsDiskType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ObservabilityPipelineBufferOptionsDiskType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ObservabilityPipelineDiskBufferOptionsVisitor)
    }
}
