...
pub struct LLMObsPatternsConfigItem {
...
impl<'de> Deserialize<'de> for LLMObsPatternsConfigItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsPatternsConfigItemVisitor;
        impl<'a> Visitor<'a> for LLMObsPatternsConfigItemVisitor {
            type Value = LLMObsPatternsConfigItem;
        ...
        deserializer.deserialize_any(LLMObsPatternsConfigItemVisitor)
    }
}
