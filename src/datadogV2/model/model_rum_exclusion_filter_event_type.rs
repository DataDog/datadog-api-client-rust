...
pub enum RumExclusionFilterEventType {
    SESSION,
    VIEW,
    ACTION,
    ERROR,
...
impl ToString for RumExclusionFilterEventType {
...
impl Serialize for RumExclusionFilterEventType {
...
impl<'de> Deserialize<'de> for RumExclusionFilterEventType {
