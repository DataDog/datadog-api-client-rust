...
impl<'de> Deserialize<'de> for IncidentSearchResponseMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentSearchResponseMetaVisitor;
        impl<'a> Visitor<'a> for IncidentSearchResponseMetaVisitor {
            type Value = IncidentSearchResponseMeta;
                ...
                M: MapAccess<'a>,
            {
                let mut pagination: Option<
                    crate::datadogV2::model::IncidentResponseMetaPagination,
                > = None;
                ...
                let content = IncidentSearchResponseMeta {
                    pagination,
        ...
        deserializer.deserialize_any(IncidentSearchResponseMetaVisitor)
    }
}
