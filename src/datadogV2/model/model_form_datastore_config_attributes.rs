...
pub struct FormDatastoreConfigAttributes {
...
impl FormDatastoreConfigAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for FormDatastoreConfigAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FormDatastoreConfigAttributesVisitor;
        impl<'a> Visitor<'a> for FormDatastoreConfigAttributesVisitor {
            type Value = FormDatastoreConfigAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FormDatastoreConfigAttributes {
                    datastore_id,
                    primary_column_name,
                    primary_key_generation_strategy,
        ...
        deserializer.deserialize_any(FormDatastoreConfigAttributesVisitor)
    }
}
