...
pub struct CreatePhoneNotificationChannelConfig {
    /// Number is the E-164 formatted phone number (e.g. +3371234567)
    #[serde(rename = "number")]
    pub number: String,
...
impl CreatePhoneNotificationChannelConfig {
    pub fn new(
        number: String,
...
impl<'de> Deserialize<'de> for CreatePhoneNotificationChannelConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreatePhoneNotificationChannelConfigVisitor;
        impl<'a> Visitor<'a> for CreatePhoneNotificationChannelConfigVisitor {
            type Value = CreatePhoneNotificationChannelConfig;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreatePhoneNotificationChannelConfig {
                    number,
                    type_,
        ...
        deserializer.deserialize_any(CreatePhoneNotificationChannelConfigVisitor)
    }
}
