...
impl<'de> Deserialize<'de> for AWSResources {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSResourcesVisitor;
        impl<'a> Visitor<'a> for AWSResourcesVisitor {
            type Value = AWSResources;
        ...
        deserializer.deserialize_any(AWSResourcesVisitor)
    }
}
