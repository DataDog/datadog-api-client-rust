...
impl<'de> Deserialize<'de> for SensitiveDataScannerRuleIncludedItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerRuleIncludedItemVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerRuleIncludedItemVisitor {
            type Value = SensitiveDataScannerRuleIncludedItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerRuleIncludedItem {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(SensitiveDataScannerRuleIncludedItemVisitor)
    }
}
