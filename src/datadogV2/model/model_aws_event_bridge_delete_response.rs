...
pub struct AWSEventBridgeDeleteResponse {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::AWSEventBridgeDeleteResponseData,
    #[serde(flatten)]
...
impl AWSEventBridgeDeleteResponse {
    pub fn new(
        data: crate::datadogV2::model::AWSEventBridgeDeleteResponseData,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSEventBridgeDeleteResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::AWSEventBridgeDeleteResponseData> =
                    None;
                ...
                let content = AWSEventBridgeDeleteResponse {
                    data,
