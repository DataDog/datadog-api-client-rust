...
pub struct AutomationRuleCreatedBy {
...
impl<'de> Deserialize<'de> for AutomationRuleCreatedBy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AutomationRuleCreatedByVisitor;
        impl<'a> Visitor<'a> for AutomationRuleCreatedByVisitor {
            type Value = AutomationRuleCreatedBy;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AutomationRuleCreatedBy {
                    id,
                    name,
                    type_,
        ...
        deserializer.deserialize_any(AutomationRuleCreatedByVisitor)
    }
}
