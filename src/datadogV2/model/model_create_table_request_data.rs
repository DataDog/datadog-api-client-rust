...
impl CreateTableRequestData {
    pub fn new(
        type_: crate::datadogV2::model::CreateTableRequestDataType,
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::CreateTableRequestDataAttributes,
    ) -> Self {
...
impl<'de> Deserialize<'de> for CreateTableRequestData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CreateTableRequestDataVisitor;
        impl<'a> Visitor<'a> for CreateTableRequestDataVisitor {
            type Value = CreateTableRequestData;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::CreateTableRequestDataType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(CreateTableRequestDataVisitor)
    }
}
