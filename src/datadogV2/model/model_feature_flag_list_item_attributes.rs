...
pub struct FeatureFlagListItemAttributes {
    ...
    pub feature_flag_environments:
        Option<Vec<crate::datadogV2::model::FeatureFlagEnvironmentListItem>>,
...
impl FeatureFlagListItemAttributes {
    pub fn new(
        description: String,
        key: String,
        name: String,
    ...
    pub fn feature_flag_environments(
        mut self,
        value: Vec<crate::datadogV2::model::FeatureFlagEnvironmentListItem>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for FeatureFlagListItemAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FeatureFlagListItemAttributesVisitor;
        impl<'a> Visitor<'a> for FeatureFlagListItemAttributesVisitor {
            type Value = FeatureFlagListItemAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut feature_flag_environments: Option<
                    Vec<crate::datadogV2::model::FeatureFlagEnvironmentListItem>,
                > = None;
                ...
                let content = FeatureFlagListItemAttributes {
                    archived_at,
                    created_at,
                    created_by,
                    description,
        ...
        deserializer.deserialize_any(FeatureFlagListItemAttributesVisitor)
    }
}
