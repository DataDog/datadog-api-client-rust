...
impl<'de> Deserialize<'de> for IncidentSearchResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentSearchResponseDataVisitor;
        impl<'a> Visitor<'a> for IncidentSearchResponseDataVisitor {
            type Value = IncidentSearchResponseData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::IncidentSearchResponseAttributes,
                > = None;
                let mut type_: Option<crate::datadogV2::model::IncidentSearchResultsType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::IncidentSearchResultsType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = IncidentSearchResponseData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(IncidentSearchResponseDataVisitor)
    }
}
