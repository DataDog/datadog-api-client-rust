...
pub struct AWSEventBridgeCreateResponse {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::AWSEventBridgeCreateResponseData,
    #[serde(flatten)]
...
impl AWSEventBridgeCreateResponse {
    pub fn new(
        data: crate::datadogV2::model::AWSEventBridgeCreateResponseData,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSEventBridgeCreateResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::AWSEventBridgeCreateResponseData> =
                    None;
