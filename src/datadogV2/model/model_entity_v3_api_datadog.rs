...
impl<'de> Deserialize<'de> for EntityV3APIDatadog {
    ...
    where
        D: Deserializer<'de>,
    {
        struct EntityV3APIDatadogVisitor;
        impl<'a> Visitor<'a> for EntityV3APIDatadogVisitor {
            type Value = EntityV3APIDatadog;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = EntityV3APIDatadog {
                    code_locations,
                    events,
                    logs,
                    performance_data,
        ...
        deserializer.deserialize_any(EntityV3APIDatadogVisitor)
    }
}
