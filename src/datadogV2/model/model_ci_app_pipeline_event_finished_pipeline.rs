...
pub struct CIAppPipelineEventFinishedPipeline {
...
impl CIAppPipelineEventFinishedPipeline {
    pub fn new(
...
impl<'de> Deserialize<'de> for CIAppPipelineEventFinishedPipeline {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppPipelineEventFinishedPipelineVisitor;
        impl<'a> Visitor<'a> for CIAppPipelineEventFinishedPipelineVisitor {
            type Value = CIAppPipelineEventFinishedPipeline;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CIAppPipelineEventFinishedPipeline {
                    end,
                    error,
                    git,
                    is_manual,
        ...
        deserializer.deserialize_any(CIAppPipelineEventFinishedPipelineVisitor)
    }
}
