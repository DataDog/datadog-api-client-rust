...
impl FrameworkControl {
    pub fn new(name: String, rule_ids: Vec<String>) -> FrameworkControl {
        FrameworkControl {
            name,
            rule_ids,
...
impl<'de> Deserialize<'de> for FrameworkControl {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FrameworkControlVisitor;
        impl<'a> Visitor<'a> for FrameworkControlVisitor {
        ...
        deserializer.deserialize_any(FrameworkControlVisitor)
    }
}
