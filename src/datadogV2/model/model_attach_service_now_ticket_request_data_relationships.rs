...
pub struct AttachServiceNowTicketRequestDataRelationships {
...
impl AttachServiceNowTicketRequestDataRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for AttachServiceNowTicketRequestDataRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AttachServiceNowTicketRequestDataRelationshipsVisitor;
        impl<'a> Visitor<'a> for AttachServiceNowTicketRequestDataRelationshipsVisitor {
            type Value = AttachServiceNowTicketRequestDataRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AttachServiceNowTicketRequestDataRelationships {
                    findings,
                    project,
        ...
        deserializer.deserialize_any(AttachServiceNowTicketRequestDataRelationshipsVisitor)
    }
}
