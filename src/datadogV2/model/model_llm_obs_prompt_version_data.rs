...
impl LLMObsPromptVersionData {
    pub fn new(
        attributes: crate::datadogV2::model::LLMObsPromptVersionDataAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for LLMObsPromptVersionData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsPromptVersionDataVisitor;
        impl<'a> Visitor<'a> for LLMObsPromptVersionDataVisitor {
            type Value = LLMObsPromptVersionData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::LLMObsPromptVersionDataAttributes,
                > = None;
                ...
                let content = LLMObsPromptVersionData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsPromptVersionDataVisitor)
    }
}
