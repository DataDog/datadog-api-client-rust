...
pub struct OrgGroupPolicyListResponse {
...
impl OrgGroupPolicyListResponse {
    pub fn new(
        data: Vec<crate::datadogV2::model::OrgGroupPolicyData>,
...
impl<'de> Deserialize<'de> for OrgGroupPolicyListResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPolicyListResponseVisitor;
        impl<'a> Visitor<'a> for OrgGroupPolicyListResponseVisitor {
            type Value = OrgGroupPolicyListResponse;
        ...
        deserializer.deserialize_any(OrgGroupPolicyListResponseVisitor)
    }
}
