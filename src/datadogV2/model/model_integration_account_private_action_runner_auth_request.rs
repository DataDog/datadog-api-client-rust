...
pub struct IntegrationAccountPrivateActionRunnerAuthRequest {
    ...
    /// Path of the credential inside the secret backend configured on the runner. Because an update replaces the authentication object entirely, omitting it removes any stored path.
