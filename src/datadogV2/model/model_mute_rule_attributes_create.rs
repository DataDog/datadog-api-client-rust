...
pub struct MuteRuleAttributesCreate {
    /// The action to take when the mute rule matches a finding.
    #[serde(rename = "action")]
    pub action: crate::datadogV2::model::MuteRuleAction,
...
impl<'de> Deserialize<'de> for MuteRuleAttributesCreate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MuteRuleAttributesCreateVisitor;
        impl<'a> Visitor<'a> for MuteRuleAttributesCreateVisitor {
            type Value = MuteRuleAttributesCreate;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut action: Option<crate::datadogV2::model::MuteRuleAction> = None;
                ...
                let content = MuteRuleAttributesCreate {
                    action,
                    enabled,
                    name,
                    rule,
        ...
        deserializer.deserialize_any(MuteRuleAttributesCreateVisitor)
    }
}
