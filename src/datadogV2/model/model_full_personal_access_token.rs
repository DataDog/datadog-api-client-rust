...
impl FullPersonalAccessToken {
    pub fn new() -> FullPersonalAccessToken {
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::FullPersonalAccessTokenAttributes,
    ) -> Self {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::PersonalAccessTokensType) -> Self {
...
impl Default for FullPersonalAccessToken {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FullPersonalAccessToken {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FullPersonalAccessTokenVisitor;
        impl<'a> Visitor<'a> for FullPersonalAccessTokenVisitor {
            type Value = FullPersonalAccessToken;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::FullPersonalAccessTokenAttributes,
                > = None;
                ...
                let content = FullPersonalAccessToken {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(FullPersonalAccessTokenVisitor)
    }
}
