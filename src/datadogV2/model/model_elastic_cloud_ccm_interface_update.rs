...
pub struct ElasticCloudCcmInterfaceUpdate {
...
impl ElasticCloudCcmInterfaceUpdate {
    pub fn new(
...
impl<'de> Deserialize<'de> for ElasticCloudCcmInterfaceUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudCcmInterfaceUpdateVisitor;
        impl<'a> Visitor<'a> for ElasticCloudCcmInterfaceUpdateVisitor {
            type Value = ElasticCloudCcmInterfaceUpdate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudCcmInterfaceUpdate {
                    authentication,
                    dataflows,
                    settings,
                    type_,
        ...
        deserializer.deserialize_any(ElasticCloudCcmInterfaceUpdateVisitor)
    }
}
