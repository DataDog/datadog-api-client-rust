...
impl Default for IssueCaseJiraIssueResult {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IssueCaseJiraIssueResult {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IssueCaseJiraIssueResultVisitor;
        impl<'a> Visitor<'a> for IssueCaseJiraIssueResultVisitor {
            type Value = IssueCaseJiraIssueResult;
        ...
        deserializer.deserialize_any(IssueCaseJiraIssueResultVisitor)
    }
}
