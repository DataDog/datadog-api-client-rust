...
pub struct ExposureRolloutStepRequest {
...
impl ExposureRolloutStepRequest {
    pub fn new(
        exposure_ratio: f64,
...
impl<'de> Deserialize<'de> for ExposureRolloutStepRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ExposureRolloutStepRequestVisitor;
        impl<'a> Visitor<'a> for ExposureRolloutStepRequestVisitor {
            type Value = ExposureRolloutStepRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ExposureRolloutStepRequest {
                    exposure_ratio,
                    grouped_step_index,
                    id,
                    interval_ms,
        ...
        deserializer.deserialize_any(ExposureRolloutStepRequestVisitor)
    }
}
