...
impl<'de> Deserialize<'de> for DatasetResponseMulti {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DatasetResponseMultiVisitor;
        impl<'a> Visitor<'a> for DatasetResponseMultiVisitor {
            type Value = DatasetResponseMulti;
        ...
        deserializer.deserialize_any(DatasetResponseMultiVisitor)
    }
}
