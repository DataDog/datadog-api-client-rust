...
impl DeploymentRelationship {
    pub fn new() -> DeploymentRelationship {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::DeploymentRelationshipData) -> Self {
...
impl Default for DeploymentRelationship {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for DeploymentRelationship {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DeploymentRelationshipVisitor;
        impl<'a> Visitor<'a> for DeploymentRelationshipVisitor {
            type Value = DeploymentRelationship;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DeploymentRelationship {
                    data,
                    meta,
        ...
        deserializer.deserialize_any(DeploymentRelationshipVisitor)
    }
}
