...
impl Default for HourlyUsagePagination {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for HourlyUsagePagination {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct HourlyUsagePaginationVisitor;
        impl<'a> Visitor<'a> for HourlyUsagePaginationVisitor {
            type Value = HourlyUsagePagination;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = HourlyUsagePagination {
                    next_record_id,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(HourlyUsagePaginationVisitor)
    }
}
