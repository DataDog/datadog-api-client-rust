...
pub struct FormData {
    ...
    pub attributes: crate::datadogV2::model::FormDataAttributes,
    /// The ID of the form.
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
...
impl FormData {
    pub fn new(
        attributes: crate::datadogV2::model::FormDataAttributes,
        id: uuid::Uuid,
...
impl<'de> Deserialize<'de> for FormData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct FormDataVisitor;
        impl<'a> Visitor<'a> for FormDataVisitor {
            type Value = FormData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::FormDataAttributes> = None;
        ...
        deserializer.deserialize_any(FormDataVisitor)
    }
}
