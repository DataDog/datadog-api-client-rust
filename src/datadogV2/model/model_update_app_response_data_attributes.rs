...
pub struct UpdateAppResponseDataAttributes {
...
impl UpdateAppResponseDataAttributes {
    pub fn new() -> UpdateAppResponseDataAttributes {
...
impl Default for UpdateAppResponseDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for UpdateAppResponseDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateAppResponseDataAttributesVisitor;
        impl<'a> Visitor<'a> for UpdateAppResponseDataAttributesVisitor {
            type Value = UpdateAppResponseDataAttributes;
        ...
        deserializer.deserialize_any(UpdateAppResponseDataAttributesVisitor)
    }
}
