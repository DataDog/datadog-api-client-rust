...
pub struct ElasticCloudCcmAccountCreateData {
    ...
    pub attributes: crate::datadogV2::model::ElasticCloudCcmAccountAttributes,
...
impl ElasticCloudCcmAccountCreateData {
    pub fn new(
        attributes: crate::datadogV2::model::ElasticCloudCcmAccountAttributes,
...
impl<'de> Deserialize<'de> for ElasticCloudCcmAccountCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudCcmAccountCreateDataVisitor;
        impl<'a> Visitor<'a> for ElasticCloudCcmAccountCreateDataVisitor {
            type Value = ElasticCloudCcmAccountCreateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::ElasticCloudCcmAccountAttributes,
                > = None;
                ...
                let content = ElasticCloudCcmAccountCreateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(ElasticCloudCcmAccountCreateDataVisitor)
    }
}
