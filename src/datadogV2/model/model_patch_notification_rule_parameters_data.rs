...
pub struct PatchNotificationRuleParametersData {
    /// Attributes of the notification rule patch request. It is required to update the version of the rule when patching it.
    #[serde(rename = "attributes")]
    pub attributes: crate::datadogV2::model::PatchNotificationRuleParametersDataAttributes,
...
impl PatchNotificationRuleParametersData {
    pub fn new(
        attributes: crate::datadogV2::model::PatchNotificationRuleParametersDataAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for PatchNotificationRuleParametersData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct PatchNotificationRuleParametersDataVisitor;
        impl<'a> Visitor<'a> for PatchNotificationRuleParametersDataVisitor {
            type Value = PatchNotificationRuleParametersData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::PatchNotificationRuleParametersDataAttributes,
                > = None;
                ...
                let content = PatchNotificationRuleParametersData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(PatchNotificationRuleParametersDataVisitor)
    }
}
