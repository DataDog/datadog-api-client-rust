...
impl CaseInsightsData {
    pub fn new(
        attributes: crate::datadogV2::model::CaseInsightsAttributes,
...
impl<'de> Deserialize<'de> for CaseInsightsData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CaseInsightsDataVisitor;
        impl<'a> Visitor<'a> for CaseInsightsDataVisitor {
            type Value = CaseInsightsData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::CaseInsightsAttributes> = None;
        ...
        deserializer.deserialize_any(CaseInsightsDataVisitor)
    }
}
