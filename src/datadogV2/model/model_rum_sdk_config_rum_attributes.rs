...
pub struct RumSdkConfigRumAttributes {
...
impl RumSdkConfigRumAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for RumSdkConfigRumAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RumSdkConfigRumAttributesVisitor;
        impl<'a> Visitor<'a> for RumSdkConfigRumAttributesVisitor {
            type Value = RumSdkConfigRumAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RumSdkConfigRumAttributes {
                    allowed_tracing_urls,
                    allowed_tracking_origins,
                    application_id,
                    context,
        ...
        deserializer.deserialize_any(RumSdkConfigRumAttributesVisitor)
    }
}
