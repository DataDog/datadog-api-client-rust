...
pub struct PipelineQuotaProcessor {
    ...
    #[serde(rename = "limit")]
    pub limit: crate::datadogV2::model::PipelineQuotaProcessorLimit,
    ...
    pub overrides: Option<Vec<crate::datadogV2::model::PipelineQuotaProcessorOverride>>,
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::PipelineQuotaProcessorType,
    #[serde(flatten)]
...
impl PipelineQuotaProcessor {
    pub fn new(
        drop_events: bool,
        id: String,
        include: String,
        inputs: Vec<String>,
        limit: crate::datadogV2::model::PipelineQuotaProcessorLimit,
        name: String,
        type_: crate::datadogV2::model::PipelineQuotaProcessorType,
    ...
    pub fn overrides(
        mut self,
        value: Vec<crate::datadogV2::model::PipelineQuotaProcessorOverride>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for PipelineQuotaProcessor {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PipelineQuotaProcessorVisitor;
        impl<'a> Visitor<'a> for PipelineQuotaProcessorVisitor {
            type Value = PipelineQuotaProcessor;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut limit: Option<crate::datadogV2::model::PipelineQuotaProcessorLimit> = None;
                let mut name: Option<String> = None;
                let mut overrides: Option<
                    Vec<crate::datadogV2::model::PipelineQuotaProcessorOverride>,
                > = None;
                let mut partition_fields: Option<Vec<String>> = None;
                let mut type_: Option<crate::datadogV2::model::PipelineQuotaProcessorType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::PipelineQuotaProcessorType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = PipelineQuotaProcessor {
                    drop_events,
                    id,
                    ignore_when_missing_partitions,
                    include,
        ...
        deserializer.deserialize_any(PipelineQuotaProcessorVisitor)
    }
}
