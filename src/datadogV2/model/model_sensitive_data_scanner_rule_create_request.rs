...
impl<'de> Deserialize<'de> for SensitiveDataScannerRuleCreateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerRuleCreateRequestVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerRuleCreateRequestVisitor {
            type Value = SensitiveDataScannerRuleCreateRequest;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SensitiveDataScannerRuleCreate> =
                    None;
                ...
                let content = SensitiveDataScannerRuleCreateRequest {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SensitiveDataScannerRuleCreateRequestVisitor)
    }
}
