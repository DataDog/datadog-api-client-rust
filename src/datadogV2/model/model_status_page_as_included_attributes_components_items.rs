...
impl StatusPageAsIncludedAttributesComponentsItems {
    pub fn new() -> StatusPageAsIncludedAttributesComponentsItems {
    ...
    pub fn components(
        mut self,
        value: Vec<
            crate::datadogV2::model::StatusPageAsIncludedAttributesComponentsItemsComponentsItems,
        >,
    ) -> Self {
...
impl Default for StatusPageAsIncludedAttributesComponentsItems {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for StatusPageAsIncludedAttributesComponentsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct StatusPageAsIncludedAttributesComponentsItemsVisitor;
        impl<'a> Visitor<'a> for StatusPageAsIncludedAttributesComponentsItemsVisitor {
            type Value = StatusPageAsIncludedAttributesComponentsItems;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut components: Option<Vec<crate::datadogV2::model::StatusPageAsIncludedAttributesComponentsItemsComponentsItems>> = None;
                ...
                let content = StatusPageAsIncludedAttributesComponentsItems {
                    components,
                    id,
                    name,
                    position,
        ...
        deserializer.deserialize_any(StatusPageAsIncludedAttributesComponentsItemsVisitor)
    }
}
