...
pub struct OrgConfigGetResponse {
    /// A single Org Config.
    #[serde(rename = "data")]
...
impl<'de> Deserialize<'de> for OrgConfigGetResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgConfigGetResponseVisitor;
        impl<'a> Visitor<'a> for OrgConfigGetResponseVisitor {
            type Value = OrgConfigGetResponse;
        ...
        deserializer.deserialize_any(OrgConfigGetResponseVisitor)
    }
}
