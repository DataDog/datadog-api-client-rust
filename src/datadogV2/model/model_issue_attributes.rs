...
pub struct IssueAttributes {
    ...
    /// Version where the issue was first observed.
    ...
    /// Count of sessions impacted by the issue.
    #[serde(rename = "impacted_sessions")]
    pub impacted_sessions: Option<i64>,
    /// Count of users impacted by the issue.
    ...
    /// Version where the issue was last observed.
