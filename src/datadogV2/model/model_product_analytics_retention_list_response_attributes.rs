...
pub struct ProductAnalyticsRetentionListResponseAttributes {
...
impl ProductAnalyticsRetentionListResponseAttributes {
    pub fn new() -> ProductAnalyticsRetentionListResponseAttributes {
...
impl Default for ProductAnalyticsRetentionListResponseAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ProductAnalyticsRetentionListResponseAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsRetentionListResponseAttributesVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsRetentionListResponseAttributesVisitor {
            type Value = ProductAnalyticsRetentionListResponseAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ProductAnalyticsRetentionListResponseAttributes {
                    records,
                    retention_entity,
        ...
        deserializer.deserialize_any(ProductAnalyticsRetentionListResponseAttributesVisitor)
    }
}
