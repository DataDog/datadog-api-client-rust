...
impl<'de> Deserialize<'de> for DeleteAppsRequestDataItems {
    ...
    where
        D: Deserializer<'de>,
    {
        struct DeleteAppsRequestDataItemsVisitor;
        impl<'a> Visitor<'a> for DeleteAppsRequestDataItemsVisitor {
            type Value = DeleteAppsRequestDataItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DeleteAppsRequestDataItems {
                    id,
                    type_,
        ...
        deserializer.deserialize_any(DeleteAppsRequestDataItemsVisitor)
    }
}
