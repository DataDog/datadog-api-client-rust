...
pub enum SecurityRuleTypesItems {
...
impl ToString for SecurityRuleTypesItems {
...
impl Serialize for SecurityRuleTypesItems {
...
impl<'de> Deserialize<'de> for SecurityRuleTypesItems {
