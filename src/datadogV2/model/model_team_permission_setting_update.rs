...
impl<'de> Deserialize<'de> for TeamPermissionSettingUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TeamPermissionSettingUpdateVisitor;
        impl<'a> Visitor<'a> for TeamPermissionSettingUpdateVisitor {
            type Value = TeamPermissionSettingUpdate;
        ...
        deserializer.deserialize_any(TeamPermissionSettingUpdateVisitor)
    }
}
