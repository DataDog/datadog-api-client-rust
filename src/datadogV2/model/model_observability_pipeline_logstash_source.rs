...
impl ObservabilityPipelineLogstashSource {
    pub fn new(
        id: String,
...
impl<'de> Deserialize<'de> for ObservabilityPipelineLogstashSource {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineLogstashSourceVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineLogstashSourceVisitor {
            type Value = ObservabilityPipelineLogstashSource;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ObservabilityPipelineLogstashSourceType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ObservabilityPipelineLogstashSourceVisitor)
    }
}
