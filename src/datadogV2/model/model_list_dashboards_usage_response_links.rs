...
pub struct ListDashboardsUsageResponseLinks {
...
impl ListDashboardsUsageResponseLinks {
    pub fn new() -> ListDashboardsUsageResponseLinks {
...
impl Default for ListDashboardsUsageResponseLinks {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ListDashboardsUsageResponseLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListDashboardsUsageResponseLinksVisitor;
        impl<'a> Visitor<'a> for ListDashboardsUsageResponseLinksVisitor {
            type Value = ListDashboardsUsageResponseLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListDashboardsUsageResponseLinks {
                    first,
                    last,
                    next,
                    prev,
        ...
        deserializer.deserialize_any(ListDashboardsUsageResponseLinksVisitor)
    }
}
