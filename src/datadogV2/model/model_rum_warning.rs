...
impl<'de> Deserialize<'de> for RUMWarning {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMWarningVisitor;
        impl<'a> Visitor<'a> for RUMWarningVisitor {
            type Value = RUMWarning;
        ...
        deserializer.deserialize_any(RUMWarningVisitor)
    }
}
