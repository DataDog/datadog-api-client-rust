...
pub struct ReorderInboxRulesParametersData {
...
impl ReorderInboxRulesParametersData {
    pub fn new(
        id: uuid::Uuid,
...
impl<'de> Deserialize<'de> for ReorderInboxRulesParametersData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ReorderInboxRulesParametersDataVisitor;
        impl<'a> Visitor<'a> for ReorderInboxRulesParametersDataVisitor {
            type Value = ReorderInboxRulesParametersData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ReorderInboxRulesParametersData {
                    id,
                    type_,
        ...
        deserializer.deserialize_any(ReorderInboxRulesParametersDataVisitor)
    }
}
