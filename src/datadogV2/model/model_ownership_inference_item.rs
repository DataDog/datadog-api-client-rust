...
pub struct OwnershipInferenceItem {
...
impl<'de> Deserialize<'de> for OwnershipInferenceItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OwnershipInferenceItemVisitor;
        impl<'a> Visitor<'a> for OwnershipInferenceItemVisitor {
            type Value = OwnershipInferenceItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OwnershipInferenceItem {
                    checksum,
                    confidence,
                    created_at,
                    evidence_versions,
        ...
        deserializer.deserialize_any(OwnershipInferenceItemVisitor)
    }
}
