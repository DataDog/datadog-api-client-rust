...
impl TeamSyncData {
    pub fn new(
        attributes: crate::datadogV2::model::TeamSyncAttributes,
        type_: crate::datadogV2::model::TeamSyncBulkType,
    ) -> TeamSyncData {
        TeamSyncData {
            attributes,
            id: None,
...
impl<'de> Deserialize<'de> for TeamSyncData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TeamSyncDataVisitor;
        impl<'a> Visitor<'a> for TeamSyncDataVisitor {
            type Value = TeamSyncData;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::TeamSyncBulkType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(TeamSyncDataVisitor)
    }
}
