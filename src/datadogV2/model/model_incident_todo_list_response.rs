...
impl<'de> Deserialize<'de> for IncidentTodoListResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTodoListResponseVisitor;
        impl<'a> Visitor<'a> for IncidentTodoListResponseVisitor {
            type Value = IncidentTodoListResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::IncidentTodoResponseData>> = None;
                ...
                let content = IncidentTodoListResponse {
                    data,
                    included,
                    meta,
                    _unparsed,
        ...
        deserializer.deserialize_any(IncidentTodoListResponseVisitor)
    }
}
