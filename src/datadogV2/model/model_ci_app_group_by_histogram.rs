...
impl<'de> Deserialize<'de> for CIAppGroupByHistogram {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppGroupByHistogramVisitor;
        impl<'a> Visitor<'a> for CIAppGroupByHistogramVisitor {
            type Value = CIAppGroupByHistogram;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CIAppGroupByHistogram {
                    interval,
                    max,
                    min,
        ...
        deserializer.deserialize_any(CIAppGroupByHistogramVisitor)
    }
}
