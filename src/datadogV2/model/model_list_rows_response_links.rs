...
pub struct ListRowsResponseLinks {
...
impl ListRowsResponseLinks {
    pub fn new(first: String, self_: String) -> ListRowsResponseLinks {
...
impl<'de> Deserialize<'de> for ListRowsResponseLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListRowsResponseLinksVisitor;
        impl<'a> Visitor<'a> for ListRowsResponseLinksVisitor {
            type Value = ListRowsResponseLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListRowsResponseLinks {
                    first,
                    next,
                    self_,
        ...
        deserializer.deserialize_any(ListRowsResponseLinksVisitor)
    }
}
