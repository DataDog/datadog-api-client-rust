...
pub struct OwnershipEvidenceAttributes {
...
impl OwnershipEvidenceAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for OwnershipEvidenceAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OwnershipEvidenceAttributesVisitor;
        impl<'a> Visitor<'a> for OwnershipEvidenceAttributesVisitor {
            type Value = OwnershipEvidenceAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OwnershipEvidenceAttributes {
                    evidence_versions,
        ...
        deserializer.deserialize_any(OwnershipEvidenceAttributesVisitor)
    }
}
