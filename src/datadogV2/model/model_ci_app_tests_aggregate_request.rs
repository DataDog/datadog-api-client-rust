...
impl<'de> Deserialize<'de> for CIAppTestsAggregateRequest {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CIAppTestsAggregateRequestVisitor;
        impl<'a> Visitor<'a> for CIAppTestsAggregateRequestVisitor {
            type Value = CIAppTestsAggregateRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut group_by: Option<Vec<crate::datadogV2::model::CIAppTestsGroupBy>> = None;
                ...
                let content = CIAppTestsAggregateRequest {
                    compute,
                    filter,
                    group_by,
                    options,
        ...
        deserializer.deserialize_any(CIAppTestsAggregateRequestVisitor)
    }
}
