...
pub struct SyntheticsTestResultData {
    /// Attributes of a Synthetic test result.
    #[serde(rename = "attributes")]
    pub attributes: Option<crate::datadogV2::model::SyntheticsTestResultAttributes>,
    /// The result ID.
    #[serde(rename = "id")]
...
impl SyntheticsTestResultData {
    pub fn new() -> SyntheticsTestResultData {
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::SyntheticsTestResultAttributes,
    ) -> Self {
...
impl Default for SyntheticsTestResultData {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SyntheticsTestResultData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SyntheticsTestResultDataVisitor;
        impl<'a> Visitor<'a> for SyntheticsTestResultDataVisitor {
            type Value = SyntheticsTestResultData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SyntheticsTestResultAttributes,
                > = None;
                ...
                let content = SyntheticsTestResultData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(SyntheticsTestResultDataVisitor)
    }
}
