...
pub struct ShiftDataAttributes {
...
impl ShiftDataAttributes {
    pub fn new() -> ShiftDataAttributes {
        ShiftDataAttributes {
            end: None,
            start: None,
...
impl Default for ShiftDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ShiftDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ShiftDataAttributesVisitor;
        impl<'a> Visitor<'a> for ShiftDataAttributesVisitor {
            type Value = ShiftDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ShiftDataAttributes {
                    end,
                    start,
        ...
        deserializer.deserialize_any(ShiftDataAttributesVisitor)
    }
}
