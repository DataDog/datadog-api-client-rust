...
impl CaseUpdateResolvedReason {
    pub fn new(
        attributes: crate::datadogV2::model::CaseUpdateResolvedReasonAttributes,
...
impl<'de> Deserialize<'de> for CaseUpdateResolvedReason {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CaseUpdateResolvedReasonVisitor;
        impl<'a> Visitor<'a> for CaseUpdateResolvedReasonVisitor {
            type Value = CaseUpdateResolvedReason;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CaseUpdateResolvedReasonAttributes,
                > = None;
                ...
                let content = CaseUpdateResolvedReason {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(CaseUpdateResolvedReasonVisitor)
    }
}
