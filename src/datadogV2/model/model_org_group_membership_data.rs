...
pub struct OrgGroupMembershipData {
    ...
    pub relationships: Option<crate::datadogV2::model::OrgGroupMembershipRelationships>,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for OrgGroupMembershipDataVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::OrgGroupMembershipAttributes> =
                    None;
