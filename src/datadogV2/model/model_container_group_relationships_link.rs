...
impl<'de> Deserialize<'de> for ContainerGroupRelationshipsLink {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ContainerGroupRelationshipsLinkVisitor;
        impl<'a> Visitor<'a> for ContainerGroupRelationshipsLinkVisitor {
            type Value = ContainerGroupRelationshipsLink;
        ...
        deserializer.deserialize_any(ContainerGroupRelationshipsLinkVisitor)
    }
}
