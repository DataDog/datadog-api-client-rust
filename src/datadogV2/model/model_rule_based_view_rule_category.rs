...
pub enum RuleBasedViewRuleCategory {
    CLOUD_CONFIGURATION,
...
impl ToString for RuleBasedViewRuleCategory {
...
impl Serialize for RuleBasedViewRuleCategory {
...
impl<'de> Deserialize<'de> for RuleBasedViewRuleCategory {
