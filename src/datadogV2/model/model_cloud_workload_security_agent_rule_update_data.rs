...
impl<'de> Deserialize<'de> for CloudWorkloadSecurityAgentRuleUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CloudWorkloadSecurityAgentRuleUpdateDataVisitor;
        impl<'a> Visitor<'a> for CloudWorkloadSecurityAgentRuleUpdateDataVisitor {
            type Value = CloudWorkloadSecurityAgentRuleUpdateData;
        ...
        deserializer.deserialize_any(CloudWorkloadSecurityAgentRuleUpdateDataVisitor)
    }
}
