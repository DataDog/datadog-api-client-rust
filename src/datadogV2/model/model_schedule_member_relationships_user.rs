...
impl<'de> Deserialize<'de> for ScheduleMemberRelationshipsUser {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ScheduleMemberRelationshipsUserVisitor;
        impl<'a> Visitor<'a> for ScheduleMemberRelationshipsUserVisitor {
            type Value = ScheduleMemberRelationshipsUser;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::ScheduleMemberRelationshipsUserData> =
                    None;
        ...
        deserializer.deserialize_any(ScheduleMemberRelationshipsUserVisitor)
    }
}
