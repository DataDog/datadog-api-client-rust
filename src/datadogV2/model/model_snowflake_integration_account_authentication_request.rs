...
#[serde(untagged)]
pub enum SnowflakeIntegrationAccountAuthenticationRequest {
...
impl<'de> Deserialize<'de> for SnowflakeIntegrationAccountAuthenticationRequest {
        ...
        D: Deserializer<'de>,
    {
        ...
        {
            if !_v._unparsed {
                return Ok(SnowflakeIntegrationAccountAuthenticationRequest::SnowflakeIntegrationAccountPrivateKeyAuthRequest(_v));
            }
        }

        return Ok(
            SnowflakeIntegrationAccountAuthenticationRequest::UnparsedObject(
