...
impl ListEntityCatalogResponseLinks {
    pub fn new() -> ListEntityCatalogResponseLinks {
...
impl Default for ListEntityCatalogResponseLinks {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ListEntityCatalogResponseLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListEntityCatalogResponseLinksVisitor;
        impl<'a> Visitor<'a> for ListEntityCatalogResponseLinksVisitor {
            type Value = ListEntityCatalogResponseLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListEntityCatalogResponseLinks {
                    next,
                    previous,
                    self_,
        ...
        deserializer.deserialize_any(ListEntityCatalogResponseLinksVisitor)
    }
}
