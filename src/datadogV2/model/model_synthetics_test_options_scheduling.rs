...
pub struct SyntheticsTestOptionsScheduling {
    ...
    pub timeframes: Vec<crate::datadogV2::model::SyntheticsTestOptionsSchedulingTimeframe>,
...
impl SyntheticsTestOptionsScheduling {
    pub fn new(
        timeframes: Vec<crate::datadogV2::model::SyntheticsTestOptionsSchedulingTimeframe>,
        timezone: String,
        ...
        impl<'a> Visitor<'a> for SyntheticsTestOptionsSchedulingVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut timeframes: Option<
                    Vec<crate::datadogV2::model::SyntheticsTestOptionsSchedulingTimeframe>,
                > = None;
