...
pub struct IncidentUserDefinedRoleDataAttributesResponse {
...
impl IncidentUserDefinedRoleDataAttributesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for IncidentUserDefinedRoleDataAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentUserDefinedRoleDataAttributesResponseVisitor;
        impl<'a> Visitor<'a> for IncidentUserDefinedRoleDataAttributesResponseVisitor {
            type Value = IncidentUserDefinedRoleDataAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentUserDefinedRoleDataAttributesResponse {
                    created,
                    description,
                    modified,
                    name,
        ...
        deserializer.deserialize_any(IncidentUserDefinedRoleDataAttributesResponseVisitor)
    }
}
