...
pub struct LLMObsPatternsTopicsResponseAttributes {
    ...
    #[serde(rename = "topics")]
    pub topics: Vec<crate::datadogV2::model::LLMObsPatternsTopic>,
    #[serde(flatten)]
...
impl LLMObsPatternsTopicsResponseAttributes {
    pub fn new(
        config_id: String,
        created_at: chrono::DateTime<chrono::Utc>,
        previous_run_id: String,
        run_id: String,
        topics: Vec<crate::datadogV2::model::LLMObsPatternsTopic>,
...
impl<'de> Deserialize<'de> for LLMObsPatternsTopicsResponseAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsPatternsTopicsResponseAttributesVisitor;
        impl<'a> Visitor<'a> for LLMObsPatternsTopicsResponseAttributesVisitor {
            type Value = LLMObsPatternsTopicsResponseAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut topics: Option<Vec<crate::datadogV2::model::LLMObsPatternsTopic>> = None;
                ...
                let content = LLMObsPatternsTopicsResponseAttributes {
                    completed_at,
                    config_id,
                    config_snapshot,
                    created_at,
        ...
        deserializer.deserialize_any(LLMObsPatternsTopicsResponseAttributesVisitor)
    }
}
