...
pub struct ObservabilityPipelineQuotaProcessorOverride {
...
impl ObservabilityPipelineQuotaProcessorOverride {
    pub fn new(
...
impl<'de> Deserialize<'de> for ObservabilityPipelineQuotaProcessorOverride {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineQuotaProcessorOverrideVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineQuotaProcessorOverrideVisitor {
            type Value = ObservabilityPipelineQuotaProcessorOverride;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ObservabilityPipelineQuotaProcessorOverride {
                    fields,
                    limit,
        ...
        deserializer.deserialize_any(ObservabilityPipelineQuotaProcessorOverrideVisitor)
    }
}
