...
impl<'de> Deserialize<'de> for FullApplicationKey {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FullApplicationKeyVisitor;
        impl<'a> Visitor<'a> for FullApplicationKeyVisitor {
            type Value = FullApplicationKey;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::FullApplicationKeyAttributes> =
                    None;
        ...
        deserializer.deserialize_any(FullApplicationKeyVisitor)
    }
}
