...
pub struct IOSSourcemapAttributes {
...
impl IOSSourcemapAttributes {
    ...
    pub fn uuids(mut self, value: String) -> Self {
        self.uuids = Some(value);
        self
    }
...
impl<'de> Deserialize<'de> for IOSSourcemapAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IOSSourcemapAttributesVisitor;
        impl<'a> Visitor<'a> for IOSSourcemapAttributesVisitor {
            type Value = IOSSourcemapAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                while let Some((k, v)) = map.next_entry::<String, serde_json::Value>()? {
                    match k.as_str() {
                        ...
                        "uuids" => {
                            ...
                            uuids = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        }
                        &_ => {
                ...
                let content = IOSSourcemapAttributes {
                    created_at,
                    mapkind,
                    size,
                    uuids,
        ...
        deserializer.deserialize_any(IOSSourcemapAttributesVisitor)
    }
}
