...
/// The definition of `GcpScanOptionsDataAttributes` object.
#[non_exhaustive]
...
impl Default for GcpScanOptionsDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<'de> Deserialize<'de> for GcpScanOptionsDataAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct GcpScanOptionsDataAttributesVisitor;
        impl<'a> Visitor<'a> for GcpScanOptionsDataAttributesVisitor {
            type Value = GcpScanOptionsDataAttributes;
        ...
        deserializer.deserialize_any(GcpScanOptionsDataAttributesVisitor)
    }
}
