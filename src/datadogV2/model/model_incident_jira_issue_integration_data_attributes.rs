...
pub struct IncidentJiraIssueIntegrationDataAttributes {
...
impl IncidentJiraIssueIntegrationDataAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for IncidentJiraIssueIntegrationDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentJiraIssueIntegrationDataAttributesVisitor;
        impl<'a> Visitor<'a> for IncidentJiraIssueIntegrationDataAttributesVisitor {
            type Value = IncidentJiraIssueIntegrationDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentJiraIssueIntegrationDataAttributes {
                    created,
                    integration_type,
                    modified,
                    status,
        ...
        deserializer.deserialize_any(IncidentJiraIssueIntegrationDataAttributesVisitor)
    }
}
