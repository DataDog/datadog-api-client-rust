...
pub struct SecurityMonitoringOktaIntegrationConfigCreateAttributes {
...
impl SecurityMonitoringOktaIntegrationConfigCreateAttributes {
    pub fn new(
        domain: String,
...
impl<'de> Deserialize<'de> for SecurityMonitoringOktaIntegrationConfigCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringOktaIntegrationConfigCreateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringOktaIntegrationConfigCreateAttributesVisitor {
            type Value = SecurityMonitoringOktaIntegrationConfigCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringOktaIntegrationConfigCreateAttributes {
                    domain,
                    integration_type,
                    name,
                    secrets,
        ...
        deserializer.deserialize_any(SecurityMonitoringOktaIntegrationConfigCreateAttributesVisitor)
    }
}
