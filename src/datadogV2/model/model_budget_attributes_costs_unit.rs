...
pub struct BudgetAttributesCostsUnit {
...
impl BudgetAttributesCostsUnit {
    pub fn new() -> BudgetAttributesCostsUnit {
...
impl Default for BudgetAttributesCostsUnit {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for BudgetAttributesCostsUnit {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct BudgetAttributesCostsUnitVisitor;
        impl<'a> Visitor<'a> for BudgetAttributesCostsUnitVisitor {
            type Value = BudgetAttributesCostsUnit;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = BudgetAttributesCostsUnit {
                    family,
                    id,
                    name,
                    plural,
        ...
        deserializer.deserialize_any(BudgetAttributesCostsUnitVisitor)
    }
}
