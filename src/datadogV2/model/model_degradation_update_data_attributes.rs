...
pub struct DegradationUpdateDataAttributes {
    /// Components affected by this update.
    #[serde(rename = "components_affected")]
    pub components_affected: Option<
        Vec<crate::datadogV2::model::DegradationUpdateDataAttributesComponentsAffectedItems>,
    >,
...
impl DegradationUpdateDataAttributes {
    pub fn new() -> DegradationUpdateDataAttributes {
    ...
    pub fn components_affected(
        mut self,
        value: Vec<crate::datadogV2::model::DegradationUpdateDataAttributesComponentsAffectedItems>,
    ) -> Self {
...
impl Default for DegradationUpdateDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for DegradationUpdateDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DegradationUpdateDataAttributesVisitor;
        impl<'a> Visitor<'a> for DegradationUpdateDataAttributesVisitor {
            type Value = DegradationUpdateDataAttributes;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut components_affected: Option<Vec<crate::datadogV2::model::DegradationUpdateDataAttributesComponentsAffectedItems>> = None;
                ...
                let content = DegradationUpdateDataAttributes {
                    components_affected,
                    created_at,
                    deleted_at,
                    description,
        ...
        deserializer.deserialize_any(DegradationUpdateDataAttributesVisitor)
    }
}
