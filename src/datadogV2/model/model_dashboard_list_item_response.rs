...
impl<'de> Deserialize<'de> for DashboardListItemResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DashboardListItemResponseVisitor;
        impl<'a> Visitor<'a> for DashboardListItemResponseVisitor {
            type Value = DashboardListItemResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DashboardListItemResponse {
                    id,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(DashboardListItemResponseVisitor)
    }
}
