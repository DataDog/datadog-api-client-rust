...
pub struct ProductAnalyticsRetentionFilters {
...
impl ProductAnalyticsRetentionFilters {
    pub fn new() -> ProductAnalyticsRetentionFilters {
...
impl Default for ProductAnalyticsRetentionFilters {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ProductAnalyticsRetentionFilters {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsRetentionFiltersVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsRetentionFiltersVisitor {
            type Value = ProductAnalyticsRetentionFilters;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ProductAnalyticsRetentionFilters {
                    audience_filters,
                    string_filter,
        ...
        deserializer.deserialize_any(ProductAnalyticsRetentionFiltersVisitor)
    }
}
