...
pub struct IncidentMicrosoftTeamsConfigurationDataAttributesResponse {
...
impl IncidentMicrosoftTeamsConfigurationDataAttributesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for IncidentMicrosoftTeamsConfigurationDataAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentMicrosoftTeamsConfigurationDataAttributesResponseVisitor;
        impl<'a> Visitor<'a> for IncidentMicrosoftTeamsConfigurationDataAttributesResponseVisitor {
            type Value = IncidentMicrosoftTeamsConfigurationDataAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentMicrosoftTeamsConfigurationDataAttributesResponse {
                    created_at,
                    manual_meeting_creation,
                    modified_at,
                    post_meeting_summary,
        ...
        deserializer
            .deserialize_any(IncidentMicrosoftTeamsConfigurationDataAttributesResponseVisitor)
    }
}
