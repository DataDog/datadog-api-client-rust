...
impl Default for CasesResponseMeta {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CasesResponseMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CasesResponseMetaVisitor;
        impl<'a> Visitor<'a> for CasesResponseMetaVisitor {
            type Value = CasesResponseMeta;
        ...
        deserializer.deserialize_any(CasesResponseMetaVisitor)
    }
}
