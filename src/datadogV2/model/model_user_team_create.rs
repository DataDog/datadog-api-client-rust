...
impl UserTeamCreate {
    ...
    pub fn relationships(mut self, value: crate::datadogV2::model::UserTeamRelationships) -> Self {
...
impl<'de> Deserialize<'de> for UserTeamCreate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct UserTeamCreateVisitor;
        impl<'a> Visitor<'a> for UserTeamCreateVisitor {
            type Value = UserTeamCreate;
        ...
        deserializer.deserialize_any(UserTeamCreateVisitor)
    }
}
