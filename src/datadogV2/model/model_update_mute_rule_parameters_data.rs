...
pub struct UpdateMuteRuleParametersData {
...
impl UpdateMuteRuleParametersData {
    pub fn new(
...
impl<'de> Deserialize<'de> for UpdateMuteRuleParametersData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateMuteRuleParametersDataVisitor;
        impl<'a> Visitor<'a> for UpdateMuteRuleParametersDataVisitor {
            type Value = UpdateMuteRuleParametersData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UpdateMuteRuleParametersData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(UpdateMuteRuleParametersDataVisitor)
    }
}
