...
pub struct ElasticCloudIntegrationAccountUpdateData {
    ...
    pub attributes: crate::datadogV2::model::ElasticCloudIntegrationAccountUpdateAttributes,
...
impl ElasticCloudIntegrationAccountUpdateData {
    pub fn new(
        attributes: crate::datadogV2::model::ElasticCloudIntegrationAccountUpdateAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for ElasticCloudIntegrationAccountUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudIntegrationAccountUpdateDataVisitor;
        impl<'a> Visitor<'a> for ElasticCloudIntegrationAccountUpdateDataVisitor {
            type Value = ElasticCloudIntegrationAccountUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::ElasticCloudIntegrationAccountUpdateAttributes,
                > = None;
                ...
                let content = ElasticCloudIntegrationAccountUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(ElasticCloudIntegrationAccountUpdateDataVisitor)
    }
}
