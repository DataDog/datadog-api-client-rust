...
impl<'de> Deserialize<'de> for ListDowntimesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListDowntimesResponseVisitor;
        impl<'a> Visitor<'a> for ListDowntimesResponseVisitor {
            type Value = ListDowntimesResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::DowntimeResponseData>> = None;
                ...
                let content = ListDowntimesResponse {
                    data,
                    included,
                    meta,
                    _unparsed,
        ...
        deserializer.deserialize_any(ListDowntimesResponseVisitor)
    }
}
