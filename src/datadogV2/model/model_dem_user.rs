...
impl DemUser {
    pub fn new(email: String, handle: String, name: String, uuid: String) -> DemUser {
        DemUser {
            email,
            handle,
            name,
...
impl<'de> Deserialize<'de> for DemUser {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DemUserVisitor;
        impl<'a> Visitor<'a> for DemUserVisitor {
            type Value = DemUser;
        ...
        deserializer.deserialize_any(DemUserVisitor)
    }
}
