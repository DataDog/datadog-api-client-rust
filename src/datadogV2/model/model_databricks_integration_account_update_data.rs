...
impl DatabricksIntegrationAccountUpdateData {
    pub fn new(
        attributes: crate::datadogV2::model::DatabricksIntegrationAccountUpdateAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for DatabricksIntegrationAccountUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DatabricksIntegrationAccountUpdateDataVisitor;
        impl<'a> Visitor<'a> for DatabricksIntegrationAccountUpdateDataVisitor {
            type Value = DatabricksIntegrationAccountUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::DatabricksIntegrationAccountUpdateAttributes,
                > = None;
                ...
                let content = DatabricksIntegrationAccountUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(DatabricksIntegrationAccountUpdateDataVisitor)
    }
}
