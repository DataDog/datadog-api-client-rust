...
pub struct CreateRulesetRequestDataAttributesRulesItemsReferenceTable {
    ...
    pub field_pairs: Vec<crate::datadogV2::model::CreateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>,
...
impl CreateRulesetRequestDataAttributesRulesItemsReferenceTable {
    pub fn new(
        field_pairs: Vec<crate::datadogV2::model::CreateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>,
...
impl<'de> Deserialize<'de> for CreateRulesetRequestDataAttributesRulesItemsReferenceTable {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateRulesetRequestDataAttributesRulesItemsReferenceTableVisitor;
        impl<'a> Visitor<'a> for CreateRulesetRequestDataAttributesRulesItemsReferenceTableVisitor {
            type Value = CreateRulesetRequestDataAttributesRulesItemsReferenceTable;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut field_pairs: Option<Vec<crate::datadogV2::model::CreateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>> = None;
                ...
                let content = CreateRulesetRequestDataAttributesRulesItemsReferenceTable {
                    case_insensitivity,
                    field_pairs,
                    if_not_exists,
                    source_keys,
        ...
        deserializer
            .deserialize_any(CreateRulesetRequestDataAttributesRulesItemsReferenceTableVisitor)
    }
}
