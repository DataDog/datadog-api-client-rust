...
impl<'de> Deserialize<'de> for GCPSTSDelegateAccountResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GCPSTSDelegateAccountResponseVisitor;
        impl<'a> Visitor<'a> for GCPSTSDelegateAccountResponseVisitor {
            type Value = GCPSTSDelegateAccountResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::GCPSTSDelegateAccount> = None;
                ...
                let content = GCPSTSDelegateAccountResponse { data, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(GCPSTSDelegateAccountResponseVisitor)
    }
}
