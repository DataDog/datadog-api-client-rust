...
pub struct FleetDeploymentsV2Page {
...
impl FleetDeploymentsV2Page {
    pub fn new() -> FleetDeploymentsV2Page {
...
impl Default for FleetDeploymentsV2Page {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FleetDeploymentsV2Page {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetDeploymentsV2PageVisitor;
        impl<'a> Visitor<'a> for FleetDeploymentsV2PageVisitor {
            type Value = FleetDeploymentsV2Page;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FleetDeploymentsV2Page {
                    total_count,
                    total_filtered_count,
        ...
        deserializer.deserialize_any(FleetDeploymentsV2PageVisitor)
    }
}
