...
pub struct SecurityMonitoringDatasetDependentsAttributes {
...
impl SecurityMonitoringDatasetDependentsAttributes {
    pub fn new(
        count: i64,
        dataset_id: String,
        ids: Vec<String>,
...
impl<'de> Deserialize<'de> for SecurityMonitoringDatasetDependentsAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringDatasetDependentsAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringDatasetDependentsAttributesVisitor {
            type Value = SecurityMonitoringDatasetDependentsAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringDatasetDependentsAttributes {
                    count,
                    dataset_id,
                    ids,
                    resource_type,
        ...
        deserializer.deserialize_any(SecurityMonitoringDatasetDependentsAttributesVisitor)
    }
}
