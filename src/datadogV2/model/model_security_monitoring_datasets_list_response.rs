...
pub struct SecurityMonitoringDatasetsListResponse {
    ...
    #[serde(rename = "data")]
    pub data: Vec<crate::datadogV2::model::SecurityMonitoringDatasetData>,
    /// Metadata returned with a list of datasets.
    #[serde(rename = "meta")]
    pub meta: crate::datadogV2::model::SecurityMonitoringDatasetsListMeta,
    #[serde(flatten)]
...
impl SecurityMonitoringDatasetsListResponse {
    pub fn new(
        data: Vec<crate::datadogV2::model::SecurityMonitoringDatasetData>,
        meta: crate::datadogV2::model::SecurityMonitoringDatasetsListMeta,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for SecurityMonitoringDatasetsListResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::SecurityMonitoringDatasetData>> =
                    None;
                let mut meta: Option<crate::datadogV2::model::SecurityMonitoringDatasetsListMeta> =
                    None;
