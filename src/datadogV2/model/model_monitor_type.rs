...
impl MonitorType {
    ...
    pub fn with_group_status(&mut self, value: i32) -> &mut Self {
    ...
    pub fn with_modified(&mut self, value: i64) -> &mut Self {
    ...
    pub fn with_templated_name(&mut self, value: String) -> &mut Self {
