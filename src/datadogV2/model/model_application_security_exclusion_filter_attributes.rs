...
pub struct ApplicationSecurityExclusionFilterAttributes {
    ...
    pub on_match: Option<crate::datadogV2::model::ApplicationSecurityExclusionFilterOnMatch>,
...
impl ApplicationSecurityExclusionFilterAttributes {
    pub fn new(description: String, enabled: bool) -> ApplicationSecurityExclusionFilterAttributes {
    ...
    pub fn on_match(
        mut self,
        value: crate::datadogV2::model::ApplicationSecurityExclusionFilterOnMatch,
    ) -> Self {
...
impl<'de> Deserialize<'de> for ApplicationSecurityExclusionFilterAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ApplicationSecurityExclusionFilterAttributesVisitor;
        impl<'a> Visitor<'a> for ApplicationSecurityExclusionFilterAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut on_match: Option<
                    crate::datadogV2::model::ApplicationSecurityExclusionFilterOnMatch,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "on_match" => {
                            ...
                            if let Some(ref _on_match) = on_match {
                                match _on_match {
                                    crate::datadogV2::model::ApplicationSecurityExclusionFilterOnMatch::UnparsedObject(_on_match) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = ApplicationSecurityExclusionFilterAttributes {
                    description,
                    enabled,
                    event_query,
                    ip_list,
        ...
        deserializer.deserialize_any(ApplicationSecurityExclusionFilterAttributesVisitor)
    }
}
