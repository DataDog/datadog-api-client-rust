...
pub struct OrgConnectionCreateAttributes {
...
impl<'de> Deserialize<'de> for OrgConnectionCreateAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct OrgConnectionCreateAttributesVisitor;
        impl<'a> Visitor<'a> for OrgConnectionCreateAttributesVisitor {
            type Value = OrgConnectionCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OrgConnectionCreateAttributes {
                    connection_types,
        ...
        deserializer.deserialize_any(OrgConnectionCreateAttributesVisitor)
    }
}
