...
impl FleetAgentsV2Page {
    pub fn new() -> FleetAgentsV2Page {
        FleetAgentsV2Page {
            total_count: None,
...
impl Default for FleetAgentsV2Page {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FleetAgentsV2Page {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetAgentsV2PageVisitor;
        impl<'a> Visitor<'a> for FleetAgentsV2PageVisitor {
            type Value = FleetAgentsV2Page;
        ...
        deserializer.deserialize_any(FleetAgentsV2PageVisitor)
    }
}
