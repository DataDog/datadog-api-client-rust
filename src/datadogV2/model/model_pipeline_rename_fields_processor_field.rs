...
pub struct PipelineRenameFieldsProcessorField {
...
impl PipelineRenameFieldsProcessorField {
    pub fn new(
        destination: String,
        include: String,
...
impl<'de> Deserialize<'de> for PipelineRenameFieldsProcessorField {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PipelineRenameFieldsProcessorFieldVisitor;
        impl<'a> Visitor<'a> for PipelineRenameFieldsProcessorFieldVisitor {
            type Value = PipelineRenameFieldsProcessorField;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = PipelineRenameFieldsProcessorField {
                    destination,
                    include,
                    preserve_source,
                    source,
        ...
        deserializer.deserialize_any(PipelineRenameFieldsProcessorFieldVisitor)
    }
}
