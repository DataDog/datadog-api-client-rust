...
pub struct RumHardcodedCrossProductSampling {
...
impl RumHardcodedCrossProductSampling {
    pub fn new() -> RumHardcodedCrossProductSampling {
...
impl Default for RumHardcodedCrossProductSampling {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for RumHardcodedCrossProductSampling {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RumHardcodedCrossProductSamplingVisitor;
        impl<'a> Visitor<'a> for RumHardcodedCrossProductSamplingVisitor {
            type Value = RumHardcodedCrossProductSampling;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RumHardcodedCrossProductSampling {
                    session_replay_enabled,
                    session_replay_sample_rate,
                    trace_enabled,
                    trace_sample_rate,
        ...
        deserializer.deserialize_any(RumHardcodedCrossProductSamplingVisitor)
    }
}
