...
impl<'de> Deserialize<'de> for SpansMetricUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansMetricUpdateDataVisitor;
        impl<'a> Visitor<'a> for SpansMetricUpdateDataVisitor {
            type Value = SpansMetricUpdateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::SpansMetricUpdateAttributes> =
                    None;
                ...
                let content = SpansMetricUpdateData {
                    attributes,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SpansMetricUpdateDataVisitor)
    }
}
