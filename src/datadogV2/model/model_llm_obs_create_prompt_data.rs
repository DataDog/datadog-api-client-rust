...
impl LLMObsCreatePromptData {
    pub fn new(
        attributes: crate::datadogV2::model::LLMObsCreatePromptDataAttributes,
...
impl<'de> Deserialize<'de> for LLMObsCreatePromptData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsCreatePromptDataVisitor;
        impl<'a> Visitor<'a> for LLMObsCreatePromptDataVisitor {
            type Value = LLMObsCreatePromptData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::LLMObsCreatePromptDataAttributes,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::LLMObsPromptType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
                ...
                let content = LLMObsCreatePromptData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsCreatePromptDataVisitor)
    }
}
