...
impl CreateCaseRequestDataAttributes {
    pub fn new() -> CreateCaseRequestDataAttributes {
...
impl Default for CreateCaseRequestDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CreateCaseRequestDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateCaseRequestDataAttributesVisitor;
        impl<'a> Visitor<'a> for CreateCaseRequestDataAttributesVisitor {
            type Value = CreateCaseRequestDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateCaseRequestDataAttributes {
                    assignee_id,
                    description,
                    priority,
                    title,
        ...
        deserializer.deserialize_any(CreateCaseRequestDataAttributesVisitor)
    }
}
