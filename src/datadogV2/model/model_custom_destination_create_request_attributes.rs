...
pub struct CustomDestinationCreateRequestAttributes {
    ...
    pub forwarder_destination: crate::datadogV2::model::CustomDestinationForwardDestination,
...
impl CustomDestinationCreateRequestAttributes {
    pub fn new(
        forwarder_destination: crate::datadogV2::model::CustomDestinationForwardDestination,
        name: String,
...
impl<'de> Deserialize<'de> for CustomDestinationCreateRequestAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CustomDestinationCreateRequestAttributesVisitor;
        impl<'a> Visitor<'a> for CustomDestinationCreateRequestAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let forwarder_destination = forwarder_destination
                    .ok_or_else(|| M::Error::missing_field("forwarder_destination"))?;
                let name = name.ok_or_else(|| M::Error::missing_field("name"))?;

                let content = CustomDestinationCreateRequestAttributes {
                    enabled,
                    forward_tags,
                    forward_tags_restriction_list,
                    forward_tags_restriction_list_type,
        ...
        deserializer.deserialize_any(CustomDestinationCreateRequestAttributesVisitor)
    }
}
