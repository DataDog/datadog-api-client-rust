...
pub struct CreateUploadRequestDataAttributes {
    ...
    pub part_count: i32,
    /// The size of each part in the upload in bytes. For multi-part uploads (part_count > 1), all parts except the last one must be at least 5,000,000 bytes. For single-part uploads (part_count = 1), any size is allowed.
