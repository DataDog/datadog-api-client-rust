...
pub struct CommitmentsCoverageScalarResponse {
...
impl CommitmentsCoverageScalarResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for CommitmentsCoverageScalarResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CommitmentsCoverageScalarResponseVisitor;
        impl<'a> Visitor<'a> for CommitmentsCoverageScalarResponseVisitor {
            type Value = CommitmentsCoverageScalarResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CommitmentsCoverageScalarResponse {
                    columns,
        ...
        deserializer.deserialize_any(CommitmentsCoverageScalarResponseVisitor)
    }
}
