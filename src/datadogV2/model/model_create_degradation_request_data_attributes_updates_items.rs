...
pub struct CreateDegradationRequestDataAttributesUpdatesItems {
    ...
    pub components_affected: Option<Vec<crate::datadogV2::model::CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems>>,
...
impl CreateDegradationRequestDataAttributesUpdatesItems {
    ...
    pub fn components_affected(
        mut self,
        value: Vec<crate::datadogV2::model::CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems>,
    ) -> Self {
