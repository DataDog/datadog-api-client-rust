...
pub struct IncidentConfigurationRelationships {
...
impl IncidentConfigurationRelationships {
    pub fn new() -> IncidentConfigurationRelationships {
...
impl Default for IncidentConfigurationRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentConfigurationRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentConfigurationRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentConfigurationRelationshipsVisitor {
            type Value = IncidentConfigurationRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentConfigurationRelationships {
                    created_by_user,
                    last_modified_by_user,
        ...
        deserializer.deserialize_any(IncidentConfigurationRelationshipsVisitor)
    }
}
