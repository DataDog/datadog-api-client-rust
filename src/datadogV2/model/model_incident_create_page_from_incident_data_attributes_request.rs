...
pub struct IncidentCreatePageFromIncidentDataAttributesRequest {
    /// The description of the page.
    #[serde(rename = "description")]
    pub description: Option<String>,
    /// The public ID of the incident.
    #[serde(rename = "incident_public_id")]
    pub incident_public_id: Option<String>,
...
impl IncidentCreatePageFromIncidentDataAttributesRequest {
    pub fn new() -> IncidentCreatePageFromIncidentDataAttributesRequest {
    ...
    pub fn incident_public_id(mut self, value: String) -> Self {
        self.incident_public_id = Some(value);
        self
    }
...
impl Default for IncidentCreatePageFromIncidentDataAttributesRequest {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentCreatePageFromIncidentDataAttributesRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentCreatePageFromIncidentDataAttributesRequestVisitor;
        impl<'a> Visitor<'a> for IncidentCreatePageFromIncidentDataAttributesRequestVisitor {
            type Value = IncidentCreatePageFromIncidentDataAttributesRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut incident_public_id: Option<String> = None;
                ...
                let content = IncidentCreatePageFromIncidentDataAttributesRequest {
                    description,
                    incident_public_id,
                    role,
                    services,
        ...
        deserializer.deserialize_any(IncidentCreatePageFromIncidentDataAttributesRequestVisitor)
    }
}
