...
impl<'de> Deserialize<'de> for LogsMetricCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsMetricCreateDataVisitor;
        impl<'a> Visitor<'a> for LogsMetricCreateDataVisitor {
            type Value = LogsMetricCreateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::LogsMetricCreateAttributes> =
                    None;
                ...
                let content = LogsMetricCreateData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(LogsMetricCreateDataVisitor)
    }
}
