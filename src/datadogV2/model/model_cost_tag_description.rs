...
pub struct CostTagDescription {
    ...
    pub attributes: crate::datadogV2::model::CostTagDescriptionAttributes,
...
impl CostTagDescription {
    pub fn new(
        attributes: crate::datadogV2::model::CostTagDescriptionAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for CostTagDescription {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CostTagDescriptionVisitor;
        impl<'a> Visitor<'a> for CostTagDescriptionVisitor {
            type Value = CostTagDescription;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::CostTagDescriptionAttributes> =
                    None;
                ...
                let content = CostTagDescription {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(CostTagDescriptionVisitor)
    }
}
