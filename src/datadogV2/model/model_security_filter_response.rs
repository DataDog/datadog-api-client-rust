...
impl<'de> Deserialize<'de> for SecurityFilterResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityFilterResponseVisitor;
        impl<'a> Visitor<'a> for SecurityFilterResponseVisitor {
            type Value = SecurityFilterResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SecurityFilter> = None;
                ...
                let content = SecurityFilterResponse {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SecurityFilterResponseVisitor)
    }
}
