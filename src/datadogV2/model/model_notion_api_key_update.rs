...
impl NotionAPIKeyUpdate {
    pub fn new(type_: crate::datadogV2::model::NotionAPIKeyType) -> NotionAPIKeyUpdate {
        NotionAPIKeyUpdate {
            api_token: None,
            type_,
...
impl<'de> Deserialize<'de> for NotionAPIKeyUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct NotionAPIKeyUpdateVisitor;
        impl<'a> Visitor<'a> for NotionAPIKeyUpdateVisitor {
            type Value = NotionAPIKeyUpdate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = NotionAPIKeyUpdate {
                    api_token,
                    type_,
        ...
        deserializer.deserialize_any(NotionAPIKeyUpdateVisitor)
    }
}
