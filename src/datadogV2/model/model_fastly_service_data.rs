...
impl<'de> Deserialize<'de> for FastlyServiceData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct FastlyServiceDataVisitor;
        impl<'a> Visitor<'a> for FastlyServiceDataVisitor {
            type Value = FastlyServiceData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::FastlyServiceAttributes> = None;
                let mut id: Option<String> = None;
                let mut type_: Option<crate::datadogV2::model::FastlyServiceType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::FastlyServiceType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(FastlyServiceDataVisitor)
    }
}
