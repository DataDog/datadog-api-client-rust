...
pub struct DORAListDeploymentsRequestAttributes {
...
impl DORAListDeploymentsRequestAttributes {
    pub fn new() -> DORAListDeploymentsRequestAttributes {
...
impl Default for DORAListDeploymentsRequestAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for DORAListDeploymentsRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DORAListDeploymentsRequestAttributesVisitor;
        impl<'a> Visitor<'a> for DORAListDeploymentsRequestAttributesVisitor {
            type Value = DORAListDeploymentsRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DORAListDeploymentsRequestAttributes {
                    from,
                    limit,
                    query,
                    sort,
        ...
        deserializer.deserialize_any(DORAListDeploymentsRequestAttributesVisitor)
    }
}
