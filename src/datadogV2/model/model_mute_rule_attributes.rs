...
pub struct MuteRuleAttributes {
    /// Action of the mute rule
    #[serde(rename = "action")]
    pub action: crate::datadogV2::model::ActionMute,
    /// Date as Unix timestamp in milliseconds
    #[serde(rename = "created_at")]
    pub created_at: i64,
    /// User creating or modifying a rule
    #[serde(rename = "created_by")]
    pub created_by: crate::datadogV2::model::AutomationRuleUser,
    ...
    pub modified_by: crate::datadogV2::model::AutomationRuleUser,
    ...
    #[serde(rename = "rule")]
    pub rule: crate::datadogV2::model::AutomationRule,
    #[serde(flatten)]
...
impl MuteRuleAttributes {
    pub fn new(
        action: crate::datadogV2::model::ActionMute,
        created_at: i64,
        created_by: crate::datadogV2::model::AutomationRuleUser,
        enabled: bool,
        modified_at: i64,
        modified_by: crate::datadogV2::model::AutomationRuleUser,
        name: String,
        rule: crate::datadogV2::model::AutomationRule,
    ) -> MuteRuleAttributes {
        MuteRuleAttributes {
            action,
            created_at,
...
impl<'de> Deserialize<'de> for MuteRuleAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MuteRuleAttributesVisitor;
        impl<'a> Visitor<'a> for MuteRuleAttributesVisitor {
            type Value = MuteRuleAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut created_by: Option<crate::datadogV2::model::AutomationRuleUser> = None;
                let mut enabled: Option<bool> = None;
                let mut modified_at: Option<i64> = None;
                let mut modified_by: Option<crate::datadogV2::model::AutomationRuleUser> = None;
                ...
                let content = MuteRuleAttributes {
                    action,
                    created_at,
                    created_by,
                    enabled,
        ...
        deserializer.deserialize_any(MuteRuleAttributesVisitor)
    }
}
