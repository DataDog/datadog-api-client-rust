...
pub struct CustomDestinationResponseForwardDestinationElasticsearch {
    /// Basic access authentication.
    #[serde(rename = "auth")]
    pub auth: std::collections::BTreeMap<String, serde_json::Value>,
...
impl CustomDestinationResponseForwardDestinationElasticsearch {
    pub fn new(
        auth: std::collections::BTreeMap<String, serde_json::Value>,
        endpoint: String,
        index_name: String,
        type_: crate::datadogV2::model::CustomDestinationResponseForwardDestinationElasticsearchType,
...
impl<'de> Deserialize<'de> for CustomDestinationResponseForwardDestinationElasticsearch {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CustomDestinationResponseForwardDestinationElasticsearchVisitor;
        impl<'a> Visitor<'a> for CustomDestinationResponseForwardDestinationElasticsearchVisitor {
            type Value = CustomDestinationResponseForwardDestinationElasticsearch;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut auth: Option<std::collections::BTreeMap<String, serde_json::Value>> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::CustomDestinationResponseForwardDestinationElasticsearchType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = CustomDestinationResponseForwardDestinationElasticsearch {
                    auth,
                    endpoint,
                    index_name,
                    index_rotation,
        ...
        deserializer
            .deserialize_any(CustomDestinationResponseForwardDestinationElasticsearchVisitor)
    }
}
