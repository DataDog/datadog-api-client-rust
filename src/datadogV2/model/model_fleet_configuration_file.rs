...
pub struct FleetConfigurationFile {
...
impl FleetConfigurationFile {
    pub fn new() -> FleetConfigurationFile {
...
impl Default for FleetConfigurationFile {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FleetConfigurationFile {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetConfigurationFileVisitor;
        impl<'a> Visitor<'a> for FleetConfigurationFileVisitor {
            type Value = FleetConfigurationFile;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FleetConfigurationFile {
                    file_content,
                    file_path,
                    filename,
        ...
        deserializer.deserialize_any(FleetConfigurationFileVisitor)
    }
}
