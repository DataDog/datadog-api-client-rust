...
pub enum RumRetentionFilterEventType {
    SESSION,
    VIEW,
    ACTION,
    ERROR,
...
impl ToString for RumRetentionFilterEventType {
...
impl Serialize for RumRetentionFilterEventType {
...
impl<'de> Deserialize<'de> for RumRetentionFilterEventType {
