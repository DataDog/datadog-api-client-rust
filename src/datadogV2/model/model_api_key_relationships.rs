...
impl<'de> Deserialize<'de> for APIKeyRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct APIKeyRelationshipsVisitor;
        impl<'a> Visitor<'a> for APIKeyRelationshipsVisitor {
            type Value = APIKeyRelationships;
        ...
        deserializer.deserialize_any(APIKeyRelationshipsVisitor)
    }
}
