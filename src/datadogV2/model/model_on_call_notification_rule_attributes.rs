...
pub struct OnCallNotificationRuleAttributes {
...
impl OnCallNotificationRuleAttributes {
    pub fn new() -> OnCallNotificationRuleAttributes {
...
impl Default for OnCallNotificationRuleAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for OnCallNotificationRuleAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OnCallNotificationRuleAttributesVisitor;
        impl<'a> Visitor<'a> for OnCallNotificationRuleAttributesVisitor {
            type Value = OnCallNotificationRuleAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OnCallNotificationRuleAttributes {
                    category,
                    channel_settings,
                    delay_minutes,
        ...
        deserializer.deserialize_any(OnCallNotificationRuleAttributesVisitor)
    }
}
