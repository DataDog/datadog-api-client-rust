...
impl<'de> Deserialize<'de> for UserTeamPermissionAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UserTeamPermissionAttributesVisitor;
        impl<'a> Visitor<'a> for UserTeamPermissionAttributesVisitor {
            type Value = UserTeamPermissionAttributes;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut permissions: Option<std::collections::BTreeMap<String, serde_json::Value>> =
                    None;
                ...
                let content = UserTeamPermissionAttributes {
                    permissions,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(UserTeamPermissionAttributesVisitor)
    }
}
