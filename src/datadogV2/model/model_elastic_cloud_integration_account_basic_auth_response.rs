...
pub struct ElasticCloudIntegrationAccountBasicAuthResponse {
...
impl ElasticCloudIntegrationAccountBasicAuthResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for ElasticCloudIntegrationAccountBasicAuthResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudIntegrationAccountBasicAuthResponseVisitor;
        impl<'a> Visitor<'a> for ElasticCloudIntegrationAccountBasicAuthResponseVisitor {
            type Value = ElasticCloudIntegrationAccountBasicAuthResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudIntegrationAccountBasicAuthResponse {
                    auth_type,
                    username,
        ...
        deserializer.deserialize_any(ElasticCloudIntegrationAccountBasicAuthResponseVisitor)
    }
}
