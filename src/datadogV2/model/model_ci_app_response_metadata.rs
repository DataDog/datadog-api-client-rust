...
impl<'de> Deserialize<'de> for CIAppResponseMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppResponseMetadataVisitor;
        impl<'a> Visitor<'a> for CIAppResponseMetadataVisitor {
            type Value = CIAppResponseMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CIAppResponseMetadata {
                    elapsed,
                    request_id,
                    status,
                    warnings,
        ...
        deserializer.deserialize_any(CIAppResponseMetadataVisitor)
    }
}
