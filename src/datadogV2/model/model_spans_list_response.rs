...
impl<'de> Deserialize<'de> for SpansListResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansListResponseVisitor;
        impl<'a> Visitor<'a> for SpansListResponseVisitor {
            type Value = SpansListResponse;
        ...
        deserializer.deserialize_any(SpansListResponseVisitor)
    }
}
