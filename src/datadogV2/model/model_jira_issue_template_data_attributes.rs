...
pub struct JiraIssueTemplateDataAttributes {
...
impl JiraIssueTemplateDataAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for JiraIssueTemplateDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct JiraIssueTemplateDataAttributesVisitor;
        impl<'a> Visitor<'a> for JiraIssueTemplateDataAttributesVisitor {
            type Value = JiraIssueTemplateDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = JiraIssueTemplateDataAttributes {
                    fields,
                    issue_type_id,
                    name,
                    project_id,
        ...
        deserializer.deserialize_any(JiraIssueTemplateDataAttributesVisitor)
    }
}
