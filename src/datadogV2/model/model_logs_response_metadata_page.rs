...
impl<'de> Deserialize<'de> for LogsResponseMetadataPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsResponseMetadataPageVisitor;
        impl<'a> Visitor<'a> for LogsResponseMetadataPageVisitor {
            type Value = LogsResponseMetadataPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LogsResponseMetadataPage { after, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(LogsResponseMetadataPageVisitor)
    }
}
