...
pub enum RoutingRuleAction {
    ...
    WebhookAction(Box<crate::datadogV2::model::WebhookAction>),
...
impl<'de> Deserialize<'de> for RoutingRuleAction {
        ...
        D: Deserializer<'de>,
    {
        ...
        if let Ok(_v) =
            serde_json::from_value::<Box<crate::datadogV2::model::WebhookAction>>(value.clone())
        {
            if !_v._unparsed {
                return Ok(RoutingRuleAction::WebhookAction(_v));
            }
        }
