...
impl<'de> Deserialize<'de> for ProcessSummary {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ProcessSummaryVisitor;
        impl<'a> Visitor<'a> for ProcessSummaryVisitor {
            type Value = ProcessSummary;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::ProcessSummaryAttributes> =
                    None;
                let mut id: Option<String> = None;
                let mut type_: Option<crate::datadogV2::model::ProcessSummaryType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ProcessSummaryType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(ProcessSummaryVisitor)
    }
}
