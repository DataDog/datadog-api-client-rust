...
pub struct AWSCloudAuthPersonaMappingAttributesResponse {
...
impl AWSCloudAuthPersonaMappingAttributesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for AWSCloudAuthPersonaMappingAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSCloudAuthPersonaMappingAttributesResponseVisitor;
        impl<'a> Visitor<'a> for AWSCloudAuthPersonaMappingAttributesResponseVisitor {
            type Value = AWSCloudAuthPersonaMappingAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AWSCloudAuthPersonaMappingAttributesResponse {
                    account_identifier,
                    account_uuid,
                    arn_pattern,
        ...
        deserializer.deserialize_any(AWSCloudAuthPersonaMappingAttributesResponseVisitor)
    }
}
