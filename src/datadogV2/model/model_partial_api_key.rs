...
impl<'de> Deserialize<'de> for PartialAPIKey {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PartialAPIKeyVisitor;
        impl<'a> Visitor<'a> for PartialAPIKeyVisitor {
            type Value = PartialAPIKey;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::PartialAPIKeyAttributes> = None;
        ...
        deserializer.deserialize_any(PartialAPIKeyVisitor)
    }
}
