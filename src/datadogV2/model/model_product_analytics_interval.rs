...
impl ProductAnalyticsInterval {
    pub fn new() -> ProductAnalyticsInterval {
...
impl Default for ProductAnalyticsInterval {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ProductAnalyticsInterval {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsIntervalVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsIntervalVisitor {
            type Value = ProductAnalyticsInterval;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut milliseconds: Option<i64> = None;
                ...
                let content = ProductAnalyticsInterval {
                    milliseconds,
                    start_time,
                    times,
                    type_,
        ...
        deserializer.deserialize_any(ProductAnalyticsIntervalVisitor)
    }
}
