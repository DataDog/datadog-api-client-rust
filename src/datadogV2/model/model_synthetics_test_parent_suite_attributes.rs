...
pub struct SyntheticsTestParentSuiteAttributes {
...
impl SyntheticsTestParentSuiteAttributes {
    pub fn new() -> SyntheticsTestParentSuiteAttributes {
...
impl Default for SyntheticsTestParentSuiteAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SyntheticsTestParentSuiteAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SyntheticsTestParentSuiteAttributesVisitor;
        impl<'a> Visitor<'a> for SyntheticsTestParentSuiteAttributesVisitor {
            type Value = SyntheticsTestParentSuiteAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SyntheticsTestParentSuiteAttributes {
                    child_name,
                    child_public_id,
                    monitor_id,
                    name,
        ...
        deserializer.deserialize_any(SyntheticsTestParentSuiteAttributesVisitor)
    }
}
