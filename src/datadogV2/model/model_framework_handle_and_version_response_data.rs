...
pub struct FrameworkHandleAndVersionResponseData {
...
impl FrameworkHandleAndVersionResponseData {
    pub fn new(
...
impl<'de> Deserialize<'de> for FrameworkHandleAndVersionResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FrameworkHandleAndVersionResponseDataVisitor;
        impl<'a> Visitor<'a> for FrameworkHandleAndVersionResponseDataVisitor {
            type Value = FrameworkHandleAndVersionResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FrameworkHandleAndVersionResponseData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(FrameworkHandleAndVersionResponseDataVisitor)
    }
}
