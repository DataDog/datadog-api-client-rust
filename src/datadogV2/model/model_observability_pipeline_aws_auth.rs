...
pub struct ObservabilityPipelineAwsAuth {
    ...
    pub assume_role: Option<Option<String>>,
...
impl ObservabilityPipelineAwsAuth {
    ...
    pub fn assume_role(mut self, value: Option<String>) -> Self {
    ...
    pub fn session_name(mut self, value: Option<String>) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for ObservabilityPipelineAwsAuthVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut assume_role: Option<Option<String>> = None;
                let mut external_id: Option<Option<String>> = None;
                let mut session_name: Option<Option<String>> = None;
