...
impl MonitorTriggerWrapper {
    pub fn new(monitor_trigger: crate::datadogV2::model::MonitorTrigger) -> MonitorTriggerWrapper {
...
impl<'de> Deserialize<'de> for MonitorTriggerWrapper {
    ...
    where
        D: Deserializer<'de>,
    {
        struct MonitorTriggerWrapperVisitor;
        impl<'a> Visitor<'a> for MonitorTriggerWrapperVisitor {
            type Value = MonitorTriggerWrapper;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut monitor_trigger: Option<crate::datadogV2::model::MonitorTrigger> = None;
                ...
                let monitor_trigger =
                    monitor_trigger.ok_or_else(|| M::Error::missing_field("monitor_trigger"))?;

                let content = MonitorTriggerWrapper {
                    monitor_trigger,
                    start_step_names,
        ...
        deserializer.deserialize_any(MonitorTriggerWrapperVisitor)
    }
}
