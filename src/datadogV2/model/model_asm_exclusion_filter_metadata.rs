...
pub struct ASMExclusionFilterMetadata {
...
impl ASMExclusionFilterMetadata {
    pub fn new() -> ASMExclusionFilterMetadata {
...
impl Default for ASMExclusionFilterMetadata {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ASMExclusionFilterMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ASMExclusionFilterMetadataVisitor;
        impl<'a> Visitor<'a> for ASMExclusionFilterMetadataVisitor {
            type Value = ASMExclusionFilterMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ASMExclusionFilterMetadata {
                    added_at,
                    added_by,
                    modified_at,
                    modified_by,
        ...
        deserializer.deserialize_any(ASMExclusionFilterMetadataVisitor)
    }
}
