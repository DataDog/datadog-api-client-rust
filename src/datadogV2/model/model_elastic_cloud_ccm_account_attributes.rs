...
pub struct ElasticCloudCcmAccountAttributes {
...
impl ElasticCloudCcmAccountAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for ElasticCloudCcmAccountAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ElasticCloudCcmAccountAttributesVisitor;
        impl<'a> Visitor<'a> for ElasticCloudCcmAccountAttributesVisitor {
            type Value = ElasticCloudCcmAccountAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ElasticCloudCcmAccountAttributes {
                    authentication,
                    dataflows,
                    name,
                    permissions,
        ...
        deserializer.deserialize_any(ElasticCloudCcmAccountAttributesVisitor)
    }
}
