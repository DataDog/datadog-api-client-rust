...
impl<'de> Deserialize<'de> for DueDateRuleUpdateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DueDateRuleUpdateRequestVisitor;
        impl<'a> Visitor<'a> for DueDateRuleUpdateRequestVisitor {
            type Value = DueDateRuleUpdateRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DueDateRuleUpdateRequest {
                    data,
        ...
        deserializer.deserialize_any(DueDateRuleUpdateRequestVisitor)
    }
}
