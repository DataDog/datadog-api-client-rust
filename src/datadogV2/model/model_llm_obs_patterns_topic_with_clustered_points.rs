...
pub struct LLMObsPatternsTopicWithClusteredPoints {
    /// List of clustered points attached to a topic.
    #[serde(rename = "cluster_points")]
    pub cluster_points: Option<Vec<crate::datadogV2::model::LLMObsPatternsClusteredPointRef>>,
...
impl LLMObsPatternsTopicWithClusteredPoints {
    pub fn new(
    ...
    pub fn cluster_points(
        mut self,
        value: Vec<crate::datadogV2::model::LLMObsPatternsClusteredPointRef>,
    ) -> Self {
        self.cluster_points = Some(value);
        self
    }
...
impl<'de> Deserialize<'de> for LLMObsPatternsTopicWithClusteredPoints {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsPatternsTopicWithClusteredPointsVisitor;
        impl<'a> Visitor<'a> for LLMObsPatternsTopicWithClusteredPointsVisitor {
            type Value = LLMObsPatternsTopicWithClusteredPoints;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut cluster_points: Option<
                    Vec<crate::datadogV2::model::LLMObsPatternsClusteredPointRef>,
                > = None;
                ...
                let content = LLMObsPatternsTopicWithClusteredPoints {
                    cluster_points,
                    created_at,
                    description,
                    first_seen_at,
        ...
        deserializer.deserialize_any(LLMObsPatternsTopicWithClusteredPointsVisitor)
    }
}
