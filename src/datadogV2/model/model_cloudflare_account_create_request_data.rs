...
impl<'de> Deserialize<'de> for CloudflareAccountCreateRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CloudflareAccountCreateRequestDataVisitor;
        impl<'a> Visitor<'a> for CloudflareAccountCreateRequestDataVisitor {
            type Value = CloudflareAccountCreateRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CloudflareAccountCreateRequestAttributes,
                > = None;
                ...
                let content = CloudflareAccountCreateRequestData {
                    attributes,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(CloudflareAccountCreateRequestDataVisitor)
    }
}
