...
pub struct TagPolicyCreateRequest {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::TagPolicyDataRequest,
    #[serde(flatten)]
...
impl TagPolicyCreateRequest {
    pub fn new(data: crate::datadogV2::model::TagPolicyDataRequest) -> TagPolicyCreateRequest {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TagPolicyCreateRequestVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::TagPolicyDataRequest> = None;
