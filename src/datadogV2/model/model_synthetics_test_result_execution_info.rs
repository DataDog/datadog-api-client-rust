...
pub struct SyntheticsTestResultExecutionInfo {
    ...
    pub duration: Option<crate::datadogV2::model::SyntheticsTestResultDuration>,
...
impl SyntheticsTestResultExecutionInfo {
    ...
    pub fn duration(
        mut self,
        value: crate::datadogV2::model::SyntheticsTestResultDuration,
    ) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for SyntheticsTestResultExecutionInfoVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut duration: Option<crate::datadogV2::model::SyntheticsTestResultDuration> =
                    None;
