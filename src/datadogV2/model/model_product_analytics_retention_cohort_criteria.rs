...
pub struct ProductAnalyticsRetentionCohortCriteria {
    ...
    pub time_interval: crate::datadogV2::model::ProductAnalyticsRetentionTimeInterval,
    #[serde(flatten)]
...
impl ProductAnalyticsRetentionCohortCriteria {
    pub fn new(
        base_query: crate::datadogV2::model::ProductAnalyticsBaseQuery,
        time_interval: crate::datadogV2::model::ProductAnalyticsRetentionTimeInterval,
...
impl<'de> Deserialize<'de> for ProductAnalyticsRetentionCohortCriteria {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsRetentionCohortCriteriaVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsRetentionCohortCriteriaVisitor {
            type Value = ProductAnalyticsRetentionCohortCriteria;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ProductAnalyticsRetentionCohortCriteria {
                    base_query,
                    time_interval,
        ...
        deserializer.deserialize_any(ProductAnalyticsRetentionCohortCriteriaVisitor)
    }
}
