...
impl<'de> Deserialize<'de> for GetAppResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GetAppResponseDataVisitor;
        impl<'a> Visitor<'a> for GetAppResponseDataVisitor {
            type Value = GetAppResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = GetAppResponseData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(GetAppResponseDataVisitor)
    }
}
