...
pub struct EntityV3Datastore {
    ...
    pub datadog: Option<crate::datadogV2::model::EntityV3DatastoreDatadog>,
...
impl EntityV3Datastore {
    pub fn new(
        ...
        kind: crate::datadogV2::model::EntityV3DatastoreKind,
    ...
    pub fn datadog(mut self, value: crate::datadogV2::model::EntityV3DatastoreDatadog) -> Self {
    ...
    pub fn spec(mut self, value: crate::datadogV2::model::EntityV3DatastoreSpec) -> Self {
...
impl<'de> Deserialize<'de> for EntityV3Datastore {
    ...
    where
        D: Deserializer<'de>,
    {
        struct EntityV3DatastoreVisitor;
        impl<'a> Visitor<'a> for EntityV3DatastoreVisitor {
            type Value = EntityV3Datastore;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut datadog: Option<crate::datadogV2::model::EntityV3DatastoreDatadog> = None;
                ...
                let mut kind: Option<crate::datadogV2::model::EntityV3DatastoreKind> = None;
                let mut metadata: Option<crate::datadogV2::model::EntityV3Metadata> = None;
                let mut spec: Option<crate::datadogV2::model::EntityV3DatastoreSpec> = None;
                    ...
                    match k.as_str() {
                        ...
                        "kind" => {
                            ...
                            if let Some(ref _kind) = kind {
                                match _kind {
                                    crate::datadogV2::model::EntityV3DatastoreKind::UnparsedObject(_kind) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(EntityV3DatastoreVisitor)
    }
}
