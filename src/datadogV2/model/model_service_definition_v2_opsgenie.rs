...
impl<'de> Deserialize<'de> for ServiceDefinitionV2Opsgenie {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ServiceDefinitionV2OpsgenieVisitor;
        impl<'a> Visitor<'a> for ServiceDefinitionV2OpsgenieVisitor {
            type Value = ServiceDefinitionV2Opsgenie;
                    ...
                    match k.as_str() {
                        "region" => {
                            ...
                            if let Some(ref _region) = region {
                                match _region {
                                    crate::datadogV2::model::ServiceDefinitionV2OpsgenieRegion::UnparsedObject(_region) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ServiceDefinitionV2OpsgenieVisitor)
    }
}
