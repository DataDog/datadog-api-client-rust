...
pub struct SimpleMonitorUserTemplate {
...
impl SimpleMonitorUserTemplate {
    pub fn new() -> SimpleMonitorUserTemplate {
...
impl Default for SimpleMonitorUserTemplate {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SimpleMonitorUserTemplate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SimpleMonitorUserTemplateVisitor;
        impl<'a> Visitor<'a> for SimpleMonitorUserTemplateVisitor {
            type Value = SimpleMonitorUserTemplate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SimpleMonitorUserTemplate {
                    created,
                    description,
                    id,
                    monitor_definition,
        ...
        deserializer.deserialize_any(SimpleMonitorUserTemplateVisitor)
    }
}
