...
pub struct ScheduleCreateRequestData {
    ...
    #[serde(rename = "type")]
    pub type_: Option<crate::datadogV2::model::ScheduleCreateRequestDataType>,
    #[serde(flatten)]
...
impl ScheduleCreateRequestData {
    pub fn new() -> ScheduleCreateRequestData {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::ScheduleCreateRequestDataType) -> Self {
...
impl Default for ScheduleCreateRequestData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<'de> Deserialize<'de> for ScheduleCreateRequestData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ScheduleCreateRequestDataVisitor;
        impl<'a> Visitor<'a> for ScheduleCreateRequestDataVisitor {
            type Value = ScheduleCreateRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::ScheduleCreateRequestDataAttributes,
                > = None;
                let mut relationships: Option<
                    crate::datadogV2::model::ScheduleCreateRequestDataRelationships,
                > = None;
                let mut type_: Option<crate::datadogV2::model::ScheduleCreateRequestDataType> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ScheduleCreateRequestDataType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ScheduleCreateRequestDataVisitor)
    }
}
