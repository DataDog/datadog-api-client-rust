...
pub struct AssetAttributes {
    ...
    pub operating_system: Option<crate::datadogV2::model::AssetAttributesOperatingSystem>,
    /// Asset risks.
    #[serde(rename = "risks")]
    pub risks: crate::datadogV2::model::AssetAttributesRisks,
    /// The asset type
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::AssetType,
    /// Asset version.
    #[serde(rename = "version")]
    pub version: Option<crate::datadogV2::model::AssetAttributesVersion>,
    #[serde(flatten)]
...
impl AssetAttributes {
    pub fn new(
        ...
        name: String,
        risks: crate::datadogV2::model::AssetAttributesRisks,
    ...
    pub fn operating_system(
        mut self,
        value: crate::datadogV2::model::AssetAttributesOperatingSystem,
    ) -> Self {
        self.operating_system = Some(value);
        self
    }

    pub fn version(mut self, value: crate::datadogV2::model::AssetAttributesVersion) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AssetAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut operating_system: Option<
                    crate::datadogV2::model::AssetAttributesOperatingSystem,
                > = None;
                let mut risks: Option<crate::datadogV2::model::AssetAttributesRisks> = None;
                let mut type_: Option<crate::datadogV2::model::AssetType> = None;
                let mut version: Option<crate::datadogV2::model::AssetAttributesVersion> = None;
