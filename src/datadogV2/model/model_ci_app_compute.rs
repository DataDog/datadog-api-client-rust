...
impl CIAppCompute {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::CIAppComputeType) -> Self {
...
impl<'de> Deserialize<'de> for CIAppCompute {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CIAppComputeVisitor;
        impl<'a> Visitor<'a> for CIAppComputeVisitor {
            type Value = CIAppCompute;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV2::model::CIAppComputeType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::CIAppComputeType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(CIAppComputeVisitor)
    }
}
