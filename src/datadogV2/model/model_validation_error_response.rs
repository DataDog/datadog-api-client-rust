...
pub struct ValidationErrorResponse {
    /// The `ValidationErrorResponse` `errors`.
    #[serde(rename = "errors")]
...
impl<'de> Deserialize<'de> for ValidationErrorResponse {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ValidationErrorResponseVisitor;
        impl<'a> Visitor<'a> for ValidationErrorResponseVisitor {
            type Value = ValidationErrorResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ValidationErrorResponse {
                    errors,
        ...
        deserializer.deserialize_any(ValidationErrorResponseVisitor)
    }
}
