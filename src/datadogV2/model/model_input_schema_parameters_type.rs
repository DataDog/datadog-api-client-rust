...
pub enum InputSchemaParametersType {
    STRING,
    NUMBER,
    BOOLEAN,
    OBJECT,
...
impl ToString for InputSchemaParametersType {
...
impl Serialize for InputSchemaParametersType {
...
impl<'de> Deserialize<'de> for InputSchemaParametersType {
