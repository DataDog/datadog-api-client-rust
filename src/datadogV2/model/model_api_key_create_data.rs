...
impl<'de> Deserialize<'de> for APIKeyCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct APIKeyCreateDataVisitor;
        impl<'a> Visitor<'a> for APIKeyCreateDataVisitor {
            type Value = APIKeyCreateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::APIKeyCreateAttributes> = None;
        ...
        deserializer.deserialize_any(APIKeyCreateDataVisitor)
    }
}
