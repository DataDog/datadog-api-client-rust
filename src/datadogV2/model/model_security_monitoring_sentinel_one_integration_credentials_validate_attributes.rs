...
pub struct SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributes {
...
impl SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributes {
    pub fn new(
        domain: String,
...
impl<'de> Deserialize<'de>
    for SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributes
{
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributesVisitor;
        impl<'a> Visitor<'a>
            for SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributesVisitor
        {
            type Value = SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributes;
        ...
        deserializer.deserialize_any(
            SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributesVisitor,
        )
    }
}
