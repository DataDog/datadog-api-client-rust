...
impl UpdateTenancyConfigDataAttributesMetricsConfig {
    pub fn new() -> UpdateTenancyConfigDataAttributesMetricsConfig {
...
impl Default for UpdateTenancyConfigDataAttributesMetricsConfig {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for UpdateTenancyConfigDataAttributesMetricsConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateTenancyConfigDataAttributesMetricsConfigVisitor;
        impl<'a> Visitor<'a> for UpdateTenancyConfigDataAttributesMetricsConfigVisitor {
            type Value = UpdateTenancyConfigDataAttributesMetricsConfig;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UpdateTenancyConfigDataAttributesMetricsConfig {
                    compartment_tag_filters,
                    enabled,
                    excluded_services,
        ...
        deserializer.deserialize_any(UpdateTenancyConfigDataAttributesMetricsConfigVisitor)
    }
}
