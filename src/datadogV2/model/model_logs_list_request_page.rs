...
impl<'de> Deserialize<'de> for LogsListRequestPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsListRequestPageVisitor;
        impl<'a> Visitor<'a> for LogsListRequestPageVisitor {
            type Value = LogsListRequestPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LogsListRequestPage {
                    cursor,
                    limit,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(LogsListRequestPageVisitor)
    }
}
