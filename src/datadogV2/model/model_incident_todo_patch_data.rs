...
impl<'de> Deserialize<'de> for IncidentTodoPatchData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTodoPatchDataVisitor;
        impl<'a> Visitor<'a> for IncidentTodoPatchDataVisitor {
            type Value = IncidentTodoPatchData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentTodoPatchData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(IncidentTodoPatchDataVisitor)
    }
}
