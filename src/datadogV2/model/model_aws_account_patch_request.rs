...
pub struct AWSAccountPatchRequest {
    ...
    #[serde(rename = "data")]
    pub data: Option<crate::datadogV2::model::AWSAccountPatchRequestData>,
    #[serde(flatten)]
...
impl AWSAccountPatchRequest {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::AWSAccountPatchRequestData) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for AWSAccountPatchRequestVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::AWSAccountPatchRequestData> = None;
                ...
                let content = AWSAccountPatchRequest {
                    data,
