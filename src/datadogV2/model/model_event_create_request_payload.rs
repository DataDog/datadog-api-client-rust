...
impl<'de> Deserialize<'de> for EventCreateRequestPayload {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EventCreateRequestPayloadVisitor;
        impl<'a> Visitor<'a> for EventCreateRequestPayloadVisitor {
            type Value = EventCreateRequestPayload;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::EventCreateRequest> = None;
        ...
        deserializer.deserialize_any(EventCreateRequestPayloadVisitor)
    }
}
