...
impl<'de> Deserialize<'de> for CIAppWarning {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppWarningVisitor;
        impl<'a> Visitor<'a> for CIAppWarningVisitor {
            type Value = CIAppWarning;
        ...
        deserializer.deserialize_any(CIAppWarningVisitor)
    }
}
