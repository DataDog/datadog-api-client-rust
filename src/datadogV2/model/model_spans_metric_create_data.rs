...
impl<'de> Deserialize<'de> for SpansMetricCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansMetricCreateDataVisitor;
        impl<'a> Visitor<'a> for SpansMetricCreateDataVisitor {
            type Value = SpansMetricCreateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::SpansMetricCreateAttributes> =
                    None;
                ...
                let content = SpansMetricCreateData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(SpansMetricCreateDataVisitor)
    }
}
