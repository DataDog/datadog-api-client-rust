...
pub struct DORADeploymentPatchByVersionRemediationByVersion {
...
impl DORADeploymentPatchByVersionRemediationByVersion {
    pub fn new(
...
impl<'de> Deserialize<'de> for DORADeploymentPatchByVersionRemediationByVersion {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DORADeploymentPatchByVersionRemediationByVersionVisitor;
        impl<'a> Visitor<'a> for DORADeploymentPatchByVersionRemediationByVersionVisitor {
            type Value = DORADeploymentPatchByVersionRemediationByVersion;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DORADeploymentPatchByVersionRemediationByVersion {
                    type_,
                    version,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(DORADeploymentPatchByVersionRemediationByVersionVisitor)
    }
}
