...
pub struct CreateTenancyConfigData {
    ...
    pub attributes: Option<crate::datadogV2::model::CreateTenancyConfigDataAttributes>,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for CreateTenancyConfigDataVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV2::model::CreateTenancyConfigDataType> = None;
