...
pub struct StatusPageAsIncludedAttributes {
    ...
    pub components:
        Option<Vec<crate::datadogV2::model::StatusPageAsIncludedAttributesComponentsItems>>,
...
impl StatusPageAsIncludedAttributes {
    pub fn new() -> StatusPageAsIncludedAttributes {
    ...
    pub fn components(
        mut self,
        value: Vec<crate::datadogV2::model::StatusPageAsIncludedAttributesComponentsItems>,
    ) -> Self {
    ...
    pub fn custom_domain(mut self, value: String) -> Self {
...
impl Default for StatusPageAsIncludedAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for StatusPageAsIncludedAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct StatusPageAsIncludedAttributesVisitor;
        impl<'a> Visitor<'a> for StatusPageAsIncludedAttributesVisitor {
            type Value = StatusPageAsIncludedAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut components: Option<
                    Vec<crate::datadogV2::model::StatusPageAsIncludedAttributesComponentsItems>,
                > = None;
                ...
                let content = StatusPageAsIncludedAttributes {
                    company_logo,
                    components,
                    created_at,
                    custom_domain,
        ...
        deserializer.deserialize_any(StatusPageAsIncludedAttributesVisitor)
    }
}
