...
impl CaseAggregateGroup {
    pub fn new(group: String, value: Vec<f64>) -> CaseAggregateGroup {
        CaseAggregateGroup {
            group,
            value,
...
impl<'de> Deserialize<'de> for CaseAggregateGroup {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CaseAggregateGroupVisitor;
        impl<'a> Visitor<'a> for CaseAggregateGroupVisitor {
            type Value = CaseAggregateGroup;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CaseAggregateGroup {
                    group,
                    value,
        ...
        deserializer.deserialize_any(CaseAggregateGroupVisitor)
    }
}
