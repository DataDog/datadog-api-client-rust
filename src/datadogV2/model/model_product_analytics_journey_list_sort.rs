...
pub struct ProductAnalyticsJourneyListSort {
    /// Column to sort on.
    #[serde(rename = "facet")]
...
impl ProductAnalyticsJourneyListSort {
    pub fn new() -> ProductAnalyticsJourneyListSort {
...
impl Default for ProductAnalyticsJourneyListSort {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ProductAnalyticsJourneyListSort {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsJourneyListSortVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsJourneyListSortVisitor {
            type Value = ProductAnalyticsJourneyListSort;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ProductAnalyticsJourneyListSort {
                    facet,
                    order,
        ...
        deserializer.deserialize_any(ProductAnalyticsJourneyListSortVisitor)
    }
}
