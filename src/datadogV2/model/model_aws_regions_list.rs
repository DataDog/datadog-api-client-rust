...
impl Default for AWSRegionsList {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for AWSRegionsList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSRegionsListVisitor;
        impl<'a> Visitor<'a> for AWSRegionsListVisitor {
            type Value = AWSRegionsList;
        ...
        deserializer.deserialize_any(AWSRegionsListVisitor)
    }
}
