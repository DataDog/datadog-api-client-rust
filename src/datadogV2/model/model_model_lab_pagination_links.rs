...
pub struct ModelLabPaginationLinks {
...
impl ModelLabPaginationLinks {
    pub fn new() -> ModelLabPaginationLinks {
...
impl Default for ModelLabPaginationLinks {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ModelLabPaginationLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ModelLabPaginationLinksVisitor;
        impl<'a> Visitor<'a> for ModelLabPaginationLinksVisitor {
            type Value = ModelLabPaginationLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ModelLabPaginationLinks {
                    first,
                    last,
                    next,
                    prev,
        ...
        deserializer.deserialize_any(ModelLabPaginationLinksVisitor)
    }
}
