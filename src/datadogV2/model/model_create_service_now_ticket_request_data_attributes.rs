...
pub struct CreateServiceNowTicketRequestDataAttributes {
...
impl CreateServiceNowTicketRequestDataAttributes {
    pub fn new() -> CreateServiceNowTicketRequestDataAttributes {
...
impl Default for CreateServiceNowTicketRequestDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CreateServiceNowTicketRequestDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateServiceNowTicketRequestDataAttributesVisitor;
        impl<'a> Visitor<'a> for CreateServiceNowTicketRequestDataAttributesVisitor {
            type Value = CreateServiceNowTicketRequestDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateServiceNowTicketRequestDataAttributes {
                    assignee_id,
                    description,
                    priority,
                    title,
        ...
        deserializer.deserialize_any(CreateServiceNowTicketRequestDataAttributesVisitor)
    }
}
