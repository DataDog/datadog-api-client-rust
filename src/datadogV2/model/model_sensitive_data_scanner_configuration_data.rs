...
impl<'de> Deserialize<'de> for SensitiveDataScannerConfigurationData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerConfigurationDataVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerConfigurationDataVisitor {
            type Value = SensitiveDataScannerConfigurationData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SensitiveDataScannerConfiguration> =
                    None;
                ...
                let content = SensitiveDataScannerConfigurationData { data, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(SensitiveDataScannerConfigurationDataVisitor)
    }
}
