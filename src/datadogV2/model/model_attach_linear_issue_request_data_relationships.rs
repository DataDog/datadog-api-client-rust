...
pub struct AttachLinearIssueRequestDataRelationships {
...
impl AttachLinearIssueRequestDataRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for AttachLinearIssueRequestDataRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AttachLinearIssueRequestDataRelationshipsVisitor;
        impl<'a> Visitor<'a> for AttachLinearIssueRequestDataRelationshipsVisitor {
            type Value = AttachLinearIssueRequestDataRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AttachLinearIssueRequestDataRelationships {
                    findings,
                    project,
        ...
        deserializer.deserialize_any(AttachLinearIssueRequestDataRelationshipsVisitor)
    }
}
