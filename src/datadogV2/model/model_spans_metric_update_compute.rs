...
impl<'de> Deserialize<'de> for SpansMetricUpdateCompute {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansMetricUpdateComputeVisitor;
        impl<'a> Visitor<'a> for SpansMetricUpdateComputeVisitor {
            type Value = SpansMetricUpdateCompute;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SpansMetricUpdateCompute {
                    include_percentiles,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SpansMetricUpdateComputeVisitor)
    }
}
