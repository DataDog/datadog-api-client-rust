...
pub struct ServiceNowTemplateCreateRequestAttributes {
...
impl ServiceNowTemplateCreateRequestAttributes {
    pub fn new(
        handle_name: String,
...
impl<'de> Deserialize<'de> for ServiceNowTemplateCreateRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ServiceNowTemplateCreateRequestAttributesVisitor;
        impl<'a> Visitor<'a> for ServiceNowTemplateCreateRequestAttributesVisitor {
            type Value = ServiceNowTemplateCreateRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ServiceNowTemplateCreateRequestAttributes {
                    assignment_group_id,
                    business_service_id,
                    fields_mapping,
                    handle_name,
        ...
        deserializer.deserialize_any(ServiceNowTemplateCreateRequestAttributesVisitor)
    }
}
