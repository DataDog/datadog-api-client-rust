...
pub struct OrgGroupMembershipUpdateRelationships {
...
impl OrgGroupMembershipUpdateRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for OrgGroupMembershipUpdateRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupMembershipUpdateRelationshipsVisitor;
        impl<'a> Visitor<'a> for OrgGroupMembershipUpdateRelationshipsVisitor {
            type Value = OrgGroupMembershipUpdateRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OrgGroupMembershipUpdateRelationships {
                    org_group,
        ...
        deserializer.deserialize_any(OrgGroupMembershipUpdateRelationshipsVisitor)
    }
}
