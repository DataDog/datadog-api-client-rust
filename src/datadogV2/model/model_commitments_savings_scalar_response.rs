...
pub struct CommitmentsSavingsScalarResponse {
...
impl CommitmentsSavingsScalarResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for CommitmentsSavingsScalarResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CommitmentsSavingsScalarResponseVisitor;
        impl<'a> Visitor<'a> for CommitmentsSavingsScalarResponseVisitor {
            type Value = CommitmentsSavingsScalarResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CommitmentsSavingsScalarResponse {
                    columns,
        ...
        deserializer.deserialize_any(CommitmentsSavingsScalarResponseVisitor)
    }
}
