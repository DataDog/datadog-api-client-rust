...
pub struct IncidentImpactRelationships {
...
impl IncidentImpactRelationships {
    pub fn new() -> IncidentImpactRelationships {
...
impl Default for IncidentImpactRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentImpactRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentImpactRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentImpactRelationshipsVisitor {
            type Value = IncidentImpactRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentImpactRelationships {
                    created_by_user,
                    incident,
                    last_modified_by_user,
        ...
        deserializer.deserialize_any(IncidentImpactRelationshipsVisitor)
    }
}
