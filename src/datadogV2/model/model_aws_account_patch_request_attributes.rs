...
pub struct AWSAccountPatchRequestAttributes {
...
impl AWSAccountPatchRequestAttributes {
    pub fn new(aws_account_id: String) -> AWSAccountPatchRequestAttributes {
        AWSAccountPatchRequestAttributes {
            account_tags: None,
            auth_config: None,
            aws_account_id,
            aws_partition: None,
...
impl<'de> Deserialize<'de> for AWSAccountPatchRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSAccountPatchRequestAttributesVisitor;
        impl<'a> Visitor<'a> for AWSAccountPatchRequestAttributesVisitor {
            type Value = AWSAccountPatchRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AWSAccountPatchRequestAttributes {
                    account_tags,
                    auth_config,
                    aws_account_id,
                    aws_partition,
        ...
        deserializer.deserialize_any(AWSAccountPatchRequestAttributesVisitor)
    }
}
