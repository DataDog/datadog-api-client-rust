...
impl<'de> Deserialize<'de> for CustomAttributeConfigAttributesCreate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CustomAttributeConfigAttributesCreateVisitor;
        impl<'a> Visitor<'a> for CustomAttributeConfigAttributesCreateVisitor {
            type Value = CustomAttributeConfigAttributesCreate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CustomAttributeConfigAttributesCreate {
                    description,
                    display_name,
                    is_multi,
                    key,
        ...
        deserializer.deserialize_any(CustomAttributeConfigAttributesCreateVisitor)
    }
}
