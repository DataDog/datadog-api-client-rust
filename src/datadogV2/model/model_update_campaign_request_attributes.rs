...
pub struct UpdateCampaignRequestAttributes {
...
impl UpdateCampaignRequestAttributes {
    pub fn new(
        name: String,
        owner_id: String,
        rule_ids: Vec<String>,
...
impl<'de> Deserialize<'de> for UpdateCampaignRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateCampaignRequestAttributesVisitor;
        impl<'a> Visitor<'a> for UpdateCampaignRequestAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UpdateCampaignRequestAttributes {
                    description,
                    due_date,
                    entity_scope,
                    guidance,
        ...
        deserializer.deserialize_any(UpdateCampaignRequestAttributesVisitor)
    }
}
