...
pub struct EPSS {
    ...
    pub severity: crate::datadogV2::model::Severity,
    #[serde(flatten)]
...
impl EPSS {
    pub fn new(score: f64, severity: crate::datadogV2::model::Severity) -> EPSS {
        EPSS {
            score,
            severity,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for EPSSVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut severity: Option<crate::datadogV2::model::Severity> = None;
                    ...
                    match k.as_str() {
                        ...
                        "severity" => {
                            ...
                            if let Some(ref _severity) = severity {
                                match _severity {
                                    crate::datadogV2::model::Severity::UnparsedObject(
                                        _severity,
                                    ) => {
                                        _unparsed = true;
                                    }
