...
impl<'de> Deserialize<'de> for AgentTrigger {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AgentTriggerVisitor;
        impl<'a> Visitor<'a> for AgentTriggerVisitor {
            type Value = AgentTrigger;
        ...
        deserializer.deserialize_any(AgentTriggerVisitor)
    }
}
