...
pub struct CommitmentsUtilizationTimeseriesResponse {
...
impl CommitmentsUtilizationTimeseriesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for CommitmentsUtilizationTimeseriesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CommitmentsUtilizationTimeseriesResponseVisitor;
        impl<'a> Visitor<'a> for CommitmentsUtilizationTimeseriesResponseVisitor {
            type Value = CommitmentsUtilizationTimeseriesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CommitmentsUtilizationTimeseriesResponse {
                    series,
                    times,
                    unit,
        ...
        deserializer.deserialize_any(CommitmentsUtilizationTimeseriesResponseVisitor)
    }
}
