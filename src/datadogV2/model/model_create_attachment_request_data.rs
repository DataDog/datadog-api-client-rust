...
impl CreateAttachmentRequestData {
    pub fn new(
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::CreateAttachmentRequestDataAttributes,
    ) -> Self {
...
impl<'de> Deserialize<'de> for CreateAttachmentRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateAttachmentRequestDataVisitor;
        impl<'a> Visitor<'a> for CreateAttachmentRequestDataVisitor {
            type Value = CreateAttachmentRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CreateAttachmentRequestDataAttributes,
                > = None;
                ...
                let content = CreateAttachmentRequestData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(CreateAttachmentRequestDataVisitor)
    }
}
