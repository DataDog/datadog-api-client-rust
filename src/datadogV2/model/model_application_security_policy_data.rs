...
pub struct ApplicationSecurityPolicyData {
    ...
    pub attributes: Option<crate::datadogV2::model::ApplicationSecurityPolicyAttributes>,
    /// The ID of the policy.
    #[serde(rename = "id")]
    pub id: Option<String>,
    /// Metadata associated with the WAF policy.
    #[serde(rename = "meta")]
    pub meta: Option<crate::datadogV2::model::ApplicationSecurityPolicyMetadata>,
    /// The type of the resource. The value should always be `policy`.
    #[serde(rename = "type")]
    pub type_: Option<crate::datadogV2::model::ApplicationSecurityPolicyType>,
    #[serde(flatten)]
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for ApplicationSecurityPolicyDataVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut meta: Option<crate::datadogV2::model::ApplicationSecurityPolicyMetadata> =
                    None;
                let mut type_: Option<crate::datadogV2::model::ApplicationSecurityPolicyType> =
                    None;
