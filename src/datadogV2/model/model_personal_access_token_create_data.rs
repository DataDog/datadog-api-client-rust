...
impl PersonalAccessTokenCreateData {
    pub fn new(
        attributes: crate::datadogV2::model::PersonalAccessTokenCreateAttributes,
...
impl<'de> Deserialize<'de> for PersonalAccessTokenCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PersonalAccessTokenCreateDataVisitor;
        impl<'a> Visitor<'a> for PersonalAccessTokenCreateDataVisitor {
            type Value = PersonalAccessTokenCreateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::PersonalAccessTokenCreateAttributes,
                > = None;
                ...
                let content = PersonalAccessTokenCreateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(PersonalAccessTokenCreateDataVisitor)
    }
}
