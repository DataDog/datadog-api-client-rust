...
impl<'de> Deserialize<'de> for MetricBulkTagConfigDelete {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MetricBulkTagConfigDeleteVisitor;
        impl<'a> Visitor<'a> for MetricBulkTagConfigDeleteVisitor {
            type Value = MetricBulkTagConfigDelete;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::MetricBulkTagConfigDeleteAttributes,
                > = None;
                ...
                let content = MetricBulkTagConfigDelete {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(MetricBulkTagConfigDeleteVisitor)
    }
}
