...
pub struct TagPolicyResponse {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::TagPolicyDataResponse,
    #[serde(flatten)]
...
impl TagPolicyResponse {
    pub fn new(data: crate::datadogV2::model::TagPolicyDataResponse) -> TagPolicyResponse {
        TagPolicyResponse {
            data,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TagPolicyResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::TagPolicyDataResponse> = None;
