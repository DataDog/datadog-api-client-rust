...
impl UpdateOpenAPIResponseAttributes {
...
impl Default for UpdateOpenAPIResponseAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for UpdateOpenAPIResponseAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateOpenAPIResponseAttributesVisitor;
        impl<'a> Visitor<'a> for UpdateOpenAPIResponseAttributesVisitor {
            type Value = UpdateOpenAPIResponseAttributes;
        ...
        deserializer.deserialize_any(UpdateOpenAPIResponseAttributesVisitor)
    }
}
