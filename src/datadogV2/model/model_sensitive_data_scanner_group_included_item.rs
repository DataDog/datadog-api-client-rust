...
impl<'de> Deserialize<'de> for SensitiveDataScannerGroupIncludedItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerGroupIncludedItemVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerGroupIncludedItemVisitor {
            type Value = SensitiveDataScannerGroupIncludedItem;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SensitiveDataScannerGroupAttributes,
                > = None;
                let mut id: Option<String> = None;
                let mut relationships: Option<
                    crate::datadogV2::model::SensitiveDataScannerGroupRelationships,
                > = None;
                ...
                let content = SensitiveDataScannerGroupIncludedItem {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(SensitiveDataScannerGroupIncludedItemVisitor)
    }
}
