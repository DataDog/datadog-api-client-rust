...
impl<'de> Deserialize<'de> for RelationshipToTeamLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RelationshipToTeamLinksVisitor;
        impl<'a> Visitor<'a> for RelationshipToTeamLinksVisitor {
            type Value = RelationshipToTeamLinks;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::RelationshipToTeamLinkData>> =
                    None;
                ...
                let content = RelationshipToTeamLinks {
                    data,
                    links,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(RelationshipToTeamLinksVisitor)
    }
}
