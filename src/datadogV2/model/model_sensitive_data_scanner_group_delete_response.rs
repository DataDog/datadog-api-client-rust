...
impl<'de> Deserialize<'de> for SensitiveDataScannerGroupDeleteResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerGroupDeleteResponseVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerGroupDeleteResponseVisitor {
            type Value = SensitiveDataScannerGroupDeleteResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerGroupDeleteResponse { meta, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(SensitiveDataScannerGroupDeleteResponseVisitor)
    }
}
