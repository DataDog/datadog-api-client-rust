...
pub struct OrgGroupPolicyOverrideListResponse {
...
impl OrgGroupPolicyOverrideListResponse {
    pub fn new(
        data: Vec<crate::datadogV2::model::OrgGroupPolicyOverrideData>,
...
impl<'de> Deserialize<'de> for OrgGroupPolicyOverrideListResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPolicyOverrideListResponseVisitor;
        impl<'a> Visitor<'a> for OrgGroupPolicyOverrideListResponseVisitor {
            type Value = OrgGroupPolicyOverrideListResponse;
        ...
        deserializer.deserialize_any(OrgGroupPolicyOverrideListResponseVisitor)
    }
}
