...
pub struct SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes {
    ...
    pub secrets: crate::datadogV2::model::SecurityMonitoringIntegrationConfigGoogleWorkspaceSecrets,
...
impl SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes {
    pub fn new(
        domain: String,
...
impl<'de> Deserialize<'de> for SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes {
                    domain,
                    integration_type,
                    name,
                    secrets,
        ...
        deserializer.deserialize_any(
            SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributesVisitor,
        )
    }
}
