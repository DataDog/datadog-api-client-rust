...
pub struct CoverageSummaryCodeownerStats {
...
impl CoverageSummaryCodeownerStats {
    pub fn new() -> CoverageSummaryCodeownerStats {
...
impl Default for CoverageSummaryCodeownerStats {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CoverageSummaryCodeownerStats {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CoverageSummaryCodeownerStatsVisitor;
        impl<'a> Visitor<'a> for CoverageSummaryCodeownerStatsVisitor {
            type Value = CoverageSummaryCodeownerStats;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CoverageSummaryCodeownerStats {
                    evaluated_flags_count,
                    evaluated_reports_count,
                    patch_coverage,
                    total_coverage,
        ...
        deserializer.deserialize_any(CoverageSummaryCodeownerStatsVisitor)
    }
}
