...
impl<'de> Deserialize<'de> for OrgGroupPaginationMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPaginationMetaVisitor;
        impl<'a> Visitor<'a> for OrgGroupPaginationMetaVisitor {
            type Value = OrgGroupPaginationMeta;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut page: Option<crate::datadogV2::model::OrgGroupPaginationMetaPage> = None;
        ...
        deserializer.deserialize_any(OrgGroupPaginationMetaVisitor)
    }
}
