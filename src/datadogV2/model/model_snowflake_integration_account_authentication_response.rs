...
pub struct SnowflakeIntegrationAccountAuthenticationResponse {
...
impl SnowflakeIntegrationAccountAuthenticationResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for SnowflakeIntegrationAccountAuthenticationResponse {
    ...
    where
        D: Deserializer<'de>,
    {
        struct SnowflakeIntegrationAccountAuthenticationResponseVisitor;
        impl<'a> Visitor<'a> for SnowflakeIntegrationAccountAuthenticationResponseVisitor {
            type Value = SnowflakeIntegrationAccountAuthenticationResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SnowflakeIntegrationAccountAuthenticationResponse {
                    auth_type,
                    private_key_name,
        ...
        deserializer.deserialize_any(SnowflakeIntegrationAccountAuthenticationResponseVisitor)
    }
}
