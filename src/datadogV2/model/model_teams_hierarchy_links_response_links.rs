...
pub struct TeamsHierarchyLinksResponseLinks {
...
impl TeamsHierarchyLinksResponseLinks {
    pub fn new() -> TeamsHierarchyLinksResponseLinks {
...
impl Default for TeamsHierarchyLinksResponseLinks {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for TeamsHierarchyLinksResponseLinks {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TeamsHierarchyLinksResponseLinksVisitor;
        impl<'a> Visitor<'a> for TeamsHierarchyLinksResponseLinksVisitor {
            type Value = TeamsHierarchyLinksResponseLinks;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = TeamsHierarchyLinksResponseLinks {
                    first,
                    last,
                    next,
                    prev,
        ...
        deserializer.deserialize_any(TeamsHierarchyLinksResponseLinksVisitor)
    }
}
