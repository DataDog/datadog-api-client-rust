...
pub struct IncidentGoogleMeetConfigurationRelationships {
...
impl IncidentGoogleMeetConfigurationRelationships {
    pub fn new() -> IncidentGoogleMeetConfigurationRelationships {
...
impl Default for IncidentGoogleMeetConfigurationRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentGoogleMeetConfigurationRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentGoogleMeetConfigurationRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentGoogleMeetConfigurationRelationshipsVisitor {
            type Value = IncidentGoogleMeetConfigurationRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentGoogleMeetConfigurationRelationships {
                    created_by_user,
                    incident_type,
                    last_modified_by_user,
        ...
        deserializer.deserialize_any(IncidentGoogleMeetConfigurationRelationshipsVisitor)
    }
}
