...
impl<'de> Deserialize<'de> for EntityResponseIncludedRelatedEntityAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EntityResponseIncludedRelatedEntityAttributesVisitor;
        impl<'a> Visitor<'a> for EntityResponseIncludedRelatedEntityAttributesVisitor {
            type Value = EntityResponseIncludedRelatedEntityAttributes;
        ...
        deserializer.deserialize_any(EntityResponseIncludedRelatedEntityAttributesVisitor)
    }
}
