...
pub struct ObservabilityPipelineOpenSearchDestinationDataStream {
...
impl ObservabilityPipelineOpenSearchDestinationDataStream {
    pub fn new() -> ObservabilityPipelineOpenSearchDestinationDataStream {
...
impl Default for ObservabilityPipelineOpenSearchDestinationDataStream {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ObservabilityPipelineOpenSearchDestinationDataStream {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineOpenSearchDestinationDataStreamVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineOpenSearchDestinationDataStreamVisitor {
            type Value = ObservabilityPipelineOpenSearchDestinationDataStream;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ObservabilityPipelineOpenSearchDestinationDataStream {
                    dataset,
                    dtype,
                    namespace,
        ...
        deserializer.deserialize_any(ObservabilityPipelineOpenSearchDestinationDataStreamVisitor)
    }
}
