...
impl<'de> Deserialize<'de> for RelationshipToSAMLAssertionAttributeData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RelationshipToSAMLAssertionAttributeDataVisitor;
        impl<'a> Visitor<'a> for RelationshipToSAMLAssertionAttributeDataVisitor {
            type Value = RelationshipToSAMLAssertionAttributeData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RelationshipToSAMLAssertionAttributeData {
                    id,
                    type_,
        ...
        deserializer.deserialize_any(RelationshipToSAMLAssertionAttributeDataVisitor)
    }
}
