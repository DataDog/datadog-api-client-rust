...
/// The definition of `ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems` object.
#[non_exhaustive]
#[skip_serializing_none]
#[derive(Clone, Debug, PartialEq, Serialize)]
pub struct ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems {
    /// The `items` `condition`.
...
impl ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems {
    pub fn new(
        condition: String,
        tag: String,
    ...
    for ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems
{
    ...
    where
        D: Deserializer<'de>,
    {
        struct ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItemsVisitor;
        impl<'a> Visitor<'a>
            for ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItemsVisitor
        {
            type Value = ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems;
        ...
        deserializer.deserialize_any(
            ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItemsVisitor,
        )
    }
}
