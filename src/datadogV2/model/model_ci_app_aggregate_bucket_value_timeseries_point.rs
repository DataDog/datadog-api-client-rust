...
impl<'de> Deserialize<'de> for CIAppAggregateBucketValueTimeseriesPoint {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppAggregateBucketValueTimeseriesPointVisitor;
        impl<'a> Visitor<'a> for CIAppAggregateBucketValueTimeseriesPointVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CIAppAggregateBucketValueTimeseriesPoint {
                    time,
                    value,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(CIAppAggregateBucketValueTimeseriesPointVisitor)
    }
}
