...
pub struct SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributes {
...
impl SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributes {
    pub fn new(
        domain: String,
...
impl<'de> Deserialize<'de>
    for SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributes
{
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributesVisitor;
        impl<'a> Visitor<'a>
            for SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributesVisitor
        {
        ...
        deserializer.deserialize_any(
            SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributesVisitor,
        )
    }
}
