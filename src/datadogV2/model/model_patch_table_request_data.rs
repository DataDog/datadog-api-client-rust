...
impl<'de> Deserialize<'de> for PatchTableRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PatchTableRequestDataVisitor;
        impl<'a> Visitor<'a> for PatchTableRequestDataVisitor {
            type Value = PatchTableRequestData;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::PatchTableRequestDataType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(PatchTableRequestDataVisitor)
    }
}
