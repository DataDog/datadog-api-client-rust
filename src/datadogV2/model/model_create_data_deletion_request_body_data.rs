...
pub struct CreateDataDeletionRequestBodyData {
...
impl<'de> Deserialize<'de> for CreateDataDeletionRequestBodyData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateDataDeletionRequestBodyDataVisitor;
        impl<'a> Visitor<'a> for CreateDataDeletionRequestBodyDataVisitor {
            type Value = CreateDataDeletionRequestBodyData;
        ...
        deserializer.deserialize_any(CreateDataDeletionRequestBodyDataVisitor)
    }
}
