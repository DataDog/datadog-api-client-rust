...
impl PersonalAccessTokenCreateAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for PersonalAccessTokenCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PersonalAccessTokenCreateAttributesVisitor;
        impl<'a> Visitor<'a> for PersonalAccessTokenCreateAttributesVisitor {
            type Value = PersonalAccessTokenCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = PersonalAccessTokenCreateAttributes {
                    expires_at,
                    name,
                    scopes,
        ...
        deserializer.deserialize_any(PersonalAccessTokenCreateAttributesVisitor)
    }
}
