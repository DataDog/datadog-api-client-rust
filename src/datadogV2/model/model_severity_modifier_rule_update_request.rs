...
impl<'de> Deserialize<'de> for SeverityModifierRuleUpdateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SeverityModifierRuleUpdateRequestVisitor;
        impl<'a> Visitor<'a> for SeverityModifierRuleUpdateRequestVisitor {
            type Value = SeverityModifierRuleUpdateRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SeverityModifierRuleUpdateRequest {
                    data,
        ...
        deserializer.deserialize_any(SeverityModifierRuleUpdateRequestVisitor)
    }
}
