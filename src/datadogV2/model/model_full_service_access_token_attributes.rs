...
pub struct FullServiceAccessTokenAttributes {
...
impl FullServiceAccessTokenAttributes {
    pub fn new() -> FullServiceAccessTokenAttributes {
...
impl Default for FullServiceAccessTokenAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FullServiceAccessTokenAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FullServiceAccessTokenAttributesVisitor;
        impl<'a> Visitor<'a> for FullServiceAccessTokenAttributesVisitor {
            type Value = FullServiceAccessTokenAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FullServiceAccessTokenAttributes {
                    created_at,
                    expires_at,
                    key,
                    name,
        ...
        deserializer.deserialize_any(FullServiceAccessTokenAttributesVisitor)
    }
}
