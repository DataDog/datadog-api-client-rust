...
pub struct AttachJiraIssueRequestDataRelationships {
...
impl AttachJiraIssueRequestDataRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for AttachJiraIssueRequestDataRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AttachJiraIssueRequestDataRelationshipsVisitor;
        impl<'a> Visitor<'a> for AttachJiraIssueRequestDataRelationshipsVisitor {
            type Value = AttachJiraIssueRequestDataRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AttachJiraIssueRequestDataRelationships {
                    findings,
                    project,
        ...
        deserializer.deserialize_any(AttachJiraIssueRequestDataRelationshipsVisitor)
    }
}
