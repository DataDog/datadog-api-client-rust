...
impl<'de> Deserialize<'de> for SecurityFilterCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityFilterCreateDataVisitor;
        impl<'a> Visitor<'a> for SecurityFilterCreateDataVisitor {
            type Value = SecurityFilterCreateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SecurityFilterCreateAttributes,
                > = None;
                ...
                let content = SecurityFilterCreateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(SecurityFilterCreateDataVisitor)
    }
}
