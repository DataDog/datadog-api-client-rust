...
pub struct DefaultInboxRuleAttributesResponse {
    /// The action to take when the inbox rule matches a finding.
    #[serde(rename = "action")]
    pub action: crate::datadogV2::model::InboxRuleAction,
...
impl DefaultInboxRuleAttributesResponse {
    pub fn new(
        action: crate::datadogV2::model::InboxRuleAction,
        created_at: i64,
...
impl<'de> Deserialize<'de> for DefaultInboxRuleAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DefaultInboxRuleAttributesResponseVisitor;
        impl<'a> Visitor<'a> for DefaultInboxRuleAttributesResponseVisitor {
            type Value = DefaultInboxRuleAttributesResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut action: Option<crate::datadogV2::model::InboxRuleAction> = None;
                ...
                let content = DefaultInboxRuleAttributesResponse {
                    action,
                    created_at,
                    created_by,
                    enabled,
        ...
        deserializer.deserialize_any(DefaultInboxRuleAttributesResponseVisitor)
    }
}
