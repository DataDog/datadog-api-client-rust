...
pub struct RUMResponseMetadata {
    ...
    #[serde(rename = "status")]
    pub status: Option<crate::datadogV2::model::RUMResponseStatus>,
    /// A list of warnings (non-fatal errors) encountered. Partial results may return if
    /// warnings are present in the response.
    #[serde(rename = "warnings")]
    pub warnings: Option<Vec<crate::datadogV2::model::RUMWarning>>,
    #[serde(skip)]
    #[serde(default)]
...
impl<'de> Deserialize<'de> for RUMResponseMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMResponseMetadataVisitor;
        impl<'a> Visitor<'a> for RUMResponseMetadataVisitor {
            type Value = RUMResponseMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut page: Option<crate::datadogV2::model::RUMResponsePage> = None;
                let mut request_id: Option<String> = None;
                let mut status: Option<crate::datadogV2::model::RUMResponseStatus> = None;
                let mut warnings: Option<Vec<crate::datadogV2::model::RUMWarning>> = None;
                    ...
                    match k.as_str() {
                        ...
                        "status" => {
                            ...
                            if let Some(ref _status) = status {
                                match _status {
                                    crate::datadogV2::model::RUMResponseStatus::UnparsedObject(
                                        _status,
                                    ) => {
                                        _unparsed = true;
                                    }
                ...
                let content = RUMResponseMetadata {
                    elapsed,
                    page,
                    request_id,
                    status,
        ...
        deserializer.deserialize_any(RUMResponseMetadataVisitor)
    }
}
