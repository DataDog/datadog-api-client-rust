...
impl SpansListRequestAttributes {
    ...
    pub fn with_page(&mut self, value: crate::datadogV2::model::SpansListRequestPage) -> &mut Self {
        self.page = Some(value);
        self
    }

    pub fn with_sort(&mut self, value: crate::datadogV2::model::SpansSort) -> &mut Self {
