...
impl<'de> Deserialize<'de> for MetricTagConfigurationUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MetricTagConfigurationUpdateDataVisitor;
        impl<'a> Visitor<'a> for MetricTagConfigurationUpdateDataVisitor {
            type Value = MetricTagConfigurationUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::MetricTagConfigurationUpdateAttributes,
                > = None;
                ...
                let content = MetricTagConfigurationUpdateData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(MetricTagConfigurationUpdateDataVisitor)
    }
}
