...
pub struct ApplicationSecurityPolicyRuleOverride {
    ...
    #[serde(rename = "extended_data_collection")]
    pub extended_data_collection: Option<bool>,
...
impl ApplicationSecurityPolicyRuleOverride {
    ...
    pub fn extended_data_collection(mut self, value: bool) -> Self {
        self.extended_data_collection = Some(value);
        self
    }
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for ApplicationSecurityPolicyRuleOverrideVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut extended_data_collection: Option<bool> = None;
