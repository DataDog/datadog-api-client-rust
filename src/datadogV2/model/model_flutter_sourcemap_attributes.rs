...
pub struct FlutterSourcemapAttributes {
...
impl FlutterSourcemapAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for FlutterSourcemapAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FlutterSourcemapAttributesVisitor;
        impl<'a> Visitor<'a> for FlutterSourcemapAttributesVisitor {
            type Value = FlutterSourcemapAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FlutterSourcemapAttributes {
                    arch,
                    created_at,
                    mapkind,
                    service,
        ...
        deserializer.deserialize_any(FlutterSourcemapAttributesVisitor)
    }
}
