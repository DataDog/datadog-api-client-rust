...
pub struct SecureEmbedUpdateResponseAttributes {
    /// Creation timestamp.
...
impl SecureEmbedUpdateResponseAttributes {
    pub fn new() -> SecureEmbedUpdateResponseAttributes {
...
impl Default for SecureEmbedUpdateResponseAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SecureEmbedUpdateResponseAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecureEmbedUpdateResponseAttributesVisitor;
        impl<'a> Visitor<'a> for SecureEmbedUpdateResponseAttributesVisitor {
            type Value = SecureEmbedUpdateResponseAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecureEmbedUpdateResponseAttributes {
                    created_at,
                    credential_suffix,
                    dashboard_id,
                    global_time,
        ...
        deserializer.deserialize_any(SecureEmbedUpdateResponseAttributesVisitor)
    }
}
