...
impl Degradation {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::DegradationData) -> Self {
...
impl<'de> Deserialize<'de> for Degradation {
    ...
    where
        D: Deserializer<'de>,
    {
        struct DegradationVisitor;
        impl<'a> Visitor<'a> for DegradationVisitor {
            type Value = Degradation;
        ...
        deserializer.deserialize_any(DegradationVisitor)
    }
}
