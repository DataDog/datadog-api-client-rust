...
pub struct RumMetricResponseCompute {
    ...
    pub aggregation_type: Option<crate::datadogV2::model::RumMetricResponseComputeAggregationType>,
...
impl RumMetricResponseCompute {
    ...
    pub fn aggregation_type(
        mut self,
        value: crate::datadogV2::model::RumMetricResponseComputeAggregationType,
    ) -> Self {
        ...
        impl<'a> Visitor<'a> for RumMetricResponseComputeVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut aggregation_type: Option<
                    crate::datadogV2::model::RumMetricResponseComputeAggregationType,
                > = None;
                        ...
                        "aggregation_type" => {
                            ...
                            if let Some(ref _aggregation_type) = aggregation_type {
                                match _aggregation_type {
                                    crate::datadogV2::model::RumMetricResponseComputeAggregationType::UnparsedObject(_aggregation_type) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
