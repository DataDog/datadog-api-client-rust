...
pub struct DeletedSuitesRequestDeleteAttributes {
...
impl DeletedSuitesRequestDeleteAttributes {
    pub fn new(public_ids: Vec<String>) -> DeletedSuitesRequestDeleteAttributes {
...
impl<'de> Deserialize<'de> for DeletedSuitesRequestDeleteAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DeletedSuitesRequestDeleteAttributesVisitor;
        impl<'a> Visitor<'a> for DeletedSuitesRequestDeleteAttributesVisitor {
            type Value = DeletedSuitesRequestDeleteAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DeletedSuitesRequestDeleteAttributes {
                    force_delete_dependencies,
                    public_ids,
        ...
        deserializer.deserialize_any(DeletedSuitesRequestDeleteAttributesVisitor)
    }
}
