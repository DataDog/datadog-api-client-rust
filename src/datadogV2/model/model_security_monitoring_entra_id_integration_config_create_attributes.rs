...
pub struct SecurityMonitoringEntraIdIntegrationConfigCreateAttributes {
...
impl SecurityMonitoringEntraIdIntegrationConfigCreateAttributes {
    pub fn new(
        domain: String,
...
impl<'de> Deserialize<'de> for SecurityMonitoringEntraIdIntegrationConfigCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringEntraIdIntegrationConfigCreateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringEntraIdIntegrationConfigCreateAttributesVisitor {
            type Value = SecurityMonitoringEntraIdIntegrationConfigCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringEntraIdIntegrationConfigCreateAttributes {
                    domain,
                    integration_type,
                    name,
                    settings,
        ...
        deserializer
            .deserialize_any(SecurityMonitoringEntraIdIntegrationConfigCreateAttributesVisitor)
    }
}
