...
impl<'de> Deserialize<'de> for LogsMetricUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsMetricUpdateDataVisitor;
        impl<'a> Visitor<'a> for LogsMetricUpdateDataVisitor {
            type Value = LogsMetricUpdateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::LogsMetricUpdateAttributes> =
                    None;
                ...
                let content = LogsMetricUpdateData {
                    attributes,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(LogsMetricUpdateDataVisitor)
    }
}
