...
impl<'de> Deserialize<'de> for RUMQueryPageOptions {
    ...
    where
        D: Deserializer<'de>,
    {
        struct RUMQueryPageOptionsVisitor;
        impl<'a> Visitor<'a> for RUMQueryPageOptionsVisitor {
            type Value = RUMQueryPageOptions;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RUMQueryPageOptions {
                    cursor,
                    limit,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(RUMQueryPageOptionsVisitor)
    }
}
