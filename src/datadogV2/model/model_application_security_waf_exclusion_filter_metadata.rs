...
pub struct ApplicationSecurityWafExclusionFilterMetadata {
...
impl ApplicationSecurityWafExclusionFilterMetadata {
    pub fn new() -> ApplicationSecurityWafExclusionFilterMetadata {
...
impl Default for ApplicationSecurityWafExclusionFilterMetadata {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ApplicationSecurityWafExclusionFilterMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ApplicationSecurityWafExclusionFilterMetadataVisitor;
        impl<'a> Visitor<'a> for ApplicationSecurityWafExclusionFilterMetadataVisitor {
            type Value = ApplicationSecurityWafExclusionFilterMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ApplicationSecurityWafExclusionFilterMetadata {
                    added_at,
                    added_by,
                    added_by_name,
                    modified_at,
        ...
        deserializer.deserialize_any(ApplicationSecurityWafExclusionFilterMetadataVisitor)
    }
}
