...
impl<'de> Deserialize<'de> for IncidentTypeAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTypeAttributesVisitor;
        impl<'a> Visitor<'a> for IncidentTypeAttributesVisitor {
            type Value = IncidentTypeAttributes;
        ...
        deserializer.deserialize_any(IncidentTypeAttributesVisitor)
    }
}
