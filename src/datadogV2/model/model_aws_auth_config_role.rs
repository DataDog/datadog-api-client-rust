...
impl AWSAuthConfigRole {
    pub fn new(role_name: String) -> AWSAuthConfigRole {
        AWSAuthConfigRole {
            external_id: None,
            role_name,
...
impl<'de> Deserialize<'de> for AWSAuthConfigRole {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSAuthConfigRoleVisitor;
        impl<'a> Visitor<'a> for AWSAuthConfigRoleVisitor {
            type Value = AWSAuthConfigRole;
        ...
        deserializer.deserialize_any(AWSAuthConfigRoleVisitor)
    }
}
