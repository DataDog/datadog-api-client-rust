...
impl<'de> Deserialize<'de> for RelationshipToIncidentIntegrationMetadataData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RelationshipToIncidentIntegrationMetadataDataVisitor;
        impl<'a> Visitor<'a> for RelationshipToIncidentIntegrationMetadataDataVisitor {
            type Value = RelationshipToIncidentIntegrationMetadataData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RelationshipToIncidentIntegrationMetadataData {
                    id,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(RelationshipToIncidentIntegrationMetadataDataVisitor)
    }
}
