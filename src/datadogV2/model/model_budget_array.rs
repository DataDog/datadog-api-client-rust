...
pub struct BudgetArray {
    ...
    #[serde(rename = "data")]
    pub data: Option<Vec<crate::datadogV2::model::Budget>>,
    #[serde(flatten)]
...
impl BudgetArray {
    ...
    pub fn data(mut self, value: Vec<crate::datadogV2::model::Budget>) -> Self {
