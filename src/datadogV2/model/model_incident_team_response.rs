...
impl<'de> Deserialize<'de> for IncidentTeamResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentTeamResponseVisitor;
        impl<'a> Visitor<'a> for IncidentTeamResponseVisitor {
            type Value = IncidentTeamResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::IncidentTeamResponseData> = None;
                ...
                let content = IncidentTeamResponse {
                    data,
                    included,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(IncidentTeamResponseVisitor)
    }
}
