...
pub struct DemVariantResponseData {
...
impl<'de> Deserialize<'de> for DemVariantResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DemVariantResponseDataVisitor;
        impl<'a> Visitor<'a> for DemVariantResponseDataVisitor {
            type Value = DemVariantResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DemVariantResponseData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(DemVariantResponseDataVisitor)
    }
}
