...
impl<'de> Deserialize<'de> for ServiceAccountCreateAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ServiceAccountCreateAttributesVisitor;
        impl<'a> Visitor<'a> for ServiceAccountCreateAttributesVisitor {
            type Value = ServiceAccountCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ServiceAccountCreateAttributes {
                    email,
                    name,
                    service_account,
                    title,
        ...
        deserializer.deserialize_any(ServiceAccountCreateAttributesVisitor)
    }
}
