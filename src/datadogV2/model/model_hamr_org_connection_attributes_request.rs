...
pub struct HamrOrgConnectionAttributesRequest {
...
impl HamrOrgConnectionAttributesRequest {
    pub fn new(
...
impl<'de> Deserialize<'de> for HamrOrgConnectionAttributesRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct HamrOrgConnectionAttributesRequestVisitor;
        impl<'a> Visitor<'a> for HamrOrgConnectionAttributesRequestVisitor {
            type Value = HamrOrgConnectionAttributesRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = HamrOrgConnectionAttributesRequest {
                    hamr_status,
                    is_primary,
                    modified_by,
                    target_org_datacenter,
        ...
        deserializer.deserialize_any(HamrOrgConnectionAttributesRequestVisitor)
    }
}
