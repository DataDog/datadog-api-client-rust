...
impl<'de> Deserialize<'de> for DowntimeMetaPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DowntimeMetaPageVisitor;
        impl<'a> Visitor<'a> for DowntimeMetaPageVisitor {
            type Value = DowntimeMetaPage;
        ...
        deserializer.deserialize_any(DowntimeMetaPageVisitor)
    }
}
