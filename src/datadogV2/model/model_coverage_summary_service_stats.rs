...
pub struct CoverageSummaryServiceStats {
...
impl CoverageSummaryServiceStats {
    pub fn new() -> CoverageSummaryServiceStats {
...
impl Default for CoverageSummaryServiceStats {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CoverageSummaryServiceStats {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CoverageSummaryServiceStatsVisitor;
        impl<'a> Visitor<'a> for CoverageSummaryServiceStatsVisitor {
            type Value = CoverageSummaryServiceStats;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CoverageSummaryServiceStats {
                    evaluated_flags_count,
                    evaluated_reports_count,
                    patch_coverage,
                    total_coverage,
        ...
        deserializer.deserialize_any(CoverageSummaryServiceStatsVisitor)
    }
}
