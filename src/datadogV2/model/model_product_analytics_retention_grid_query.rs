...
pub struct ProductAnalyticsRetentionGridQuery {
...
impl ProductAnalyticsRetentionGridQuery {
    pub fn new(
...
impl<'de> Deserialize<'de> for ProductAnalyticsRetentionGridQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsRetentionGridQueryVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsRetentionGridQueryVisitor {
            type Value = ProductAnalyticsRetentionGridQuery;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ProductAnalyticsRetentionGridQuery {
                    computation_scope,
                    compute,
                    group_by,
                    search,
        ...
        deserializer.deserialize_any(ProductAnalyticsRetentionGridQueryVisitor)
    }
}
