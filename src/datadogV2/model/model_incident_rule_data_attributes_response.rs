...
pub struct IncidentRuleDataAttributesResponse {
    ...
    pub condition_table_type: Option<i64>,
...
impl IncidentRuleDataAttributesResponse {
    ...
    pub fn condition_table_type(mut self, value: i64) -> Self {
    ...
    pub fn execution_type(mut self, value: i64) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for IncidentRuleDataAttributesResponseVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut execution_type: Option<i64> = None;
