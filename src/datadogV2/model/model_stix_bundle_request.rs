...
pub struct STIXBundleRequest {
    ...
    pub objects: Vec<crate::datadogV2::model::STIXIndicatorObject>,
...
impl STIXBundleRequest {
    pub fn new(
        id: String,
        objects: Vec<crate::datadogV2::model::STIXIndicatorObject>,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for STIXBundleRequestVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut objects: Option<Vec<crate::datadogV2::model::STIXIndicatorObject>> = None;
