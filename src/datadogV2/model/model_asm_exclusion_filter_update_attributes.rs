...
pub struct ASMExclusionFilterUpdateAttributes {
...
impl ASMExclusionFilterUpdateAttributes {
    pub fn new(
        description: String,
        enabled: bool,
        path_glob: String,
...
impl<'de> Deserialize<'de> for ASMExclusionFilterUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ASMExclusionFilterUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for ASMExclusionFilterUpdateAttributesVisitor {
            type Value = ASMExclusionFilterUpdateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ASMExclusionFilterUpdateAttributes {
                    description,
                    enabled,
                    ip_list,
                    parameters,
        ...
        deserializer.deserialize_any(ASMExclusionFilterUpdateAttributesVisitor)
    }
}
