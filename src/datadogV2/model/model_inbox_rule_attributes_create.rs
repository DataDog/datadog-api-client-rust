...
pub struct InboxRuleAttributesCreate {
...
impl InboxRuleAttributesCreate {
    pub fn new(
...
impl<'de> Deserialize<'de> for InboxRuleAttributesCreate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct InboxRuleAttributesCreateVisitor;
        impl<'a> Visitor<'a> for InboxRuleAttributesCreateVisitor {
            type Value = InboxRuleAttributesCreate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = InboxRuleAttributesCreate {
                    action,
                    enabled,
                    name,
                    rule,
        ...
        deserializer.deserialize_any(InboxRuleAttributesCreateVisitor)
    }
}
