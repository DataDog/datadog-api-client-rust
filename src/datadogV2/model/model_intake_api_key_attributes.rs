...
pub struct IntakeAPIKeyAttributes {
...
impl IntakeAPIKeyAttributes {
    pub fn new(api_key: String, org_id: i64) -> IntakeAPIKeyAttributes {
...
impl<'de> Deserialize<'de> for IntakeAPIKeyAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IntakeAPIKeyAttributesVisitor;
        impl<'a> Visitor<'a> for IntakeAPIKeyAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IntakeAPIKeyAttributes {
                    api_key,
                    org_id,
        ...
        deserializer.deserialize_any(IntakeAPIKeyAttributesVisitor)
    }
}
