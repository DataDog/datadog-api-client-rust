...
pub struct StatusPagesComponentDataAttributes {
    #[serde(rename = "components")]
    pub components:
        Option<Vec<crate::datadogV2::model::StatusPagesComponentDataAttributesComponentsItems>>,
...
impl StatusPagesComponentDataAttributes {
    pub fn new(
    ...
    pub fn components(
        mut self,
        value: Vec<crate::datadogV2::model::StatusPagesComponentDataAttributesComponentsItems>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for StatusPagesComponentDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct StatusPagesComponentDataAttributesVisitor;
        impl<'a> Visitor<'a> for StatusPagesComponentDataAttributesVisitor {
            type Value = StatusPagesComponentDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                let mut components: Option<
                    Vec<crate::datadogV2::model::StatusPagesComponentDataAttributesComponentsItems>,
                > = None;
                ...
                let content = StatusPagesComponentDataAttributes {
                    components,
                    created_at,
                    modified_at,
                    name,
        ...
        deserializer.deserialize_any(StatusPagesComponentDataAttributesVisitor)
    }
}
