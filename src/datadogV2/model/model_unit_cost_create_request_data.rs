...
pub struct UnitCostCreateRequestData {
...
impl UnitCostCreateRequestData {
    pub fn new(
...
impl<'de> Deserialize<'de> for UnitCostCreateRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UnitCostCreateRequestDataVisitor;
        impl<'a> Visitor<'a> for UnitCostCreateRequestDataVisitor {
            type Value = UnitCostCreateRequestData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UnitCostCreateRequestData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(UnitCostCreateRequestDataVisitor)
    }
}
