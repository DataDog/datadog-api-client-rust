...
pub struct TableRowResourceArray {
    /// The rows.
    #[serde(rename = "data")]
...
impl<'de> Deserialize<'de> for TableRowResourceArray {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TableRowResourceArrayVisitor;
        impl<'a> Visitor<'a> for TableRowResourceArrayVisitor {
            type Value = TableRowResourceArray;
        ...
        deserializer.deserialize_any(TableRowResourceArrayVisitor)
    }
}
