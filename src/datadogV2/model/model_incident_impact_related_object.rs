...
pub enum IncidentImpactRelatedObject {
    INCIDENT,
    CREATED_BY_USER,
...
impl ToString for IncidentImpactRelatedObject {
...
impl Serialize for IncidentImpactRelatedObject {
...
impl<'de> Deserialize<'de> for IncidentImpactRelatedObject {
