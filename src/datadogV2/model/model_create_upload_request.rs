...
impl CreateUploadRequest {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::CreateUploadRequestData) -> Self {
...
impl<'de> Deserialize<'de> for CreateUploadRequest {
    ...
    where
        D: Deserializer<'de>,
    {
        struct CreateUploadRequestVisitor;
        impl<'a> Visitor<'a> for CreateUploadRequestVisitor {
            type Value = CreateUploadRequest;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::CreateUploadRequestData> = None;
                ...
                let content = CreateUploadRequest {
                    data,
        ...
        deserializer.deserialize_any(CreateUploadRequestVisitor)
    }
}
