...
impl ContainerGroup {
    ...
    pub fn attributes(mut self, value: crate::datadogV2::model::ContainerGroupAttributes) -> Self {
...
impl<'de> Deserialize<'de> for ContainerGroup {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ContainerGroupVisitor;
        impl<'a> Visitor<'a> for ContainerGroupVisitor {
            type Value = ContainerGroup;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::ContainerGroupAttributes> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ContainerGroupType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(ContainerGroupVisitor)
    }
}
