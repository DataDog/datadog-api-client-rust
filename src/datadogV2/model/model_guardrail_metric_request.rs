...
pub struct GuardrailMetricRequest {
...
impl<'de> Deserialize<'de> for GuardrailMetricRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GuardrailMetricRequestVisitor;
        impl<'a> Visitor<'a> for GuardrailMetricRequestVisitor {
            type Value = GuardrailMetricRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = GuardrailMetricRequest {
                    metric_id,
                    trigger_action,
        ...
        deserializer.deserialize_any(GuardrailMetricRequestVisitor)
    }
}
