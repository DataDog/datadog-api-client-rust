...
pub struct ResolveVulnerableSymbolsResponseDataAttributes {
    ...
    pub results: Option<
        Vec<crate::datadogV2::model::ResolveVulnerableSymbolsResponseDataAttributesResultsItems>,
    >,
    #[serde(flatten)]
...
impl ResolveVulnerableSymbolsResponseDataAttributes {
    ...
    pub fn results(
        mut self,
        value: Vec<
            crate::datadogV2::model::ResolveVulnerableSymbolsResponseDataAttributesResultsItems,
        >,
    ) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for ResolveVulnerableSymbolsResponseDataAttributesVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut results: Option<Vec<crate::datadogV2::model::ResolveVulnerableSymbolsResponseDataAttributesResultsItems>> = None;
