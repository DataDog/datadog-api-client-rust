...
impl<'de> Deserialize<'de> for SensitiveDataScannerRuleUpdateResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerRuleUpdateResponseVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerRuleUpdateResponseVisitor {
            type Value = SensitiveDataScannerRuleUpdateResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerRuleUpdateResponse { meta, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(SensitiveDataScannerRuleUpdateResponseVisitor)
    }
}
