...
impl ScaRequestDataAttributesRelationsItems {
    pub fn new() -> ScaRequestDataAttributesRelationsItems {
...
impl Default for ScaRequestDataAttributesRelationsItems {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ScaRequestDataAttributesRelationsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ScaRequestDataAttributesRelationsItemsVisitor;
        impl<'a> Visitor<'a> for ScaRequestDataAttributesRelationsItemsVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ScaRequestDataAttributesRelationsItems {
                    depends_on,
                    ref_,
        ...
        deserializer.deserialize_any(ScaRequestDataAttributesRelationsItemsVisitor)
    }
}
