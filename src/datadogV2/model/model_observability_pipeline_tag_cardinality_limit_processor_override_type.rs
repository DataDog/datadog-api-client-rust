...
pub enum ObservabilityPipelineTagCardinalityLimitProcessorOverrideType {
    LIMIT_OVERRIDE,
    EXCLUDED,
...
impl<'de> Deserialize<'de> for ObservabilityPipelineTagCardinalityLimitProcessorOverrideType {
