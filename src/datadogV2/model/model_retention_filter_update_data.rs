...
impl<'de> Deserialize<'de> for RetentionFilterUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RetentionFilterUpdateDataVisitor;
        impl<'a> Visitor<'a> for RetentionFilterUpdateDataVisitor {
            type Value = RetentionFilterUpdateData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RetentionFilterUpdateData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(RetentionFilterUpdateDataVisitor)
    }
}
