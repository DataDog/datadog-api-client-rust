...
pub struct SyntheticsVariableParser {
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::SyntheticsGlobalVariableParserType,
...
impl SyntheticsVariableParser {
    pub fn new(
        type_: crate::datadogV2::model::SyntheticsGlobalVariableParserType,
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for SyntheticsVariableParserVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut type_: Option<crate::datadogV2::model::SyntheticsGlobalVariableParserType> =
                    None;
                    ...
                    match k.as_str() {
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::SyntheticsGlobalVariableParserType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
