...
impl<'de> Deserialize<'de> for IncidentResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentResponseDataVisitor;
        impl<'a> Visitor<'a> for IncidentResponseDataVisitor {
            type Value = IncidentResponseData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::IncidentResponseAttributes> =
                    None;
                let mut id: Option<String> = None;
                let mut relationships: Option<
                    crate::datadogV2::model::IncidentResponseRelationships,
                > = None;
                ...
                let content = IncidentResponseData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(IncidentResponseDataVisitor)
    }
}
