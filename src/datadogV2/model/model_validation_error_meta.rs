...
impl ValidationErrorMeta {
    pub fn new(message: String) -> ValidationErrorMeta {
        ValidationErrorMeta {
            field: None,
            id: None,
            message,
...
impl<'de> Deserialize<'de> for ValidationErrorMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ValidationErrorMetaVisitor;
        impl<'a> Visitor<'a> for ValidationErrorMetaVisitor {
            type Value = ValidationErrorMeta;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ValidationErrorMeta {
                    field,
                    id,
                    message,
        ...
        deserializer.deserialize_any(ValidationErrorMetaVisitor)
    }
}
