...
impl AsanaAccessToken {
    pub fn new(
        access_token: String,
        type_: crate::datadogV2::model::AsanaAccessTokenType,
    ) -> AsanaAccessToken {
        AsanaAccessToken {
            access_token,
            type_,
...
impl<'de> Deserialize<'de> for AsanaAccessToken {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AsanaAccessTokenVisitor;
        impl<'a> Visitor<'a> for AsanaAccessTokenVisitor {
            type Value = AsanaAccessToken;
        ...
        deserializer.deserialize_any(AsanaAccessTokenVisitor)
    }
}
