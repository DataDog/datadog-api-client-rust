...
pub struct LLMObsSpanToolResult {
...
impl LLMObsSpanToolResult {
    pub fn new() -> LLMObsSpanToolResult {
...
impl Default for LLMObsSpanToolResult {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for LLMObsSpanToolResult {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsSpanToolResultVisitor;
        impl<'a> Visitor<'a> for LLMObsSpanToolResultVisitor {
            type Value = LLMObsSpanToolResult;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LLMObsSpanToolResult {
                    name,
                    result,
                    tool_id,
                    type_,
        ...
        deserializer.deserialize_any(LLMObsSpanToolResultVisitor)
    }
}
