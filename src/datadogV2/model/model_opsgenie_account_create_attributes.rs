...
pub struct OpsgenieAccountCreateAttributes {
...
impl OpsgenieAccountCreateAttributes {
    pub fn new(
        api_key: String,
...
impl<'de> Deserialize<'de> for OpsgenieAccountCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OpsgenieAccountCreateAttributesVisitor;
        impl<'a> Visitor<'a> for OpsgenieAccountCreateAttributesVisitor {
            type Value = OpsgenieAccountCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OpsgenieAccountCreateAttributes {
                    api_key,
                    region,
        ...
        deserializer.deserialize_any(OpsgenieAccountCreateAttributesVisitor)
    }
}
