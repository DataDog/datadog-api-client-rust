...
pub struct MaintenanceArray {
    #[serde(rename = "data")]
    pub data: Vec<crate::datadogV2::model::MaintenanceData>,
...
impl MaintenanceArray {
    pub fn new(data: Vec<crate::datadogV2::model::MaintenanceData>) -> MaintenanceArray {
        MaintenanceArray {
            data,
            included: None,
            meta: None,
...
impl<'de> Deserialize<'de> for MaintenanceArray {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MaintenanceArrayVisitor;
        impl<'a> Visitor<'a> for MaintenanceArrayVisitor {
            type Value = MaintenanceArray;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::MaintenanceData>> = None;
        ...
        deserializer.deserialize_any(MaintenanceArrayVisitor)
    }
}
