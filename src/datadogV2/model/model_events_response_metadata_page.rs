...
impl<'de> Deserialize<'de> for EventsResponseMetadataPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EventsResponseMetadataPageVisitor;
        impl<'a> Visitor<'a> for EventsResponseMetadataPageVisitor {
            type Value = EventsResponseMetadataPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = EventsResponseMetadataPage { after, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(EventsResponseMetadataPageVisitor)
    }
}
