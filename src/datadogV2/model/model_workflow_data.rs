...
pub struct WorkflowData {
    ...
    pub attributes: crate::datadogV2::model::WorkflowDataAttributes,
...
impl WorkflowData {
    pub fn new(
        attributes: crate::datadogV2::model::WorkflowDataAttributes,
...
impl<'de> Deserialize<'de> for WorkflowData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct WorkflowDataVisitor;
        impl<'a> Visitor<'a> for WorkflowDataVisitor {
            type Value = WorkflowData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::WorkflowDataAttributes> = None;
        ...
        deserializer.deserialize_any(WorkflowDataVisitor)
    }
}
