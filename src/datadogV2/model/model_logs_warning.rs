...
impl<'de> Deserialize<'de> for LogsWarning {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsWarningVisitor;
        impl<'a> Visitor<'a> for LogsWarningVisitor {
            type Value = LogsWarning;
        ...
        deserializer.deserialize_any(LogsWarningVisitor)
    }
}
