...
pub struct IncidentConfigurationPatchDataAttributesRequest {
...
impl IncidentConfigurationPatchDataAttributesRequest {
    pub fn new() -> IncidentConfigurationPatchDataAttributesRequest {
...
impl Default for IncidentConfigurationPatchDataAttributesRequest {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentConfigurationPatchDataAttributesRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentConfigurationPatchDataAttributesRequestVisitor;
        impl<'a> Visitor<'a> for IncidentConfigurationPatchDataAttributesRequestVisitor {
            type Value = IncidentConfigurationPatchDataAttributesRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentConfigurationPatchDataAttributesRequest {
                    execute_integrations,
                    execute_notification_rules,
                    include_in_analytics,
                    include_in_search,
        ...
        deserializer.deserialize_any(IncidentConfigurationPatchDataAttributesRequestVisitor)
    }
}
