...
impl<'de> Deserialize<'de> for SensitiveDataScannerGroupUpdateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerGroupUpdateRequestVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerGroupUpdateRequestVisitor {
            type Value = SensitiveDataScannerGroupUpdateRequest;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SensitiveDataScannerGroupUpdate> =
                    None;
                ...
                let content = SensitiveDataScannerGroupUpdateRequest {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SensitiveDataScannerGroupUpdateRequestVisitor)
    }
}
