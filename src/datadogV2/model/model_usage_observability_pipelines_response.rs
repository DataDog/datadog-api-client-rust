...
impl<'de> Deserialize<'de> for UsageObservabilityPipelinesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UsageObservabilityPipelinesResponseVisitor;
        impl<'a> Visitor<'a> for UsageObservabilityPipelinesResponseVisitor {
            type Value = UsageObservabilityPipelinesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UsageObservabilityPipelinesResponse { data, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(UsageObservabilityPipelinesResponseVisitor)
    }
}
