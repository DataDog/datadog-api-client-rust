...
pub struct IncidentNotificationRuleRelationships {
    ...
    #[serde(rename = "notification_template")]
    pub notification_template:
        Option<crate::datadogV2::model::RelationshipToIncidentNotificationTemplate>,
    #[serde(flatten)]
...
impl IncidentNotificationRuleRelationships {
    pub fn new() -> IncidentNotificationRuleRelationships {
    ...
    pub fn notification_template(
        mut self,
        value: crate::datadogV2::model::RelationshipToIncidentNotificationTemplate,
    ) -> Self {
        self.notification_template = Some(value);
        self
    }
...
impl Default for IncidentNotificationRuleRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentNotificationRuleRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentNotificationRuleRelationshipsVisitor;
        impl<'a> Visitor<'a> for IncidentNotificationRuleRelationshipsVisitor {
            type Value = IncidentNotificationRuleRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut last_modified_by_user: Option<crate::datadogV2::model::RelationshipToUser> =
                    None;
                let mut notification_template: Option<
                    crate::datadogV2::model::RelationshipToIncidentNotificationTemplate,
                > = None;
                ...
                let content = IncidentNotificationRuleRelationships {
                    created_by_user,
                    incident_type,
                    last_modified_by_user,
                    notification_template,
        ...
        deserializer.deserialize_any(IncidentNotificationRuleRelationshipsVisitor)
    }
}
