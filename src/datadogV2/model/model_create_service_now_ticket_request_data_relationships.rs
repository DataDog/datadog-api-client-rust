...
pub struct CreateServiceNowTicketRequestDataRelationships {
...
impl CreateServiceNowTicketRequestDataRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for CreateServiceNowTicketRequestDataRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateServiceNowTicketRequestDataRelationshipsVisitor;
        impl<'a> Visitor<'a> for CreateServiceNowTicketRequestDataRelationshipsVisitor {
            type Value = CreateServiceNowTicketRequestDataRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateServiceNowTicketRequestDataRelationships {
                    findings,
                    project,
        ...
        deserializer.deserialize_any(CreateServiceNowTicketRequestDataRelationshipsVisitor)
    }
}
