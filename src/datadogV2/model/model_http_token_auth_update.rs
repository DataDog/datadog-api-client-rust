...
pub struct HTTPTokenAuthUpdate {
    ...
    pub url_parameters: Option<Vec<crate::datadogV2::model::UrlParamUpdate>>,
    #[serde(flatten)]
...
impl HTTPTokenAuthUpdate {
    pub fn new(type_: crate::datadogV2::model::HTTPTokenAuthType) -> HTTPTokenAuthUpdate {
        HTTPTokenAuthUpdate {
            body: None,
            headers: None,
            tokens: None,
    ...
    pub fn headers(mut self, value: Vec<crate::datadogV2::model::HTTPHeaderUpdate>) -> Self {
        self.headers = Some(value);
        self
    }

    pub fn tokens(mut self, value: Vec<crate::datadogV2::model::HTTPTokenUpdate>) -> Self {
        self.tokens = Some(value);
        self
    }

    pub fn url_parameters(mut self, value: Vec<crate::datadogV2::model::UrlParamUpdate>) -> Self {
...
impl<'de> Deserialize<'de> for HTTPTokenAuthUpdate {
    ...
    where
        D: Deserializer<'de>,
    {
        struct HTTPTokenAuthUpdateVisitor;
        impl<'a> Visitor<'a> for HTTPTokenAuthUpdateVisitor {
            type Value = HTTPTokenAuthUpdate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut headers: Option<Vec<crate::datadogV2::model::HTTPHeaderUpdate>> = None;
                let mut tokens: Option<Vec<crate::datadogV2::model::HTTPTokenUpdate>> = None;
                let mut type_: Option<crate::datadogV2::model::HTTPTokenAuthType> = None;
                let mut url_parameters: Option<Vec<crate::datadogV2::model::UrlParamUpdate>> = None;
                ...
                let content = HTTPTokenAuthUpdate {
                    body,
                    headers,
                    tokens,
                    type_,
        ...
        deserializer.deserialize_any(HTTPTokenAuthUpdateVisitor)
    }
}
