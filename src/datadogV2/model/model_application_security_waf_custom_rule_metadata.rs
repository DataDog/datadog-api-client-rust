...
pub struct ApplicationSecurityWafCustomRuleMetadata {
...
impl ApplicationSecurityWafCustomRuleMetadata {
    pub fn new() -> ApplicationSecurityWafCustomRuleMetadata {
...
impl Default for ApplicationSecurityWafCustomRuleMetadata {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ApplicationSecurityWafCustomRuleMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ApplicationSecurityWafCustomRuleMetadataVisitor;
        impl<'a> Visitor<'a> for ApplicationSecurityWafCustomRuleMetadataVisitor {
            type Value = ApplicationSecurityWafCustomRuleMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ApplicationSecurityWafCustomRuleMetadata {
                    added_at,
                    added_by,
                    added_by_name,
                    modified_at,
        ...
        deserializer.deserialize_any(ApplicationSecurityWafCustomRuleMetadataVisitor)
    }
}
