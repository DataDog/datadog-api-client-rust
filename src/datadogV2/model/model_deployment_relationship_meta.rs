...
pub struct DeploymentRelationshipMeta {
    /// The `meta` `created_at`.
...
impl DeploymentRelationshipMeta {
    pub fn new() -> DeploymentRelationshipMeta {
...
impl Default for DeploymentRelationshipMeta {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for DeploymentRelationshipMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DeploymentRelationshipMetaVisitor;
        impl<'a> Visitor<'a> for DeploymentRelationshipMetaVisitor {
            type Value = DeploymentRelationshipMeta;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DeploymentRelationshipMeta {
                    created_at,
                    user_id,
                    user_name,
                    user_uuid,
        ...
        deserializer.deserialize_any(DeploymentRelationshipMetaVisitor)
    }
}
