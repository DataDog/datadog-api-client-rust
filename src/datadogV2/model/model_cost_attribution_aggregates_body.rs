...
impl<'de> Deserialize<'de> for CostAttributionAggregatesBody {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CostAttributionAggregatesBodyVisitor;
        impl<'a> Visitor<'a> for CostAttributionAggregatesBodyVisitor {
            type Value = CostAttributionAggregatesBody;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CostAttributionAggregatesBody {
                    agg_type,
                    field,
                    value,
                    _unparsed,
        ...
        deserializer.deserialize_any(CostAttributionAggregatesBodyVisitor)
    }
}
