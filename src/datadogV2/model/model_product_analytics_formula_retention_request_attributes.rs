...
pub struct ProductAnalyticsFormulaRetentionRequestAttributes {
    ...
    #[serde(rename = "query")]
    pub query: crate::datadogV2::model::ProductAnalyticsFormulaRetentionQuery,
...
impl ProductAnalyticsFormulaRetentionRequestAttributes {
    pub fn new(
        from: i64,
        query: crate::datadogV2::model::ProductAnalyticsFormulaRetentionQuery,
        to: i64,
...
impl<'de> Deserialize<'de> for ProductAnalyticsFormulaRetentionRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsFormulaRetentionRequestAttributesVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsFormulaRetentionRequestAttributesVisitor {
            type Value = ProductAnalyticsFormulaRetentionRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut query: Option<
                    crate::datadogV2::model::ProductAnalyticsFormulaRetentionQuery,
                > = None;
                ...
                let content = ProductAnalyticsFormulaRetentionRequestAttributes {
                    exclude_anonymous_traffic,
                    from,
                    query,
                    to,
        ...
        deserializer.deserialize_any(ProductAnalyticsFormulaRetentionRequestAttributesVisitor)
    }
}
