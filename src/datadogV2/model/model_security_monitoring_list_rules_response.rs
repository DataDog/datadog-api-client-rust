...
impl<'de> Deserialize<'de> for SecurityMonitoringListRulesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringListRulesResponseVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringListRulesResponseVisitor {
            type Value = SecurityMonitoringListRulesResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::SecurityMonitoringRuleResponse>> =
                    None;
                ...
                let content = SecurityMonitoringListRulesResponse {
                    data,
                    meta,
        ...
        deserializer.deserialize_any(SecurityMonitoringListRulesResponseVisitor)
    }
}
