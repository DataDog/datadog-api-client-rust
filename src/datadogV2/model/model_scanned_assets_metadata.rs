...
pub struct ScannedAssetsMetadata {
    /// List of scanned assets metadata.
    #[serde(rename = "data")]
    pub data: Vec<crate::datadogV2::model::ScannedAssetMetadata>,
...
impl ScannedAssetsMetadata {
    pub fn new(data: Vec<crate::datadogV2::model::ScannedAssetMetadata>) -> ScannedAssetsMetadata {
...
impl<'de> Deserialize<'de> for ScannedAssetsMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ScannedAssetsMetadataVisitor;
        impl<'a> Visitor<'a> for ScannedAssetsMetadataVisitor {
            type Value = ScannedAssetsMetadata;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::ScannedAssetMetadata>> = None;
                ...
                let content = ScannedAssetsMetadata {
                    data,
                    links,
                    meta,
        ...
        deserializer.deserialize_any(ScannedAssetsMetadataVisitor)
    }
}
