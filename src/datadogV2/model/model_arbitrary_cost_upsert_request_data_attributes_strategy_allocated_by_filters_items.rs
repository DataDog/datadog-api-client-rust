...
pub struct ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems {
    /// The `items` `condition`.
...
impl ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems {
    pub fn new(
        condition: String,
        tag: String,
...
impl<'de> Deserialize<'de>
    for ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems
{
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItemsVisitor;
        impl<'a> Visitor<'a>
            for ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItemsVisitor
        {
            type Value = ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems;
        ...
        deserializer.deserialize_any(
            ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItemsVisitor,
        )
    }
}
