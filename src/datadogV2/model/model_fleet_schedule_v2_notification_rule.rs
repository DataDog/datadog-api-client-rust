...
pub struct FleetScheduleV2NotificationRule {
...
impl FleetScheduleV2NotificationRule {
    pub fn new() -> FleetScheduleV2NotificationRule {
    ...
    pub fn handles(mut self, value: Vec<String>) -> Self {
...
impl Default for FleetScheduleV2NotificationRule {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FleetScheduleV2NotificationRule {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetScheduleV2NotificationRuleVisitor;
        impl<'a> Visitor<'a> for FleetScheduleV2NotificationRuleVisitor {
            type Value = FleetScheduleV2NotificationRule;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FleetScheduleV2NotificationRule {
                    handles,
                    tags,
        ...
        deserializer.deserialize_any(FleetScheduleV2NotificationRuleVisitor)
    }
}
