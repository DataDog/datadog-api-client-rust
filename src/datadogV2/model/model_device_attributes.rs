...
pub struct DeviceAttributes {
    ...
    #[serde(rename = "interface_statuses")]
    pub interface_statuses: Option<crate::datadogV2::model::DeviceAttributesInterfaceStatuses>,
...
impl DeviceAttributes {
    ...
    pub fn interface_statuses(
        mut self,
        value: crate::datadogV2::model::DeviceAttributesInterfaceStatuses,
    ) -> Self {
        self.interface_statuses = Some(value);
        self
    }
...
impl<'de> Deserialize<'de> for DeviceAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct DeviceAttributesVisitor;
        impl<'a> Visitor<'a> for DeviceAttributesVisitor {
            type Value = DeviceAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut interface_statuses: Option<
                    crate::datadogV2::model::DeviceAttributesInterfaceStatuses,
                > = None;
        ...
        deserializer.deserialize_any(DeviceAttributesVisitor)
    }
}
