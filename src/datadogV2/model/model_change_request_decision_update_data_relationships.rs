...
pub struct ChangeRequestDecisionUpdateDataRelationships {
...
impl ChangeRequestDecisionUpdateDataRelationships {
    pub fn new(
...
impl<'de> Deserialize<'de> for ChangeRequestDecisionUpdateDataRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ChangeRequestDecisionUpdateDataRelationshipsVisitor;
        impl<'a> Visitor<'a> for ChangeRequestDecisionUpdateDataRelationshipsVisitor {
            type Value = ChangeRequestDecisionUpdateDataRelationships;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ChangeRequestDecisionUpdateDataRelationships {
                    change_request_decisions,
        ...
        deserializer.deserialize_any(ChangeRequestDecisionUpdateDataRelationshipsVisitor)
    }
}
