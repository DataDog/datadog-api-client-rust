...
pub struct CreateTableRequestDataAttributesSchemaFieldsItems {
    /// The field name.
    #[serde(rename = "name")]
    pub name: String,
...
impl CreateTableRequestDataAttributesSchemaFieldsItems {
    pub fn new(
        name: String,
...
impl<'de> Deserialize<'de> for CreateTableRequestDataAttributesSchemaFieldsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateTableRequestDataAttributesSchemaFieldsItemsVisitor;
        impl<'a> Visitor<'a> for CreateTableRequestDataAttributesSchemaFieldsItemsVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateTableRequestDataAttributesSchemaFieldsItems {
                    name,
                    type_,
        ...
        deserializer.deserialize_any(CreateTableRequestDataAttributesSchemaFieldsItemsVisitor)
    }
}
