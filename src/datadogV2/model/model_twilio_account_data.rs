...
pub struct TwilioAccountData {
    ...
    pub attributes: crate::datadogV2::model::TwilioAccountAttributes,
...
impl TwilioAccountData {
    pub fn new(
        attributes: crate::datadogV2::model::TwilioAccountAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for TwilioAccountData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TwilioAccountDataVisitor;
        impl<'a> Visitor<'a> for TwilioAccountDataVisitor {
            type Value = TwilioAccountData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::TwilioAccountAttributes> = None;
        ...
        deserializer.deserialize_any(TwilioAccountDataVisitor)
    }
}
