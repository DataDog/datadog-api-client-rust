...
pub struct DeploymentGateRulesResponse {
    ...
    #[serde(rename = "data")]
    pub data: Option<crate::datadogV2::model::ListDeploymentRuleResponseData>,
    #[serde(flatten)]
...
impl DeploymentGateRulesResponse {
    ...
    pub fn data(mut self, value: crate::datadogV2::model::ListDeploymentRuleResponseData) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for DeploymentGateRulesResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::ListDeploymentRuleResponseData> =
                    None;
