...
pub struct AiMemoryViolationResultResponseAttributes {
...
impl AiMemoryViolationResultResponseAttributes {
    pub fn new(
...
impl<'de> Deserialize<'de> for AiMemoryViolationResultResponseAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AiMemoryViolationResultResponseAttributesVisitor;
        impl<'a> Visitor<'a> for AiMemoryViolationResultResponseAttributesVisitor {
            type Value = AiMemoryViolationResultResponseAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AiMemoryViolationResultResponseAttributes {
                    created_at,
                    created_by,
                    line,
                    message,
        ...
        deserializer.deserialize_any(AiMemoryViolationResultResponseAttributesVisitor)
    }
}
