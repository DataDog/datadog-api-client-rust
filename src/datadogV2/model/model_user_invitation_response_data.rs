...
impl UserInvitationResponseData {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::UserInvitationsType) -> Self {
...
impl<'de> Deserialize<'de> for UserInvitationResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UserInvitationResponseDataVisitor;
        impl<'a> Visitor<'a> for UserInvitationResponseDataVisitor {
            type Value = UserInvitationResponseData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::UserInvitationDataAttributes> =
                    None;
                ...
                let content = UserInvitationResponseData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(UserInvitationResponseDataVisitor)
    }
}
