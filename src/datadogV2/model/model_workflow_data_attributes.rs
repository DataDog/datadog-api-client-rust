...
pub struct WorkflowDataAttributes {
    ...
    #[serde(rename = "name")]
    pub name: String,
    /// Set the workflow to published or unpublished. If published this allows the workflow to be automatically triggered.
    ...
    /// Secret of the workflow. A secret must be set to trigger a workflow using a Webhook.
