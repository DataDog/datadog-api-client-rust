...
pub struct InboxRuleAttributesResponse {
...
impl InboxRuleAttributesResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for InboxRuleAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct InboxRuleAttributesResponseVisitor;
        impl<'a> Visitor<'a> for InboxRuleAttributesResponseVisitor {
            type Value = InboxRuleAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = InboxRuleAttributesResponse {
                    action,
                    created_at,
                    created_by,
                    enabled,
        ...
        deserializer.deserialize_any(InboxRuleAttributesResponseVisitor)
    }
}
