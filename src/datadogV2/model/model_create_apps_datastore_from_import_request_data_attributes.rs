...
pub struct CreateAppsDatastoreFromImportRequestDataAttributes {
    ...
    pub primary_key_generation_strategy: Option<crate::datadogV2::model::CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy>,
...
impl CreateAppsDatastoreFromImportRequestDataAttributes {
    pub fn new(
        name: String,
    ...
    pub fn primary_key_generation_strategy(
        mut self,
        value: crate::datadogV2::model::CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy,
    ) -> Self {
...
impl<'de> Deserialize<'de> for CreateAppsDatastoreFromImportRequestDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateAppsDatastoreFromImportRequestDataAttributesVisitor;
        impl<'a> Visitor<'a> for CreateAppsDatastoreFromImportRequestDataAttributesVisitor {
            type Value = CreateAppsDatastoreFromImportRequestDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut primary_key_generation_strategy: Option<crate::datadogV2::model::CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy> = None;
                        ...
                        "primary_key_generation_strategy" => {
                                ...
                                primary_key_generation_strategy
                            {
                                match _primary_key_generation_strategy {
                                    crate::datadogV2::model::CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy::UnparsedObject(_primary_key_generation_strategy) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = CreateAppsDatastoreFromImportRequestDataAttributes {
                    description,
                    name,
                    org_access,
                    primary_column_name,
        ...
        deserializer.deserialize_any(CreateAppsDatastoreFromImportRequestDataAttributesVisitor)
    }
}
