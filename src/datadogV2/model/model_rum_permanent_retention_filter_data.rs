...
pub struct RumPermanentRetentionFilterData {
    ...
    #[serde(rename = "meta")]
    pub meta: Option<crate::datadogV2::model::RumPermanentRetentionFilterMeta>,
...
impl RumPermanentRetentionFilterData {
    ...
    pub fn meta(mut self, value: crate::datadogV2::model::RumPermanentRetentionFilterMeta) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for RumPermanentRetentionFilterDataVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut meta: Option<crate::datadogV2::model::RumPermanentRetentionFilterMeta> =
                    None;
