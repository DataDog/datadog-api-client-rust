...
impl<'de> Deserialize<'de> for UpdateAppResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateAppResponseDataVisitor;
        impl<'a> Visitor<'a> for UpdateAppResponseDataVisitor {
            type Value = UpdateAppResponseData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UpdateAppResponseData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(UpdateAppResponseDataVisitor)
    }
}
