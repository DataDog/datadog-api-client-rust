...
pub struct Pipeline {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::PipelineData,
    #[serde(flatten)]
...
impl Pipeline {
    pub fn new(data: crate::datadogV2::model::PipelineData) -> Pipeline {
        Pipeline {
            data,
...
impl<'de> Deserialize<'de> for Pipeline {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for PipelineVisitor {
            type Value = Pipeline;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::PipelineData> = None;
