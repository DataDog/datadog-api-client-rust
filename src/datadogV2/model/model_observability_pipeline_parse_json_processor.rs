...
impl ObservabilityPipelineParseJSONProcessor {
    pub fn new(
        field: String,
        id: String,
        include: String,
...
impl<'de> Deserialize<'de> for ObservabilityPipelineParseJSONProcessor {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineParseJSONProcessorVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineParseJSONProcessorVisitor {
            type Value = ObservabilityPipelineParseJSONProcessor;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<
                    crate::datadogV2::model::ObservabilityPipelineParseJSONProcessorType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ObservabilityPipelineParseJSONProcessorType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ObservabilityPipelineParseJSONProcessorVisitor)
    }
}
