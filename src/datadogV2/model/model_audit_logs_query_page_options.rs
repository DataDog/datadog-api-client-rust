...
impl<'de> Deserialize<'de> for AuditLogsQueryPageOptions {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AuditLogsQueryPageOptionsVisitor;
        impl<'a> Visitor<'a> for AuditLogsQueryPageOptionsVisitor {
            type Value = AuditLogsQueryPageOptions;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AuditLogsQueryPageOptions {
                    cursor,
                    limit,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(AuditLogsQueryPageOptionsVisitor)
    }
}
