...
pub struct FleetAgentInfoDetails {
...
impl FleetAgentInfoDetails {
    pub fn new() -> FleetAgentInfoDetails {
...
impl Default for FleetAgentInfoDetails {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for FleetAgentInfoDetails {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FleetAgentInfoDetailsVisitor;
        impl<'a> Visitor<'a> for FleetAgentInfoDetailsVisitor {
            type Value = FleetAgentInfoDetails;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = FleetAgentInfoDetails {
                    agent_version,
                    api_key_name,
                    api_key_uuid,
                    cloud_provider,
        ...
        deserializer.deserialize_any(FleetAgentInfoDetailsVisitor)
    }
}
