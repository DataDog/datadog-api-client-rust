...
pub struct DemInferredJourneyIgnoredAttributes {
    ...
    #[serde(rename = "ignored_at")]
    pub ignored_at: chrono::DateTime<chrono::Utc>,
...
impl DemInferredJourneyIgnoredAttributes {
    pub fn new(
        created_at: chrono::DateTime<chrono::Utc>,
        ignored_at: chrono::DateTime<chrono::Utc>,
...
impl<'de> Deserialize<'de> for DemInferredJourneyIgnoredAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DemInferredJourneyIgnoredAttributesVisitor;
        impl<'a> Visitor<'a> for DemInferredJourneyIgnoredAttributesVisitor {
            type Value = DemInferredJourneyIgnoredAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut ignored_at: Option<chrono::DateTime<chrono::Utc>> = None;
                ...
                while let Some((k, v)) = map.next_entry::<String, serde_json::Value>()? {
                    match k.as_str() {
                        ...
                        "ignored_at" => {
                            ignored_at = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        }
                        "journey_rum" => {
                            journey_rum =
                                Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                ...
                let ignored_at = ignored_at.ok_or_else(|| M::Error::missing_field("ignored_at"))?;
                let journey_rum =
                ...
                let content = DemInferredJourneyIgnoredAttributes {
                    created_at,
                    description,
                    ignored_at,
                    journey_rum,
        ...
        deserializer.deserialize_any(DemInferredJourneyIgnoredAttributesVisitor)
    }
}
