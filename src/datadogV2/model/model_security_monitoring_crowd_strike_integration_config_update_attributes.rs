...
pub struct SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes {
    ...
    pub integration_type: crate::datadogV2::model::SecurityMonitoringIntegrationTypeCrowdStrike,
    ...
    pub secrets:
        Option<crate::datadogV2::model::SecurityMonitoringIntegrationConfigCrowdStrikeSecrets>,
...
impl SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes {
    pub fn new(
    ...
    pub fn secrets(
        mut self,
        value: crate::datadogV2::model::SecurityMonitoringIntegrationConfigCrowdStrikeSecrets,
    ) -> Self {
...
impl<'de> Deserialize<'de> for SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributesVisitor {
            type Value = SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut integration_type: Option<
                    crate::datadogV2::model::SecurityMonitoringIntegrationTypeCrowdStrike,
                > = None;
                let mut name: Option<String> = None;
                let mut secrets: Option<
                    crate::datadogV2::model::SecurityMonitoringIntegrationConfigCrowdStrikeSecrets,
                > = None;
                        ...
                        "integration_type" => {
                            ...
                            if let Some(ref _integration_type) = integration_type {
                                match _integration_type {
                                    crate::datadogV2::model::SecurityMonitoringIntegrationTypeCrowdStrike::UnparsedObject(_integration_type) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes {
                    domain,
                    enabled,
                    integration_type,
                    name,
        ...
        deserializer
            .deserialize_any(SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributesVisitor)
    }
}
