...
impl Serialize for AzureUCConfigPatchRequestType {
...
impl<'de> Deserialize<'de> for AzureUCConfigPatchRequestType {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match s.as_str() {
            "azure_uc_config_patch_request" => Self::AZURE_UC_CONFIG_PATCH_REQUEST,
            _ => {
