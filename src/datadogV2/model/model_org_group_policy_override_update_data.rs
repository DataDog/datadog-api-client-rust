...
impl OrgGroupPolicyOverrideUpdateData {
    pub fn new(
        attributes: crate::datadogV2::model::OrgGroupPolicyOverrideUpdateAttributes,
        id: uuid::Uuid,
...
impl<'de> Deserialize<'de> for OrgGroupPolicyOverrideUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPolicyOverrideUpdateDataVisitor;
        impl<'a> Visitor<'a> for OrgGroupPolicyOverrideUpdateDataVisitor {
            type Value = OrgGroupPolicyOverrideUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::OrgGroupPolicyOverrideUpdateAttributes,
                > = None;
                ...
                let content = OrgGroupPolicyOverrideUpdateData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(OrgGroupPolicyOverrideUpdateDataVisitor)
    }
}
