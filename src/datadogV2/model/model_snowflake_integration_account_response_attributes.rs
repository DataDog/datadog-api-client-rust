...
pub struct SnowflakeIntegrationAccountResponseAttributes {
    ...
    pub authentication:
        Option<crate::datadogV2::model::SnowflakeIntegrationAccountAuthenticationResponse>,
    /// Data Datadog collects from Snowflake, keyed by dataflow id.
    #[serde(rename = "dataflows")]
    pub dataflows: Option<crate::datadogV2::model::SnowflakeIntegrationDataflowsResponse>,
...
impl SnowflakeIntegrationAccountResponseAttributes {
    ...
    pub fn authentication(
        mut self,
        value: crate::datadogV2::model::SnowflakeIntegrationAccountAuthenticationResponse,
    ) -> Self {
    ...
    pub fn dataflows(
        mut self,
        value: crate::datadogV2::model::SnowflakeIntegrationDataflowsResponse,
    ) -> Self {
                        ...
                        "authentication" => {
                            ...
                            if let Some(ref _authentication) = authentication {
                                match _authentication {
                                    crate::datadogV2::model::SnowflakeIntegrationAccountAuthenticationResponse::UnparsedObject(_authentication) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
