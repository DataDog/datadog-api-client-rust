...
impl<'de> Deserialize<'de> for SecurityMonitoringSignal {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringSignalVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringSignalVisitor {
            type Value = SecurityMonitoringSignal;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SecurityMonitoringSignalAttributes,
                > = None;
                ...
                let content = SecurityMonitoringSignal {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(SecurityMonitoringSignalVisitor)
    }
}
