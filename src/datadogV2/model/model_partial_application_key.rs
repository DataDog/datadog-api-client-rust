...
impl<'de> Deserialize<'de> for PartialApplicationKey {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PartialApplicationKeyVisitor;
        impl<'a> Visitor<'a> for PartialApplicationKeyVisitor {
            type Value = PartialApplicationKey;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::PartialApplicationKeyAttributes,
                > = None;
                ...
                let content = PartialApplicationKey {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(PartialApplicationKeyVisitor)
    }
}
