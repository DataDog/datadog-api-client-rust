...
pub struct TwilioIntegrationAccountResponse {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::TwilioIntegrationAccountResponseData,
    #[serde(flatten)]
...
impl TwilioIntegrationAccountResponse {
    pub fn new(
        data: crate::datadogV2::model::TwilioIntegrationAccountResponseData,
...
impl<'de> Deserialize<'de> for TwilioIntegrationAccountResponse {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for TwilioIntegrationAccountResponseVisitor {
            ...
            {
                let mut data: Option<
                    crate::datadogV2::model::TwilioIntegrationAccountResponseData,
                > = None;
