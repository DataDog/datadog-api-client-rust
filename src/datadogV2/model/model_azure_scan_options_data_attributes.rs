...
impl Default for AzureScanOptionsDataAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for AzureScanOptionsDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AzureScanOptionsDataAttributesVisitor;
        impl<'a> Visitor<'a> for AzureScanOptionsDataAttributesVisitor {
            type Value = AzureScanOptionsDataAttributes;
        ...
        deserializer.deserialize_any(AzureScanOptionsDataAttributesVisitor)
    }
}
