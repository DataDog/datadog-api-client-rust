...
pub struct ApplicationSecurityPolicyListResponse {
    /// The WAF policy data.
    #[serde(rename = "data")]
    pub data: Option<Vec<crate::datadogV2::model::ApplicationSecurityPolicyData>>,
    #[serde(flatten)]
...
impl ApplicationSecurityPolicyListResponse {
    ...
    pub fn data(
        mut self,
        value: Vec<crate::datadogV2::model::ApplicationSecurityPolicyData>,
    ) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for ApplicationSecurityPolicyListResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::ApplicationSecurityPolicyData>> =
                    None;
