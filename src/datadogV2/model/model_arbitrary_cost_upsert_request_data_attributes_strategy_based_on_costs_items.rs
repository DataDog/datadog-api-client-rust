...
pub struct ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItems {
    /// The `items` `condition`.
...
impl ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItems {
    pub fn new(
        condition: String,
        tag: String,
...
impl<'de> Deserialize<'de> for ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItemsVisitor;
        impl<'a> Visitor<'a> for ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItemsVisitor {
            type Value = ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItems {
                    condition,
                    tag,
                    value,
                    values,
        ...
        deserializer.deserialize_any(
            ArbitraryCostUpsertRequestDataAttributesStrategyBasedOnCostsItemsVisitor,
        )
    }
}
