...
pub struct ArbitraryRuleResponseDataAttributesCostsToAllocateItems {
    /// The `items` `condition`.
...
impl ArbitraryRuleResponseDataAttributesCostsToAllocateItems {
    pub fn new(
        condition: String,
        tag: String,
...
impl<'de> Deserialize<'de> for ArbitraryRuleResponseDataAttributesCostsToAllocateItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ArbitraryRuleResponseDataAttributesCostsToAllocateItemsVisitor;
        impl<'a> Visitor<'a> for ArbitraryRuleResponseDataAttributesCostsToAllocateItemsVisitor {
            type Value = ArbitraryRuleResponseDataAttributesCostsToAllocateItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ArbitraryRuleResponseDataAttributesCostsToAllocateItems {
                    condition,
                    tag,
                    value,
                    values,
        ...
        deserializer.deserialize_any(ArbitraryRuleResponseDataAttributesCostsToAllocateItemsVisitor)
    }
}
