...
pub struct AWSCCMConfig {
    ...
    pub data_export_configs: Option<Vec<crate::datadogV2::model::DataExportConfig>>,
    #[serde(flatten)]
...
impl AWSCCMConfig {
    pub fn new() -> AWSCCMConfig {
        AWSCCMConfig {
            data_export_configs: None,
            additional_properties: std::collections::BTreeMap::new(),
            _unparsed: false,
        }
    }

    pub fn data_export_configs(
        mut self,
        value: Vec<crate::datadogV2::model::DataExportConfig>,
    ) -> Self {
        self.data_export_configs = Some(value);
        self
    }
