...
pub struct AggregatedSignalsProblemsRequestAttributes {
...
impl AggregatedSignalsProblemsRequestAttributes {
    pub fn new(
    ...
    pub fn detection_types(mut self, value: Vec<String>) -> Self {
        self.detection_types = Some(value);
        self
    }
...
impl<'de> Deserialize<'de> for AggregatedSignalsProblemsRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AggregatedSignalsProblemsRequestAttributesVisitor;
        impl<'a> Visitor<'a> for AggregatedSignalsProblemsRequestAttributesVisitor {
            type Value = AggregatedSignalsProblemsRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                > = None;
                let mut detection_types: Option<Vec<String>> = None;
                ...
                let content = AggregatedSignalsProblemsRequestAttributes {
                    application_id,
                    criteria,
                    detection_types,
                    filter,
        ...
        deserializer.deserialize_any(AggregatedSignalsProblemsRequestAttributesVisitor)
    }
}
