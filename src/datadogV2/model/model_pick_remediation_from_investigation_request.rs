...
pub struct PickRemediationFromInvestigationRequest {
    ...
    #[serde(rename = "number_of_keyword_variants")]
    pub number_of_keyword_variants: Option<i64>,
...
impl PickRemediationFromInvestigationRequest {
    pub fn new(
        investigation: String,
        number_of_relevant_actions: i64,
    ) -> PickRemediationFromInvestigationRequest {
        PickRemediationFromInvestigationRequest {
            client: None,
            integrations: None,
            investigation,
            number_of_keyword_variants: None,
    ...
    pub fn number_of_keyword_variants(mut self, value: i64) -> Self {
        self.number_of_keyword_variants = Some(value);
        self
    }
...
impl<'de> Deserialize<'de> for PickRemediationFromInvestigationRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PickRemediationFromInvestigationRequestVisitor;
        impl<'a> Visitor<'a> for PickRemediationFromInvestigationRequestVisitor {
            type Value = PickRemediationFromInvestigationRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut number_of_keyword_variants: Option<i64> = None;
        ...
        deserializer.deserialize_any(PickRemediationFromInvestigationRequestVisitor)
    }
}
