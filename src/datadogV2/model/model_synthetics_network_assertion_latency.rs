...
pub struct SyntheticsNetworkAssertionLatency {
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::SyntheticsNetworkAssertionLatencyType,
    #[serde(flatten)]
...
impl SyntheticsNetworkAssertionLatency {
    pub fn new(
        ...
        target: f64,
        type_: crate::datadogV2::model::SyntheticsNetworkAssertionLatencyType,
...
impl<'de> Deserialize<'de> for SyntheticsNetworkAssertionLatency {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SyntheticsNetworkAssertionLatencyVisitor;
        impl<'a> Visitor<'a> for SyntheticsNetworkAssertionLatencyVisitor {
            type Value = SyntheticsNetworkAssertionLatency;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<
                    crate::datadogV2::model::SyntheticsNetworkAssertionLatencyType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::SyntheticsNetworkAssertionLatencyType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = SyntheticsNetworkAssertionLatency {
                    operator,
                    property,
                    target,
                    type_,
        ...
        deserializer.deserialize_any(SyntheticsNetworkAssertionLatencyVisitor)
    }
}
