...
impl<'de> Deserialize<'de> for AWSAccountUpdateRequestData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AWSAccountUpdateRequestDataVisitor;
        impl<'a> Visitor<'a> for AWSAccountUpdateRequestDataVisitor {
            type Value = AWSAccountUpdateRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::AWSAccountUpdateRequestAttributes,
                > = None;
                ...
                let content = AWSAccountUpdateRequestData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(AWSAccountUpdateRequestDataVisitor)
    }
}
