...
pub struct RevertCustomRuleRevisionRequestDataAttributes {
    ...
    #[serde(rename = "revert_to_revision_id")]
    pub revert_to_revision_id: Option<String>,
    #[serde(flatten)]
...
impl RevertCustomRuleRevisionRequestDataAttributes {
    pub fn new() -> RevertCustomRuleRevisionRequestDataAttributes {
        RevertCustomRuleRevisionRequestDataAttributes {
            ...
            revert_to_revision_id: None,
            additional_properties: std::collections::BTreeMap::new(),
            _unparsed: false,
        }
    }

    pub fn current_revision_id(mut self, value: String) -> Self {
        self.current_revision_id = Some(value);
        self
    }

    pub fn revert_to_revision_id(mut self, value: String) -> Self {
        self.revert_to_revision_id = Some(value);
        self
    }
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for RevertCustomRuleRevisionRequestDataAttributesVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut current_revision_id: Option<String> = None;
                let mut revert_to_revision_id: Option<String> = None;
