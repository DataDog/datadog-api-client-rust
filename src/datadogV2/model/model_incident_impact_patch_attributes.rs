...
pub struct IncidentImpactPatchAttributes {
...
impl IncidentImpactPatchAttributes {
    pub fn new() -> IncidentImpactPatchAttributes {
...
impl Default for IncidentImpactPatchAttributes {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentImpactPatchAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentImpactPatchAttributesVisitor;
        impl<'a> Visitor<'a> for IncidentImpactPatchAttributesVisitor {
            type Value = IncidentImpactPatchAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentImpactPatchAttributes {
                    description,
                    end_at,
                    fields,
                    start_at,
        ...
        deserializer.deserialize_any(IncidentImpactPatchAttributesVisitor)
    }
}
