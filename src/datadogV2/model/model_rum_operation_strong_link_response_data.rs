...
impl RUMOperationStrongLinkResponseData {
    pub fn new(
        attributes: crate::datadogV2::model::RUMOperationStrongLinkResponseAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for RUMOperationStrongLinkResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMOperationStrongLinkResponseDataVisitor;
        impl<'a> Visitor<'a> for RUMOperationStrongLinkResponseDataVisitor {
            type Value = RUMOperationStrongLinkResponseData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::RUMOperationStrongLinkResponseAttributes,
                > = None;
                ...
                let content = RUMOperationStrongLinkResponseData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(RUMOperationStrongLinkResponseDataVisitor)
    }
}
