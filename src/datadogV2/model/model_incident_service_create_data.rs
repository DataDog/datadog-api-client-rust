...
impl<'de> Deserialize<'de> for IncidentServiceCreateData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct IncidentServiceCreateDataVisitor;
        impl<'a> Visitor<'a> for IncidentServiceCreateDataVisitor {
            type Value = IncidentServiceCreateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::IncidentServiceCreateAttributes,
                > = None;
                ...
                let content = IncidentServiceCreateData {
                    attributes,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(IncidentServiceCreateDataVisitor)
    }
}
