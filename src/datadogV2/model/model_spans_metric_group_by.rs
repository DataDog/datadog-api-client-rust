...
impl<'de> Deserialize<'de> for SpansMetricGroupBy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansMetricGroupByVisitor;
        impl<'a> Visitor<'a> for SpansMetricGroupByVisitor {
            type Value = SpansMetricGroupBy;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SpansMetricGroupBy {
                    path,
                    tag_name,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SpansMetricGroupByVisitor)
    }
}
