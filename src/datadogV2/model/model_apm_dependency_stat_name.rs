...
pub enum ApmDependencyStatName {
    AVG_DURATION,
    AVG_ROOT_DURATION,
    AVG_SPANS_PER_TRACE,
    ERROR_RATE,
...
impl ToString for ApmDependencyStatName {
...
impl Serialize for ApmDependencyStatName {
...
impl<'de> Deserialize<'de> for ApmDependencyStatName {
