...
impl<'de> Deserialize<'de> for SpansWarning {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SpansWarningVisitor;
        impl<'a> Visitor<'a> for SpansWarningVisitor {
            type Value = SpansWarning;
        ...
        deserializer.deserialize_any(SpansWarningVisitor)
    }
}
