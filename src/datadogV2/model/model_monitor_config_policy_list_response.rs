...
impl<'de> Deserialize<'de> for MonitorConfigPolicyListResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonitorConfigPolicyListResponseVisitor;
        impl<'a> Visitor<'a> for MonitorConfigPolicyListResponseVisitor {
            type Value = MonitorConfigPolicyListResponse;
            ...
            {
                let mut data: Option<
                    Vec<crate::datadogV2::model::MonitorConfigPolicyResponseData>,
                > = None;
                ...
                let content = MonitorConfigPolicyListResponse { data, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(MonitorConfigPolicyListResponseVisitor)
    }
}
