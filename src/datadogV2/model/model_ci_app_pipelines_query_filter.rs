...
impl<'de> Deserialize<'de> for CIAppPipelinesQueryFilter {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppPipelinesQueryFilterVisitor;
        impl<'a> Visitor<'a> for CIAppPipelinesQueryFilterVisitor {
            type Value = CIAppPipelinesQueryFilter;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CIAppPipelinesQueryFilter {
                    from,
                    query,
                    to,
                    _unparsed,
        ...
        deserializer.deserialize_any(CIAppPipelinesQueryFilterVisitor)
    }
}
