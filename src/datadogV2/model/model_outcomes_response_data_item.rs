...
impl OutcomesResponseDataItem {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::OutcomeType) -> Self {
...
impl<'de> Deserialize<'de> for OutcomesResponseDataItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OutcomesResponseDataItemVisitor;
        impl<'a> Visitor<'a> for OutcomesResponseDataItemVisitor {
            type Value = OutcomesResponseDataItem;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::OutcomesBatchResponseAttributes,
                > = None;
                let mut id: Option<String> = None;
                let mut relationships: Option<crate::datadogV2::model::RuleOutcomeRelationships> =
                    None;
                let mut type_: Option<crate::datadogV2::model::OutcomeType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::OutcomeType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
                ...
                let content = OutcomesResponseDataItem {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(OutcomesResponseDataItemVisitor)
    }
}
