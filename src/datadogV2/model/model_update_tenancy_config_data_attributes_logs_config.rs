...
impl UpdateTenancyConfigDataAttributesLogsConfig {
    pub fn new() -> UpdateTenancyConfigDataAttributesLogsConfig {
...
impl Default for UpdateTenancyConfigDataAttributesLogsConfig {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for UpdateTenancyConfigDataAttributesLogsConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UpdateTenancyConfigDataAttributesLogsConfigVisitor;
        impl<'a> Visitor<'a> for UpdateTenancyConfigDataAttributesLogsConfigVisitor {
            type Value = UpdateTenancyConfigDataAttributesLogsConfig;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UpdateTenancyConfigDataAttributesLogsConfig {
                    compartment_tag_filters,
                    enabled,
                    enabled_services,
        ...
        deserializer.deserialize_any(UpdateTenancyConfigDataAttributesLogsConfigVisitor)
    }
}
