...
impl<'de> Deserialize<'de> for RUMBucketResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMBucketResponseVisitor;
        impl<'a> Visitor<'a> for RUMBucketResponseVisitor {
            type Value = RUMBucketResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut by: Option<std::collections::BTreeMap<String, String>> = None;
        ...
        deserializer.deserialize_any(RUMBucketResponseVisitor)
    }
}
