...
impl Default for AwsScanOptionsUpdateAttributes {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<'de> Deserialize<'de> for AwsScanOptionsUpdateAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AwsScanOptionsUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for AwsScanOptionsUpdateAttributesVisitor {
            type Value = AwsScanOptionsUpdateAttributes;
        ...
        deserializer.deserialize_any(AwsScanOptionsUpdateAttributesVisitor)
    }
}
