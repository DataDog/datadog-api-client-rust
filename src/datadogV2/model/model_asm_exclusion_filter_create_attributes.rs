...
pub struct ASMExclusionFilterCreateAttributes {
    ...
    pub rules_target: Option<Vec<crate::datadogV2::model::ASMExclusionFilterRulesTarget>>,
    /// The scope of the exclusion filter.
    #[serde(rename = "scope")]
    pub scope: Option<Vec<crate::datadogV2::model::ASMExclusionFilterScope>>,
    #[serde(flatten)]
...
impl ASMExclusionFilterCreateAttributes {
    pub fn new(
        description: String,
        enabled: bool,
        path_glob: String,
    ...
    pub fn rules_target(
        mut self,
        value: Vec<crate::datadogV2::model::ASMExclusionFilterRulesTarget>,
    ) -> Self {
        self.rules_target = Some(value);
        self
    }

    pub fn scope(mut self, value: Vec<crate::datadogV2::model::ASMExclusionFilterScope>) -> Self {
...
impl<'de> Deserialize<'de> for ASMExclusionFilterCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ASMExclusionFilterCreateAttributesVisitor;
        impl<'a> Visitor<'a> for ASMExclusionFilterCreateAttributesVisitor {
            type Value = ASMExclusionFilterCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut rules_target: Option<
                    Vec<crate::datadogV2::model::ASMExclusionFilterRulesTarget>,
                > = None;
                let mut scope: Option<Vec<crate::datadogV2::model::ASMExclusionFilterScope>> = None;
                ...
                let content = ASMExclusionFilterCreateAttributes {
                    description,
                    enabled,
                    ip_list,
                    parameters,
        ...
        deserializer.deserialize_any(ASMExclusionFilterCreateAttributesVisitor)
    }
}
