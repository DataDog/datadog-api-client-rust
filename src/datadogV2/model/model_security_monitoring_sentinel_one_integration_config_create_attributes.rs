...
pub struct SecurityMonitoringSentinelOneIntegrationConfigCreateAttributes {
    ...
    pub secrets: crate::datadogV2::model::SecurityMonitoringIntegrationConfigSentinelOneSecrets,
...
impl SecurityMonitoringSentinelOneIntegrationConfigCreateAttributes {
    pub fn new(
        domain: String,
...
impl<'de> Deserialize<'de> for SecurityMonitoringSentinelOneIntegrationConfigCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityMonitoringSentinelOneIntegrationConfigCreateAttributesVisitor;
        impl<'a> Visitor<'a> for SecurityMonitoringSentinelOneIntegrationConfigCreateAttributesVisitor {
            type Value = SecurityMonitoringSentinelOneIntegrationConfigCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SecurityMonitoringSentinelOneIntegrationConfigCreateAttributes {
                    domain,
                    integration_type,
                    name,
                    secrets,
        ...
        deserializer
            .deserialize_any(SecurityMonitoringSentinelOneIntegrationConfigCreateAttributesVisitor)
    }
}
