...
impl SeverityModifierRuleCreateRequest {
    pub fn new(
...
impl<'de> Deserialize<'de> for SeverityModifierRuleCreateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SeverityModifierRuleCreateRequestVisitor;
        impl<'a> Visitor<'a> for SeverityModifierRuleCreateRequestVisitor {
            type Value = SeverityModifierRuleCreateRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SeverityModifierRuleCreateRequest {
                    data,
        ...
        deserializer.deserialize_any(SeverityModifierRuleCreateRequestVisitor)
    }
}
