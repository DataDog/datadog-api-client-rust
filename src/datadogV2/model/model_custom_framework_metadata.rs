...
pub struct CustomFrameworkMetadata {
    ...
    pub attributes: Option<crate::datadogV2::model::CustomFrameworkWithoutRequirements>,
    /// The ID of the custom framework.
    #[serde(rename = "id")]
    pub id: Option<String>,
    /// The type of the resource. The value must be `custom_framework`.
    #[serde(rename = "type")]
    pub type_: Option<crate::datadogV2::model::CustomFrameworkType>,
    #[serde(flatten)]
...
impl CustomFrameworkMetadata {
    pub fn new() -> CustomFrameworkMetadata {
    ...
    pub fn attributes(
        mut self,
        value: crate::datadogV2::model::CustomFrameworkWithoutRequirements,
    ) -> Self {
    ...
    pub fn type_(mut self, value: crate::datadogV2::model::CustomFrameworkType) -> Self {
...
impl Default for CustomFrameworkMetadata {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        impl<'a> Visitor<'a> for CustomFrameworkMetadataVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::CustomFrameworkWithoutRequirements,
                > = None;
