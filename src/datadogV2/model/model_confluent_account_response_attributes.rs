...
impl<'de> Deserialize<'de> for ConfluentAccountResponseAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ConfluentAccountResponseAttributesVisitor;
        impl<'a> Visitor<'a> for ConfluentAccountResponseAttributesVisitor {
            type Value = ConfluentAccountResponseAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ConfluentAccountResponseAttributes {
                    api_key,
                    resources,
                    tags,
                    _unparsed,
        ...
        deserializer.deserialize_any(ConfluentAccountResponseAttributesVisitor)
    }
}
