...
impl<'de> Deserialize<'de> for FastlyAccountResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FastlyAccountResponseDataVisitor;
        impl<'a> Visitor<'a> for FastlyAccountResponseDataVisitor {
            type Value = FastlyAccountResponseData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::FastlyAccounResponseAttributes,
                > = None;
                ...
                let content = FastlyAccountResponseData {
                    attributes,
                    id,
                    type_,
                    _unparsed,
        ...
        deserializer.deserialize_any(FastlyAccountResponseDataVisitor)
    }
}
