...
impl AWSAccountCreateRequestData {
    pub fn new(
        attributes: crate::datadogV2::model::AWSAccountCreateRequestAttributes,
...
impl<'de> Deserialize<'de> for AWSAccountCreateRequestData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AWSAccountCreateRequestDataVisitor;
        impl<'a> Visitor<'a> for AWSAccountCreateRequestDataVisitor {
            type Value = AWSAccountCreateRequestData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::AWSAccountCreateRequestAttributes,
                > = None;
                ...
                let content = AWSAccountCreateRequestData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(AWSAccountCreateRequestDataVisitor)
    }
}
