...
pub struct CreateCaseRequestData {
...
impl CreateCaseRequestData {
    ...
    pub fn relationships(
        mut self,
        value: crate::datadogV2::model::CreateCaseRequestDataRelationships,
    ) -> Self {
...
impl<'de> Deserialize<'de> for CreateCaseRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateCaseRequestDataVisitor;
        impl<'a> Visitor<'a> for CreateCaseRequestDataVisitor {
            type Value = CreateCaseRequestData;
        ...
        deserializer.deserialize_any(CreateCaseRequestDataVisitor)
    }
}
