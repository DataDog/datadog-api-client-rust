...
pub struct IncidentMSTeamsIntegrationDataAttributes {
    ...
    #[serde(rename = "teams")]
    pub teams: Vec<crate::datadogV2::model::IncidentMSTeamsChannel>,
    #[serde(flatten)]
...
impl IncidentMSTeamsIntegrationDataAttributes {
    pub fn new(
        created: chrono::DateTime<chrono::Utc>,
        integration_type: String,
        modified: chrono::DateTime<chrono::Utc>,
        status: String,
        teams: Vec<crate::datadogV2::model::IncidentMSTeamsChannel>,
...
impl<'de> Deserialize<'de> for IncidentMSTeamsIntegrationDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentMSTeamsIntegrationDataAttributesVisitor;
        impl<'a> Visitor<'a> for IncidentMSTeamsIntegrationDataAttributesVisitor {
            type Value = IncidentMSTeamsIntegrationDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut teams: Option<Vec<crate::datadogV2::model::IncidentMSTeamsChannel>> = None;
                ...
                let content = IncidentMSTeamsIntegrationDataAttributes {
                    created,
                    integration_type,
                    modified,
                    status,
        ...
        deserializer.deserialize_any(IncidentMSTeamsIntegrationDataAttributesVisitor)
    }
}
