...
impl ListPersonalAccessTokensResponse {
    ...
    pub fn meta(mut self, value: crate::datadogV2::model::PersonalAccessTokenResponseMeta) -> Self {
...
impl Default for ListPersonalAccessTokensResponse {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for ListPersonalAccessTokensResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListPersonalAccessTokensResponseVisitor;
        impl<'a> Visitor<'a> for ListPersonalAccessTokensResponseVisitor {
        ...
        deserializer.deserialize_any(ListPersonalAccessTokensResponseVisitor)
    }
}
