...
pub struct LLMObsExperimentationSimpleSearchDataAttributesRequest {
    ...
    #[serde(rename = "page")]
    pub page: Option<crate::datadogV2::model::LLMObsExperimentationNumberPage>,
    /// Sort order for results.
    #[serde(rename = "sort")]
    pub sort: Option<Vec<crate::datadogV2::model::LLMObsExperimentationSortField>>,
    #[serde(flatten)]
...
impl LLMObsExperimentationSimpleSearchDataAttributesRequest {
    pub fn new(
    ...
    pub fn page(mut self, value: crate::datadogV2::model::LLMObsExperimentationNumberPage) -> Self {
    ...
    pub fn sort(
        mut self,
        value: Vec<crate::datadogV2::model::LLMObsExperimentationSortField>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for LLMObsExperimentationSimpleSearchDataAttributesRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsExperimentationSimpleSearchDataAttributesRequestVisitor;
        impl<'a> Visitor<'a> for LLMObsExperimentationSimpleSearchDataAttributesRequestVisitor {
            type Value = LLMObsExperimentationSimpleSearchDataAttributesRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut include: Option<crate::datadogV2::model::LLMObsExperimentationInclude> =
                    None;
                let mut page: Option<crate::datadogV2::model::LLMObsExperimentationNumberPage> =
                    None;
                let mut sort: Option<Vec<crate::datadogV2::model::LLMObsExperimentationSortField>> =
                    None;
                ...
                let content = LLMObsExperimentationSimpleSearchDataAttributesRequest {
                    content_preview,
                    filter,
                    include,
                    page,
        ...
        deserializer.deserialize_any(LLMObsExperimentationSimpleSearchDataAttributesRequestVisitor)
    }
}
