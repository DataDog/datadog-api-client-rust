...
impl<'de> Deserialize<'de> for ServiceDefinitionV2Repo {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ServiceDefinitionV2RepoVisitor;
        impl<'a> Visitor<'a> for ServiceDefinitionV2RepoVisitor {
            type Value = ServiceDefinitionV2Repo;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ServiceDefinitionV2Repo {
                    name,
                    provider,
                    url,
        ...
        deserializer.deserialize_any(ServiceDefinitionV2RepoVisitor)
    }
}
