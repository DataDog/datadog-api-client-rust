...
impl<'de> Deserialize<'de> for SensitiveDataScannerConfigRequest {
    ...
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerConfigRequestVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerConfigRequestVisitor {
            type Value = SensitiveDataScannerConfigRequest;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SensitiveDataScannerReorderConfig> =
                    None;
                ...
                let content = SensitiveDataScannerConfigRequest {
                    data,
                    meta,
        ...
        deserializer.deserialize_any(SensitiveDataScannerConfigRequestVisitor)
    }
}
