...
impl<'de> Deserialize<'de> for RUMApplicationListAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMApplicationListAttributesVisitor;
        impl<'a> Visitor<'a> for RUMApplicationListAttributesVisitor {
            type Value = RUMApplicationListAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = RUMApplicationListAttributes {
                    application_id,
                    created_at,
                    created_by_handle,
                    hash,
        ...
        deserializer.deserialize_any(RUMApplicationListAttributesVisitor)
    }
}
