...
pub struct ObservabilityPipelineData {
...
impl<'de> Deserialize<'de> for ObservabilityPipelineData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ObservabilityPipelineDataVisitor;
        impl<'a> Visitor<'a> for ObservabilityPipelineDataVisitor {
            type Value = ObservabilityPipelineData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ObservabilityPipelineData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(ObservabilityPipelineDataVisitor)
    }
}
