...
pub struct CIAppPipelineEventInProgressPipeline {
    ...
    #[serde(rename = "status")]
    pub status: crate::datadogV2::model::CIAppPipelineEventPipelineInProgressStatus,
...
impl CIAppPipelineEventInProgressPipeline {
    pub fn new(
        level: crate::datadogV2::model::CIAppPipelineEventPipelineLevel,
        name: String,
        partial_retry: bool,
        start: chrono::DateTime<chrono::Utc>,
        status: crate::datadogV2::model::CIAppPipelineEventPipelineInProgressStatus,
        unique_id: String,
        url: String,
...
impl<'de> Deserialize<'de> for CIAppPipelineEventInProgressPipeline {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppPipelineEventInProgressPipelineVisitor;
        impl<'a> Visitor<'a> for CIAppPipelineEventInProgressPipelineVisitor {
            type Value = CIAppPipelineEventInProgressPipeline;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut status: Option<
                    crate::datadogV2::model::CIAppPipelineEventPipelineInProgressStatus,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "status" => {
                            ...
                            if let Some(ref _status) = status {
                                match _status {
                                    crate::datadogV2::model::CIAppPipelineEventPipelineInProgressStatus::UnparsedObject(_status) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = CIAppPipelineEventInProgressPipeline {
                    error,
                    git,
                    is_manual,
                    is_resumed,
        ...
        deserializer.deserialize_any(CIAppPipelineEventInProgressPipelineVisitor)
    }
}
