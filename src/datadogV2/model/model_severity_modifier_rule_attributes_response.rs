...
pub struct SeverityModifierRuleAttributesResponse {
    ...
    #[serde(rename = "action")]
    pub action: crate::datadogV2::model::SeverityModifierRuleAction,
...
impl SeverityModifierRuleAttributesResponse {
    pub fn new(
        action: crate::datadogV2::model::SeverityModifierRuleAction,
        created_at: i64,
...
impl<'de> Deserialize<'de> for SeverityModifierRuleAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SeverityModifierRuleAttributesResponseVisitor;
        impl<'a> Visitor<'a> for SeverityModifierRuleAttributesResponseVisitor {
            type Value = SeverityModifierRuleAttributesResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut action: Option<crate::datadogV2::model::SeverityModifierRuleAction> = None;
                    ...
                    match k.as_str() {
                        "action" => {
                            ...
                            if let Some(ref _action) = action {
                                match _action {
                                    crate::datadogV2::model::SeverityModifierRuleAction::UnparsedObject(_action) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = SeverityModifierRuleAttributesResponse {
                    action,
                    created_at,
                    created_by,
                    enabled,
        ...
        deserializer.deserialize_any(SeverityModifierRuleAttributesResponseVisitor)
    }
}
