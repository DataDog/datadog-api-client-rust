...
impl StatusPagesComponentDataAttributesComponentsItems {
    pub fn new() -> StatusPagesComponentDataAttributesComponentsItems {
...
impl Default for StatusPagesComponentDataAttributesComponentsItems {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for StatusPagesComponentDataAttributesComponentsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct StatusPagesComponentDataAttributesComponentsItemsVisitor;
        impl<'a> Visitor<'a> for StatusPagesComponentDataAttributesComponentsItemsVisitor {
            type Value = StatusPagesComponentDataAttributesComponentsItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = StatusPagesComponentDataAttributesComponentsItems {
                    id,
                    name,
                    position,
                    status,
        ...
        deserializer.deserialize_any(StatusPagesComponentDataAttributesComponentsItemsVisitor)
    }
}
