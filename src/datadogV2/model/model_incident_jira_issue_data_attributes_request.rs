...
pub struct IncidentJiraIssueDataAttributesRequest {
...
impl IncidentJiraIssueDataAttributesRequest {
    pub fn new(
        account_id: String,
    ...
    pub fn template_id(mut self, value: uuid::Uuid) -> Self {
...
impl<'de> Deserialize<'de> for IncidentJiraIssueDataAttributesRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentJiraIssueDataAttributesRequestVisitor;
        impl<'a> Visitor<'a> for IncidentJiraIssueDataAttributesRequestVisitor {
            type Value = IncidentJiraIssueDataAttributesRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut template_id: Option<uuid::Uuid> = None;
                ...
                let content = IncidentJiraIssueDataAttributesRequest {
                    account_id,
                    issue_type_id,
                    project_id,
                    template_id,
        ...
        deserializer.deserialize_any(IncidentJiraIssueDataAttributesRequestVisitor)
    }
}
