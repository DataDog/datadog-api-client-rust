...
impl<'de> Deserialize<'de> for ProcessTimeseriesQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProcessTimeseriesQueryVisitor;
        impl<'a> Visitor<'a> for ProcessTimeseriesQueryVisitor {
        ...
        deserializer.deserialize_any(ProcessTimeseriesQueryVisitor)
    }
}
