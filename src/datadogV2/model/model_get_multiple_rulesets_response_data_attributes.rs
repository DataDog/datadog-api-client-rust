...
/// The definition of `GetMultipleRulesetsResponseDataAttributes` object.
#[non_exhaustive]
...
impl<'de> Deserialize<'de> for GetMultipleRulesetsResponseDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GetMultipleRulesetsResponseDataAttributesVisitor;
        impl<'a> Visitor<'a> for GetMultipleRulesetsResponseDataAttributesVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut rulesets: Option<Vec<crate::datadogV2::model::GetMultipleRulesetsResponseDataAttributesRulesetsItems>> = None;
        ...
        deserializer.deserialize_any(GetMultipleRulesetsResponseDataAttributesVisitor)
    }
}
