...
impl<'de> Deserialize<'de> for IncidentUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentUpdateDataVisitor;
        impl<'a> Visitor<'a> for IncidentUpdateDataVisitor {
            type Value = IncidentUpdateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::IncidentUpdateAttributes> =
                    None;
                ...
                let content = IncidentUpdateData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(IncidentUpdateDataVisitor)
    }
}
