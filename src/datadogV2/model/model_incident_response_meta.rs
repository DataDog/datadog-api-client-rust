...
impl<'de> Deserialize<'de> for IncidentResponseMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentResponseMetaVisitor;
        impl<'a> Visitor<'a> for IncidentResponseMetaVisitor {
            type Value = IncidentResponseMeta;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentResponseMeta {
                    pagination,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(IncidentResponseMetaVisitor)
    }
}
