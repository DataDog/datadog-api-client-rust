...
impl<'de> Deserialize<'de> for SensitiveDataScannerRuleUpdate {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerRuleUpdateVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerRuleUpdateVisitor {
            type Value = SensitiveDataScannerRuleUpdate;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerRuleUpdate {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(SensitiveDataScannerRuleUpdateVisitor)
    }
}
