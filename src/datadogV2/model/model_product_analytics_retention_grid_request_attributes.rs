...
pub struct ProductAnalyticsRetentionGridRequestAttributes {
    ...
    #[serde(rename = "query")]
    pub query: crate::datadogV2::model::ProductAnalyticsRetentionGridQuery,
...
impl ProductAnalyticsRetentionGridRequestAttributes {
    pub fn new(
        from: i64,
        query: crate::datadogV2::model::ProductAnalyticsRetentionGridQuery,
        to: i64,
...
impl<'de> Deserialize<'de> for ProductAnalyticsRetentionGridRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsRetentionGridRequestAttributesVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsRetentionGridRequestAttributesVisitor {
            type Value = ProductAnalyticsRetentionGridRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut query: Option<crate::datadogV2::model::ProductAnalyticsRetentionGridQuery> =
                    None;
                ...
                let content = ProductAnalyticsRetentionGridRequestAttributes {
                    exclude_anonymous_traffic,
                    from,
                    query,
                    to,
        ...
        deserializer.deserialize_any(ProductAnalyticsRetentionGridRequestAttributesVisitor)
    }
}
