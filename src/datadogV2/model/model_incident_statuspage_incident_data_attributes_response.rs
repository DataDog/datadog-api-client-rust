...
pub struct IncidentStatuspageIncidentDataAttributesResponse {
    /// Timestamp when the integration was created.
    #[serde(rename = "created")]
    pub created: chrono::DateTime<chrono::Utc>,
    /// List of Statuspage incidents.
    #[serde(rename = "incidents")]
    pub incidents: Option<Vec<crate::datadogV2::model::IncidentStatuspageIncidentEntry>>,
...
impl IncidentStatuspageIncidentDataAttributesResponse {
    pub fn new(
    ...
    pub fn incidents(
        mut self,
        value: Vec<crate::datadogV2::model::IncidentStatuspageIncidentEntry>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for IncidentStatuspageIncidentDataAttributesResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentStatuspageIncidentDataAttributesResponseVisitor;
        impl<'a> Visitor<'a> for IncidentStatuspageIncidentDataAttributesResponseVisitor {
            type Value = IncidentStatuspageIncidentDataAttributesResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut incidents: Option<
                    Vec<crate::datadogV2::model::IncidentStatuspageIncidentEntry>,
                > = None;
                ...
                let content = IncidentStatuspageIncidentDataAttributesResponse {
                    created,
                    incidents,
                    integration_type,
                    modified,
        ...
        deserializer.deserialize_any(IncidentStatuspageIncidentDataAttributesResponseVisitor)
    }
}
