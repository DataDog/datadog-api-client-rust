...
pub struct InterfaceAttributes {
    ...
    #[serde(rename = "status")]
    pub status: Option<crate::datadogV2::model::InterfaceAttributesStatus>,
    #[serde(flatten)]
...
impl InterfaceAttributes {
    ...
    pub fn status(mut self, value: crate::datadogV2::model::InterfaceAttributesStatus) -> Self {
...
impl<'de> Deserialize<'de> for InterfaceAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct InterfaceAttributesVisitor;
        impl<'a> Visitor<'a> for InterfaceAttributesVisitor {
            type Value = InterfaceAttributes;
                ...
                M: MapAccess<'a>,
            {
                    ...
                    match k.as_str() {
                        ...
                        "status" => {
                            ...
                            if let Some(ref _status) = status {
                                match _status {
                                    crate::datadogV2::model::InterfaceAttributesStatus::UnparsedObject(_status) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = InterfaceAttributes {
                    alias,
                    description,
                    index,
                    mac_address,
        ...
        deserializer.deserialize_any(InterfaceAttributesVisitor)
    }
}
