...
pub struct MaintenanceDataAttributesUpdatesItems {
    /// The components affected at the time of the update.
    #[serde(rename = "components_affected")]
    pub components_affected: Option<
        Vec<crate::datadogV2::model::MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems>,
    >,
...
impl MaintenanceDataAttributesUpdatesItems {
    pub fn new() -> MaintenanceDataAttributesUpdatesItems {
    ...
    pub fn components_affected(
        mut self,
        value: Vec<
            crate::datadogV2::model::MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems,
        >,
    ) -> Self {
...
impl Default for MaintenanceDataAttributesUpdatesItems {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for MaintenanceDataAttributesUpdatesItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MaintenanceDataAttributesUpdatesItemsVisitor;
        impl<'a> Visitor<'a> for MaintenanceDataAttributesUpdatesItemsVisitor {
            type Value = MaintenanceDataAttributesUpdatesItems;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut components_affected: Option<Vec<crate::datadogV2::model::MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems>> = None;
                ...
                let content = MaintenanceDataAttributesUpdatesItems {
                    components_affected,
                    created_at,
                    description,
                    id,
        ...
        deserializer.deserialize_any(MaintenanceDataAttributesUpdatesItemsVisitor)
    }
}
