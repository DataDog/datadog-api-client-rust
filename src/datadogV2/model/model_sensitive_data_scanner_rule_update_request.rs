...
impl<'de> Deserialize<'de> for SensitiveDataScannerRuleUpdateRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerRuleUpdateRequestVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerRuleUpdateRequestVisitor {
            type Value = SensitiveDataScannerRuleUpdateRequest;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::SensitiveDataScannerRuleUpdate> =
                    None;
                ...
                let content = SensitiveDataScannerRuleUpdateRequest {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SensitiveDataScannerRuleUpdateRequestVisitor)
    }
}
