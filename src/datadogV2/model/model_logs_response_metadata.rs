...
impl<'de> Deserialize<'de> for LogsResponseMetadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LogsResponseMetadataVisitor;
        impl<'a> Visitor<'a> for LogsResponseMetadataVisitor {
            type Value = LogsResponseMetadata;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut page: Option<crate::datadogV2::model::LogsResponseMetadataPage> = None;
                let mut request_id: Option<String> = None;
                let mut status: Option<crate::datadogV2::model::LogsAggregateResponseStatus> = None;
                let mut warnings: Option<Vec<crate::datadogV2::model::LogsWarning>> = None;
                    ...
                    match k.as_str() {
                        ...
                        "status" => {
                            ...
                            if let Some(ref _status) = status {
                                match _status {
                                    crate::datadogV2::model::LogsAggregateResponseStatus::UnparsedObject(_status) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = LogsResponseMetadata {
                    elapsed,
                    page,
                    request_id,
                    status,
        ...
        deserializer.deserialize_any(LogsResponseMetadataVisitor)
    }
}
