...
impl ScheduleMember {
    ...
    pub fn relationships(
        mut self,
        value: crate::datadogV2::model::ScheduleMemberRelationships,
    ) -> Self {
...
impl<'de> Deserialize<'de> for ScheduleMember {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ScheduleMemberVisitor;
        impl<'a> Visitor<'a> for ScheduleMemberVisitor {
            type Value = ScheduleMember;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut relationships: Option<
                    crate::datadogV2::model::ScheduleMemberRelationships,
                > = None;
                let mut type_: Option<crate::datadogV2::model::ScheduleMemberType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::ScheduleMemberType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(ScheduleMemberVisitor)
    }
}
