...
impl<'de> Deserialize<'de> for LogsCompute {
    ...
    where
        D: Deserializer<'de>,
    {
        struct LogsComputeVisitor;
        impl<'a> Visitor<'a> for LogsComputeVisitor {
            type Value = LogsCompute;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV2::model::LogsComputeType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::LogsComputeType::UnparsedObject(
                                        _type_,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(LogsComputeVisitor)
    }
}
