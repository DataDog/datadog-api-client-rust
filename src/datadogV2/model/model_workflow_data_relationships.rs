...
pub struct WorkflowDataRelationships {
    ...
    pub creator: Option<crate::datadogV2::model::UserRelationships>,
    /// Relationships of the user object.
    #[serde(rename = "owner")]
    pub owner: Option<crate::datadogV2::model::UserRelationships>,
    #[serde(flatten)]
...
impl WorkflowDataRelationships {
    ...
    pub fn creator(mut self, value: crate::datadogV2::model::UserRelationships) -> Self {
        self.creator = Some(value);
        self
    }

    pub fn owner(mut self, value: crate::datadogV2::model::UserRelationships) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for WorkflowDataRelationshipsVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut creator: Option<crate::datadogV2::model::UserRelationships> = None;
                let mut owner: Option<crate::datadogV2::model::UserRelationships> = None;
