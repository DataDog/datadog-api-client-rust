...
pub struct MetricAssetDashboardRelationships {
...
impl MetricAssetDashboardRelationships {
...
impl Default for MetricAssetDashboardRelationships {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for MetricAssetDashboardRelationships {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MetricAssetDashboardRelationshipsVisitor;
        impl<'a> Visitor<'a> for MetricAssetDashboardRelationshipsVisitor {
            type Value = MetricAssetDashboardRelationships;
        ...
        deserializer.deserialize_any(MetricAssetDashboardRelationshipsVisitor)
    }
}
