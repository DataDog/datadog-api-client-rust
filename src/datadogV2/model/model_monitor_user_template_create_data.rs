...
pub struct MonitorUserTemplateCreateData {
...
impl MonitorUserTemplateCreateData {
    pub fn new(
...
impl<'de> Deserialize<'de> for MonitorUserTemplateCreateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonitorUserTemplateCreateDataVisitor;
        impl<'a> Visitor<'a> for MonitorUserTemplateCreateDataVisitor {
            type Value = MonitorUserTemplateCreateData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = MonitorUserTemplateCreateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(MonitorUserTemplateCreateDataVisitor)
    }
}
