...
pub struct AWSMetrics {
    ...
    pub namespace_filters: Option<crate::datadogV2::model::AWSNamespacesList>,
...
impl AWSMetrics {
    ...
    pub fn namespace_filters(mut self, value: crate::datadogV2::model::AWSNamespacesList) -> Self {
...
impl Default for AWSMetrics {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for AWSMetrics {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct AWSMetricsVisitor;
        impl<'a> Visitor<'a> for AWSMetricsVisitor {
            type Value = AWSMetrics;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut namespace_filters: Option<crate::datadogV2::model::AWSNamespacesList> =
                    None;
        ...
        deserializer.deserialize_any(AWSMetricsVisitor)
    }
}
