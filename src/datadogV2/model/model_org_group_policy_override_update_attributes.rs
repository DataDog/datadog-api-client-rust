...
pub struct OrgGroupPolicyOverrideUpdateAttributes {
...
impl OrgGroupPolicyOverrideUpdateAttributes {
    pub fn new(org_site: String, org_uuid: uuid::Uuid) -> OrgGroupPolicyOverrideUpdateAttributes {
...
impl<'de> Deserialize<'de> for OrgGroupPolicyOverrideUpdateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OrgGroupPolicyOverrideUpdateAttributesVisitor;
        impl<'a> Visitor<'a> for OrgGroupPolicyOverrideUpdateAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = OrgGroupPolicyOverrideUpdateAttributes {
                    org_site,
                    org_uuid,
        ...
        deserializer.deserialize_any(OrgGroupPolicyOverrideUpdateAttributesVisitor)
    }
}
