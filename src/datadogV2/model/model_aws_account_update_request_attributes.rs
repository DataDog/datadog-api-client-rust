...
pub struct AWSAccountUpdateRequestAttributes {
...
impl<'de> Deserialize<'de> for AWSAccountUpdateRequestAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AWSAccountUpdateRequestAttributesVisitor;
        impl<'a> Visitor<'a> for AWSAccountUpdateRequestAttributesVisitor {
            type Value = AWSAccountUpdateRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = AWSAccountUpdateRequestAttributes {
                    account_tags,
                    auth_config,
                    aws_account_id,
                    aws_partition,
        ...
        deserializer.deserialize_any(AWSAccountUpdateRequestAttributesVisitor)
    }
}
