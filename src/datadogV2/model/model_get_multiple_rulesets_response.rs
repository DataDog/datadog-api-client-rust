...
impl<'de> Deserialize<'de> for GetMultipleRulesetsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GetMultipleRulesetsResponseVisitor;
        impl<'a> Visitor<'a> for GetMultipleRulesetsResponseVisitor {
            type Value = GetMultipleRulesetsResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::GetMultipleRulesetsResponseData> =
                    None;
        ...
        deserializer.deserialize_any(GetMultipleRulesetsResponseVisitor)
    }
}
