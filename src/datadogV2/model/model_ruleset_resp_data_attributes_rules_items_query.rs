...
pub struct RulesetRespDataAttributesRulesItemsQuery {
    /// The definition of `RulesetRespDataAttributesRulesItemsQueryAddition` object.
    #[serialize_always]
    #[serde(rename = "addition")]
    pub addition: Option<crate::datadogV2::model::RulesetRespDataAttributesRulesItemsQueryAddition>,
...
impl<'de> Deserialize<'de> for RulesetRespDataAttributesRulesItemsQuery {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RulesetRespDataAttributesRulesItemsQueryVisitor;
        impl<'a> Visitor<'a> for RulesetRespDataAttributesRulesItemsQueryVisitor {
            type Value = RulesetRespDataAttributesRulesItemsQuery;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut addition: Option<
                    Option<
                        crate::datadogV2::model::RulesetRespDataAttributesRulesItemsQueryAddition,
                    >,
                > = None;
        ...
        deserializer.deserialize_any(RulesetRespDataAttributesRulesItemsQueryVisitor)
    }
}
