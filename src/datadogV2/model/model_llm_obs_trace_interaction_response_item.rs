...
pub struct LLMObsTraceInteractionResponseItem {
...
impl LLMObsTraceInteractionResponseItem {
    pub fn new(
...
impl<'de> Deserialize<'de> for LLMObsTraceInteractionResponseItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsTraceInteractionResponseItemVisitor;
        impl<'a> Visitor<'a> for LLMObsTraceInteractionResponseItemVisitor {
            type Value = LLMObsTraceInteractionResponseItem;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = LLMObsTraceInteractionResponseItem {
                    already_existed,
                    content_id,
                    created_at,
                    id,
        ...
        deserializer.deserialize_any(LLMObsTraceInteractionResponseItemVisitor)
    }
}
