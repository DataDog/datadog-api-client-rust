...
impl<'de> Deserialize<'de> for AuthNMappingUpdateData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct AuthNMappingUpdateDataVisitor;
        impl<'a> Visitor<'a> for AuthNMappingUpdateDataVisitor {
            type Value = AuthNMappingUpdateData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::AuthNMappingUpdateAttributes> =
                    None;
                ...
                let content = AuthNMappingUpdateData {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(AuthNMappingUpdateDataVisitor)
    }
}
