...
pub enum ObservabilityPipelineConfigProcessorItem {
    ...
    ObservabilityPipelineRemapVrlProcessor(
        Box<crate::datadogV2::model::ObservabilityPipelineRemapVrlProcessor>,
    ),
...
impl<'de> Deserialize<'de> for ObservabilityPipelineConfigProcessorItem {
        ...
        D: Deserializer<'de>,
    {
        ...
        {
            if !_v._unparsed {
                return Ok(ObservabilityPipelineConfigProcessorItem::ObservabilityPipelineRemapVrlProcessor(_v));
            }
        }
