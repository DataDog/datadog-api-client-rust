...
impl EntityV3System {
    pub fn new(
        ...
        kind: crate::datadogV2::model::EntityV3SystemKind,
    ...
    pub fn datadog(mut self, value: crate::datadogV2::model::EntityV3SystemDatadog) -> Self {
    ...
    pub fn spec(mut self, value: crate::datadogV2::model::EntityV3SystemSpec) -> Self {
...
impl<'de> Deserialize<'de> for EntityV3System {
    ...
    where
        D: Deserializer<'de>,
    {
        struct EntityV3SystemVisitor;
        impl<'a> Visitor<'a> for EntityV3SystemVisitor {
            type Value = EntityV3System;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut datadog: Option<crate::datadogV2::model::EntityV3SystemDatadog> = None;
                ...
                let mut kind: Option<crate::datadogV2::model::EntityV3SystemKind> = None;
                let mut metadata: Option<crate::datadogV2::model::EntityV3Metadata> = None;
                let mut spec: Option<crate::datadogV2::model::EntityV3SystemSpec> = None;
                    ...
                    match k.as_str() {
                        ...
                        "kind" => {
                            ...
                            if let Some(ref _kind) = kind {
                                match _kind {
                                    crate::datadogV2::model::EntityV3SystemKind::UnparsedObject(
                                        _kind,
                                    ) => {
                                        _unparsed = true;
                                    }
        ...
        deserializer.deserialize_any(EntityV3SystemVisitor)
    }
}
