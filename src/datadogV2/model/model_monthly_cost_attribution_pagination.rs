...
impl<'de> Deserialize<'de> for MonthlyCostAttributionPagination {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonthlyCostAttributionPaginationVisitor;
        impl<'a> Visitor<'a> for MonthlyCostAttributionPaginationVisitor {
            type Value = MonthlyCostAttributionPagination;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = MonthlyCostAttributionPagination {
                    next_record_id,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(MonthlyCostAttributionPaginationVisitor)
    }
}
