...
impl<'de> Deserialize<'de> for DowntimeCreateRequestData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DowntimeCreateRequestDataVisitor;
        impl<'a> Visitor<'a> for DowntimeCreateRequestDataVisitor {
            type Value = DowntimeCreateRequestData;
        ...
        deserializer.deserialize_any(DowntimeCreateRequestDataVisitor)
    }
}
