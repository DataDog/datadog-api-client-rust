...
pub struct IncidentPostmortemUpdatedTrigger {
...
impl IncidentPostmortemUpdatedTrigger {
    pub fn new() -> IncidentPostmortemUpdatedTrigger {
...
impl Default for IncidentPostmortemUpdatedTrigger {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentPostmortemUpdatedTrigger {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentPostmortemUpdatedTriggerVisitor;
        impl<'a> Visitor<'a> for IncidentPostmortemUpdatedTriggerVisitor {
            type Value = IncidentPostmortemUpdatedTrigger;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentPostmortemUpdatedTrigger {
                    execution_limit,
                    incident_type,
                    tag_condition,
        ...
        deserializer.deserialize_any(IncidentPostmortemUpdatedTriggerVisitor)
    }
}
