...
pub struct ElasticCloudIntegrationAccountResponse {
    ...
    #[serde(rename = "data")]
    pub data: Option<crate::datadogV2::model::ElasticCloudIntegrationAccountData>,
    #[serde(flatten)]
...
impl ElasticCloudIntegrationAccountResponse {
    pub fn new() -> ElasticCloudIntegrationAccountResponse {
    ...
    pub fn data(
        mut self,
        value: crate::datadogV2::model::ElasticCloudIntegrationAccountData,
    ) -> Self {
...
impl Default for ElasticCloudIntegrationAccountResponse {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for ElasticCloudIntegrationAccountResponseVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<crate::datadogV2::model::ElasticCloudIntegrationAccountData> =
                    None;
