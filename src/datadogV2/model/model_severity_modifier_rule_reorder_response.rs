...
impl SeverityModifierRuleReorderResponse {
    pub fn new(
...
impl<'de> Deserialize<'de> for SeverityModifierRuleReorderResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SeverityModifierRuleReorderResponseVisitor;
        impl<'a> Visitor<'a> for SeverityModifierRuleReorderResponseVisitor {
            type Value = SeverityModifierRuleReorderResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SeverityModifierRuleReorderResponse {
                    data,
        ...
        deserializer.deserialize_any(SeverityModifierRuleReorderResponseVisitor)
    }
}
