...
pub struct ApplicationSecurityWafCustomRuleCreateAttributes {
...
impl ApplicationSecurityWafCustomRuleCreateAttributes {
    pub fn new(
        blocking: bool,
...
impl<'de> Deserialize<'de> for ApplicationSecurityWafCustomRuleCreateAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ApplicationSecurityWafCustomRuleCreateAttributesVisitor;
        impl<'a> Visitor<'a> for ApplicationSecurityWafCustomRuleCreateAttributesVisitor {
            type Value = ApplicationSecurityWafCustomRuleCreateAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ApplicationSecurityWafCustomRuleCreateAttributes {
                    action,
                    blocking,
                    conditions,
                    enabled,
        ...
        deserializer.deserialize_any(ApplicationSecurityWafCustomRuleCreateAttributesVisitor)
    }
}
