...
pub struct CustomFrameworkDataAttributes {
...
impl CustomFrameworkDataAttributes {
    pub fn new(
        handle: String,
        name: String,
...
impl<'de> Deserialize<'de> for CustomFrameworkDataAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CustomFrameworkDataAttributesVisitor;
        impl<'a> Visitor<'a> for CustomFrameworkDataAttributesVisitor {
            type Value = CustomFrameworkDataAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CustomFrameworkDataAttributes {
                    description,
                    handle,
                    icon_url,
                    name,
        ...
        deserializer.deserialize_any(CustomFrameworkDataAttributesVisitor)
    }
}
