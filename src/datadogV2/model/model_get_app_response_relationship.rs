...
pub struct GetAppResponseRelationship {
...
impl GetAppResponseRelationship {
    pub fn new() -> GetAppResponseRelationship {
...
impl Default for GetAppResponseRelationship {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for GetAppResponseRelationship {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct GetAppResponseRelationshipVisitor;
        impl<'a> Visitor<'a> for GetAppResponseRelationshipVisitor {
            type Value = GetAppResponseRelationship;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = GetAppResponseRelationship {
                    connections,
                    deployment,
        ...
        deserializer.deserialize_any(GetAppResponseRelationshipVisitor)
    }
}
