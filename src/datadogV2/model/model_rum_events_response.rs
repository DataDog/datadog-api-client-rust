...
impl RUMEventsResponse {
    ...
    pub fn data(mut self, value: Vec<crate::datadogV2::model::RUMEvent>) -> Self {
...
impl<'de> Deserialize<'de> for RUMEventsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct RUMEventsResponseVisitor;
        impl<'a> Visitor<'a> for RUMEventsResponseVisitor {
            type Value = RUMEventsResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::RUMEvent>> = None;
        ...
        deserializer.deserialize_any(RUMEventsResponseVisitor)
    }
}
