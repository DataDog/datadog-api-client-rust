...
pub struct CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems {
    #[serde(rename = "id")]
...
impl CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems {
    pub fn new() -> CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems {
...
impl Default for CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateStatusPageRequestDataAttributesComponentsItemsComponentsItemsVisitor;
        impl<'a> Visitor<'a>
            for CreateStatusPageRequestDataAttributesComponentsItemsComponentsItemsVisitor
        {
            type Value = CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems {
                    id,
                    name,
                    position,
                    status,
        ...
        deserializer.deserialize_any(
            CreateStatusPageRequestDataAttributesComponentsItemsComponentsItemsVisitor,
        )
    }
}
