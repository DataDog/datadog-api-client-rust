...
impl<'de> Deserialize<'de> for SecurityFilterUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityFilterUpdateDataVisitor;
        impl<'a> Visitor<'a> for SecurityFilterUpdateDataVisitor {
            type Value = SecurityFilterUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SecurityFilterUpdateAttributes,
                > = None;
                ...
                let content = SecurityFilterUpdateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(SecurityFilterUpdateDataVisitor)
    }
}
