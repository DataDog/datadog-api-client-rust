...
impl<'de> Deserialize<'de> for SecurityFiltersResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SecurityFiltersResponseVisitor;
        impl<'a> Visitor<'a> for SecurityFiltersResponseVisitor {
            type Value = SecurityFiltersResponse;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut data: Option<Vec<crate::datadogV2::model::SecurityFilter>> = None;
                let mut meta: Option<crate::datadogV2::model::SecurityFilterMeta> = None;
                ...
                let content = SecurityFiltersResponse {
                    data,
                    meta,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SecurityFiltersResponseVisitor)
    }
}
