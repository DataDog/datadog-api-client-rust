...
impl<'de> Deserialize<'de> for DashboardListItemRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DashboardListItemRequestVisitor;
        impl<'a> Visitor<'a> for DashboardListItemRequestVisitor {
            type Value = DashboardListItemRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DashboardListItemRequest {
                    id,
                    type_,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(DashboardListItemRequestVisitor)
    }
}
