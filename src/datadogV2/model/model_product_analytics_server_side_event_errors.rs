...
pub struct ProductAnalyticsServerSideEventErrors {
    /// Structured errors.
    #[serde(rename = "errors")]
    pub errors: Option<Vec<crate::datadogV2::model::ProductAnalyticsServerSideEventError>>,
    #[serde(flatten)]
...
impl ProductAnalyticsServerSideEventErrors {
    ...
    pub fn errors(
        mut self,
        value: Vec<crate::datadogV2::model::ProductAnalyticsServerSideEventError>,
    ) -> Self {
        ...
        impl<'a> Visitor<'a> for ProductAnalyticsServerSideEventErrorsVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut errors: Option<
                    Vec<crate::datadogV2::model::ProductAnalyticsServerSideEventError>,
                > = None;
