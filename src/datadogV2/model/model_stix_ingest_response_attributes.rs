...
impl STIXIngestResponseAttributes {
    pub fn new(added: i64, invalid: i64, unsupported: i64) -> STIXIngestResponseAttributes {
        ...
        impl<'a> Visitor<'a> for STIXIngestResponseAttributesVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                while let Some((k, v)) = map.next_entry::<String, serde_json::Value>()? {
                    match k.as_str() {
                        "added" => {
                            added = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        }
                        "invalid" => {
                ...
                let added = added.ok_or_else(|| M::Error::missing_field("added"))?;
