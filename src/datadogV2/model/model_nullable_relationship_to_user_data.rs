...
impl<'de> Deserialize<'de> for NullableRelationshipToUserData {
    ...
    where
        D: Deserializer<'de>,
    {
        struct NullableRelationshipToUserDataVisitor;
        impl<'a> Visitor<'a> for NullableRelationshipToUserDataVisitor {
            type Value = NullableRelationshipToUserData;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = NullableRelationshipToUserData {
                    id,
                    type_,
        ...
        deserializer.deserialize_any(NullableRelationshipToUserDataVisitor)
    }
}
