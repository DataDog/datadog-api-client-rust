...
impl<'de> Deserialize<'de> for SensitiveDataScannerStandardPatternsResponseItem {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerStandardPatternsResponseItemVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerStandardPatternsResponseItemVisitor {
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV2::model::SensitiveDataScannerStandardPatternAttributes,
                > = None;
                let mut id: Option<String> = None;
                let mut type_: Option<
                    crate::datadogV2::model::SensitiveDataScannerStandardPatternType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::SensitiveDataScannerStandardPatternType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = SensitiveDataScannerStandardPatternsResponseItem {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(SensitiveDataScannerStandardPatternsResponseItemVisitor)
    }
}
