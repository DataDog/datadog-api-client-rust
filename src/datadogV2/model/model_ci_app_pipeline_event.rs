...
impl<'de> Deserialize<'de> for CIAppPipelineEvent {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CIAppPipelineEventVisitor;
        impl<'a> Visitor<'a> for CIAppPipelineEventVisitor {
            type Value = CIAppPipelineEvent;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::CIAppPipelineEventAttributes> =
                    None;
                let mut id: Option<String> = None;
                let mut type_: Option<crate::datadogV2::model::CIAppPipelineEventTypeName> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::CIAppPipelineEventTypeName::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = CIAppPipelineEvent {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(CIAppPipelineEventVisitor)
    }
}
