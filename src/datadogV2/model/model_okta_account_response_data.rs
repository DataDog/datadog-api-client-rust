...
impl<'de> Deserialize<'de> for OktaAccountResponseData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct OktaAccountResponseDataVisitor;
        impl<'a> Visitor<'a> for OktaAccountResponseDataVisitor {
            type Value = OktaAccountResponseData;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut attributes: Option<crate::datadogV2::model::OktaAccountAttributes> = None;
                ...
                let content = OktaAccountResponseData {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(OktaAccountResponseDataVisitor)
    }
}
