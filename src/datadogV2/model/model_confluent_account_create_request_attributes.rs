...
impl<'de> Deserialize<'de> for ConfluentAccountCreateRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ConfluentAccountCreateRequestAttributesVisitor;
        impl<'a> Visitor<'a> for ConfluentAccountCreateRequestAttributesVisitor {
            type Value = ConfluentAccountCreateRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut resources: Option<
                    Vec<crate::datadogV2::model::ConfluentAccountResourceAttributes>,
                > = None;
                ...
                let content = ConfluentAccountCreateRequestAttributes {
                    api_key,
                    api_secret,
                    resources,
                    tags,
        ...
        deserializer.deserialize_any(ConfluentAccountCreateRequestAttributesVisitor)
    }
}
