...
impl<'de> Deserialize<'de> for UserTeamResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UserTeamResponseVisitor;
        impl<'a> Visitor<'a> for UserTeamResponseVisitor {
            type Value = UserTeamResponse;
        ...
        deserializer.deserialize_any(UserTeamResponseVisitor)
    }
}
