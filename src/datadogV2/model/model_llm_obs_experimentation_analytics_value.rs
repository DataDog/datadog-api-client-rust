...
pub struct LLMObsExperimentationAnalyticsValue {
...
impl LLMObsExperimentationAnalyticsValue {
    pub fn new(
...
impl<'de> Deserialize<'de> for LLMObsExperimentationAnalyticsValue {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct LLMObsExperimentationAnalyticsValueVisitor;
        impl<'a> Visitor<'a> for LLMObsExperimentationAnalyticsValueVisitor {
            type Value = LLMObsExperimentationAnalyticsValue;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut metrics: Option<std::collections::BTreeMap<String, serde_json::Value>> =
                    None;
                ...
                let content = LLMObsExperimentationAnalyticsValue {
                    by,
                    metrics,
        ...
        deserializer.deserialize_any(LLMObsExperimentationAnalyticsValueVisitor)
    }
}
