...
pub struct CreateEmailNotificationChannelConfig {
...
impl CreateEmailNotificationChannelConfig {
    pub fn new(
        address: String,
...
impl<'de> Deserialize<'de> for CreateEmailNotificationChannelConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct CreateEmailNotificationChannelConfigVisitor;
        impl<'a> Visitor<'a> for CreateEmailNotificationChannelConfigVisitor {
            type Value = CreateEmailNotificationChannelConfig;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = CreateEmailNotificationChannelConfig {
                    address,
                    formats,
                    type_,
        ...
        deserializer.deserialize_any(CreateEmailNotificationChannelConfigVisitor)
    }
}
