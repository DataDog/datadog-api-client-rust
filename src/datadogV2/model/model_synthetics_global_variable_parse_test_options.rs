...
pub struct SyntheticsGlobalVariableParseTestOptions {
    ...
    #[serde(rename = "parser")]
    pub parser: Option<crate::datadogV2::model::SyntheticsVariableParser>,
    /// Type of value to extract from a test for a Synthetic global variable.
    #[serde(rename = "type")]
    pub type_: crate::datadogV2::model::SyntheticsGlobalVariableParseTestOptionsType,
    #[serde(flatten)]
...
impl SyntheticsGlobalVariableParseTestOptions {
    ...
    pub fn parser(mut self, value: crate::datadogV2::model::SyntheticsVariableParser) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for SyntheticsGlobalVariableParseTestOptionsVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut parser: Option<crate::datadogV2::model::SyntheticsVariableParser> = None;
                let mut type_: Option<
                    crate::datadogV2::model::SyntheticsGlobalVariableParseTestOptionsType,
                > = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV2::model::SyntheticsGlobalVariableParseTestOptionsType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
