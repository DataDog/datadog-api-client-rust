...
pub struct ListConnectionGroupsResponseMeta {
...
impl ListConnectionGroupsResponseMeta {
    pub fn new(total: i64, total_filtered: i64) -> ListConnectionGroupsResponseMeta {
...
impl<'de> Deserialize<'de> for ListConnectionGroupsResponseMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ListConnectionGroupsResponseMetaVisitor;
        impl<'a> Visitor<'a> for ListConnectionGroupsResponseMetaVisitor {
            type Value = ListConnectionGroupsResponseMeta;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ListConnectionGroupsResponseMeta {
                    integration_counts,
                    total,
                    total_filtered,
        ...
        deserializer.deserialize_any(ListConnectionGroupsResponseMetaVisitor)
    }
}
