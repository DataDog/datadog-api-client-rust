...
impl<'de> Deserialize<'de> for SensitiveDataScannerGroupResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SensitiveDataScannerGroupResponseVisitor;
        impl<'a> Visitor<'a> for SensitiveDataScannerGroupResponseVisitor {
            type Value = SensitiveDataScannerGroupResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SensitiveDataScannerGroupResponse {
                    attributes,
                    id,
                    relationships,
                    type_,
        ...
        deserializer.deserialize_any(SensitiveDataScannerGroupResponseVisitor)
    }
}
