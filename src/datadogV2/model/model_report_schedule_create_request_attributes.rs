...
pub struct ReportScheduleCreateRequestAttributes {
...
impl ReportScheduleCreateRequestAttributes {
    pub fn new(
        description: String,
...
impl<'de> Deserialize<'de> for ReportScheduleCreateRequestAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ReportScheduleCreateRequestAttributesVisitor;
        impl<'a> Visitor<'a> for ReportScheduleCreateRequestAttributesVisitor {
            type Value = ReportScheduleCreateRequestAttributes;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ReportScheduleCreateRequestAttributes {
                    delivery_format,
                    description,
                    recipients,
                    resource_id,
        ...
        deserializer.deserialize_any(ReportScheduleCreateRequestAttributesVisitor)
    }
}
