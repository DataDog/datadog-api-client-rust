...
pub struct EntityV3Service {
    ...
    pub datadog: Option<crate::datadogV2::model::EntityV3ServiceDatadog>,
...
impl EntityV3Service {
    pub fn new(
        ...
        kind: crate::datadogV2::model::EntityV3ServiceKind,
    ...
    pub fn datadog(mut self, value: crate::datadogV2::model::EntityV3ServiceDatadog) -> Self {
    ...
    pub fn spec(mut self, value: crate::datadogV2::model::EntityV3ServiceSpec) -> Self {
...
impl<'de> Deserialize<'de> for EntityV3Service {
    ...
    where
        D: Deserializer<'de>,
    {
        struct EntityV3ServiceVisitor;
        impl<'a> Visitor<'a> for EntityV3ServiceVisitor {
            type Value = EntityV3Service;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut datadog: Option<crate::datadogV2::model::EntityV3ServiceDatadog> = None;
                ...
                let mut kind: Option<crate::datadogV2::model::EntityV3ServiceKind> = None;
                let mut metadata: Option<crate::datadogV2::model::EntityV3Metadata> = None;
                let mut spec: Option<crate::datadogV2::model::EntityV3ServiceSpec> = None;
                    ...
                    match k.as_str() {
                        ...
                        "kind" => {
                            ...
                            if let Some(ref _kind) = kind {
                                match _kind {
                                    crate::datadogV2::model::EntityV3ServiceKind::UnparsedObject(_kind) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(EntityV3ServiceVisitor)
    }
}
