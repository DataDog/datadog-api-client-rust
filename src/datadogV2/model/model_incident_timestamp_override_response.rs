...
pub struct IncidentTimestampOverrideResponse {
    ...
    #[serde(rename = "data")]
    pub data: crate::datadogV2::model::IncidentTimestampOverrideDataResponse,
...
impl IncidentTimestampOverrideResponse {
    pub fn new(
        data: crate::datadogV2::model::IncidentTimestampOverrideDataResponse,
...
impl<'de> Deserialize<'de> for IncidentTimestampOverrideResponse {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for IncidentTimestampOverrideResponseVisitor {
            ...
            {
                let mut data: Option<
                    crate::datadogV2::model::IncidentTimestampOverrideDataResponse,
                > = None;
