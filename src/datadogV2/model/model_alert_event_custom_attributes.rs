...
pub struct AlertEventCustomAttributes {
    ...
    #[serde(rename = "status")]
    pub status: Option<crate::datadogV2::model::AlertEventCustomAttributesStatus>,
    #[serde(skip)]
    #[serde(default)]
...
impl AlertEventCustomAttributes {
    pub fn new() -> AlertEventCustomAttributes {
    ...
    pub fn status(
        mut self,
        value: crate::datadogV2::model::AlertEventCustomAttributesStatus,
    ) -> Self {
...
impl Default for AlertEventCustomAttributes {
    fn default() -> Self {
        Self::new()
    }
}
