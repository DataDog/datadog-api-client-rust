...
pub struct IncidentUserDefinedRoleRelationshipsResponse {
    ...
    pub incident_type:
        Option<crate::datadogV2::model::IncidentUserDefinedRoleIncidentTypeRelationship>,
    /// Relationship to user.
...
impl IncidentUserDefinedRoleRelationshipsResponse {
    pub fn new() -> IncidentUserDefinedRoleRelationshipsResponse {
    ...
    pub fn incident_type(
        mut self,
        value: crate::datadogV2::model::IncidentUserDefinedRoleIncidentTypeRelationship,
    ) -> Self {
...
impl Default for IncidentUserDefinedRoleRelationshipsResponse {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for IncidentUserDefinedRoleRelationshipsResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IncidentUserDefinedRoleRelationshipsResponseVisitor;
        impl<'a> Visitor<'a> for IncidentUserDefinedRoleRelationshipsResponseVisitor {
            type Value = IncidentUserDefinedRoleRelationshipsResponse;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IncidentUserDefinedRoleRelationshipsResponse {
                    created_by_user,
                    incident_type,
                    last_modified_by_user,
        ...
        deserializer.deserialize_any(IncidentUserDefinedRoleRelationshipsResponseVisitor)
    }
}
