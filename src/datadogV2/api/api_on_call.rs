...
/// ListOnCallEscalationPoliciesOptionalParams is a struct for passing parameters to the method [`OnCallAPI::list_on_call_escalation_policies`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct ListOnCallEscalationPoliciesOptionalParams {
...
impl ListOnCallEscalationPoliciesOptionalParams {
    /// Size for a given page. The maximum allowed value is 100.
...
/// ListOnCallScheduleOverridesOptionalParams is a struct for passing parameters to the method [`OnCallAPI::list_on_call_schedule_overrides`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct ListOnCallScheduleOverridesOptionalParams {
    /// Size for a given page. The maximum allowed value is 100.
    pub page_size: Option<i64>,
    /// Specific page number to return.
    pub page_number: Option<i64>,
...
impl ListOnCallScheduleOverridesOptionalParams {
    /// Size for a given page. The maximum allowed value is 100.
    pub fn page_size(mut self, value: i64) -> Self {
        self.page_size = Some(value);
        self
...
/// CreateOnCallScheduleOverrideError is a struct for typed errors of method [`OnCallAPI::create_on_call_schedule_override`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateOnCallScheduleOverrideError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// DeleteOnCallScheduleOverrideError is a struct for typed errors of method [`OnCallAPI::delete_on_call_schedule_override`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteOnCallScheduleOverrideError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// ListOnCallEscalationPoliciesError is a struct for typed errors of method [`OnCallAPI::list_on_call_escalation_policies`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListOnCallEscalationPoliciesError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// ListOnCallScheduleOverridesError is a struct for typed errors of method [`OnCallAPI::list_on_call_schedule_overrides`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListOnCallScheduleOverridesError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl OnCallAPI {
    ...
    pub async fn create_on_call_schedule_override(
        &self,
        schedule_id: String,
        body: crate::datadogV2::model::OverrideRequest,
    ) -> Result<
        crate::datadogV2::model::OverrideResponse,
        datadog::Error<CreateOnCallScheduleOverrideError>,
    > {
        match self
            .create_on_call_schedule_override_with_http_info(schedule_id, body)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Create an override for a given schedule.
    pub async fn create_on_call_schedule_override_with_http_info(
        &self,
        schedule_id: String,
        body: crate::datadogV2::model::OverrideRequest,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::OverrideResponse>,
        datadog::Error<CreateOnCallScheduleOverrideError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.create_on_call_schedule_override";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::OverrideResponse>(&local_content)
            {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
                        status: local_status,
            ...
            let local_entity: Option<CreateOnCallScheduleOverrideError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn delete_on_call_schedule_override(
        &self,
        schedule_id: String,
        override_id: String,
    ) -> Result<(), datadog::Error<DeleteOnCallScheduleOverrideError>> {
        match self
            .delete_on_call_schedule_override_with_http_info(schedule_id, override_id)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    /// Delete an override for a given schedule.
    pub async fn delete_on_call_schedule_override_with_http_info(
        &self,
        schedule_id: String,
        override_id: String,
    ) -> Result<datadog::ResponseContent<()>, datadog::Error<DeleteOnCallScheduleOverrideError>>
    {
        let local_configuration = &self.config;
        let operation_id = "v2.delete_on_call_schedule_override";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteOnCallScheduleOverrideError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_on_call_escalation_policies(
        &self,
        params: ListOnCallEscalationPoliciesOptionalParams,
    ) -> Result<
        crate::datadogV2::model::EscalationPoliciesResponse,
        datadog::Error<ListOnCallEscalationPoliciesError>,
    > {
        match self
            .list_on_call_escalation_policies_with_http_info(params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get a list of all escalation policies.
    pub async fn list_on_call_escalation_policies_with_http_info(
        &self,
        params: ListOnCallEscalationPoliciesOptionalParams,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::EscalationPoliciesResponse>,
        datadog::Error<ListOnCallEscalationPoliciesError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.list_on_call_escalation_policies";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::EscalationPoliciesResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<ListOnCallEscalationPoliciesError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_on_call_schedule_overrides(
        &self,
        schedule_id: String,
        filter_start: String,
        filter_end: String,
        params: ListOnCallScheduleOverridesOptionalParams,
    ) -> Result<
        crate::datadogV2::model::OverridesResponse,
        datadog::Error<ListOnCallScheduleOverridesError>,
    > {
        match self
            .list_on_call_schedule_overrides_with_http_info(
                schedule_id,
                filter_start,
                filter_end,
                params,
    ...
    /// Get a list of all overrides for a given schedule.
    pub async fn list_on_call_schedule_overrides_with_http_info(
        &self,
        schedule_id: String,
        filter_start: String,
        filter_end: String,
        ...
        datadog::ResponseContent<crate::datadogV2::model::OverridesResponse>,
        datadog::Error<ListOnCallScheduleOverridesError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.list_on_call_schedule_overrides";
        ...
        local_req_builder =
            local_req_builder.query(&[("filter[start]", &filter_start.to_string())]);
        local_req_builder = local_req_builder.query(&[("filter[end]", &filter_end.to_string())]);
        if let Some(ref local_query_param) = page_size {
            local_req_builder =
                local_req_builder.query(&[("page[size]", &local_query_param.to_string())]);
        };
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::OverridesResponse>(&local_content)
            {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
                        status: local_status,
            ...
            let local_entity: Option<ListOnCallScheduleOverridesError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    ) -> Result<crate::datadogV2::model::SchedulesResponse, datadog::Error<ListOnCallSchedulesError>>
    {
    ...
    pub async fn list_on_call_schedules_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::SchedulesResponse>,
        datadog::Error<ListOnCallSchedulesError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.list_on_call_schedules";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::SchedulesResponse>(&local_content)
            {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
                        status: local_status,
