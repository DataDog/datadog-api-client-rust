...
impl OnCallAPI {
    ...
    pub async fn delete_on_call_schedule(
        ...
        match self
            .delete_on_call_schedule_with_http_info(schedule_uuid)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    pub async fn delete_on_call_schedule_with_http_info(
        ...
        let local_uri_str = format!(
            ...
            local_configuration.get_operation_host(operation_id),
            schedule_uuid = datadog::urlencode(schedule_uuid)
        );
        let mut local_req_builder =
    ...
    pub async fn get_on_call_schedule(
        ...
        match self
            .get_on_call_schedule_with_http_info(schedule_uuid, params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    pub async fn update_on_call_schedule(
        ...
        match self
            .update_on_call_schedule_with_http_info(schedule_uuid, body, params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
