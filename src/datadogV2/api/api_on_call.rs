...
impl OnCallAPI {
    ...
    /// Create a new notification channel for an on-call user. The authenticated user must be the target user or have `on_call_admin`
    ...
    /// Delete a notification channel for an on-call user. The authenticated user must be the target user or have `on_call_admin`
    ...
    /// Get a notification channel for an on-call user. The authenticated user must be the target user or have `on_call_admin`
    ...
    /// List the notification channels for an on-call user. The authenticated user must be the target user or have `on_call_admin`
