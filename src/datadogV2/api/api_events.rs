...
impl EventsAPI {
    ...
    pub async fn create_event(
        &self,
        body: crate::datadogV2::model::ChangeEventCreateRequestPayload,
    ) -> Result<
        crate::datadogV2::model::ChangeEventCreateResponsePayload,
    ...
    pub async fn create_event_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::ChangeEventCreateResponsePayload>,
        datadog::Error<CreateEventError>,
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.create_event' is not enabled".to_string(),
            };
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::ChangeEventCreateResponsePayload>(
                &local_content,
            ) {
                Ok(e) => {
