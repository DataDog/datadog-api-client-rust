...
/// ListEventEmailAddressesOptionalParams is a struct for passing parameters to the method [`EventsAPI::list_event_email_addresses`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct ListEventEmailAddressesOptionalParams {
...
impl ListEventEmailAddressesOptionalParams {
    /// When set to `true`, returns only active (non-revoked) email addresses.
...
/// DeleteEventEmailAddressError is a struct for typed errors of method [`EventsAPI::delete_event_email_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteEventEmailAddressError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// DeleteOnCallEventEmailAddressError is a struct for typed errors of method [`EventsAPI::delete_on_call_event_email_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteOnCallEventEmailAddressError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// GetEventEmailAddressError is a struct for typed errors of method [`EventsAPI::get_event_email_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEventEmailAddressError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// ListOnCallEventEmailAddressesError is a struct for typed errors of method [`EventsAPI::list_on_call_event_email_addresses`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListOnCallEventEmailAddressesError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// UpdateEventEmailAddressError is a struct for typed errors of method [`EventsAPI::update_event_email_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateEventEmailAddressError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl EventsAPI {
    ...
    pub async fn create_event_email_address(
        &self,
        body: crate::datadogV2::model::EventEmailAddressCreateRequest,
    ) -> Result<
        crate::datadogV2::model::EventEmailAddressSingleResponse,
    ...
    pub async fn create_event_email_address_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::EventEmailAddressSingleResponse>,
        datadog::Error<CreateEventEmailAddressError>,
    > {
        let local_configuration = &self.config;
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::EventEmailAddressSingleResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
    ...
    pub async fn create_on_call_event_email_address(
        &self,
        body: crate::datadogV2::model::OnCallEventEmailAddressCreateRequest,
    ) -> Result<
        crate::datadogV2::model::EventEmailAddressSingleResponse,
    ...
    pub async fn delete_event_email_address(
        &self,
        email_uuid: uuid::Uuid,
    ) -> Result<(), datadog::Error<DeleteEventEmailAddressError>> {
        match self
            .delete_event_email_address_with_http_info(email_uuid)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    /// Revoke an existing API email address in your organization.
    pub async fn delete_event_email_address_with_http_info(
        &self,
        email_uuid: uuid::Uuid,
    ) -> Result<datadog::ResponseContent<()>, datadog::Error<DeleteEventEmailAddressError>> {
        let local_configuration = &self.config;
        let operation_id = "v2.delete_event_email_address";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.delete_event_email_address' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        let local_uri_str = format!(
            ...
            local_configuration.get_operation_host(operation_id),
            email_uuid = datadog::urlencode(email_uuid.to_string())
        );
        let mut local_req_builder =
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteEventEmailAddressError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn delete_on_call_event_email_address(
        &self,
        id: uuid::Uuid,
    ) -> Result<(), datadog::Error<DeleteOnCallEventEmailAddressError>> {
        match self
            .delete_on_call_event_email_address_with_http_info(id)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    /// Revoke an existing on-call event email address in your organization.
    pub async fn delete_on_call_event_email_address_with_http_info(
        &self,
        id: uuid::Uuid,
    ) -> Result<datadog::ResponseContent<()>, datadog::Error<DeleteOnCallEventEmailAddressError>>
    {
        let local_configuration = &self.config;
        let operation_id = "v2.delete_on_call_event_email_address";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.delete_on_call_event_email_address' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteOnCallEventEmailAddressError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_event_email_address(
        &self,
        email_uuid: uuid::Uuid,
    ) -> Result<
        crate::datadogV2::model::EventEmailAddressSingleResponse,
        datadog::Error<GetEventEmailAddressError>,
    > {
        match self
            .get_event_email_address_with_http_info(email_uuid)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get a single API email address for your organization.
    pub async fn get_event_email_address_with_http_info(
        &self,
        email_uuid: uuid::Uuid,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::EventEmailAddressSingleResponse>,
    ...
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.get_event_email_address";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.get_event_email_address' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetEventEmailAddressError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_event_email_addresses(
        &self,
        params: ListEventEmailAddressesOptionalParams,
    ) -> Result<
        crate::datadogV2::model::EventEmailAddressesResponse,
        datadog::Error<ListEventEmailAddressesError>,
    > {
        match self.list_event_email_addresses_with_http_info(params).await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    pub async fn list_event_email_addresses_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::EventEmailAddressesResponse>,
        datadog::Error<ListEventEmailAddressesError>,
    > {
        let local_configuration = &self.config;
        ...
        if let Some(ref local_query_param) = active {
            local_req_builder =
                local_req_builder.query(&[("active", &local_query_param.to_string())]);
        };
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::EventEmailAddressesResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
    ...
    pub async fn list_on_call_event_email_addresses(
        &self,
        filter_team_handle: String,
    ) -> Result<
        crate::datadogV2::model::EventEmailAddressesResponse,
        datadog::Error<ListOnCallEventEmailAddressesError>,
    > {
        match self
            .list_on_call_event_email_addresses_with_http_info(filter_team_handle)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// List all on-call event email addresses for a given team handle.
    pub async fn list_on_call_event_email_addresses_with_http_info(
        &self,
        filter_team_handle: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::EventEmailAddressesResponse>,
    ...
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.list_on_call_event_email_addresses";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.list_on_call_event_email_addresses' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        local_req_builder =
            local_req_builder.query(&[("filter[team_handle]", &filter_team_handle.to_string())]);
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<ListOnCallEventEmailAddressesError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn update_event_email_address(
        &self,
        email_uuid: uuid::Uuid,
        body: crate::datadogV2::model::EventEmailAddressUpdateRequest,
    ) -> Result<
        crate::datadogV2::model::EventEmailAddressSingleResponse,
        datadog::Error<UpdateEventEmailAddressError>,
    > {
        match self
            .update_event_email_address_with_http_info(email_uuid, body)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Update an existing API email address in your organization.
    pub async fn update_event_email_address_with_http_info(
        &self,
        email_uuid: uuid::Uuid,
        body: crate::datadogV2::model::EventEmailAddressUpdateRequest,
    ) -> Result<
    ...
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.update_event_email_address";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.update_event_email_address' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<UpdateEventEmailAddressError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
