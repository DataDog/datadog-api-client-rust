...
impl EventsAPI {
    ...
    ///
    /// ❌ Use the V1 endpoint for use cases involving other event categories.
    ///
    /// ❌ Notifications are not supported for events sent to this endpoint. Use the V1 endpoint for notification functionality.
