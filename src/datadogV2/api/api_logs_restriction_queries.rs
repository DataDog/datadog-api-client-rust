...
/// ReplaceRestrictionQueryError is a struct for typed errors of method [`LogsRestrictionQueriesAPI::replace_restriction_query`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReplaceRestrictionQueryError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl LogsRestrictionQueriesAPI {
    ...
    pub async fn replace_restriction_query(
        &self,
        restriction_query_id: String,
    ...
    /// Replace a restriction query.
    pub async fn replace_restriction_query_with_http_info(
        &self,
        restriction_query_id: String,
        body: crate::datadogV2::model::RestrictionQueryUpdatePayload,
    ) -> Result<
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<ReplaceRestrictionQueryError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
