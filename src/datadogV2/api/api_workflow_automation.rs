...
impl WorkflowAutomationAPI {
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.create_workflow' is not enabled".to_string(),
            };
    ...
    pub async fn delete_workflow_with_http_info(
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.delete_workflow' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.get_workflow' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.update_workflow' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
