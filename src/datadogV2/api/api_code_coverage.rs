...
/// GetCodeCoverageBranchSummaryError is a struct for typed errors of method [`CodeCoverageAPI::get_code_coverage_branch_summary`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCodeCoverageBranchSummaryError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// GetCodeCoverageCommitSummaryError is a struct for typed errors of method [`CodeCoverageAPI::get_code_coverage_commit_summary`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCodeCoverageCommitSummaryError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl Default for CodeCoverageAPI {
    fn default() -> Self {
        Self::with_config(datadog::Configuration::default())
    }
}

impl CodeCoverageAPI {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    > {
        match self
            .get_code_coverage_branch_summary_with_http_info(body)
            .await
        {
            Ok(response_content) => {
    ...
    pub async fn get_code_coverage_branch_summary_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::CoverageSummaryResponse>,
        datadog::Error<GetCodeCoverageBranchSummaryError>,
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::CoverageSummaryResponse>(
                &local_content,
            ) {
                Ok(e) => {
            ...
            let local_entity: Option<GetCodeCoverageBranchSummaryError> =
    ...
    > {
        match self
            .get_code_coverage_commit_summary_with_http_info(body)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetCodeCoverageCommitSummaryError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_code_coverage_files(
        ...
        datadog::Error<GetCodeCoverageFilesError>,
    > {
    ...
    pub async fn get_code_coverage_files_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::FilesCoverageResponse>,
        datadog::Error<GetCodeCoverageFilesError>,
    > {
        let local_configuration = &self.config;
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::FilesCoverageResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<GetCodeCoverageFilesError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_code_coverage_pr_summary(
        ...
        crate::datadogV2::model::CoverageSummaryResponse,
        datadog::Error<GetCodeCoveragePRSummaryError>,
    > {
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetCodeCoveragePRSummaryError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
