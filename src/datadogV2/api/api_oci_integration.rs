...
/// ListTenancyProductsError is a struct for typed errors of method [`OCIIntegrationAPI::list_tenancy_products`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListTenancyProductsError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl OCIIntegrationAPI {
    ...
    pub async fn create_tenancy_config(
        &self,
        body: crate::datadogV2::model::CreateTenancyConfigRequest,
    ) -> Result<crate::datadogV2::model::TenancyConfig, datadog::Error<CreateTenancyConfigError>>
    {
    ...
    pub async fn create_tenancy_config_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::TenancyConfig>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::TenancyConfig>(&local_content) {
                Ok(e) => {
            ...
            let local_entity: Option<CreateTenancyConfigError> =
    ...
    pub async fn delete_tenancy_config(
        &self,
        tenancy_ocid: String,
    ) -> Result<(), datadog::Error<DeleteTenancyConfigError>> {
        match self
    ...
    pub async fn delete_tenancy_config_with_http_info(
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteTenancyConfigError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_tenancy_config(
        &self,
        tenancy_ocid: String,
    ) -> Result<crate::datadogV2::model::TenancyConfig, datadog::Error<GetTenancyConfigError>> {
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetTenancyConfigError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_tenancy_configs(
        &self,
    ) -> Result<crate::datadogV2::model::TenancyConfigList, datadog::Error<GetTenancyConfigsError>>
    {
    ...
    pub async fn get_tenancy_configs_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::TenancyConfigList>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::TenancyConfigList>(&local_content)
            {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
                        status: local_status,
            ...
            let local_entity: Option<GetTenancyConfigsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_tenancy_products(
        &self,
        product_keys: String,
    ) -> Result<
        crate::datadogV2::model::TenancyProductsList,
        datadog::Error<ListTenancyProductsError>,
    > {
        match self
            .list_tenancy_products_with_http_info(product_keys)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Lists the products for a given tenancy. Returns the enabled/disabled status of Datadog products (such as Cloud Security Posture Management) for specific OCI tenancies.
    pub async fn list_tenancy_products_with_http_info(
        &self,
        product_keys: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::TenancyProductsList>,
        datadog::Error<ListTenancyProductsError>,
    > {
        let local_configuration = &self.config;
        ...
        local_req_builder = local_req_builder.query(&[("productKeys", &product_keys.to_string())]);
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::TenancyProductsList>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<ListTenancyProductsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn update_tenancy_config(
        &self,
        tenancy_ocid: String,
        body: crate::datadogV2::model::UpdateTenancyConfigRequest,
    ) -> Result<crate::datadogV2::model::TenancyConfig, datadog::Error<UpdateTenancyConfigError>>
    {
        match self
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<UpdateTenancyConfigError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
