...
impl TeamsAPI {
    ...
    pub async fn create_team_notification_rule(
        &self,
        team_id: String,
        body: crate::datadogV2::model::TeamNotificationRule,
    ) -> Result<
        crate::datadogV2::model::TeamNotificationRule,
    ...
    pub async fn create_team_notification_rule_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::TeamNotificationRule>,
        datadog::Error<CreateTeamNotificationRuleError>,
    > {
        let local_configuration = &self.config;
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::TeamNotificationRule>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
    ...
    pub async fn delete_team_notification_rule(
        ...
        match self
            .delete_team_notification_rule_with_http_info(rule_id, team_id)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    > {
        match self
            .get_team_notification_rule_with_http_info(rule_id, team_id)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    > {
        match self
            .update_team_notification_rule_with_http_info(rule_id, team_id, body)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
