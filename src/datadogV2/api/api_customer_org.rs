...
/// DisableCustomerOrgError is a struct for typed errors of method [`CustomerOrgAPI::disable_customer_org`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DisableCustomerOrgError {
...
#[derive(Debug, Clone)]
pub struct CustomerOrgAPI {
    config: datadog::Configuration,
    client: reqwest_middleware::ClientWithMiddleware,
}

impl Default for CustomerOrgAPI {
    fn default() -> Self {
...
impl CustomerOrgAPI {
    ...
    pub async fn disable_customer_org(
        ...
        crate::datadogV2::model::CustomerOrgDisableResponse,
        datadog::Error<DisableCustomerOrgError>,
    > {
        match self.disable_customer_org_with_http_info(body).await {
            Ok(response_content) => {
    ...
    pub async fn disable_customer_org_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::CustomerOrgDisableResponse>,
        datadog::Error<DisableCustomerOrgError>,
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::CustomerOrgDisableResponse>(
                &local_content,
            ) {
                Ok(e) => {
            ...
            let local_entity: Option<DisableCustomerOrgError> =
