...
/// CreateHamrOrgConnectionError is a struct for typed errors of method [`HighAvailabilityMultiRegionAPI::create_hamr_org_connection`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateHamrOrgConnectionError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// GetHamrOrgConnectionError is a struct for typed errors of method [`HighAvailabilityMultiRegionAPI::get_hamr_org_connection`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetHamrOrgConnectionError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
#[derive(Debug, Clone)]
pub struct HighAvailabilityMultiRegionAPI {
    config: datadog::Configuration,
    client: reqwest_middleware::ClientWithMiddleware,
}

impl Default for HighAvailabilityMultiRegionAPI {
    fn default() -> Self {
        Self::with_config(datadog::Configuration::default())
    }
}

impl HighAvailabilityMultiRegionAPI {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    pub async fn create_hamr_org_connection(
        &self,
        body: crate::datadogV2::model::HamrOrgConnectionRequest,
    ) -> Result<
        crate::datadogV2::model::HamrOrgConnectionResponse,
        datadog::Error<CreateHamrOrgConnectionError>,
    > {
        match self.create_hamr_org_connection_with_http_info(body).await {
            Ok(response_content) => {
    ...
    /// This endpoint allows you to configure the HAMR connection between the authenticated organization
    /// and a target organization, including setting the connection status (ONBOARDING, PASSIVE, FAILOVER, ACTIVE, RECOVERY)
    pub async fn create_hamr_org_connection_with_http_info(
        &self,
        body: crate::datadogV2::model::HamrOrgConnectionRequest,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::HamrOrgConnectionResponse>,
        datadog::Error<CreateHamrOrgConnectionError>,
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::HamrOrgConnectionResponse>(
                &local_content,
            ) {
                Ok(e) => {
            ...
            let local_entity: Option<CreateHamrOrgConnectionError> =
    ...
    pub async fn get_hamr_org_connection(
        &self,
    ) -> Result<
        crate::datadogV2::model::HamrOrgConnectionResponse,
        datadog::Error<GetHamrOrgConnectionError>,
    > {
        match self.get_hamr_org_connection_with_http_info().await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// This endpoint returns information about the HAMR connection configuration, including the target organization,
    /// datacenter, status, and whether this is the primary or secondary organization in the HAMR relationship.
    pub async fn get_hamr_org_connection_with_http_info(
        &self,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::HamrOrgConnectionResponse>,
        datadog::Error<GetHamrOrgConnectionError>,
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetHamrOrgConnectionError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
