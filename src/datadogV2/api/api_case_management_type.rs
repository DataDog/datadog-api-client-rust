...
/// CreateCaseTypeError is a struct for typed errors of method [`CaseManagementTypeAPI::create_case_type`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateCaseTypeError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// DeleteCaseTypeError is a struct for typed errors of method [`CaseManagementTypeAPI::delete_case_type`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteCaseTypeError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// GetAllCaseTypesError is a struct for typed errors of method [`CaseManagementTypeAPI::get_all_case_types`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
impl Default for CaseManagementTypeAPI {
    fn default() -> Self {
        Self::with_config(datadog::Configuration::default())
    }
}

impl CaseManagementTypeAPI {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    ) -> Result<crate::datadogV2::model::CaseTypeResponse, datadog::Error<CreateCaseTypeError>>
    {
        match self.create_case_type_with_http_info(body).await {
            Ok(response_content) => {
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<CreateCaseTypeError> =
    ...
    pub async fn delete_case_type(
        &self,
        case_type_id: String,
    ) -> Result<(), datadog::Error<DeleteCaseTypeError>> {
        match self.delete_case_type_with_http_info(case_type_id).await {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
        }
    }
    ...
    pub async fn delete_case_type_with_http_info(
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteCaseTypeError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    {
        match self.get_all_case_types_with_http_info().await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    pub async fn get_all_case_types_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::CaseTypesResponse>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::CaseTypesResponse>(&local_content)
            {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
                        status: local_status,
