...
/// GetGovernanceConfigError is a struct for typed errors of method [`GovernanceSettingsAPI::get_governance_config`]
...
/// GetGovernanceNotificationSettingsError is a struct for typed errors of method [`GovernanceSettingsAPI::get_governance_notification_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// ListGovernanceLimitsError is a struct for typed errors of method [`GovernanceSettingsAPI::list_governance_limits`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListGovernanceLimitsError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// ListGovernanceResourceLimitsError is a struct for typed errors of method [`GovernanceSettingsAPI::list_governance_resource_limits`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListGovernanceResourceLimitsError {
    JSONAPIErrorResponse(crate::datadogV2::model::JSONAPIErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// UpdateGovernanceNotificationSettingsError is a struct for typed errors of method [`GovernanceSettingsAPI::update_governance_notification_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
#[derive(Debug, Clone)]
pub struct GovernanceSettingsAPI {
    config: datadog::Configuration,
    client: reqwest_middleware::ClientWithMiddleware,
}

impl Default for GovernanceSettingsAPI {
    fn default() -> Self {
        Self::with_config(datadog::Configuration::default())
    }
}

impl GovernanceSettingsAPI {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    > {
        ...
        let operation_id = "v2.get_governance_config";
    ...
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.get_governance_notification_settings";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
    ...
    pub async fn list_governance_limits(
        &self,
    ) -> Result<
        crate::datadogV2::model::GovernanceLimitsResponse,
        datadog::Error<ListGovernanceLimitsError>,
    > {
        match self.list_governance_limits_with_http_info().await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// Each limit reports the query used to compute current usage, the unit and time range it is
    /// measured over, and its current usage status.
    pub async fn list_governance_limits_with_http_info(
        &self,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::GovernanceLimitsResponse>,
        datadog::Error<ListGovernanceLimitsError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.list_governance_limits";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.list_governance_limits' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::GovernanceLimitsResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<ListGovernanceLimitsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_governance_resource_limits(
        &self,
    ) -> Result<
        crate::datadogV2::model::GovernanceResourceLimitsResponse,
        datadog::Error<ListGovernanceResourceLimitsError>,
    > {
        match self.list_governance_resource_limits_with_http_info().await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// Each resource limit reports its current value and configured limit, the queries used to
    /// compute them, and its current usage status.
    pub async fn list_governance_resource_limits_with_http_info(
        &self,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::GovernanceResourceLimitsResponse>,
        datadog::Error<ListGovernanceResourceLimitsError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.list_governance_resource_limits";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.list_governance_resource_limits' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::GovernanceResourceLimitsResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<ListGovernanceResourceLimitsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.update_governance_notification_settings";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
