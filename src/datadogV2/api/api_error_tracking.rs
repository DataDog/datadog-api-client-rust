...
pub struct GetIssueOptionalParams {
    ...
    pub include: Option<Vec<crate::datadogV2::model::IssueIncludeQueryParameterItem>>,
}
...
impl GetIssueOptionalParams {
    ...
    pub fn include(
        mut self,
        value: Vec<crate::datadogV2::model::IssueIncludeQueryParameterItem>,
    ) -> Self {
...
impl ErrorTrackingAPI {
    ...
    ) -> Result<crate::datadogV2::model::IssuesResponse, datadog::Error<SearchIssuesError>> {
    ...
    pub async fn search_issues_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::IssuesResponse>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::IssuesResponse>(&local_content) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
                        status: local_status,
                        content: local_content,
