...
impl ElasticCloudIntegrationAccountsAPI {
    ...
    pub async fn create_elastic_cloud_integration_account(
        &self,
        interface_id: crate::datadogV2::model::ElasticCloudInterfaceId,
        body: crate::datadogV2::model::ElasticCloudIntegrationAccountRequest,
    ) -> Result<
        crate::datadogV2::model::ElasticCloudIntegrationAccountResponse,
        datadog::Error<CreateElasticCloudIntegrationAccountError>,
    > {
        match self
            .create_elastic_cloud_integration_account_with_http_info(interface_id, body)
            .await
        {
            Ok(response_content) => {
    ...
    pub async fn delete_elastic_cloud_integration_account(
        ...
        match self
            .delete_elastic_cloud_integration_account_with_http_info(interface_id, account_id)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    > {
        match self
            .get_elastic_cloud_integration_account_with_http_info(interface_id, account_id)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    > {
        match self
            .list_elastic_cloud_integration_accounts_with_http_info(interface_id)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    > {
        match self
            .update_elastic_cloud_integration_account_with_http_info(interface_id, account_id, body)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
