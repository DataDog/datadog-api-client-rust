...
/// GetEntityRiskScoreError is a struct for typed errors of method [`EntityRiskScoresAPI::get_entity_risk_score`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEntityRiskScoreError {
...
impl EntityRiskScoresAPI {
    ...
    pub async fn get_entity_risk_score(
        &self,
        entity_id: String,
    ) -> Result<
        crate::datadogV2::model::SecurityEntityRiskScoreResponse,
        datadog::Error<GetEntityRiskScoreError>,
    > {
        match self.get_entity_risk_score_with_http_info(entity_id).await {
            Ok(response_content) => {
    ...
    /// Get the risk score for a specific entity by its ID. Returns security risk assessment including risk score, severity, detected signals, misconfigurations, and identity risks.
    pub async fn get_entity_risk_score_with_http_info(
        &self,
        entity_id: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::SecurityEntityRiskScoreResponse>,
        datadog::Error<GetEntityRiskScoreError>,
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::SecurityEntityRiskScoreResponse>(
                &local_content,
            ) {
                Ok(e) => {
            ...
            let local_entity: Option<GetEntityRiskScoreError> =
