...
/// ListTeamConnectionsOptionalParams is a struct for passing parameters to the method [`TeamConnectionsAPI::list_team_connections`]
#[non_exhaustive]
...
/// CreateTeamConnectionsError is a struct for typed errors of method [`TeamConnectionsAPI::create_team_connections`]
...
/// DeleteTeamConnectionsError is a struct for typed errors of method [`TeamConnectionsAPI::delete_team_connections`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// ListTeamConnectionsError is a struct for typed errors of method [`TeamConnectionsAPI::list_team_connections`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
#[derive(Debug, Clone)]
pub struct TeamConnectionsAPI {
    config: datadog::Configuration,
    client: reqwest_middleware::ClientWithMiddleware,
}

impl Default for TeamConnectionsAPI {
    fn default() -> Self {
        Self::with_config(datadog::Configuration::default())
    }
}

impl TeamConnectionsAPI {
    pub fn new() -> Self {
        Self::default()
    }
