...
/// GetSyntheticsBrowserTestResultOptionalParams is a struct for passing parameters to the method [`SyntheticsAPI::get_synthetics_browser_test_result`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct GetSyntheticsBrowserTestResultOptionalParams {
...
impl GetSyntheticsBrowserTestResultOptionalParams {
    /// The event ID used to look up the result in the event store.
...
/// GetSyntheticsTestResultOptionalParams is a struct for passing parameters to the method [`SyntheticsAPI::get_synthetics_test_result`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct GetSyntheticsTestResultOptionalParams {
    /// The event ID used to look up the result in the event store.
    pub event_id: Option<String>,
    /// Timestamp in seconds to look up the result.
    pub timestamp: Option<i64>,
...
impl GetSyntheticsTestResultOptionalParams {
    /// The event ID used to look up the result in the event store.
    pub fn event_id(mut self, value: String) -> Self {
        self.event_id = Some(value);
        self
...
/// ListSyntheticsBrowserTestLatestResultsOptionalParams is a struct for passing parameters to the method [`SyntheticsAPI::list_synthetics_browser_test_latest_results`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct ListSyntheticsBrowserTestLatestResultsOptionalParams {
...
impl ListSyntheticsBrowserTestLatestResultsOptionalParams {
    /// Timestamp in milliseconds from which to start querying results.
    ...
    /// Device IDs for which to query results.
    pub fn device_id(mut self, value: Vec<String>) -> Self {
...
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct ListSyntheticsTestLatestResultsOptionalParams {
    /// Timestamp in milliseconds from which to start querying results.
    pub from_ts: Option<i64>,
    /// Timestamp in milliseconds up to which to query results.
    pub to_ts: Option<i64>,
...
impl ListSyntheticsTestLatestResultsOptionalParams {
    /// Timestamp in milliseconds from which to start querying results.
    pub fn from_ts(mut self, value: i64) -> Self {
        self.from_ts = Some(value);
        self
...
/// GetSyntheticsBrowserTestResultError is a struct for typed errors of method [`SyntheticsAPI::get_synthetics_browser_test_result`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// GetSyntheticsTestResultError is a struct for typed errors of method [`SyntheticsAPI::get_synthetics_test_result`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSyntheticsTestResultError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// ListSyntheticsBrowserTestLatestResultsError is a struct for typed errors of method [`SyntheticsAPI::list_synthetics_browser_test_latest_results`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListSyntheticsBrowserTestLatestResultsError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListSyntheticsTestLatestResultsError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// PollSyntheticsTestResultsError is a struct for typed errors of method [`SyntheticsAPI::poll_synthetics_test_results`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PollSyntheticsTestResultsError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl SyntheticsAPI {
    ...
    pub async fn get_synthetics_browser_test_result(
        &self,
        public_id: String,
        result_id: String,
        params: GetSyntheticsBrowserTestResultOptionalParams,
    ) -> Result<
        crate::datadogV2::model::SyntheticsTestResultResponse,
        datadog::Error<GetSyntheticsBrowserTestResultError>,
    > {
        match self
            .get_synthetics_browser_test_result_with_http_info(public_id, result_id, params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get a specific full result from a given Synthetic browser test.
    pub async fn get_synthetics_browser_test_result_with_http_info(
        &self,
        public_id: String,
        result_id: String,
        params: GetSyntheticsBrowserTestResultOptionalParams,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::SyntheticsTestResultResponse>,
        datadog::Error<GetSyntheticsBrowserTestResultError>,
    > {
        let local_configuration = &self.config;
        ...
        if let Some(ref local_query_param) = event_id {
            local_req_builder =
                local_req_builder.query(&[("event_id", &local_query_param.to_string())]);
        };
        if let Some(ref local_query_param) = timestamp {
            local_req_builder =
                local_req_builder.query(&[("timestamp", &local_query_param.to_string())]);
        };
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::SyntheticsTestResultResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
    ...
    pub async fn get_synthetics_test_result(
        &self,
        public_id: String,
        result_id: String,
        params: GetSyntheticsTestResultOptionalParams,
    ) -> Result<
        crate::datadogV2::model::SyntheticsTestResultResponse,
        datadog::Error<GetSyntheticsTestResultError>,
    > {
        match self
            .get_synthetics_test_result_with_http_info(public_id, result_id, params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get a specific full result from a given Synthetic test.
    pub async fn get_synthetics_test_result_with_http_info(
        &self,
        public_id: String,
        result_id: String,
        params: GetSyntheticsTestResultOptionalParams,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetSyntheticsTestResultError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_synthetics_browser_test_latest_results(
        &self,
        public_id: String,
        params: ListSyntheticsBrowserTestLatestResultsOptionalParams,
    ) -> Result<
        crate::datadogV2::model::SyntheticsTestLatestResultsResponse,
        datadog::Error<ListSyntheticsBrowserTestLatestResultsError>,
    > {
        match self
            .list_synthetics_browser_test_latest_results_with_http_info(public_id, params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get the latest result summaries for a given Synthetic browser test.
    pub async fn list_synthetics_browser_test_latest_results_with_http_info(
        &self,
        public_id: String,
        params: ListSyntheticsBrowserTestLatestResultsOptionalParams,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::SyntheticsTestLatestResultsResponse>,
        datadog::Error<ListSyntheticsBrowserTestLatestResultsError>,
    > {
        let local_configuration = &self.config;
        ...
        if let Some(ref local_query_param) = run_type {
            local_req_builder =
                local_req_builder.query(&[("runType", &local_query_param.to_string())]);
        };
        ...
        if let Some(ref local) = device_id {
            for param in local {
                local_req_builder = local_req_builder.query(&[("device_id", &param.to_string())]);
            }
        };
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::SyntheticsTestLatestResultsResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<ListSyntheticsBrowserTestLatestResultsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_synthetics_test_latest_results(
        &self,
        public_id: String,
        params: ListSyntheticsTestLatestResultsOptionalParams,
    ) -> Result<
        crate::datadogV2::model::SyntheticsTestLatestResultsResponse,
        datadog::Error<ListSyntheticsTestLatestResultsError>,
    > {
        match self
            .list_synthetics_test_latest_results_with_http_info(public_id, params)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get the latest result summaries for a given Synthetic test.
    pub async fn list_synthetics_test_latest_results_with_http_info(
        &self,
        public_id: String,
        params: ListSyntheticsTestLatestResultsOptionalParams,
    ) -> Result<
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<ListSyntheticsTestLatestResultsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    /// triggering tests via CI/CD to retrieve results once they are available.
    pub async fn poll_synthetics_test_results(
        &self,
        result_ids: String,
    ) -> Result<
        crate::datadogV2::model::SyntheticsPollTestResultsResponse,
        datadog::Error<PollSyntheticsTestResultsError>,
    > {
        match self
            .poll_synthetics_test_results_with_http_info(result_ids)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Poll for test results given a list of result IDs. This is typically used after
    /// triggering tests via CI/CD to retrieve results once they are available.
    pub async fn poll_synthetics_test_results_with_http_info(
        &self,
        result_ids: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::SyntheticsPollTestResultsResponse>,
        datadog::Error<PollSyntheticsTestResultsError>,
    > {
        let local_configuration = &self.config;
        ...
        local_req_builder = local_req_builder.query(&[("result_ids", &result_ids.to_string())]);
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::SyntheticsPollTestResultsResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<PollSyntheticsTestResultsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
