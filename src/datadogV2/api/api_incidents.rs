...
impl IncidentsAPI {
    ...
    pub async fn create_page_from_incident(
        ...
        crate::datadogV2::model::IncidentCreatePageResponse,
    ...
    pub async fn create_page_from_incident_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::IncidentCreatePageResponse>,
        datadog::Error<CreatePageFromIncidentError>,
    > {
        let local_configuration = &self.config;
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::IncidentCreatePageResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
