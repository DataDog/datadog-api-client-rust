...
/// CreateApplicationSecurityExclusionFilterError is a struct for typed errors of method [`ApplicationSecurityAPI::create_application_security_exclusion_filter`]
...
/// DeleteApplicationSecurityExclusionFilterError is a struct for typed errors of method [`ApplicationSecurityAPI::delete_application_security_exclusion_filter`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// GetApplicationSecurityExclusionFilterError is a struct for typed errors of method [`ApplicationSecurityAPI::get_application_security_exclusion_filter`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetApplicationSecurityExclusionFilterError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}

/// ListApplicationSecurityExclusionFiltersError is a struct for typed errors of method [`ApplicationSecurityAPI::list_application_security_exclusion_filters`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// UpdateApplicationSecurityExclusionFilterError is a struct for typed errors of method [`ApplicationSecurityAPI::update_application_security_exclusion_filter`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
impl ApplicationSecurityAPI {
    ...
    pub async fn create_application_security_exclusion_filter(
        &self,
        body: crate::datadogV2::model::ApplicationSecurityExclusionFilterRequest,
    ) -> Result<
    ...
    pub async fn get_application_security_exclusion_filter(
        &self,
        exclusion_filter_id: String,
    ) -> Result<
        crate::datadogV2::model::ApplicationSecurityExclusionFilterResponse,
        datadog::Error<GetApplicationSecurityExclusionFilterError>,
    > {
        match self
            .get_application_security_exclusion_filter_with_http_info(exclusion_filter_id)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Retrieve a specific Application Security exclusion filter using its identifier.
    pub async fn get_application_security_exclusion_filter_with_http_info(
        &self,
        exclusion_filter_id: String,
    ) -> Result<
        datadog::ResponseContent<
    ...
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.get_application_security_exclusion_filter";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetApplicationSecurityExclusionFilterError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn list_application_security_exclusion_filters(
        ...
        crate::datadogV2::model::ApplicationSecurityExclusionFiltersResponse,
