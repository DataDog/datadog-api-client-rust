...
/// GetWidgetsFromImageOptionalParams is a struct for passing parameters to the method [`StegadographyAPI::get_widgets_from_image`]
#[non_exhaustive]
#[derive(Clone, Default, Debug)]
pub struct GetWidgetsFromImageOptionalParams {
    /// A PNG image (for example, a dashboard screenshot) containing embedded widget watermarks.
    pub image: Option<Vec<u8>>,
}

impl GetWidgetsFromImageOptionalParams {
    /// A PNG image (for example, a dashboard screenshot) containing embedded widget watermarks.
...
/// GetWidgetsFromImageError is a struct for typed errors of method [`StegadographyAPI::get_widgets_from_image`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetWidgetsFromImageError {
...
impl StegadographyAPI {
    ...
    pub async fn get_widgets_from_image(
        &self,
        params: GetWidgetsFromImageOptionalParams,
    ) -> Result<
        crate::datadogV2::model::StegadographyWidgetsResponse,
        datadog::Error<GetWidgetsFromImageError>,
    > {
        match self.get_widgets_from_image_with_http_info(params).await {
            Ok(response_content) => {
    ...
    pub async fn get_widgets_from_image_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::StegadographyWidgetsResponse>,
        datadog::Error<GetWidgetsFromImageError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.get_widgets_from_image";
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            warn!("Using unstable operation {operation_id}");
        } else {
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.get_widgets_from_image' is not enabled".to_string(),
            };
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::StegadographyWidgetsResponse>(
                &local_content,
            ) {
                Ok(e) => {
            ...
            let local_entity: Option<GetWidgetsFromImageError> =
