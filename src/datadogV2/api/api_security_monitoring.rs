...
pub struct ListVulnerabilitiesOptionalParams {
    ...
    pub filter_cvss_base_severity: Option<crate::datadogV2::model::Severity>,
    ...
    pub filter_cvss_datadog_severity: Option<crate::datadogV2::model::Severity>,
    ...
    pub filter_status: Option<crate::datadogV2::model::Status>,
    /// Filter by the tool of the vulnerability.
    pub filter_tool: Option<crate::datadogV2::model::Tool>,
    ...
    pub filter_risks_epss_severity: Option<crate::datadogV2::model::Severity>,
    /// Filter by language.
    pub filter_language: Option<String>,
    /// Filter by ecosystem.
    pub filter_ecosystem: Option<crate::datadogV2::model::Ecosystem>,
...
impl ListVulnerabilitiesOptionalParams {
    ...
    /// Filter by vulnerability base severity.
    pub fn filter_cvss_base_severity(mut self, value: crate::datadogV2::model::Severity) -> Self {
    ...
    pub fn filter_cvss_datadog_severity(
        mut self,
        value: crate::datadogV2::model::Severity,
    ) -> Self {
    ...
    /// Filter by the status of the vulnerability.
    pub fn filter_status(mut self, value: crate::datadogV2::model::Status) -> Self {
        self.filter_status = Some(value);
        self
    }
    /// Filter by the tool of the vulnerability.
    pub fn filter_tool(mut self, value: crate::datadogV2::model::Tool) -> Self {
    ...
    /// Filter by vulnerability [EPSS](<https://www.first.org/epss/>) severity.
    pub fn filter_risks_epss_severity(mut self, value: crate::datadogV2::model::Severity) -> Self {
    ...
    /// Filter by ecosystem.
    pub fn filter_ecosystem(mut self, value: crate::datadogV2::model::Ecosystem) -> Self {
...
impl SecurityMonitoringAPI {
    ...
    /// ### Filtering
    ///
    /// The request can include some filter params to filter the data to be retrieved. The format of the filter params follows the [JSON:API format](<https://jsonapi.org/format/#fetching-filtering>): `filter[$prop_name]`, where `prop_name` is the property name in the entity being filtered by.
    ///
