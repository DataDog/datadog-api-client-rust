...
/// RetrieveCustomFrameworkError is a struct for typed errors of method [`SecurityMonitoringAPI::retrieve_custom_framework`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RetrieveCustomFrameworkError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl SecurityMonitoringAPI {
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.create_custom_framework' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
    ...
    pub async fn delete_custom_framework(
        ...
        handle: String,
        version: String,
    ) -> Result<(), datadog::Error<DeleteCustomFrameworkError>> {
        match self
    ...
    pub async fn delete_custom_framework_with_http_info(
        ...
        handle: String,
        version: String,
    ) -> Result<datadog::ResponseContent<()>, datadog::Error<DeleteCustomFrameworkError>> {
        let local_configuration = &self.config;
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.delete_custom_framework' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
    ...
    pub async fn retrieve_custom_framework(
        &self,
        handle: String,
        version: String,
    ) -> Result<
        crate::datadogV2::model::RetrieveCustomFrameworkResponse,
        datadog::Error<RetrieveCustomFrameworkError>,
    > {
        match self
            .retrieve_custom_framework_with_http_info(handle, version)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Retrieve a custom framework.
    pub async fn retrieve_custom_framework_with_http_info(
        &self,
        handle: String,
        version: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::RetrieveCustomFrameworkResponse>,
        datadog::Error<RetrieveCustomFrameworkError>,
    > {
        let local_configuration = &self.config;
        let operation_id = "v2.retrieve_custom_framework";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::RetrieveCustomFrameworkResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<RetrieveCustomFrameworkError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.update_custom_framework' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
