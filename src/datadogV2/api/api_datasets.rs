...
impl DatasetsAPI {
    ...
    pub async fn create_dataset(
        &self,
        body: crate::datadogV2::model::DatasetCreateRequest,
    ) -> Result<crate::datadogV2::model::DatasetResponseSingle, datadog::Error<CreateDatasetError>>
    {
        match self.create_dataset_with_http_info(body).await {
            Ok(response_content) => {
    ...
    /// Create a dataset with the configurations in the request.
    pub async fn create_dataset_with_http_info(
        &self,
        body: crate::datadogV2::model::DatasetCreateRequest,
    ) -> Result<
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<CreateDatasetError> =
    ...
    pub async fn delete_dataset(
        &self,
        dataset_id: String,
    ) -> Result<(), datadog::Error<DeleteDatasetError>> {
        match self.delete_dataset_with_http_info(dataset_id).await {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
        }
    }
    ...
    /// Deletes the dataset associated with the ID.
    pub async fn delete_dataset_with_http_info(
        &self,
        dataset_id: String,
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteDatasetError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_all_datasets(
        &self,
    ) -> Result<crate::datadogV2::model::DatasetResponseMulti, datadog::Error<GetAllDatasetsError>>
    {
        match self.get_all_datasets_with_http_info().await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// Get all datasets that have been configured for an organization.
    pub async fn get_all_datasets_with_http_info(
        &self,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::DatasetResponseMulti>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::DatasetResponseMulti>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
            ...
            let local_entity: Option<GetAllDatasetsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_dataset(
        &self,
        dataset_id: String,
    ) -> Result<crate::datadogV2::model::DatasetResponseSingle, datadog::Error<GetDatasetError>>
    {
        match self.get_dataset_with_http_info(dataset_id).await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// Retrieves the dataset associated with the ID.
    pub async fn get_dataset_with_http_info(
        &self,
        dataset_id: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::DatasetResponseSingle>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetDatasetError> = serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
                entity: local_entity,
