...
impl RUMAPI {
    ...
    > {
        ...
        let local_uri_str = format!(
            ...
            local_configuration.get_operation_host("v2.create_rum_application")
        );
        let mut local_req_builder =
            local_client.request(reqwest::Method::POST, local_uri_str.as_str());
    ...
    pub async fn delete_rum_application_with_http_info(
        ...
        let local_uri_str = format!(
            ...
            local_configuration.get_operation_host("v2.delete_rum_application"),
            id = urlencode(id)
        );
        let mut local_req_builder =
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v2/rum/applications/{id}",
            local_configuration.get_operation_host("v2.get_rum_application"),
            id = urlencode(id)
        );
        let mut local_req_builder =
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v2/rum/applications",
            local_configuration.get_operation_host("v2.get_rum_applications")
        );
        let mut local_req_builder =
            local_client.request(reqwest::Method::GET, local_uri_str.as_str());
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v2/rum/events",
            local_configuration.get_operation_host("v2.list_rum_events")
        );
        let mut local_req_builder =
            local_client.request(reqwest::Method::GET, local_uri_str.as_str());
    ...
    > {
        ...
        let local_uri_str = format!(
            ...
            local_configuration.get_operation_host("v2.search_rum_events")
        );
        let mut local_req_builder =
            local_client.request(reqwest::Method::POST, local_uri_str.as_str());
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v2/rum/applications/{id}",
            local_configuration.get_operation_host("v2.update_rum_application"),
            id = urlencode(id)
        );
        let mut local_req_builder =
