...
impl LogsMetricsAPI {
    ...
    ) -> Result<crate::datadogV2::model::LogsMetricResponse, datadog::Error<CreateLogsMetricError>>
    {
    ...
    pub async fn create_logs_metric_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::LogsMetricResponse>,
    ...
    pub async fn delete_logs_metric(
        &self,
        metric_id: String,
    ) -> Result<(), datadog::Error<DeleteLogsMetricError>> {
    ...
    pub async fn get_logs_metric(
        &self,
        metric_id: String,
    ) -> Result<crate::datadogV2::model::LogsMetricResponse, datadog::Error<GetLogsMetricError>>
    {
    ...
    pub async fn list_logs_metrics(
        &self,
    ) -> Result<crate::datadogV2::model::LogsMetricsResponse, datadog::Error<ListLogsMetricsError>>
    {
    ...
    pub async fn list_logs_metrics_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::LogsMetricsResponse>,
    ...
    ) -> Result<crate::datadogV2::model::LogsMetricResponse, datadog::Error<UpdateLogsMetricError>>
    {
        match self
