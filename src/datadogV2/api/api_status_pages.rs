...
impl StatusPagesAPI {
    ...
    /// Creates a new backfilled degradation with pre-defined updates.
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.create_backfilled_degradation' is not enabled".to_string(),
            };
    ...
    /// Creates a new backfilled maintenance with pre-defined updates.
    ...
    > {
        ...
        if local_configuration.is_unstable_operation_enabled(operation_id) {
            ...
            let local_error = datadog::UnstableOperationDisabledError {
                msg: "Operation 'v2.create_backfilled_maintenance' is not enabled".to_string(),
            };
            return Err(datadog::Error::UnstableOperationDisabledError(local_error));
        }
