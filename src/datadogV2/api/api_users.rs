...
/// DeleteUserInvitationsError is a struct for typed errors of method [`UsersAPI::delete_user_invitations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteUserInvitationsError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// GetCurrentUserError is a struct for typed errors of method [`UsersAPI::get_current_user`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// GetUserIdentityProvidersError is a struct for typed errors of method [`UsersAPI::get_user_identity_providers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetUserIdentityProvidersError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
/// UpdateCurrentUserError is a struct for typed errors of method [`UsersAPI::update_current_user`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// UpdateUserIdentityProvidersError is a struct for typed errors of method [`UsersAPI::update_user_identity_providers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateUserIdentityProvidersError {
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
impl UsersAPI {
    ...
    pub async fn delete_user_invitations(
        &self,
        user_id: uuid::Uuid,
    ) -> Result<(), datadog::Error<DeleteUserInvitationsError>> {
        match self.delete_user_invitations_with_http_info(user_id).await {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
        }
    }
    ...
    /// Cancel all pending invitations for a specified user.
    /// Requires the `user_access_invite` permission.
    pub async fn delete_user_invitations_with_http_info(
        &self,
        user_id: uuid::Uuid,
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeleteUserInvitationsError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_current_user(
        &self,
    ) -> Result<crate::datadogV2::model::UserResponse, datadog::Error<GetCurrentUserError>> {
        match self.get_current_user_with_http_info().await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// assigned roles with their granted permissions, and team-scoped roles.
    /// No additional permissions are required beyond valid authentication.
    pub async fn get_current_user_with_http_info(
        &self,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::UserResponse>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetCurrentUserError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_user_identity_providers(
        &self,
        user_id: String,
    ) -> Result<
        crate::datadogV2::model::UserOverrideIdentityProvidersResponse,
        datadog::Error<GetUserIdentityProvidersError>,
    > {
        match self
            .get_user_identity_providers_with_http_info(user_id)
            .await
        {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
    ...
    /// Get the identity provider overrides for a specific user in the organization.
    /// When a user has no overrides set, they use the organization's default identity providers.
    pub async fn get_user_identity_providers_with_http_info(
        &self,
        user_id: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::UserOverrideIdentityProvidersResponse>,
        datadog::Error<GetUserIdentityProvidersError>,
    > {
        let local_configuration = &self.config;
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetUserIdentityProvidersError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    ) -> Result<crate::datadogV2::model::UserResponse, datadog::Error<UpdateCurrentUserError>> {
        match self.update_current_user_with_http_info(body).await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// returns a 422 error. Email address changes are recorded in the audit trail.
    /// Requires the `user_self_profile_write` permission.
    pub async fn update_current_user_with_http_info(
        &self,
        body: crate::datadogV2::model::UserUpdateRequest,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::UserResponse>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<UpdateCurrentUserError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn update_user_identity_providers(
        &self,
        user_id: String,
        body: crate::datadogV2::model::UpdateUserIdentityProvidersRequest,
    ) -> Result<(), datadog::Error<UpdateUserIdentityProvidersError>> {
        match self
            .update_user_identity_providers_with_http_info(user_id, body)
            .await
        {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
    ...
    /// Pass an empty list to remove all overrides, reverting the user to the organization's
    /// default identity providers.
    pub async fn update_user_identity_providers_with_http_info(
        &self,
        user_id: String,
        body: crate::datadogV2::model::UpdateUserIdentityProvidersRequest,
    ) -> Result<datadog::ResponseContent<()>, datadog::Error<UpdateUserIdentityProvidersError>>
    {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<UpdateUserIdentityProvidersError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
