...
/// DeletePipelineError is a struct for typed errors of method [`ObservabilityPipelinesAPI::delete_pipeline`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// GetPipelineError is a struct for typed errors of method [`ObservabilityPipelinesAPI::get_pipeline`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub enum ValidatePipelineError {
    ValidationErrorResponse(crate::datadogV2::model::ValidationErrorResponse),
    APIErrorResponse(crate::datadogV2::model::APIErrorResponse),
    UnknownValue(serde_json::Value),
}
...
#[derive(Debug, Clone)]
pub struct ObservabilityPipelinesAPI {
    config: datadog::Configuration,
    client: reqwest_middleware::ClientWithMiddleware,
}

impl Default for ObservabilityPipelinesAPI {
    fn default() -> Self {
...
impl ObservabilityPipelinesAPI {
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::ObservabilityPipeline>(
                &local_content,
            ) {
                Ok(e) => {
            ...
            let local_entity: Option<CreatePipelineError> =
    ...
    pub async fn delete_pipeline(
        &self,
        pipeline_id: String,
    ) -> Result<(), datadog::Error<DeletePipelineError>> {
        match self.delete_pipeline_with_http_info(pipeline_id).await {
            Ok(_) => Ok(()),
            Err(err) => Err(err),
        }
    }
    ...
    /// Delete a pipeline.
    pub async fn delete_pipeline_with_http_info(
        &self,
        pipeline_id: String,
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<DeletePipelineError> =
                serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
    ...
    pub async fn get_pipeline(
        &self,
        pipeline_id: String,
    ) -> Result<crate::datadogV2::model::ObservabilityPipeline, datadog::Error<GetPipelineError>>
    {
        match self.get_pipeline_with_http_info(pipeline_id).await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// Get a specific pipeline by its ID.
    pub async fn get_pipeline_with_http_info(
        &self,
        pipeline_id: String,
    ) -> Result<
        datadog::ResponseContent<crate::datadogV2::model::ObservabilityPipeline>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<GetPipelineError> = serde_json::from_str(&local_content).ok();
            let local_error = datadog::ResponseContent {
                status: local_status,
                content: local_content,
                entity: local_entity,
    ...
    pub async fn update_pipeline(
        &self,
        pipeline_id: String,
        body: crate::datadogV2::model::ObservabilityPipeline,
    ) -> Result<crate::datadogV2::model::ObservabilityPipeline, datadog::Error<UpdatePipelineError>>
    {
        match self.update_pipeline_with_http_info(pipeline_id, body).await {
            Ok(response_content) => {
                if let Some(e) = response_content.entity {
                    Ok(e)
                } else {
    ...
    /// Update a pipeline.
    pub async fn update_pipeline_with_http_info(
        &self,
        pipeline_id: String,
        body: crate::datadogV2::model::ObservabilityPipeline,
    ) -> Result<
    ...
    pub async fn validate_pipeline(
        ...
        crate::datadogV2::model::ValidationErrorResponse,
    ...
    pub async fn validate_pipeline_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::ValidationErrorResponse>,
        datadog::Error<ValidatePipelineError>,
    > {
        let local_configuration = &self.config;
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::ValidationErrorResponse>(
                &local_content,
            ) {
                Ok(e) => {
                    return Ok(datadog::ResponseContent {
