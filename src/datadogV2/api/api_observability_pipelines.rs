...
impl ObservabilityPipelinesAPI {
    ...
    pub async fn create_pipeline(
        &self,
        body: crate::datadogV2::model::PipelineCreateRequest,
    ) -> Result<crate::datadogV2::model::Pipeline, datadog::Error<CreatePipelineError>> {
    ...
    pub async fn create_pipeline_with_http_info(
        ...
        datadog::ResponseContent<crate::datadogV2::model::Pipeline>,
    ...
    > {
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            match serde_json::from_str::<crate::datadogV2::model::Pipeline>(&local_content) {
                Ok(e) => {
    ...
    pub async fn get_pipeline(
        &self,
        pipeline_id: String,
    ) -> Result<crate::datadogV2::model::Pipeline, datadog::Error<GetPipelineError>> {
    ...
    pub async fn update_pipeline(
        &self,
        pipeline_id: String,
        body: crate::datadogV2::model::Pipeline,
    ) -> Result<crate::datadogV2::model::Pipeline, datadog::Error<UpdatePipelineError>> {
