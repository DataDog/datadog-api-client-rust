...
/// BatchUpdateCSMThreatsAgentPolicyError is a struct for typed errors of method [`CSMThreatsAPI::batch_update_csm_threats_agent_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BatchUpdateCSMThreatsAgentPolicyError {
...
impl CSMThreatsAPI {
    ...
    pub async fn batch_update_csm_threats_agent_policy(
        &self,
        body: crate::datadogV2::model::CloudWorkloadSecurityAgentPolicyBatchUpdateRequest,
    ) -> Result<
        crate::datadogV2::model::CloudWorkloadSecurityAgentPoliciesListResponse,
        datadog::Error<BatchUpdateCSMThreatsAgentPolicyError>,
    > {
        match self
            .batch_update_csm_threats_agent_policy_with_http_info(body)
            .await
        {
            Ok(response_content) => {
    ...
    /// Update Cloud Security Management Threats Agent policies.
    /// Returns the Agent policies objects when the request is successful.
    pub async fn batch_update_csm_threats_agent_policy_with_http_info(
        &self,
        body: crate::datadogV2::model::CloudWorkloadSecurityAgentPolicyBatchUpdateRequest,
    ) -> Result<
    ...
    > {
        ...
        let operation_id = "v2.batch_update_csm_threats_agent_policy";
        ...
        if !local_status.is_client_error() && !local_status.is_server_error() {
            ...
            let local_entity: Option<BatchUpdateCSMThreatsAgentPolicyError> =
