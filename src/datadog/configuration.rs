...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.create_aws_accountv2".to_owned(), false),
            ("v2.delete_aws_accountv2".to_owned(), false),
            ("v2.get_aws_accountv2".to_owned(), false),
            ("v2.list_aws_accountsv2".to_owned(), false),
            ("v2.patch_aws_accountv2".to_owned(), false),
