...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.accept_recommended_entities".to_owned(), false),
            ("v2.convert_catalog_entities".to_owned(), false),
            ("v2.decline_recommended_entities".to_owned(), false),
            ("v2.get_idp_config_value".to_owned(), false),
            ("v2.trigger_recommended_entities".to_owned(), false),
            ("v2.upsert_idp_config_value".to_owned(), false),
