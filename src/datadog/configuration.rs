...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.add_case_insights".to_owned(), false),
            ("v2.aggregate_cases".to_owned(), false),
            ("v2.bulk_update_cases".to_owned(), false),
            ("v2.count_cases".to_owned(), false),
            ("v2.create_case_automation_rule".to_owned(), false),
            ("v2.create_case_jira_issue".to_owned(), false),
            ("v2.create_case_link".to_owned(), false),
            ("v2.create_case_notebook".to_owned(), false),
            ("v2.create_case_service_now_ticket".to_owned(), false),
            ("v2.create_case_view".to_owned(), false),
            ("v2.create_maintenance_window".to_owned(), false),
            ("v2.delete_case_automation_rule".to_owned(), false),
            ("v2.delete_case_link".to_owned(), false),
            ("v2.delete_case_view".to_owned(), false),
            ("v2.delete_maintenance_window".to_owned(), false),
            ("v2.disable_case_automation_rule".to_owned(), false),
            ("v2.enable_case_automation_rule".to_owned(), false),
            ("v2.favorite_case_project".to_owned(), false),
            ("v2.get_case_automation_rule".to_owned(), false),
            ("v2.get_case_view".to_owned(), false),
            ("v2.link_incident".to_owned(), false),
            ("v2.link_jira_issue_to_case".to_owned(), false),
            ("v2.list_case_automation_rules".to_owned(), false),
            ("v2.list_case_links".to_owned(), false),
            ("v2.list_case_timeline".to_owned(), false),
            ("v2.list_case_views".to_owned(), false),
            ("v2.list_case_watchers".to_owned(), false),
            ("v2.list_maintenance_windows".to_owned(), false),
            ("v2.list_user_case_project_favorites".to_owned(), false),
            ("v2.move_case_to_project".to_owned(), false),
            ("v2.remove_case_insights".to_owned(), false),
            ("v2.unfavorite_case_project".to_owned(), false),
            ("v2.unlink_jira_issue".to_owned(), false),
            ("v2.unwatch_case".to_owned(), false),
            ("v2.update_case_automation_rule".to_owned(), false),
            ("v2.update_case_comment".to_owned(), false),
            ("v2.update_case_due_date".to_owned(), false),
            ("v2.update_case_resolved_reason".to_owned(), false),
            ("v2.update_case_view".to_owned(), false),
            ("v2.update_maintenance_window".to_owned(), false),
            ("v2.watch_case".to_owned(), false),
            ("v2.update_case_type".to_owned(), false),
            ("v2.update_custom_attribute_config".to_owned(), false),
            ...
            (
                "v2.batch_create_incident_rule_execution_states".to_owned(),
                false,
            ),
            (
                "v2.batch_update_incident_rule_execution_states".to_owned(),
                false,
            ),
            ...
            ("v2.create_incident_communication".to_owned(), false),
            ("v2.create_incident_google_meet_space".to_owned(), false),
            ("v2.create_incident_integration".to_owned(), false),
            ("v2.create_incident_jira_issue".to_owned(), false),
            ("v2.create_incident_jira_template".to_owned(), false),
            (
                "v2.create_incident_microsoft_teams_configuration".to_owned(),
                false,
            ),
            (
                "v2.create_incident_ms_teams_online_meeting".to_owned(),
                false,
            ),
            ...
            ("v2.create_incident_role_assignment".to_owned(), false),
            ("v2.create_incident_statuspage_incident".to_owned(), false),
            ("v2.create_incident_status_page_notice".to_owned(), false),
            ("v2.create_incident_timeline_entry".to_owned(), false),
            ...
            ("v2.create_incident_zoom_configuration".to_owned(), false),
            ("v2.create_incident_zoom_meeting".to_owned(), false),
            ("v2.create_statuspage_email_subscription".to_owned(), false),
            ...
            ("v2.delete_incident_communication".to_owned(), false),
            ("v2.delete_incident_integration".to_owned(), false),
            ("v2.delete_incident_jira_template".to_owned(), false),
            ...
            ("v2.delete_incident_role_assignment".to_owned(), false),
            ("v2.delete_incident_timeline_entry".to_owned(), false),
            ...
            ("v2.export_incidents".to_owned(), false),
            ("v2.get_global_incident_settings".to_owned(), false),
            ("v2.get_incident".to_owned(), false),
            ("v2.get_incident_automation_data".to_owned(), false),
            ("v2.get_incident_case_source_link".to_owned(), false),
            ("v2.get_incident_communication".to_owned(), false),
            ("v2.get_incident_integration".to_owned(), false),
            ("v2.get_incident_jira_template".to_owned(), false),
            ("v2.get_incident_notification_rule".to_owned(), false),
            ("v2.get_incident_notification_template".to_owned(), false),
            (
                "v2.get_incident_pagerduty_related_incidents".to_owned(),
                false,
            ),
            ("v2.get_incident_page_source_link".to_owned(), false),
            ("v2.get_incident_postmortem_template".to_owned(), false),
            ("v2.get_incident_reserved_role".to_owned(), false),
            ("v2.get_incident_role_assignment".to_owned(), false),
            ("v2.get_incident_status_pages_suggestion".to_owned(), false),
            ("v2.get_incident_timeline_entry_thread".to_owned(), false),
            ("v2.get_incident_todo".to_owned(), false),
            ("v2.get_incident_type".to_owned(), false),
            ("v2.get_incident_user_defined_field".to_owned(), false),
            (
                "v2.get_statuspage_subscription_preferences".to_owned(),
                false,
            ),
            ...
            ("v2.list_incident_communications".to_owned(), false),
            ("v2.list_incident_integrations".to_owned(), false),
            ("v2.list_incident_jira_templates".to_owned(), false),
            ("v2.list_incident_notification_rules".to_owned(), false),
            ("v2.list_incident_notification_templates".to_owned(), false),
            ("v2.list_incident_pagerduty_services".to_owned(), false),
            ("v2.list_incident_postmortem_templates".to_owned(), false),
            ("v2.list_incident_reserved_roles".to_owned(), false),
            ("v2.list_incident_rule_execution_states".to_owned(), false),
            ("v2.list_incidents".to_owned(), false),
            ("v2.list_incident_template_variables".to_owned(), false),
            ("v2.list_incident_timeline_entries".to_owned(), false),
            ...
            ("v2.list_statuspage_email_subscriptions".to_owned(), false),
            ("v2.patch_incident_notification_rule".to_owned(), false),
            ("v2.render_incident_template".to_owned(), false),
            ("v2.search_incidents".to_owned(), false),
            ("v2.search_incidents_v2".to_owned(), false),
            ...
            ("v2.update_incident_communication".to_owned(), false),
            ("v2.update_incident_integration".to_owned(), false),
            ("v2.update_incident_jira_template".to_owned(), false),
            (
                "v2.update_incident_microsoft_teams_configuration".to_owned(),
                false,
            ),
            ...
            ("v2.update_incident_statuspage_incident".to_owned(), false),
            ("v2.update_incident_status_page_notice".to_owned(), false),
            ("v2.update_incident_timeline_entry".to_owned(), false),
            ...
            ("v2.update_incident_zoom_configuration".to_owned(), false),
            ("v2.upsert_incident_automation_data".to_owned(), false),
