...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.create_rum_segment".to_owned(), false),
            ("v2.create_rum_static_segment".to_owned(), false),
            ("v2.delete_rum_segment".to_owned(), false),
            ("v2.get_rum_segment".to_owned(), false),
            ("v2.initialize_rum_segments".to_owned(), false),
            ("v2.list_rum_segments".to_owned(), false),
            ("v2.list_rum_segment_templates".to_owned(), false),
            ("v2.update_rum_segment".to_owned(), false),
