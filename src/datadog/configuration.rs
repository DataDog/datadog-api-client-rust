...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.get_replay_analysis_issue".to_owned(), false),
            ("v2.list_replay_analysis_issues".to_owned(), false),
            ("v2.list_replay_analysis_issue_sessions".to_owned(), false),
            ("v2.generate_replay_summary".to_owned(), false),
