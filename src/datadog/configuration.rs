...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.create_scorecard_campaign".to_owned(), false),
            ("v2.create_scorecard_outcomes_batch".to_owned(), false),
            ("v2.create_scorecard_rule".to_owned(), false),
            ("v2.delete_scorecard_campaign".to_owned(), false),
            ("v2.delete_scorecard_rule".to_owned(), false),
            ("v2.delete_scorecard_rule_workflow".to_owned(), false),
            ("v2.generate_scorecard_campaign_report".to_owned(), false),
            (
                "v2.generate_scorecard_campaign_team_reports".to_owned(),
                false,
            ),
            ("v2.get_scorecard_campaign".to_owned(), false),
            ("v2.list_scorecard_campaigns".to_owned(), false),
            ("v2.list_scorecard_default_rules".to_owned(), false),
            ("v2.list_scorecard_facets".to_owned(), false),
            ("v2.list_scorecard_outcomes".to_owned(), false),
            ("v2.list_scorecard_rules".to_owned(), false),
            ("v2.list_scorecards".to_owned(), false),
            ("v2.list_scorecard_scores".to_owned(), false),
            ("v2.setup_scorecard_rules".to_owned(), false),
            ("v2.update_scorecard_campaign".to_owned(), false),
            ("v2.update_scorecard_outcomes_async".to_owned(), false),
            ("v2.update_scorecard_rule".to_owned(), false),
            ("v2.update_scorecard_rule_workflow".to_owned(), false),
