...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.upsert_sync_config".to_owned(), false),
            ("v2.get_code_coverage_branch_summary".to_owned(), false),
            ("v2.get_code_coverage_commit_summary".to_owned(), false),
            ("v2.get_cost_ai_preferred_tags".to_owned(), false),
            ("v2.get_cost_setting".to_owned(), false),
            ("v2.list_cost_tag_pipeline_active_keys".to_owned(), false),
            ("v2.list_custom_allocation_rules_status".to_owned(), false),
            ("v2.list_tag_pipelines_rulesets_status".to_owned(), false),
