...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.create_elastic_cloud_ccm_account".to_owned(), false),
            (
                "v2.create_elastic_cloud_monitoring_account".to_owned(),
                false,
            ),
            ("v2.delete_elastic_cloud_ccm_account".to_owned(), false),
            (
                "v2.delete_elastic_cloud_monitoring_account".to_owned(),
                false,
            ),
            ("v2.get_elastic_cloud_ccm_account".to_owned(), false),
            ("v2.get_elastic_cloud_monitoring_account".to_owned(), false),
            ("v2.list_elastic_cloud_ccm_accounts".to_owned(), false),
            (
                "v2.list_elastic_cloud_monitoring_accounts".to_owned(),
                false,
            ),
            ("v2.update_elastic_cloud_ccm_account".to_owned(), false),
            (
                "v2.update_elastic_cloud_monitoring_account".to_owned(),
                false,
            ),
            ("v2.create_twilio_account".to_owned(), false),
            ("v2.delete_twilio_account".to_owned(), false),
            ("v2.get_twilio_account".to_owned(), false),
            ("v2.list_twilio_accounts".to_owned(), false),
            ("v2.update_twilio_account".to_owned(), false),
