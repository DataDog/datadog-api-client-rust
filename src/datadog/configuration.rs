...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.create_incident_config_rule".to_owned(), false),
            ...
            ("v2.delete_incident_config_rule".to_owned(), false),
            ...
            ("v2.get_incident_config_rule".to_owned(), false),
            ...
            ("v2.list_incident_config_rules".to_owned(), false),
            ...
            ("v2.update_incident_config_rule".to_owned(), false),
