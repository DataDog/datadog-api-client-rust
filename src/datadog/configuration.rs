...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.get_rum_cohort".to_owned(), false),
            ("v2.get_rum_cohort_users".to_owned(), false),
            ("v2.get_rum_funnel".to_owned(), false),
            ("v2.get_rum_funnel_step_suggestions".to_owned(), false),
            ("v2.get_rum_sankey".to_owned(), false),
