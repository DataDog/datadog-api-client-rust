...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.get_llm_obs_annotated_interaction".to_owned(), false),
            ...
            ("v2.create_execution_policy".to_owned(), false),
            ("v2.delete_execution_policy".to_owned(), false),
            ("v2.get_execution_policy".to_owned(), false),
            ("v2.list_execution_policies".to_owned(), false),
            ("v2.update_execution_policy".to_owned(), false),
            ...
            ("v2.create_unit_cost".to_owned(), false),
            ("v2.delete_unit_cost".to_owned(), false),
            ...
            ("v2.get_unit_cost".to_owned(), false),
            ...
            ("v2.list_unit_costs".to_owned(), false),
            ...
            ("v2.get_governance_detection".to_owned(), false),
            ...
            ("v2.mitigate_governance_detections".to_owned(), false),
            ("v2.update_governance_control".to_owned(), false),
            (
                "v2.update_governance_control_notification_settings".to_owned(),
                false,
            ),
            ("v2.update_governance_detection".to_owned(), false),
            (
                "v2.update_governance_notification_settings".to_owned(),
                false,
            ),
            ("v2.create_tag_rule".to_owned(), false),
            ("v2.delete_tag_rule".to_owned(), false),
            ("v2.get_tag_rule".to_owned(), false),
            ("v2.get_tag_rule_score".to_owned(), false),
            ("v2.list_tag_rules".to_owned(), false),
            ("v2.update_tag_rule".to_owned(), false),
            ...
            ("v2.create_databricks_integration_account".to_owned(), false),
            ("v2.delete_databricks_integration_account".to_owned(), false),
            ("v2.get_databricks_integration_account".to_owned(), false),
            ("v2.list_databricks_integration_accounts".to_owned(), false),
            ("v2.update_databricks_integration_account".to_owned(), false),
            (
            ...
            ("v2.create_snowflake_integration_account".to_owned(), false),
            ("v2.delete_snowflake_integration_account".to_owned(), false),
            ("v2.get_snowflake_integration_account".to_owned(), false),
            ("v2.list_snowflake_integration_accounts".to_owned(), false),
            ("v2.update_snowflake_integration_account".to_owned(), false),
            ...
            ("v2.create_exclusion_filter".to_owned(), false),
            ("v2.delete_exclusion_filter".to_owned(), false),
            ("v2.get_exclusion_filter".to_owned(), false),
            ("v2.list_exclusion_filters".to_owned(), false),
            ("v2.update_exclusion_filter".to_owned(), false),
            ("v2.create_rum_config".to_owned(), false),
            ("v2.get_rum_config".to_owned(), false),
            ("v2.update_rum_config".to_owned(), false),
            ("v2.create_teams_ownership_mapping".to_owned(), false),
            ("v2.create_teams_ownership_mappings_batch".to_owned(), false),
            ("v2.delete_teams_ownership_mapping".to_owned(), false),
            ("v2.get_teams_ownership_mapping".to_owned(), false),
            ("v2.list_teams_ownership_mappings".to_owned(), false),
            ("v2.list_teams_ownership_rules".to_owned(), false),
            ("v2.create_rum_operation".to_owned(), false),
            ("v2.create_rum_operation_strong_link".to_owned(), false),
            ("v2.delete_rum_operation".to_owned(), false),
            ("v2.delete_rum_operation_strong_link".to_owned(), false),
            ("v2.get_rum_operation".to_owned(), false),
            ("v2.get_rum_operation_by_name".to_owned(), false),
            ("v2.list_rum_operations".to_owned(), false),
