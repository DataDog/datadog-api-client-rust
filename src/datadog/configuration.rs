...
impl Default for Configuration {
    fn default() -> Self {
        let unstable_operations = HashMap::from([
            ...
            ("v2.create_integration_account".to_owned(), false),
            ("v2.delete_integration_account".to_owned(), false),
            ("v2.get_integration_account".to_owned(), false),
            ("v2.list_integration_accounts".to_owned(), false),
            ("v2.update_integration_account".to_owned(), false),
