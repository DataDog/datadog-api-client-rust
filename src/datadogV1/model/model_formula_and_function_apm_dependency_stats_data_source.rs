...
impl Serialize for FormulaAndFunctionApmDependencyStatsDataSource {
...
impl<'de> Deserialize<'de> for FormulaAndFunctionApmDependencyStatsDataSource {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match s.as_str() {
            "apm_dependency_stats" => Self::APM_DEPENDENCY_STATS,
