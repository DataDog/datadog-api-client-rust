...
impl<'de> Deserialize<'de> for DbmExplainPlansRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DbmExplainPlansRequestVisitor;
        impl<'a> Visitor<'a> for DbmExplainPlansRequestVisitor {
            type Value = DbmExplainPlansRequest;
        ...
        deserializer.deserialize_any(DbmExplainPlansRequestVisitor)
    }
}
