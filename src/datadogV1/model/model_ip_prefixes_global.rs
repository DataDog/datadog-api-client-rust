...
impl IPPrefixesGlobal {
    pub fn new() -> IPPrefixesGlobal {
        IPPrefixesGlobal {
            prefixes_ipv4: None,
            prefixes_ipv6: None,
            _unparsed: false,
...
impl<'de> Deserialize<'de> for IPPrefixesGlobal {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IPPrefixesGlobalVisitor;
        impl<'a> Visitor<'a> for IPPrefixesGlobalVisitor {
            type Value = IPPrefixesGlobal;
        ...
        deserializer.deserialize_any(IPPrefixesGlobalVisitor)
    }
}
