...
pub struct TopologyQueryDataStreams {
    /// Name of the data source.
    #[serde(rename = "data_source")]
    pub data_source: crate::datadogV1::model::TopologyQueryDataStreamsDataSource,
...
impl TopologyQueryDataStreams {
    pub fn new(
        data_source: crate::datadogV1::model::TopologyQueryDataStreamsDataSource,
        filters: Vec<String>,
        service: String,
...
impl<'de> Deserialize<'de> for TopologyQueryDataStreams {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TopologyQueryDataStreamsVisitor;
        impl<'a> Visitor<'a> for TopologyQueryDataStreamsVisitor {
            type Value = TopologyQueryDataStreams;
                ...
                M: MapAccess<'a>,
            {
                let mut data_source: Option<
                    crate::datadogV1::model::TopologyQueryDataStreamsDataSource,
                > = None;
                    ...
                    match k.as_str() {
                        "data_source" => {
                            ...
                            if let Some(ref _data_source) = data_source {
                                match _data_source {
                                    crate::datadogV1::model::TopologyQueryDataStreamsDataSource::UnparsedObject(_data_source) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = TopologyQueryDataStreams {
                    data_source,
                    filters,
                    query_string,
                    service,
        ...
        deserializer.deserialize_any(TopologyQueryDataStreamsVisitor)
    }
}
