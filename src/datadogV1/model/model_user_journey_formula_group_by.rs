...
pub struct UserJourneyFormulaGroupBy {
...
impl UserJourneyFormulaGroupBy {
    pub fn new(facet: String) -> UserJourneyFormulaGroupBy {
...
impl<'de> Deserialize<'de> for UserJourneyFormulaGroupBy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UserJourneyFormulaGroupByVisitor;
        impl<'a> Visitor<'a> for UserJourneyFormulaGroupByVisitor {
            type Value = UserJourneyFormulaGroupBy;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = UserJourneyFormulaGroupBy {
                    facet,
                    limit,
                    should_exclude_missing,
                    sort,
        ...
        deserializer.deserialize_any(UserJourneyFormulaGroupByVisitor)
    }
}
