...
impl<'de> Deserialize<'de> for DashboardBulkDeleteRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DashboardBulkDeleteRequestVisitor;
        impl<'a> Visitor<'a> for DashboardBulkDeleteRequestVisitor {
            type Value = DashboardBulkDeleteRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = DashboardBulkDeleteRequest { data, _unparsed };

                Ok(content)
            }
        }

        deserializer.deserialize_any(DashboardBulkDeleteRequestVisitor)
    }
}
