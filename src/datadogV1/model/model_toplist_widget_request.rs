...
impl<'de> Deserialize<'de> for ToplistWidgetRequest {
    ...
    where
        D: Deserializer<'de>,
    {
        struct ToplistWidgetRequestVisitor;
        impl<'a> Visitor<'a> for ToplistWidgetRequestVisitor {
            type Value = ToplistWidgetRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ToplistWidgetRequest {
                    apm_query,
                    audit_query,
                    conditional_formats,
                    event_query,
        ...
        deserializer.deserialize_any(ToplistWidgetRequestVisitor)
    }
}
