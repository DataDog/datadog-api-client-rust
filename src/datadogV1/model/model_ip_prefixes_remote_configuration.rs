...
pub struct IPPrefixesRemoteConfiguration {
...
impl IPPrefixesRemoteConfiguration {
    pub fn new() -> IPPrefixesRemoteConfiguration {
...
impl<'de> Deserialize<'de> for IPPrefixesRemoteConfiguration {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IPPrefixesRemoteConfigurationVisitor;
        impl<'a> Visitor<'a> for IPPrefixesRemoteConfigurationVisitor {
            type Value = IPPrefixesRemoteConfiguration;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IPPrefixesRemoteConfiguration {
                    prefixes_ipv4,
                    prefixes_ipv6,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(IPPrefixesRemoteConfigurationVisitor)
    }
}
