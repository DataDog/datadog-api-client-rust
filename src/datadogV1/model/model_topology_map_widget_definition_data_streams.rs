...
pub struct TopologyMapWidgetDefinitionDataStreams {
    ...
    pub requests: Vec<crate::datadogV1::model::TopologyRequestDataStreams>,
...
impl TopologyMapWidgetDefinitionDataStreams {
    pub fn new(
        requests: Vec<crate::datadogV1::model::TopologyRequestDataStreams>,
...
impl<'de> Deserialize<'de> for TopologyMapWidgetDefinitionDataStreams {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TopologyMapWidgetDefinitionDataStreamsVisitor;
        impl<'a> Visitor<'a> for TopologyMapWidgetDefinitionDataStreamsVisitor {
            type Value = TopologyMapWidgetDefinitionDataStreams;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut requests: Option<Vec<crate::datadogV1::model::TopologyRequestDataStreams>> =
                    None;
                ...
                let mut type_: Option<crate::datadogV1::model::TopologyMapWidgetDefinitionType> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV1::model::TopologyMapWidgetDefinitionType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = TopologyMapWidgetDefinitionDataStreams {
                    custom_links,
                    description,
                    requests,
                    time,
        ...
        deserializer.deserialize_any(TopologyMapWidgetDefinitionDataStreamsVisitor)
    }
}
