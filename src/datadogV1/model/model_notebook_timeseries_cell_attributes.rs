...
impl<'de> Deserialize<'de> for NotebookTimeseriesCellAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct NotebookTimeseriesCellAttributesVisitor;
        impl<'a> Visitor<'a> for NotebookTimeseriesCellAttributesVisitor {
            type Value = NotebookTimeseriesCellAttributes;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut definition: Option<crate::datadogV1::model::TimeseriesWidgetDefinition> =
                    None;
                ...
                let content = NotebookTimeseriesCellAttributes {
                    definition,
                    graph_size,
                    split_by,
                    time,
        ...
        deserializer.deserialize_any(NotebookTimeseriesCellAttributesVisitor)
    }
}
