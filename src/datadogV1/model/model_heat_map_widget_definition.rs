...
pub struct HeatMapWidgetDefinition {
    ...
    #[serde(rename = "yaxis")]
    pub yaxis: Option<crate::datadogV1::model::HeatMapWidgetYAxis>,
    #[serde(flatten)]
...
impl HeatMapWidgetDefinition {
    ...
    pub fn yaxis(mut self, value: crate::datadogV1::model::HeatMapWidgetYAxis) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for HeatMapWidgetDefinitionVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut yaxis: Option<crate::datadogV1::model::HeatMapWidgetYAxis> = None;
