...
pub struct IPPrefixesSyntheticsPrivateLocations {
...
impl IPPrefixesSyntheticsPrivateLocations {
    pub fn new() -> IPPrefixesSyntheticsPrivateLocations {
...
impl<'de> Deserialize<'de> for IPPrefixesSyntheticsPrivateLocations {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IPPrefixesSyntheticsPrivateLocationsVisitor;
        impl<'a> Visitor<'a> for IPPrefixesSyntheticsPrivateLocationsVisitor {
            type Value = IPPrefixesSyntheticsPrivateLocations;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IPPrefixesSyntheticsPrivateLocations {
                    prefixes_ipv4,
                    prefixes_ipv6,
        ...
        deserializer.deserialize_any(IPPrefixesSyntheticsPrivateLocationsVisitor)
    }
}
