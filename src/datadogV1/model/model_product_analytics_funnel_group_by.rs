...
pub struct ProductAnalyticsFunnelGroupBy {
    /// Facet to group by.
    #[serde(rename = "facet")]
    pub facet: String,
    ...
    #[serde(rename = "sort")]
    pub sort: Option<crate::datadogV1::model::ProductAnalyticsFunnelGroupBySort>,
...
impl ProductAnalyticsFunnelGroupBy {
    pub fn new(facet: String) -> ProductAnalyticsFunnelGroupBy {
    ...
    pub fn sort(
        mut self,
        value: crate::datadogV1::model::ProductAnalyticsFunnelGroupBySort,
    ) -> Self {
...
impl<'de> Deserialize<'de> for ProductAnalyticsFunnelGroupBy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsFunnelGroupByVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsFunnelGroupByVisitor {
            type Value = ProductAnalyticsFunnelGroupBy;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut sort: Option<crate::datadogV1::model::ProductAnalyticsFunnelGroupBySort> =
                    None;
                ...
                let content = ProductAnalyticsFunnelGroupBy {
                    facet,
                    limit,
                    should_exclude_missing,
                    sort,
        ...
        deserializer.deserialize_any(ProductAnalyticsFunnelGroupByVisitor)
    }
}
