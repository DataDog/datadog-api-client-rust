...
impl<'de> Deserialize<'de> for NotebookToplistCellAttributes {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct NotebookToplistCellAttributesVisitor;
        impl<'a> Visitor<'a> for NotebookToplistCellAttributesVisitor {
            type Value = NotebookToplistCellAttributes;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut definition: Option<crate::datadogV1::model::ToplistWidgetDefinition> = None;
                ...
                let content = NotebookToplistCellAttributes {
                    definition,
                    graph_size,
                    split_by,
                    time,
        ...
        deserializer.deserialize_any(NotebookToplistCellAttributesVisitor)
    }
}
