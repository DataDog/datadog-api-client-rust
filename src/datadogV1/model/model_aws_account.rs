...
impl AWSAccount {
    ...
    pub fn with_access_key_id(&mut self, value: String) -> &mut Self {
    ...
    pub fn with_account_specific_namespace_rules(
        &mut self,
    ...
    pub fn with_cspm_resource_collection_enabled(&mut self, value: bool) -> &mut Self {
        self.cspm_resource_collection_enabled = Some(value);
        self
    }

    pub fn with_excluded_regions(&mut self, value: Vec<String>) -> &mut Self {
        self.excluded_regions = Some(value);
        self
    }

    pub fn with_filter_tags(&mut self, value: Vec<String>) -> &mut Self {
        self.filter_tags = Some(value);
        self
    }

    pub fn with_host_tags(&mut self, value: Vec<String>) -> &mut Self {
        self.host_tags = Some(value);
        self
    }

    pub fn with_metrics_collection_enabled(&mut self, value: bool) -> &mut Self {
    ...
    pub fn with_role_name(&mut self, value: String) -> &mut Self {
        self.role_name = Some(value);
        self
    }

    pub fn with_secret_access_key(&mut self, value: String) -> &mut Self {
