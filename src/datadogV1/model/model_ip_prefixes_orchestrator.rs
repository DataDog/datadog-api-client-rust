...
impl<'de> Deserialize<'de> for IPPrefixesOrchestrator {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct IPPrefixesOrchestratorVisitor;
        impl<'a> Visitor<'a> for IPPrefixesOrchestratorVisitor {
            type Value = IPPrefixesOrchestrator;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = IPPrefixesOrchestrator {
                    prefixes_ipv4,
                    prefixes_ipv6,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(IPPrefixesOrchestratorVisitor)
    }
}
