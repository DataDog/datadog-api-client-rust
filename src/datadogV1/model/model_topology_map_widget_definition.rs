...
impl<'de> Deserialize<'de> for TopologyMapWidgetDefinition {
    ...
    where
        D: Deserializer<'de>,
    {
        struct TopologyMapWidgetDefinitionVisitor;
        impl<'a> Visitor<'a> for TopologyMapWidgetDefinitionVisitor {
            type Value = TopologyMapWidgetDefinition;
        ...
        deserializer.deserialize_any(TopologyMapWidgetDefinitionVisitor)
    }
}
