...
pub struct ProductAnalyticsFunnelGroupBySort {
    /// Aggregation type.
...
impl ProductAnalyticsFunnelGroupBySort {
    pub fn new(aggregation: String) -> ProductAnalyticsFunnelGroupBySort {
...
impl<'de> Deserialize<'de> for ProductAnalyticsFunnelGroupBySort {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ProductAnalyticsFunnelGroupBySortVisitor;
        impl<'a> Visitor<'a> for ProductAnalyticsFunnelGroupBySortVisitor {
            type Value = ProductAnalyticsFunnelGroupBySort;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = ProductAnalyticsFunnelGroupBySort {
                    aggregation,
                    metric,
                    order,
                    _unparsed,
        ...
        deserializer.deserialize_any(ProductAnalyticsFunnelGroupBySortVisitor)
    }
}
