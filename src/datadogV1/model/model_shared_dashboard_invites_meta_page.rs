...
impl<'de> Deserialize<'de> for SharedDashboardInvitesMetaPage {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SharedDashboardInvitesMetaPageVisitor;
        impl<'a> Visitor<'a> for SharedDashboardInvitesMetaPageVisitor {
            type Value = SharedDashboardInvitesMetaPage;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SharedDashboardInvitesMetaPage {
                    total_count,
                    _unparsed,
                };
        ...
        deserializer.deserialize_any(SharedDashboardInvitesMetaPageVisitor)
    }
}
