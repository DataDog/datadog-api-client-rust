...
pub struct GCPMonitoredResourceConfig {
    ...
    #[serde(rename = "type")]
    pub type_: Option<crate::datadogV1::model::GCPMonitoredResourceConfigType>,
    #[serde(flatten)]
...
impl GCPMonitoredResourceConfig {
    ...
    pub fn type_(mut self, value: crate::datadogV1::model::GCPMonitoredResourceConfigType) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for GCPMonitoredResourceConfigVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV1::model::GCPMonitoredResourceConfigType> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV1::model::GCPMonitoredResourceConfigType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
