...
pub struct PointPlotWidgetDefinition {
    ...
    #[serde(rename = "legend")]
    pub legend: Option<crate::datadogV1::model::PointPlotWidgetLegend>,
    ...
    pub requests: Vec<crate::datadogV1::model::PointPlotWidgetRequest>,
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV1::model::PointPlotWidgetDefinitionType,
...
impl PointPlotWidgetDefinition {
    pub fn new(
        requests: Vec<crate::datadogV1::model::PointPlotWidgetRequest>,
        type_: crate::datadogV1::model::PointPlotWidgetDefinitionType,
    ...
    pub fn legend(mut self, value: crate::datadogV1::model::PointPlotWidgetLegend) -> Self {
...
impl<'de> Deserialize<'de> for PointPlotWidgetDefinition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct PointPlotWidgetDefinitionVisitor;
        impl<'a> Visitor<'a> for PointPlotWidgetDefinitionVisitor {
            type Value = PointPlotWidgetDefinition;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut legend: Option<crate::datadogV1::model::PointPlotWidgetLegend> = None;
                let mut markers: Option<Vec<crate::datadogV1::model::WidgetMarker>> = None;
                let mut requests: Option<Vec<crate::datadogV1::model::PointPlotWidgetRequest>> =
                    None;
                ...
                let mut type_: Option<crate::datadogV1::model::PointPlotWidgetDefinitionType> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV1::model::PointPlotWidgetDefinitionType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = PointPlotWidgetDefinition {
                    custom_links,
                    description,
                    legend,
                    markers,
        ...
        deserializer.deserialize_any(PointPlotWidgetDefinitionVisitor)
    }
}
