...
pub struct SyntheticsMobileStepParams {
    ...
    #[serde(rename = "check")]
    pub check: Option<crate::datadogV1::model::SyntheticsMobileStepParamsCheck>,
    ...
    pub position: Option<crate::datadogV1::model::SyntheticsMobileStepParamsPosition>,
...
impl SyntheticsMobileStepParams {
    ...
    pub fn check(
        mut self,
        value: crate::datadogV1::model::SyntheticsMobileStepParamsCheck,
    ) -> Self {
    ...
    pub fn position(
        mut self,
        value: crate::datadogV1::model::SyntheticsMobileStepParamsPosition,
    ) -> Self {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for SyntheticsMobileStepParamsVisitor {
            ...
            where
                M: MapAccess<'a>,
            {
                let mut check: Option<crate::datadogV1::model::SyntheticsMobileStepParamsCheck> =
                    None;
                ...
                let mut position: Option<
                    crate::datadogV1::model::SyntheticsMobileStepParamsPosition,
                > = None;
