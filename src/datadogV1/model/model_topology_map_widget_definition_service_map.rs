...
pub struct TopologyMapWidgetDefinitionServiceMap {
    ...
    pub requests: Vec<crate::datadogV1::model::TopologyRequestServiceMap>,
...
impl TopologyMapWidgetDefinitionServiceMap {
    pub fn new(
        requests: Vec<crate::datadogV1::model::TopologyRequestServiceMap>,
...
impl<'de> Deserialize<'de> for TopologyMapWidgetDefinitionServiceMap {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct TopologyMapWidgetDefinitionServiceMapVisitor;
        impl<'a> Visitor<'a> for TopologyMapWidgetDefinitionServiceMapVisitor {
            type Value = TopologyMapWidgetDefinitionServiceMap;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut requests: Option<Vec<crate::datadogV1::model::TopologyRequestServiceMap>> =
                    None;
                ...
                let content = TopologyMapWidgetDefinitionServiceMap {
                    custom_links,
                    description,
                    requests,
                    time,
        ...
        deserializer.deserialize_any(TopologyMapWidgetDefinitionServiceMapVisitor)
    }
}
