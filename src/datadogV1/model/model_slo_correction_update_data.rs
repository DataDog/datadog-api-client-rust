...
impl<'de> Deserialize<'de> for SLOCorrectionUpdateData {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SLOCorrectionUpdateDataVisitor;
        impl<'a> Visitor<'a> for SLOCorrectionUpdateDataVisitor {
            type Value = SLOCorrectionUpdateData;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV1::model::SLOCorrectionUpdateRequestAttributes,
                > = None;
                ...
                let content = SLOCorrectionUpdateData {
                    attributes,
                    type_,
        ...
        deserializer.deserialize_any(SLOCorrectionUpdateDataVisitor)
    }
}
