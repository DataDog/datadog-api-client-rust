...
impl<'de> Deserialize<'de> for SyntheticsTriggerBody {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SyntheticsTriggerBodyVisitor;
        impl<'a> Visitor<'a> for SyntheticsTriggerBodyVisitor {
            type Value = SyntheticsTriggerBody;
        ...
        deserializer.deserialize_any(SyntheticsTriggerBodyVisitor)
    }
}
