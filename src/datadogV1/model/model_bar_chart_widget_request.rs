...
pub struct BarChartWidgetRequest {
    /// The log query.
...
impl BarChartWidgetRequest {
    pub fn new() -> BarChartWidgetRequest {
        #[allow(deprecated)]
...
impl Default for BarChartWidgetRequest {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for BarChartWidgetRequest {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct BarChartWidgetRequestVisitor;
        impl<'a> Visitor<'a> for BarChartWidgetRequestVisitor {
            type Value = BarChartWidgetRequest;
                ...
                M: MapAccess<'a>,
            {
                ...
                #[allow(deprecated)]
                let content = BarChartWidgetRequest {
                    apm_query,
                    audit_query,
                    conditional_formats,
                    event_query,
        ...
        deserializer.deserialize_any(BarChartWidgetRequestVisitor)
    }
}
