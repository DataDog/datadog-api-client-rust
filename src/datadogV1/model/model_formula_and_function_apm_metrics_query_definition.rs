...
pub struct FormulaAndFunctionApmMetricsQueryDefinition {
    /// Data source for APM metrics queries.
    #[serde(rename = "data_source")]
    pub data_source: crate::datadogV1::model::FormulaAndFunctionApmMetricsDataSource,
    ...
    pub span_kind: Option<crate::datadogV1::model::FormulaAndFunctionApmMetricsSpanKind>,
    /// APM metric stat name.
    #[serde(rename = "stat")]
    pub stat: crate::datadogV1::model::FormulaAndFunctionApmMetricStatName,
    #[serde(flatten)]
...
impl FormulaAndFunctionApmMetricsQueryDefinition {
    pub fn new(
        data_source: crate::datadogV1::model::FormulaAndFunctionApmMetricsDataSource,
        name: String,
        stat: crate::datadogV1::model::FormulaAndFunctionApmMetricStatName,
    ...
    pub fn span_kind(
        mut self,
        value: crate::datadogV1::model::FormulaAndFunctionApmMetricsSpanKind,
    ) -> Self {
...
impl<'de> Deserialize<'de> for FormulaAndFunctionApmMetricsQueryDefinition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct FormulaAndFunctionApmMetricsQueryDefinitionVisitor;
        impl<'a> Visitor<'a> for FormulaAndFunctionApmMetricsQueryDefinitionVisitor {
            type Value = FormulaAndFunctionApmMetricsQueryDefinition;
                ...
                M: MapAccess<'a>,
            {
                let mut data_source: Option<
                    crate::datadogV1::model::FormulaAndFunctionApmMetricsDataSource,
                > = None;
                ...
                let mut span_kind: Option<
                    crate::datadogV1::model::FormulaAndFunctionApmMetricsSpanKind,
                > = None;
                let mut stat: Option<crate::datadogV1::model::FormulaAndFunctionApmMetricStatName> =
                    None;
                    ...
                    match k.as_str() {
                        "data_source" => {
                            ...
                            if let Some(ref _data_source) = data_source {
                                match _data_source {
                                    crate::datadogV1::model::FormulaAndFunctionApmMetricsDataSource::UnparsedObject(_data_source) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                        ...
                        "span_kind" => {
                            ...
                            if let Some(ref _span_kind) = span_kind {
                                match _span_kind {
                                    crate::datadogV1::model::FormulaAndFunctionApmMetricsSpanKind::UnparsedObject(_span_kind) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                        ...
                        "stat" => {
                            ...
                            if let Some(ref _stat) = stat {
                                match _stat {
                                    crate::datadogV1::model::FormulaAndFunctionApmMetricStatName::UnparsedObject(_stat) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = FormulaAndFunctionApmMetricsQueryDefinition {
                    data_source,
                    group_by,
                    name,
                    operation_mode,
