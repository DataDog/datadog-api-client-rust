...
pub struct NotebookCreateDataAttributes {
    ...
    pub template_variables: Option<Option<Vec<crate::datadogV1::model::NotebookTemplateVariable>>>,
...
impl NotebookCreateDataAttributes {
    ...
    pub fn template_variables(
        mut self,
        value: Option<Vec<crate::datadogV1::model::NotebookTemplateVariable>>,
    ) -> Self {
...
impl<'de> Deserialize<'de> for NotebookCreateDataAttributes {
    ...
    where
        D: Deserializer<'de>,
    {
        struct NotebookCreateDataAttributesVisitor;
        impl<'a> Visitor<'a> for NotebookCreateDataAttributesVisitor {
            type Value = NotebookCreateDataAttributes;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut cells: Option<Vec<crate::datadogV1::model::NotebookCellCreateRequest>> =
                    None;
                ...
                let mut template_variables: Option<
                    Option<Vec<crate::datadogV1::model::NotebookTemplateVariable>>,
                > = None;
                ...
                let content = NotebookCreateDataAttributes {
                    cells,
                    metadata,
                    name,
                    status,
        ...
        deserializer.deserialize_any(NotebookCreateDataAttributesVisitor)
    }
}
