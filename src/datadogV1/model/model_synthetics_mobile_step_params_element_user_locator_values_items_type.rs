...
impl ToString for SyntheticsMobileStepParamsElementUserLocatorValuesItemsType {
    fn to_string(&self) -> String {
        match self {
            Self::ACCESSIBILITYNOT_ID => String::from("accessibility-id"),
            Self::ID => String::from("id"),
            Self::IOSNOT_PREDICATENOT_STRING => String::from("ios-predicate-string"),
            Self::IOSNOT_CLASSNOT_CHAIN => String::from("ios-class-chain"),
...
impl<'de> Deserialize<'de> for SyntheticsMobileStepParamsElementUserLocatorValuesItemsType {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match s.as_str() {
            "accessibility-id" => Self::ACCESSIBILITYNOT_ID,
            "id" => Self::ID,
            "ios-predicate-string" => Self::IOSNOT_PREDICATENOT_STRING,
            "ios-class-chain" => Self::IOSNOT_CLASSNOT_CHAIN,
            "xpath" => Self::XPATH,
