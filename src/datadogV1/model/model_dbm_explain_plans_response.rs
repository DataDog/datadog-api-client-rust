...
/// Response object with DBM explain plan events matching the request.
#[non_exhaustive]
...
impl Default for DbmExplainPlansResponse {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for DbmExplainPlansResponse {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct DbmExplainPlansResponseVisitor;
        impl<'a> Visitor<'a> for DbmExplainPlansResponseVisitor {
            type Value = DbmExplainPlansResponse;
        ...
        deserializer.deserialize_any(DbmExplainPlansResponseVisitor)
    }
}
