...
pub struct UsageSummaryDateOrg {
    ...
    #[serde(rename = "cloud_siem_indexed_logs_sum")]
    pub cloud_siem_indexed_logs_sum: Option<i64>,
    ...
    #[serde(rename = "csm_host_pro_hosts_agentless_scanners_sum")]
    pub csm_host_pro_hosts_agentless_scanners_sum: Option<i64>,
    ...
    #[serde(rename = "csm_host_pro_hosts_agentless_scanners_top99p")]
    pub csm_host_pro_hosts_agentless_scanners_top99p: Option<i64>,
    ...
    /// Shows the sum of all Cloud Security Management Pro Agentless scanner hosts over all hours in the current date for the given org.
    #[serde(rename = "cspm_hosts_agentless_scanners_sum")]
    pub cspm_hosts_agentless_scanners_sum: Option<i64>,
    /// Shows the 99th percentile of all Cloud Security Management Pro Agentless scanner hosts over all hours in the current date for the given org.
    #[serde(rename = "cspm_hosts_agentless_scanners_top99p")]
    pub cspm_hosts_agentless_scanners_top99p: Option<i64>,
    ...
    #[serde(rename = "do_jobs_monitoring_orchestrators_job_hours_sum")]
    pub do_jobs_monitoring_orchestrators_job_hours_sum: Option<i64>,
    ...
    /// Shows the sum of all SIEM 12mo Retention over all hours in the current date for the given org.
    #[serde(rename = "siem_12mo_retention_sum")]
    pub siem_12mo_retention_sum: Option<i64>,
    /// Shows the sum of all SIEM 6mo Retention over all hours in the current date for the given org.
    #[serde(rename = "siem_6mo_retention_sum")]
    pub siem_6mo_retention_sum: Option<i64>,
...
impl UsageSummaryDateOrg {
    pub fn new() -> UsageSummaryDateOrg {
        ...
        UsageSummaryDateOrg {
            ...
            cloud_siem_indexed_logs_sum: None,
            ...
            csm_host_pro_hosts_agentless_scanners_sum: None,
            csm_host_pro_hosts_agentless_scanners_top99p: None,
            ...
            cspm_hosts_agentless_scanners_sum: None,
            cspm_hosts_agentless_scanners_top99p: None,
            ...
            do_jobs_monitoring_orchestrators_job_hours_sum: None,
    ...
    #[allow(deprecated)]
    pub fn cloud_siem_indexed_logs_sum(mut self, value: i64) -> Self {
        self.cloud_siem_indexed_logs_sum = Some(value);
        self
    }
    ...
    #[allow(deprecated)]
    pub fn csm_host_pro_hosts_agentless_scanners_sum(mut self, value: i64) -> Self {
        self.csm_host_pro_hosts_agentless_scanners_sum = Some(value);
        self
    }

    #[allow(deprecated)]
    pub fn csm_host_pro_hosts_agentless_scanners_top99p(mut self, value: i64) -> Self {
        self.csm_host_pro_hosts_agentless_scanners_top99p = Some(value);
        self
    }
    ...
    #[allow(deprecated)]
    pub fn cspm_hosts_agentless_scanners_sum(mut self, value: i64) -> Self {
        self.cspm_hosts_agentless_scanners_sum = Some(value);
        self
    }

    #[allow(deprecated)]
    pub fn cspm_hosts_agentless_scanners_top99p(mut self, value: i64) -> Self {
        self.cspm_hosts_agentless_scanners_top99p = Some(value);
        self
    }
    ...
    #[allow(deprecated)]
    pub fn do_jobs_monitoring_orchestrators_job_hours_sum(mut self, value: i64) -> Self {
        self.do_jobs_monitoring_orchestrators_job_hours_sum = Some(value);
        self
    }
    ...
    #[allow(deprecated)]
    pub fn siem_12mo_retention_sum(mut self, value: i64) -> Self {
        self.siem_12mo_retention_sum = Some(value);
        self
    }

    #[allow(deprecated)]
    pub fn siem_6mo_retention_sum(mut self, value: i64) -> Self {
        self.siem_6mo_retention_sum = Some(value);
        self
    }
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'a> Visitor<'a> for UsageSummaryDateOrgVisitor {
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut cloud_siem_indexed_logs_sum: Option<i64> = None;
                ...
                let mut csm_host_pro_hosts_agentless_scanners_sum: Option<i64> = None;
                let mut csm_host_pro_hosts_agentless_scanners_top99p: Option<i64> = None;
                ...
                let mut cspm_hosts_agentless_scanners_sum: Option<i64> = None;
                let mut cspm_hosts_agentless_scanners_top99p: Option<i64> = None;
                ...
                let mut do_jobs_monitoring_orchestrators_job_hours_sum: Option<i64> = None;
                ...
                while let Some((k, v)) = map.next_entry::<String, serde_json::Value>()? {
                    match k.as_str() {
                        "account_name" => {
                            ...
                            account_name = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "account_public_id" => {
                            if v.is_null() {
                                continue;
                            }
                            account_public_id = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "agent_host_top99p" => {
                            if v.is_null() {
                                continue;
                        ...
                        "cloud_siem_indexed_logs_sum" => {
                            ...
                            cloud_siem_indexed_logs_sum = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        ...
                        "csm_host_pro_hosts_agentless_scanners_sum" => {
                            ...
                            csm_host_pro_hosts_agentless_scanners_sum = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "csm_host_pro_hosts_agentless_scanners_top99p" => {
                            if v.is_null() {
                                continue;
                            }
                            csm_host_pro_hosts_agentless_scanners_top99p = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        ...
                        "cspm_hosts_agentless_scanners_sum" => {
                            ...
                            cspm_hosts_agentless_scanners_sum = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "cspm_hosts_agentless_scanners_top99p" => {
                            if v.is_null() {
                                continue;
                            }
                            cspm_hosts_agentless_scanners_top99p = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "custom_historical_ts_avg" => {
                            if v.is_null() {
                                continue;
                            }
                            custom_historical_ts_avg = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "custom_live_ts_avg" => {
                            if v.is_null() {
                                continue;
                            }
                            custom_live_ts_avg = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "custom_ts_avg" => {
                            if v.is_null() {
                                continue;
                        ...
                        "do_jobs_monitoring_orchestrators_job_hours_sum" => {
                            ...
                            do_jobs_monitoring_orchestrators_job_hours_sum = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        ...
                        "siem_12mo_retention_sum" => {
                            ...
                            siem_12mo_retention_sum = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
                        "siem_6mo_retention_sum" => {
                            if v.is_null() {
                                continue;
                            }
                            siem_6mo_retention_sum = Some(serde_json::from_value(v).map_err(M::Error::custom)?);
                        },
