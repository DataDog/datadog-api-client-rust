...
pub struct UsageSummaryDateOrg {
    ...
    /// Shows the sum of all ephemeral infrastructure hosts for Basic with the Datadog Agent over all hours in the current date for the given org.
    #[serde(rename = "eph_infra_host_basic_infra_basic_agent_sum")]
    pub eph_infra_host_basic_infra_basic_agent_sum: Option<i64>,
    /// Shows the sum of all ephemeral infrastructure hosts for Basic on vSphere over all hours in the current date for the given org.
    #[serde(rename = "eph_infra_host_basic_infra_basic_vsphere_sum")]
    pub eph_infra_host_basic_infra_basic_vsphere_sum: Option<i64>,
    /// Shows the sum of all ephemeral infrastructure hosts for Basic over all hours in the current date for the given org.
    ...
    /// Shows the 99th percentile of all distinct infrastructure hosts for Basic with the Datadog Agent over all hours in the current date for the given org.
    #[serde(rename = "infra_host_basic_infra_basic_agent_top99p")]
    pub infra_host_basic_infra_basic_agent_top99p: Option<i64>,
    /// Shows the 99th percentile of all distinct infrastructure hosts for Basic on vSphere over all hours in the current date for the given org.
    #[serde(rename = "infra_host_basic_infra_basic_vsphere_top99p")]
    pub infra_host_basic_infra_basic_vsphere_top99p: Option<i64>,
    /// Shows the 99th percentile of all distinct infrastructure hosts for Basic over all hours in the current date for the given org.
