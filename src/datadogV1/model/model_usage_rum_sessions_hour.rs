...
impl UsageRumSessionsHour {
    ...
    pub fn with_replay_session_count(&mut self, value: i64) -> &mut Self {
        self.replay_session_count = Some(value);
        self
    }

    pub fn with_session_count(&mut self, value: Option<i64>) -> &mut Self {
        self.session_count = Some(value);
        self
    }

    pub fn with_session_count_android(&mut self, value: Option<i64>) -> &mut Self {
        self.session_count_android = Some(value);
        self
    }

    pub fn with_session_count_flutter(&mut self, value: Option<i64>) -> &mut Self {
        self.session_count_flutter = Some(value);
        self
    }

    pub fn with_session_count_ios(&mut self, value: Option<i64>) -> &mut Self {
        self.session_count_ios = Some(value);
        self
    }

    pub fn with_session_count_reactnative(&mut self, value: Option<i64>) -> &mut Self {
