...
impl ToString for MonthlyUsageAttributionSupportedMetrics {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::FLEX_LOGS_STARTER_USAGE => String::from("flex_logs_starter_usage"),
            Self::FLEX_LOGS_STARTER_PERCENTAGE => String::from("flex_logs_starter_percentage"),
...
impl<'de> Deserialize<'de> for MonthlyUsageAttributionSupportedMetrics {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(match s.as_str() {
            ...
            "flex_logs_starter_usage" => Self::FLEX_LOGS_STARTER_USAGE,
            "flex_logs_starter_percentage" => Self::FLEX_LOGS_STARTER_PERCENTAGE,
