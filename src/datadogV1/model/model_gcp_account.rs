...
impl GCPAccount {
    ...
    pub fn with_auth_provider_x509_cert_url(&mut self, value: String) -> &mut Self {
        self.auth_provider_x509_cert_url = Some(value);
        self
    }

    pub fn with_auth_uri(&mut self, value: String) -> &mut Self {
    ...
    pub fn with_client_x509_cert_url(&mut self, value: String) -> &mut Self {
    ...
    pub fn with_private_key(&mut self, value: String) -> &mut Self {
        self.private_key = Some(value);
        self
    }

    pub fn with_private_key_id(&mut self, value: String) -> &mut Self {
        self.private_key_id = Some(value);
        self
    }

    pub fn with_project_id(&mut self, value: String) -> &mut Self {
    ...
    pub fn with_token_uri(&mut self, value: String) -> &mut Self {
