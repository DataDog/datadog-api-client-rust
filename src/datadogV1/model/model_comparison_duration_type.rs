...
pub enum ComparisonDurationType {
    PREVIOUS_TIMEFRAME,
    CUSTOM_TIMEFRAME,
    PREVIOUS_DAY,
    PREVIOUS_WEEK,
...
impl ToString for ComparisonDurationType {
...
impl Serialize for ComparisonDurationType {
...
impl<'de> Deserialize<'de> for ComparisonDurationType {
