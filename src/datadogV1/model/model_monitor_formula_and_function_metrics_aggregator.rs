...
pub enum MonitorFormulaAndFunctionMetricsAggregator {
    AVG,
    MIN,
    MAX,
    SUM,
...
impl ToString for MonitorFormulaAndFunctionMetricsAggregator {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::COUNT_UNIQUE => String::from("count_unique"),
            Self::UnparsedObject(v) => v.value.to_string(),
        }
    }
}

impl Serialize for MonitorFormulaAndFunctionMetricsAggregator {
...
impl<'de> Deserialize<'de> for MonitorFormulaAndFunctionMetricsAggregator {
