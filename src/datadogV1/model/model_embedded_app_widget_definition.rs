...
pub struct EmbeddedAppWidgetDefinition {
    ...
    #[serde(rename = "inputs")]
    pub inputs: Option<Vec<crate::datadogV1::model::EmbeddedAppWidgetInput>>,
    ...
    #[serde(rename = "type")]
    pub type_: crate::datadogV1::model::EmbeddedAppWidgetDefinitionType,
    #[serde(skip)]
    #[serde(default)]
    pub(crate) _unparsed: bool,
}

impl EmbeddedAppWidgetDefinition {
    pub fn new(
        type_: crate::datadogV1::model::EmbeddedAppWidgetDefinitionType,
    ...
    pub fn inputs(mut self, value: Vec<crate::datadogV1::model::EmbeddedAppWidgetInput>) -> Self {
        self.inputs = Some(value);
        self
    }

    pub fn template_id(mut self, value: String) -> Self {
...
impl<'de> Deserialize<'de> for EmbeddedAppWidgetDefinition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct EmbeddedAppWidgetDefinitionVisitor;
        impl<'a> Visitor<'a> for EmbeddedAppWidgetDefinitionVisitor {
            type Value = EmbeddedAppWidgetDefinition;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut inputs: Option<Vec<crate::datadogV1::model::EmbeddedAppWidgetInput>> = None;
                ...
                let mut type_: Option<crate::datadogV1::model::EmbeddedAppWidgetDefinitionType> =
                    None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV1::model::EmbeddedAppWidgetDefinitionType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = EmbeddedAppWidgetDefinition {
                    app_id,
                    custom_links,
                    description,
                    inputs,
        ...
        deserializer.deserialize_any(EmbeddedAppWidgetDefinitionVisitor)
    }
}
