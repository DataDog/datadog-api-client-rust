...
impl<'de> Deserialize<'de> for IPPrefixesAPI {
    ...
    where
        D: Deserializer<'de>,
    {
        struct IPPrefixesAPIVisitor;
        impl<'a> Visitor<'a> for IPPrefixesAPIVisitor {
            type Value = IPPrefixesAPI;
        ...
        deserializer.deserialize_any(IPPrefixesAPIVisitor)
    }
}
