...
impl<'de> Deserialize<'de> for ChangeWidgetDefinition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ChangeWidgetDefinitionVisitor;
        impl<'a> Visitor<'a> for ChangeWidgetDefinitionVisitor {
            type Value = ChangeWidgetDefinition;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV1::model::ChangeWidgetDefinitionType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV1::model::ChangeWidgetDefinitionType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ChangeWidgetDefinitionVisitor)
    }
}
