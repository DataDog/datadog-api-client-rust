...
impl UsageSyntheticsBrowserHour {
    ...
    pub fn browser_check_calls_count(mut self, value: Option<i64>) -> Self {
...
impl<'de> Deserialize<'de> for UsageSyntheticsBrowserHour {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct UsageSyntheticsBrowserHourVisitor;
        impl<'a> Visitor<'a> for UsageSyntheticsBrowserHourVisitor {
            type Value = UsageSyntheticsBrowserHour;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut browser_check_calls_count: Option<Option<i64>> = None;
                ...
                let content = UsageSyntheticsBrowserHour {
                    browser_check_calls_count,
                    hour,
                    org_name,
                    public_id,
        ...
        deserializer.deserialize_any(UsageSyntheticsBrowserHourVisitor)
    }
}
