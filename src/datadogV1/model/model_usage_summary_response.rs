...
pub struct UsageSummaryResponse {
    ...
    /// Shows the sum of all ephemeral infrastructure hosts for Basic over all hours in the current month for all organizations.
    #[serde(rename = "eph_infra_host_basic_agg_sum")]
    pub eph_infra_host_basic_agg_sum: Option<i64>,
    /// Shows the sum of all ephemeral infrastructure hosts for Basic with the Datadog Agent over all hours in the current month for all organizations.
    #[serde(rename = "eph_infra_host_basic_infra_basic_agent_agg_sum")]
    pub eph_infra_host_basic_infra_basic_agent_agg_sum: Option<i64>,
    /// Shows the sum of all ephemeral infrastructure hosts for Basic on vSphere over all hours in the current month for all organizations.
    ...
    /// Shows the 99th percentile of all distinct infrastructure hosts for Basic with the Datadog Agent over all hours in the current month for all organizations.
    ...
    /// Shows the 99th percentile of all distinct infrastructure hosts for Basic over all hours in the current month for all organizations.
