...
impl<'de> Deserialize<'de> for MonitorFormulaAndFunctionEventQueryDefinitionCompute {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct MonitorFormulaAndFunctionEventQueryDefinitionComputeVisitor;
        impl<'a> Visitor<'a> for MonitorFormulaAndFunctionEventQueryDefinitionComputeVisitor {
            type Value = MonitorFormulaAndFunctionEventQueryDefinitionCompute;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = MonitorFormulaAndFunctionEventQueryDefinitionCompute {
                    aggregation,
                    interval,
                    metric,
                    _unparsed,
        ...
        deserializer.deserialize_any(MonitorFormulaAndFunctionEventQueryDefinitionComputeVisitor)
    }
}
