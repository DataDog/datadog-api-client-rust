...
impl ToplistWidgetDefinition {
    ...
    pub fn style(&mut self, value: crate::datadogV1::model::ToplistWidgetStyle) -> &mut Self {
...
impl<'de> Deserialize<'de> for ToplistWidgetDefinition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct ToplistWidgetDefinitionVisitor;
        impl<'a> Visitor<'a> for ToplistWidgetDefinitionVisitor {
            type Value = ToplistWidgetDefinition;
                ...
                M: MapAccess<'a>,
            {
                ...
                let mut type_: Option<crate::datadogV1::model::ToplistWidgetDefinitionType> = None;
                    ...
                    match k.as_str() {
                        ...
                        "type" => {
                            ...
                            if let Some(ref _type_) = type_ {
                                match _type_ {
                                    crate::datadogV1::model::ToplistWidgetDefinitionType::UnparsedObject(_type_) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
        ...
        deserializer.deserialize_any(ToplistWidgetDefinitionVisitor)
    }
}
