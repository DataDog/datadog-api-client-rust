...
impl UsageSyntheticsAPIHour {
    ...
    pub fn check_calls_count(&mut self, value: Option<i64>) -> &mut Self {
...
impl<'de> Deserialize<'de> for UsageSyntheticsAPIHour {
    ...
    where
        D: Deserializer<'de>,
    {
        struct UsageSyntheticsAPIHourVisitor;
        impl<'a> Visitor<'a> for UsageSyntheticsAPIHourVisitor {
            type Value = UsageSyntheticsAPIHour;
            ...
            where
                M: MapAccess<'a>,
            {
                let mut check_calls_count: Option<Option<i64>> = None;
                ...
                let content = UsageSyntheticsAPIHour {
                    check_calls_count,
                    hour,
                    org_name,
                    public_id,
        ...
        deserializer.deserialize_any(UsageSyntheticsAPIHourVisitor)
    }
}
