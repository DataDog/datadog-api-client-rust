...
pub struct UsageSummaryDate {
    ...
    /// Host count average of Cloud Cost Management for AWS for the given date for all organizations.
    #[serde(rename = "cloud_cost_management_aws_host_count_avg")]
    pub cloud_cost_management_aws_host_count_avg: Option<i64>,
    /// Host count average of Cloud Cost Management for Azure for the given date for all organizations.
    #[serde(rename = "cloud_cost_management_azure_host_count_avg")]
    pub cloud_cost_management_azure_host_count_avg: Option<i64>,
    /// Host count average of Cloud Cost Management for GCP for the given date for all organizations.
    #[serde(rename = "cloud_cost_management_gcp_host_count_avg")]
    pub cloud_cost_management_gcp_host_count_avg: Option<i64>,
    /// Host count average of Cloud Cost Management for all cloud providers for the given date for all organizations.
    ...
    /// Shows the 99th percentile of all Cloud Security Management Enterprise AWS hosts over all hours in the current date for all organizations.
    #[serde(rename = "csm_host_enterprise_aws_host_count_top99p")]
    pub csm_host_enterprise_aws_host_count_top99p: Option<i64>,
    /// Shows the 99th percentile of all Cloud Security Management Enterprise Azure hosts over all hours in the current date for all organizations.
    #[serde(rename = "csm_host_enterprise_azure_host_count_top99p")]
    pub csm_host_enterprise_azure_host_count_top99p: Option<i64>,
    /// Shows the 99th percentile of all Cloud Security Management Enterprise compliance hosts over all hours in the current date for all organizations.
    ...
    /// Shows the 99th percentile of all Cloud Security Management Enterprise Cloud Workload Security hosts over all hours in the current date for all organizations.
    ...
    /// Shows the sum of all bytes scanned of logs usage by the Sensitive Data Scanner over all hours in the current date for all organizations.
    ...
    /// Shows the sum of all bytes scanned across all usage types by the Sensitive Data Scanner over all hours in the current date for all organizations.
    #[serde(rename = "sds_total_scanned_bytes_sum")]
    pub sds_total_scanned_bytes_sum: Option<i64>,
    /// Shows the average of the number of Serverless Apps for Azure for the given date for all organizations.
    #[serde(rename = "serverless_apps_azure_count_avg")]
    pub serverless_apps_azure_count_avg: Option<i64>,
    /// Shows the average of the number of Serverless Apps for Google Cloud for the given date for all organizations.
    #[serde(rename = "serverless_apps_google_count_avg")]
    pub serverless_apps_google_count_avg: Option<i64>,
    /// Shows the average of the number of Serverless Apps for Azure and Google Cloud for the given date for all organizations.
    ...
    /// Shows the 99th percentile of all universal service management hosts over all hours in the current date for all organizations.
    ...
    /// Shows the 99th percentile of all Application Vulnerability Management hosts over all hours in the current date for all organizations.
