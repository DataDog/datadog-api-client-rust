...
impl UsageSummaryDate {
    ...
    #[allow(deprecated)]
    pub fn with_date(&mut self, value: String) -> &mut Self {
        self.date = Some(value);
        self
    }

    #[allow(deprecated)]
    pub fn with_dbm_host_top99p(&mut self, value: i64) -> &mut Self {
        self.dbm_host_top99p = Some(value);
        self
    }

    #[allow(deprecated)]
    pub fn with_dbm_queries_count_avg(&mut self, value: i64) -> &mut Self {
    ...
    #[allow(deprecated)]
    pub fn with_iot_device_sum(&mut self, value: i64) -> &mut Self {
        self.iot_device_sum = Some(value);
        self
    }

    #[allow(deprecated)]
    pub fn with_iot_device_top99p(&mut self, value: i64) -> &mut Self {
    ...
    pub fn with_orgs(
        &mut self,
        value: Vec<crate::datadogV1::model::UsageSummaryDateOrg>,
    ) -> &mut Self {
