...
pub struct HostMapWidgetInfrastructureRequestLeaf {
...
impl HostMapWidgetInfrastructureRequestLeaf {
    pub fn new(
...
impl<'de> Deserialize<'de> for HostMapWidgetInfrastructureRequestLeaf {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct HostMapWidgetInfrastructureRequestLeafVisitor;
        impl<'a> Visitor<'a> for HostMapWidgetInfrastructureRequestLeafVisitor {
            type Value = HostMapWidgetInfrastructureRequestLeaf;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = HostMapWidgetInfrastructureRequestLeaf {
                    conditional_formats,
                    enrichments,
                    filter,
                    group_by,
        ...
        deserializer.deserialize_any(HostMapWidgetInfrastructureRequestLeafVisitor)
    }
}
