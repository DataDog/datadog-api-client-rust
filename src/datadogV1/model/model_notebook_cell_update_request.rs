...
pub struct NotebookCellUpdateRequest {
    ...
    pub attributes: crate::datadogV1::model::NotebookCellUpdateRequestAttributes,
    /// Notebook cell ID.
    #[serde(rename = "id")]
    pub id: String,
...
impl NotebookCellUpdateRequest {
    pub fn new(
        attributes: crate::datadogV1::model::NotebookCellUpdateRequestAttributes,
        id: String,
...
impl<'de> Deserialize<'de> for NotebookCellUpdateRequest {
    ...
    where
        D: Deserializer<'de>,
    {
        struct NotebookCellUpdateRequestVisitor;
        impl<'a> Visitor<'a> for NotebookCellUpdateRequestVisitor {
            type Value = NotebookCellUpdateRequest;
                ...
                M: MapAccess<'a>,
            {
                let mut attributes: Option<
                    crate::datadogV1::model::NotebookCellUpdateRequestAttributes,
                > = None;
                    ...
                    match k.as_str() {
                        "attributes" => {
                            ...
                            if let Some(ref _attributes) = attributes {
                                match _attributes {
                                    crate::datadogV1::model::NotebookCellUpdateRequestAttributes::UnparsedObject(_attributes) => {
                                        _unparsed = true;
                                    },
                                    _ => {}
                                }
                ...
                let content = NotebookCellUpdateRequest {
                    attributes,
                    id,
                    type_,
        ...
        deserializer.deserialize_any(NotebookCellUpdateRequestVisitor)
    }
}
