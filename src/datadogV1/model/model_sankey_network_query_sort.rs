...
pub struct SankeyNetworkQuerySort {
    /// Field to sort by.
    #[serde(rename = "field")]
...
impl SankeyNetworkQuerySort {
    pub fn new() -> SankeyNetworkQuerySort {
...
impl Default for SankeyNetworkQuerySort {
    fn default() -> Self {
        Self::new()
    }
}

impl<'de> Deserialize<'de> for SankeyNetworkQuerySort {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        struct SankeyNetworkQuerySortVisitor;
        impl<'a> Visitor<'a> for SankeyNetworkQuerySortVisitor {
            type Value = SankeyNetworkQuerySort;
                ...
                M: MapAccess<'a>,
            {
                ...
                let content = SankeyNetworkQuerySort {
                    field,
                    order,
        ...
        deserializer.deserialize_any(SankeyNetworkQuerySortVisitor)
    }
}
