...
pub struct UsageAuditLogsHour {
    ...
    #[serde(rename = "lines_indexed", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
    pub lines_indexed: Option<Int64>,
