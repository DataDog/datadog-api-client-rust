...
pub struct UsageCWSHour {
    ...
    #[serde(rename = "cws_container_count", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
    pub cws_container_count: Option<Int64>,
    /// The total number of Cloud Workload Security host hours from the start of the given hour’s month until the given hour.
    #[serde(rename = "cws_host_count", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
    pub cws_host_count: Option<Int64>,
