...
pub struct UsageIoTHour {
    ...
    #[serde(rename = "iot_device_count", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
    pub iot_device_count: Option<Int64>,
