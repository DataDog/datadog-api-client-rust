...
pub struct UsageProfilingHour {
    ...
    #[serde(rename = "avg_container_agent_count", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
    pub avg_container_agent_count: Option<Int64>,
