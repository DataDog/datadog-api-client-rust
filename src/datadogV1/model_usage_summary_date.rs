...
pub struct UsageSummaryDate {
    ...
    pub dbm_host_top99p: i64,
    /// Shows the average of all normalized Database Monitoring queries over all hours in the current date for all organizations.
    #[serde(rename = "dbm_queries_count_avg", skip_serializing_if = "Option::is_none")]
    pub dbm_queries_count_avg: i64,
    ...
    pub orgs: Vec<UsageSummaryDateOrg>,
