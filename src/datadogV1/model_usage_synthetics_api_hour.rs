...
pub struct UsageSyntheticsAPIHour {
    ...
    #[serde(rename = "check_calls_count", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
    pub check_calls_count: Option<Int64>,
