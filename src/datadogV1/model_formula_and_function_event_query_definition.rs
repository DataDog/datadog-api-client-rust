...
pub struct FormulaAndFunctionEventQueryDefinition {
    ...
    pub compute: FormulaAndFunctionEventQueryDefinitionCompute,
    /// Data source for event platform-based queries.
    #[serde(rename = "data_source", skip_serializing_if = "Option::is_none")]
    pub data_source: FormulaAndFunctionEventsDataSource,
    /// Group by options.
    #[serde(rename = "group_by", skip_serializing_if = "Option::is_none")]
    pub group_by: Vec<FormulaAndFunctionEventQueryGroupBy>,
    ...
    /// Search options.
    #[serde(rename = "search")]
    pub search: FormulaAndFunctionEventQueryDefinitionSearch,
