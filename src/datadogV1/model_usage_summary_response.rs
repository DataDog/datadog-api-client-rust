...
pub struct UsageSummaryResponse {
    ...
    pub apm_azure_app_service_host_top99p_sum: i64,
    /// Shows the average of all APM ECS Fargate tasks over all hours in the current months for all organizations.
    #[serde(rename = "apm_fargate_count_avg_sum", skip_serializing_if = "Option::is_none")]
    pub apm_fargate_count_avg_sum: i64,
    ...
    #[serde(rename = "appsec_fargate_count_avg_sum", skip_serializing_if = "Option::is_none")]
    pub appsec_fargate_count_avg_sum: i64,
    /// Shows the sum of all audit logs lines indexed over all hours in the current months for all organizations.
    #[serde(rename = "audit_logs_lines_indexed_agg_sum", skip_serializing_if = "Option::is_none")]
    pub audit_logs_lines_indexed_agg_sum: i64,
    /// Shows the total number of organizations that had Audit Trail enabled over a specific number of months.
    #[serde(rename = "audit_trail_enabled_hwm_sum", skip_serializing_if = "Option::is_none")]
    pub audit_trail_enabled_hwm_sum: i64,
    /// Shows the average of all profiled Fargate tasks over all hours in the current months for all organizations.
    #[serde(rename = "avg_profiled_fargate_tasks_sum", skip_serializing_if = "Option::is_none")]
    pub avg_profiled_fargate_tasks_sum: i64,
    ...
    pub azure_app_service_top99p_sum: i64,
    ...
    pub billable_ingested_bytes_agg_sum: i64,
    /// Shows the sum of all browser lite sessions over all hours in the current months for all organizations.
    #[serde(rename = "browser_rum_lite_session_count_agg_sum", skip_serializing_if = "Option::is_none")]
    pub browser_rum_lite_session_count_agg_sum: i64,
    /// Shows the sum of all browser replay sessions over all hours in the current months for all organizations.
    #[serde(rename = "browser_rum_replay_session_count_agg_sum", skip_serializing_if = "Option::is_none")]
    pub browser_rum_replay_session_count_agg_sum: i64,
    /// Shows the sum of all browser RUM units over all hours in the current months for all organizations.
    #[serde(rename = "browser_rum_units_agg_sum", skip_serializing_if = "Option::is_none")]
    pub browser_rum_units_agg_sum: i64,
    /// Shows the sum of all CI pipeline indexed spans over all hours in the current months for all organizations.
    #[serde(rename = "ci_pipeline_indexed_spans_agg_sum", skip_serializing_if = "Option::is_none")]
    pub ci_pipeline_indexed_spans_agg_sum: i64,
    /// Shows the sum of all CI test indexed spans over all hours in the current months for all organizations.
    #[serde(rename = "ci_test_indexed_spans_agg_sum", skip_serializing_if = "Option::is_none")]
    pub ci_test_indexed_spans_agg_sum: i64,
    ...
    #[serde(rename = "ci_visibility_itr_committers_hwm_sum", skip_serializing_if = "Option::is_none")]
    pub ci_visibility_itr_committers_hwm_sum: i64,
    ...
    #[serde(rename = "ci_visibility_pipeline_committers_hwm_sum", skip_serializing_if = "Option::is_none")]
    pub ci_visibility_pipeline_committers_hwm_sum: i64,
    ...
    #[serde(rename = "ci_visibility_test_committers_hwm_sum", skip_serializing_if = "Option::is_none")]
    pub ci_visibility_test_committers_hwm_sum: i64,
    /// Sum of the host count average for Cloud Cost Management for AWS.
    #[serde(rename = "cloud_cost_management_aws_host_count_avg_sum", skip_serializing_if = "Option::is_none")]
    pub cloud_cost_management_aws_host_count_avg_sum: i64,
    /// Sum of the host count average for Cloud Cost Management for Azure.
    #[serde(rename = "cloud_cost_management_azure_host_count_avg_sum", skip_serializing_if = "Option::is_none")]
    pub cloud_cost_management_azure_host_count_avg_sum: i64,
    /// Sum of the host count average for Cloud Cost Management for all cloud providers.
    #[serde(rename = "cloud_cost_management_host_count_avg_sum", skip_serializing_if = "Option::is_none")]
    pub cloud_cost_management_host_count_avg_sum: i64,
    ...
    pub container_avg_sum: i64,
    /// Shows the average of the containers without the Datadog Agent over all hours in the current month for all organizations.
    #[serde(rename = "container_excl_agent_avg_sum", skip_serializing_if = "Option::is_none")]
    pub container_excl_agent_avg_sum: i64,
    ...
    #[serde(rename = "cspm_aas_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_aas_host_top99p_sum: i64,
    ...
    #[serde(rename = "cspm_aws_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_aws_host_top99p_sum: i64,
    ...
    #[serde(rename = "cspm_azure_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_azure_host_top99p_sum: i64,
    ...
    #[serde(rename = "cspm_container_avg_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_container_avg_sum: i64,
    ...
    #[serde(rename = "cspm_container_hwm_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_container_hwm_sum: i64,
    ...
    #[serde(rename = "cspm_gcp_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_gcp_host_top99p_sum: i64,
    ...
    #[serde(rename = "cspm_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub cspm_host_top99p_sum: i64,
    ...
    #[serde(rename = "cws_containers_avg_sum", skip_serializing_if = "Option::is_none")]
    pub cws_containers_avg_sum: i64,
    ...
    #[serde(rename = "cws_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub cws_host_top99p_sum: i64,
    ...
    pub fargate_tasks_count_avg_sum: i64,
    ...
    pub fargate_tasks_count_hwm_sum: i64,
    ...
    #[serde(rename = "forwarding_events_bytes_agg_sum", skip_serializing_if = "Option::is_none")]
    pub forwarding_events_bytes_agg_sum: i64,
    ...
    pub heroku_host_top99p_sum: i64,
    ...
    pub incident_management_monthly_active_users_hwm_sum: i64,
    ...
    pub indexed_events_count_agg_sum: i64,
    ...
    pub live_indexed_events_agg_sum: i64,
    ...
    pub live_ingested_bytes_agg_sum: i64,
    /// Object containing logs usage data broken down by retention period.
    #[serde(rename = "logs_by_retention", skip_serializing_if = "Option::is_none")]
    pub logs_by_retention: LogsByRetention,
    /// Shows the sum of all mobile lite sessions over all hours in the current months for all organizations.
    #[serde(rename = "mobile_rum_lite_session_count_agg_sum", skip_serializing_if = "Option::is_none")]
    pub mobile_rum_lite_session_count_agg_sum: i64,
    ...
    pub mobile_rum_session_count_agg_sum: i64,
    ...
    pub mobile_rum_session_count_android_agg_sum: i64,
    /// Shows the sum of all mobile RUM Sessions on Flutter over all hours in the current months for all organizations.
    #[serde(rename = "mobile_rum_session_count_flutter_agg_sum", skip_serializing_if = "Option::is_none")]
    pub mobile_rum_session_count_flutter_agg_sum: i64,
    ...
    pub mobile_rum_session_count_ios_agg_sum: i64,
    /// Shows the sum of all mobile RUM Sessions on React Native over all hours in the current months for all organizations.
    #[serde(rename = "mobile_rum_session_count_reactnative_agg_sum", skip_serializing_if = "Option::is_none")]
    pub mobile_rum_session_count_reactnative_agg_sum: i64,
    /// Shows the sum of all mobile RUM Sessions on Roku over all hours in the current months for all organizations.
    #[serde(rename = "mobile_rum_session_count_roku_agg_sum", skip_serializing_if = "Option::is_none")]
    pub mobile_rum_session_count_roku_agg_sum: i64,
    /// Shows the sum of all mobile RUM units over all hours in the current months for all organizations.
    #[serde(rename = "mobile_rum_units_agg_sum", skip_serializing_if = "Option::is_none")]
    pub mobile_rum_units_agg_sum: i64,
    ...
    pub netflow_indexed_events_count_agg_sum: i64,
    ...
    pub npm_host_top99p_sum: i64,
    /// Sum of all observability pipelines bytes processed over all hours in the current months for all organizations.
    #[serde(rename = "observability_pipelines_bytes_processed_agg_sum", skip_serializing_if = "Option::is_none")]
    pub observability_pipelines_bytes_processed_agg_sum: i64,
    /// Sum of all online archived events over all hours in the current months for all organizations.
    #[serde(rename = "online_archive_events_count_agg_sum", skip_serializing_if = "Option::is_none")]
    pub online_archive_events_count_agg_sum: i64,
    ...
    #[serde(rename = "opentelemetry_apm_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub opentelemetry_apm_host_top99p_sum: i64,
    ...
    pub opentelemetry_host_top99p_sum: i64,
    ...
    pub profiling_container_agent_count_avg: i64,
    ...
    pub profiling_host_count_top99p_sum: i64,
    ...
    pub rehydrated_indexed_events_agg_sum: i64,
    ...
    pub rehydrated_ingested_bytes_agg_sum: i64,
    ...
    pub rum_session_count_agg_sum: i64,
    ...
    pub rum_total_session_count_agg_sum: i64,
    /// Shows the sum of all browser and mobile RUM units over all hours in the current months for all organizations.
    #[serde(rename = "rum_units_agg_sum", skip_serializing_if = "Option::is_none")]
    pub rum_units_agg_sum: i64,
    ...
    pub synthetics_browser_check_calls_count_agg_sum: i64,
    ...
    pub synthetics_check_calls_count_agg_sum: i64,
    ...
    #[serde(rename = "synthetics_parallel_testing_max_slots_hwm_sum", skip_serializing_if = "Option::is_none")]
    pub synthetics_parallel_testing_max_slots_hwm_sum: i64,
    ...
    pub trace_search_indexed_events_count_agg_sum: i64,
    ...
    pub twol_ingested_events_bytes_agg_sum: i64,
    ...
    #[serde(rename = "universal_service_monitoring_host_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub universal_service_monitoring_host_top99p_sum: i64,
    /// An array of objects regarding hourly usage.
    #[serde(rename = "usage", skip_serializing_if = "Option::is_none")]
    pub usage: Vec<UsageSummaryDate>,
    ...
    pub vsphere_host_top99p_sum: i64,
    ...
    #[serde(rename = "vuln_management_host_count_top99p_sum", skip_serializing_if = "Option::is_none")]
    pub vuln_management_host_count_top99p_sum: i64,
    /// Sum of all workflows executed over all hours in the current months for all organizations.
    #[serde(rename = "workflow_executions_usage_agg_sum", skip_serializing_if = "Option::is_none")]
    pub workflow_executions_usage_agg_sum: i64,
}
