...
impl ToString for SyntheticsTestRequestBodyType {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::APPLICATION_X_WWW_FORM_URLENCODED => String::from("application/x-www-form-urlencoded"),
            Self::GRAPHQL => String::from("graphql"),
        }
    }
}

impl Default for SyntheticsTestRequestBodyType {
    fn default() -> SyntheticsTestRequestBodyType {
        Self::TEXT_PLAIN
    }
}
