...
create/update requests.
    ...
    pub timeframe: SearchSLOTimeframe,
...
Ignored in create/update requests.
    #[serde(rename = "warning_display", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none", deserialize_with = "Option::deserialize")]
