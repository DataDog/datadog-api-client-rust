...
impl GCPIntegrationAPI {
    ...
    > {
        ...
        let local_uri_str = format!(
            ...
            local_configuration.get_operation_host("v1.create_gcp_integration")
        );
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v1/integration/gcp",
            local_configuration.get_operation_host("v1.delete_gcp_integration")
        );
        let mut local_req_builder =
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v1/integration/gcp",
            local_configuration.get_operation_host("v1.list_gcp_integration")
        );
        let mut local_req_builder =
    ...
    > {
        ...
        let local_uri_str = format!(
            "{}/api/v1/integration/gcp",
            local_configuration.get_operation_host("v1.update_gcp_integration")
        );
        let mut local_req_builder =
