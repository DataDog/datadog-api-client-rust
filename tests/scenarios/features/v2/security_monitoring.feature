...
Feature: Security Monitoring
  ...
  Scenario: Mute or unmute security findings returns "Accepted" response
    ...
    And body with value {"data": {"attributes": {"mute": {"description": "To be resolved later.", "expiration_date": 1778721573794, "muted": true, "reason": "PENDING_FIX"}}, "id": "93bfeb70-af47-424d-908a-948d3f08e37f", "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 202 Accepted
  ...
  @replay-only @team:DataDog/k9-investigation
  Scenario: Mute security findings returns "Accepted" response
    Given new "MuteSecurityFindings" request
    And body with value {"data": {"attributes": {"mute": {"description": "To be resolved later.", "expiration_date": 1778721573794, "muted": true, "reason": "RISK_ACCEPTED"}}, "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 202 Accepted

  @team:DataDog/k9-investigation
  Scenario: Mute security findings returns "Bad Request" response
    Given new "MuteSecurityFindings" request
    And body with value {"data": {"attributes": {"mute": {"description": "", "expiration_date": 1778721573794, "muted": true, "reason": "RISK_ACCEPTED"}}, "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Mute security findings returns "Unprocessable Entity" response
    Given new "MuteSecurityFindings" request
    And body with value {"data": {"attributes": {"mute": {"description": "To be resolved later.", "expiration_date": 1, "muted": true, "reason": "RISK_ACCEPTED"}}, "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 422 Unprocessable Entity
  ...
  Scenario: Unmute security findings returns "Accepted" response
    Given new "MuteSecurityFindings" request
    And body with value {"data": {"attributes": {"mute": {"description": "Resolved.", "muted": false, "reason": "NO_PENDING_FIX"}}, "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 202 Accepted

  @team:DataDog/k9-investigation
  Scenario: Unmute security findings returns "Bad Request" response
    Given new "MuteSecurityFindings" request
    And body with value {"data": {"attributes": {"mute": {"description": "", "muted": false, "reason": "NO_PENDING_FIX"}}, "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Unmute security findings returns "Unprocessable Entity" response
    Given new "MuteSecurityFindings" request
    And body with value {"data": {"attributes": {"mute": {"description": "Resolved.", "muted": false, "reason": "RISK_ACCEPTED"}}, "relationships": {"findings": {"data": [{"id": "ZGVmLTAwcC1pZXJ-aS0wZjhjNjMyZDNmMzRlZTgzNw==", "type": "findings"}]}}, "type": "mute"}}
    When the request is sent
    Then the response status is 422 Unprocessable Entity
