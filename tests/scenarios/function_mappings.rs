...
pub fn collect_function_calls(world: &mut DatadogWorld) {
    ...
    world
        .function_mappings
        .insert("v2.ListAWSAccountsv2".into(), test_v2_list_aws_accountsv2);
    world
        .function_mappings
        .insert("v2.CreateAWSAccountv2".into(), test_v2_create_aws_accountv2);
    world
        .function_mappings
        .insert("v2.DeleteAWSAccountv2".into(), test_v2_delete_aws_accountv2);
    world
        .function_mappings
        .insert("v2.GetAWSAccountv2".into(), test_v2_get_aws_accountv2);
    world
        .function_mappings
        .insert("v2.PatchAWSAccountv2".into(), test_v2_patch_aws_accountv2);
    world
        .function_mappings
...
fn test_v2_list_aws_accountsv2(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
        .expect("api instance not found");
    let response = match block_on(api.list_aws_accountsv2_with_http_info()) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_create_aws_accountv2(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_aws_accountv2_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_delete_aws_accountv2(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
    ...
    let response = match block_on(api.delete_aws_accountv2_with_http_info(aws_account_config_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_aws_accountv2(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
    ...
    let aws_account_config_id =
        serde_json::from_value(_parameters.get("aws_account_config_id").unwrap().clone()).unwrap();
    let response = match block_on(api.get_aws_accountv2_with_http_info(aws_account_config_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_patch_aws_accountv2(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
    ...
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response =
        match block_on(api.patch_aws_accountv2_with_http_info(aws_account_config_id, body)) {
            Ok(response) => response,
            Err(error) => {
                return match error {
                    Error::ResponseError(e) => {
