...
pub fn initialize_api_instance(world: &mut DatadogWorld, api: String) {
    match api.as_str() {
        ...
        "AWSIntegration" => {
            ...
            world.api_instances.v2_api_aws_integration = Some(
                datadogV2::api_aws_integration::AWSIntegrationAPI::with_client_and_config(
                    world.config.clone(),
                    world.http_client.as_ref().unwrap().clone(),
                ),
            );
        ...
        "AWSLogsIntegration" => {
            ...
            world.api_instances.v2_api_aws_logs_integration = Some(
                datadogV2::api_aws_logs_integration::AWSLogsIntegrationAPI::with_client_and_config(
                    world.config.clone(),
                    world.http_client.as_ref().unwrap().clone(),
                ),
            );
        ...
        "Apps" => {
            world.api_instances.v2_api_apps =
                Some(datadogV2::api_apps::AppsAPI::with_client_and_config(
                    world.config.clone(),
                    world.http_client.as_ref().unwrap().clone(),
                ));
        }
        ...
        "DataDeletion" => {
            world.api_instances.v2_api_data_deletion = Some(
                datadogV2::api_data_deletion::DataDeletionAPI::with_client_and_config(
                    world.config.clone(),
                    world.http_client.as_ref().unwrap().clone(),
                ),
            );
        ...
        "WorkflowAutomation" => {
            world.api_instances.v2_api_workflow_automation = Some(
                datadogV2::api_workflow_automation::WorkflowAutomationAPI::with_client_and_config(
                    world.config.clone(),
                    world.http_client.as_ref().unwrap().clone(),
                ),
            );
...
pub fn collect_function_calls(world: &mut DatadogWorld) {
    ...
    world
        .function_mappings
        .insert("v2.DeleteApps".into(), test_v2_delete_apps);
    world
        .function_mappings
        .insert("v2.ListApps".into(), test_v2_list_apps);
    world
        .function_mappings
        .insert("v2.CreateApp".into(), test_v2_create_app);
    world
        .function_mappings
        .insert("v2.DeleteApp".into(), test_v2_delete_app);
    world
        .function_mappings
        .insert("v2.GetApp".into(), test_v2_get_app);
    world
        .function_mappings
        .insert("v2.UpdateApp".into(), test_v2_update_app);
    world
        .function_mappings
        .insert("v2.DisableApp".into(), test_v2_disable_app);
    world
        .function_mappings
        .insert("v2.DeployApp".into(), test_v2_deploy_app);
    world
        .function_mappings
    ...
    world.function_mappings.insert(
        "v2.UploadCustomCostsFile".into(),
        test_v2_upload_custom_costs_file,
    );
    world.function_mappings.insert(
        "v2.DeleteCustomCostsFile".into(),
        test_v2_delete_custom_costs_file,
    );
    world.function_mappings.insert(
        "v2.GetCustomCostsFile".into(),
        test_v2_get_custom_costs_file,
    );
    world.function_mappings.insert(
        "v2.ListCostGCPUsageCostConfigs".into(),
        test_v2_list_cost_gcp_usage_cost_configs,
    );
    world.function_mappings.insert(
        "v2.CreateCostGCPUsageCostConfig".into(),
        test_v2_create_cost_gcp_usage_cost_config,
    );
    world.function_mappings.insert(
        "v2.DeleteCostGCPUsageCostConfig".into(),
    ...
    world.function_mappings.insert(
        "v2.GetDataDeletionRequests".into(),
        test_v2_get_data_deletion_requests,
    );
    world.function_mappings.insert(
    ...
    world
        .function_mappings
        .insert("v2.CreateEvent".into(), test_v2_create_event);
    world
        .function_mappings
    ...
    world
        .function_mappings
        .insert("v2.ListIncidentTypes".into(), test_v2_list_incident_types);
    world
        .function_mappings
        .insert("v2.CreateIncidentType".into(), test_v2_create_incident_type);
    world
        .function_mappings
        .insert("v2.DeleteIncidentType".into(), test_v2_delete_incident_type);
    world
        .function_mappings
        .insert("v2.GetIncidentType".into(), test_v2_get_incident_type);
    world
        .function_mappings
    ...
    world
        .function_mappings
        .insert("v2.CreateAWSAccount".into(), test_v2_create_aws_account);
    world
        .function_mappings
        .insert("v2.DeleteAWSAccount".into(), test_v2_delete_aws_account);
    world
        .function_mappings
        .insert("v2.GetAWSAccount".into(), test_v2_get_aws_account);
    world
        .function_mappings
        .insert("v2.UpdateAWSAccount".into(), test_v2_update_aws_account);
    world
        .function_mappings
    ...
    world.function_mappings.insert(
        "v2.ListDeviceUserTags".into(),
        test_v2_list_device_user_tags,
    );
    world.function_mappings.insert(
    ...
    world
        .function_mappings
        .insert("v2.CreateRumMetric".into(), test_v2_create_rum_metric);
    world
        .function_mappings
        .insert("v2.DeleteRumMetric".into(), test_v2_delete_rum_metric);
    world
        .function_mappings
        .insert("v2.GetRumMetric".into(), test_v2_get_rum_metric);
    world
        .function_mappings
    ...
    world.function_mappings.insert(
        "v2.CreateWorkflowInstance".into(),
        test_v2_create_workflow_instance,
    );
    world.function_mappings.insert(
        "v2.GetWorkflowInstance".into(),
        test_v2_get_workflow_instance,
    );
    world.function_mappings.insert(
...
fn test_v2_delete_apps(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_apps
        .as_ref()
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.delete_apps_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_list_apps(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_apps
        .as_ref()
    ...
    let page = _parameters
        .get("page")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let filter_user_name = _parameters
        .get("filter[user_name]")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let filter_user_uuid = _parameters
        .get("filter[user_uuid]")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    ...
    let filter_query = _parameters
        .get("filter[query]")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let filter_deployed = _parameters
        .get("filter[deployed]")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    ...
    let sort = _parameters
        .get("sort")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let mut params = datadogV2::api_apps::ListAppsOptionalParams::default();
    params.limit = limit;
    params.page = page;
    params.filter_user_name = filter_user_name;
    params.filter_user_uuid = filter_user_uuid;
...
fn test_v2_create_app(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_apps
        .as_ref()
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_app_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_delete_app(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_apps
        .as_ref()
    ...
    let response = match block_on(api.delete_app_with_http_info(app_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_app(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_apps
        .as_ref()
...
fn test_v2_update_app(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_apps
        .as_ref()
    ...
    let app_id = serde_json::from_value(_parameters.get("app_id").unwrap().clone()).unwrap();
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.update_app_with_http_info(app_id, body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_disable_app(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        ...
        .expect("api instance not found");
    let app_id = serde_json::from_value(_parameters.get("app_id").unwrap().clone()).unwrap();
    let response = match block_on(api.disable_app_with_http_info(app_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_deploy_app(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        ...
        .expect("api instance not found");
    let app_id = serde_json::from_value(_parameters.get("app_id").unwrap().clone()).unwrap();
    let response = match block_on(api.deploy_app_with_http_info(app_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_list_custom_costs_files(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_cloud_cost_management
        .as_ref()
...
fn test_v2_upload_custom_costs_file(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.upload_custom_costs_file_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_delete_custom_costs_file(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .as_ref()
        .expect("api instance not found");
    let file_id = serde_json::from_value(_parameters.get("file_id").unwrap().clone()).unwrap();
    let response = match block_on(api.delete_custom_costs_file_with_http_info(file_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_custom_costs_file(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_cloud_cost_management
        .as_ref()
        .expect("api instance not found");
    let file_id = serde_json::from_value(_parameters.get("file_id").unwrap().clone()).unwrap();
    let response = match block_on(api.get_custom_costs_file_with_http_info(file_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_list_cost_gcp_usage_cost_configs(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .as_ref()
        .expect("api instance not found");
    let response = match block_on(api.list_cost_gcp_usage_cost_configs_with_http_info()) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_create_cost_gcp_usage_cost_config(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_cost_gcp_usage_cost_config_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_delete_cost_gcp_usage_cost_config(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
    ...
    let cloud_account_id =
        serde_json::from_value(_parameters.get("cloud_account_id").unwrap().clone()).unwrap();
    let response =
        match block_on(api.delete_cost_gcp_usage_cost_config_with_http_info(cloud_account_id)) {
            Ok(response) => response,
            Err(error) => {
                return match error {
                    Error::ResponseError(e) => {
...
fn test_v2_create_data_deletion_request(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        .api_instances
        .v2_api_data_deletion
        .as_ref()
        .expect("api instance not found");
    let product = serde_json::from_value(_parameters.get("product").unwrap().clone()).unwrap();
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_data_deletion_request_with_http_info(product, body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_data_deletion_requests(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .as_ref()
        .expect("api instance not found");
    let next_page = _parameters
        .get("next_page")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let product = _parameters
        .get("product")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let query = _parameters
        .get("query")
    ...
    let page_size = _parameters
        .get("page_size")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let mut params = datadogV2::api_data_deletion::GetDataDeletionRequestsOptionalParams::default();
    params.next_page = next_page;
    params.product = product;
    params.query = query;
    params.status = status;
    params.page_size = page_size;
    let response = match block_on(api.get_data_deletion_requests_with_http_info(params)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_cancel_data_deletion_request(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .expect("api instance not found");
    let id = serde_json::from_value(_parameters.get("id").unwrap().clone()).unwrap();
    let response = match block_on(api.cancel_data_deletion_request_with_http_info(id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_create_event(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_events
        .as_ref()
...
fn test_v2_list_incident_types(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_incidents
        .as_ref()
    ...
    let include_deleted = _parameters
        .get("include_deleted")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let mut params = datadogV2::api_incidents::ListIncidentTypesOptionalParams::default();
    params.include_deleted = include_deleted;
    let response = match block_on(api.list_incident_types_with_http_info(params)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_create_incident_type(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_incidents
        .as_ref()
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_incident_type_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_delete_incident_type(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_incidents
        .as_ref()
    ...
    let response = match block_on(api.delete_incident_type_with_http_info(incident_type_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_incident_type(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_incidents
        .as_ref()
    ...
    let incident_type_id =
        serde_json::from_value(_parameters.get("incident_type_id").unwrap().clone()).unwrap();
    let response = match block_on(api.get_incident_type_with_http_info(incident_type_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_update_incident_type(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_incidents
        .as_ref()
...
fn test_v2_list_aws_accounts(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
        .expect("api instance not found");
    let aws_account_id = _parameters
        .get("aws_account_id")
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let mut params = datadogV2::api_aws_integration::ListAWSAccountsOptionalParams::default();
...
fn test_v2_create_aws_account(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
...
fn test_v2_delete_aws_account(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
        .expect("api instance not found");
    let aws_account_config_id =
        serde_json::from_value(_parameters.get("aws_account_config_id").unwrap().clone()).unwrap();
    let response = match block_on(api.delete_aws_account_with_http_info(aws_account_config_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_aws_account(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
    ...
    let aws_account_config_id =
        serde_json::from_value(_parameters.get("aws_account_config_id").unwrap().clone()).unwrap();
    let response = match block_on(api.get_aws_account_with_http_info(aws_account_config_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_update_aws_account(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
    ...
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response =
        match block_on(api.update_aws_account_with_http_info(aws_account_config_id, body)) {
            Ok(response) => response,
            Err(error) => {
                return match error {
                    Error::ResponseError(e) => {
...
fn test_v2_list_aws_namespaces(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_integration
        .as_ref()
...
fn test_v2_create_new_aws_external_id(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .as_ref()
        .expect("api instance not found");
    let response = match block_on(api.create_new_aws_external_id_with_http_info()) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_list_aws_logs_services(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_aws_logs_integration
        .as_ref()
        .expect("api instance not found");
    let response = match block_on(api.list_aws_logs_services_with_http_info()) {
        Ok(response) => response,
...
fn test_v2_get_channel_by_name(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        ...
        .expect("api instance not found");
    let tenant_name =
        serde_json::from_value(_parameters.get("tenant_name").unwrap().clone()).unwrap();
    let team_name = serde_json::from_value(_parameters.get("team_name").unwrap().clone()).unwrap();
    let channel_name =
        serde_json::from_value(_parameters.get("channel_name").unwrap().clone()).unwrap();
    let response = match block_on(api.get_channel_by_name_with_http_info(
        tenant_name,
        team_name,
        channel_name,
    )) {
...
fn test_v2_list_device_user_tags(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_network_device_monitoring
        .as_ref()
        .expect("api instance not found");
    let device_id = serde_json::from_value(_parameters.get("device_id").unwrap().clone()).unwrap();
    let response = match block_on(api.list_device_user_tags_with_http_info(device_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_update_device_user_tags(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_network_device_monitoring
        .as_ref()
...
fn test_v2_convert_job_result_to_signal(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
        ...
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.convert_job_result_to_signal_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_list_rum_metrics(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_rum_metrics
        .as_ref()
        .expect("api instance not found");
    let response = match block_on(api.list_rum_metrics_with_http_info()) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_create_rum_metric(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_rum_metrics
        .as_ref()
        .expect("api instance not found");
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_rum_metric_with_http_info(body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_delete_rum_metric(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_rum_metrics
        .as_ref()
        .expect("api instance not found");
    let metric_id = serde_json::from_value(_parameters.get("metric_id").unwrap().clone()).unwrap();
    let response = match block_on(api.delete_rum_metric_with_http_info(metric_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_rum_metric(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_rum_metrics
        .as_ref()
        .expect("api instance not found");
    let metric_id = serde_json::from_value(_parameters.get("metric_id").unwrap().clone()).unwrap();
    let response = match block_on(api.get_rum_metric_with_http_info(metric_id)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_update_rum_metric(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_rum_metrics
        .as_ref()
...
fn test_v2_list_workflow_instances(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
    ...
    let page_number = _parameters
        ...
        .and_then(|param| Some(serde_json::from_value(param.clone()).unwrap()));
    let mut params =
        datadogV2::api_workflow_automation::ListWorkflowInstancesOptionalParams::default();
    params.page_size = page_size;
    params.page_number = page_number;
    let response = match block_on(api.list_workflow_instances_with_http_info(workflow_id, params)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_create_workflow_instance(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
    ...
    let workflow_id =
        serde_json::from_value(_parameters.get("workflow_id").unwrap().clone()).unwrap();
    let body = serde_json::from_value(_parameters.get("body").unwrap().clone()).unwrap();
    let response = match block_on(api.create_workflow_instance_with_http_info(workflow_id, body)) {
        Ok(response) => response,
        Err(error) => {
            return match error {
                Error::ResponseError(e) => {
...
fn test_v2_get_workflow_instance(world: &mut DatadogWorld, _parameters: &HashMap<String, Value>) {
    let api = world
        .api_instances
        .v2_api_workflow_automation
        .as_ref()
    ...
    let response =
        match block_on(api.get_workflow_instance_with_http_info(workflow_id, instance_id)) {
            Ok(response) => response,
            Err(error) => {
                return match error {
                    Error::ResponseError(e) => {
...
fn test_v2_cancel_workflow_instance(
    world: &mut DatadogWorld,
    _parameters: &HashMap<String, Value>,
) {
    let api = world
    ...
    let instance_id =
        serde_json::from_value(_parameters.get("instance_id").unwrap().clone()).unwrap();
    let response =
        match block_on(api.cancel_workflow_instance_with_http_info(workflow_id, instance_id)) {
            Ok(response) => response,
            Err(error) => {
                return match error {
                    Error::ResponseError(e) => {
